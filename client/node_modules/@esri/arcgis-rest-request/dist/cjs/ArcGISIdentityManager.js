...
const getOauthStateId_js_1 = require("./utils/getOauthStateId.js");
const encodeOauthState_js_1 = require("./utils/encodeOauthState.js");
/**
...
class ArcGISIdentityManager extends AuthenticationManagerBase_js_1.AuthenticationManagerBase {
    ...
    static beginOAuth2(options, win) {
         ...
         */
        const stateId = (0, getOauthStateId_js_1.getOauthStateId)(state, win);
        ...
        const authorizeUrlParams = {
            ...
            state: (0, encodeOauthState_js_1.encodeOauthState)(stateId, state, win.location.href),
            locale: locale,
            style: style
        };
