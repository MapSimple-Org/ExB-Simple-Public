...
const qn = "Canceled";
function No(e) {
  return e instanceof So ? !0 : e instanceof Error && e.name === qn && e.message === qn;
}
...
class Wt {
  ...
  add(t) {
    ...
    return this._isDisposed ? Wt.DISABLE_DISPOSED_WARNING || console.warn(new Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!").stack) : this._toDispose.add(t), t;
  }
  /**
...
class cn {
  ...
  constructor() {
    this._store = new Wt(), this._store;
  }
  dispose() {
    this._store.dispose();
  }
...
const Eo = globalThis.performance && typeof globalThis.performance.now == "function";
class Rn {
  static create(t) {
    return new Rn(t);
  }
  constructor(t) {
    this._now = Eo && t === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance), this._startTime = this._now(), this._stopTime = -1;
  }
  stop() {
...
(function(e) {
  ...
  e.onceIf = r;
  function i(k, R, I) {
    return h((T, P = null, D) => k(($) => T.call(P, R($)), null, D), I);
  }
  e.map = i;
  function s(k, R, I) {
    return h((T, P = null, D) => k(($) => {
      R($), T.call(P, $);
    }, null, D), I);
  }
  e.forEach = s;
  function a(k, R, I) {
    return h((T, P = null, D) => k(($) => R($) && T.call(P, $), null, D), I);
  }
  e.filter = a;
  function l(k) {
    return k;
  ...
  function d(k, R, I = 100, T = !1, P = !1, D, $) {
    let j, ee, ot, zt = 0, Rt;
    const xo = {
      leakWarningThreshold: D,
      onWillAddFirstListener() {
        j = k((yo) => {
          zt++, ee = R(ee, yo), T && !ot && (Gt.fire(ee), ee = void 0), Rt = () => {
            const wo = ee;
            ee = void 0, ot = void 0, (!T || zt > 1) && Gt.fire(wo), zt = 0;
  ...
  function y(k, R, I = (T) => T) {
    const T = (...j) => $.fire(I(...j)), P = () => k.on(R, T), D = () => k.removeListener(R, T), $ = new _e({ onWillAddFirstListener: P, onDidRemoveLastListener: D });
    return $.event;
  }
  e.fromNodeEventEmitter = y;
  function b(k, R, I = (T) => T) {
    const T = (...j) => $.fire(I(...j)), P = () => k.addEventListener(R, T), D = () => k.removeEventListener(R, T), $ = new _e({ onWillAddFirstListener: P, onDidRemoveLastListener: D });
    return $.event;
  }
  ...
  function N(k) {
    return (R, I, T) => {
      ...
      k.addObserver($), k.reportChanges();
      const j = {
        dispose() {
          k.removeObserver($);
        }
      };
      return T instanceof Wt ? T.add(j) : Array.isArray(T) && T.push(j), j;
    };
  }
...
class Er {
  ...
  constructor(t, n, r = (Er._idPool++).toString(16).padStart(3, "0")) {
...
class _e {
  constructor(t) {
    this._size = 0, this._options = t, this._leakageMon = this._options?.leakWarningThreshold ? new Er(t?.onListenerError ?? Ft, this._options?.leakWarningThreshold ?? Mo) : void 0, this._perfMon = this._options?._profName ? new hn(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue;
  }
  dispose() {
  ...
  get event() {
    return this._event ??= (t, n, r) => {
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        ...
        return (this._options?.onListenerError || Ft)(u), cn.None;
      }
      if (this._disposed)
        return cn.None;
      n && (t = t.bind(n));
      const i = new Mn(t);
      let s;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (i.stack = Mr.create(), s = this._leakageMon.check(i.stack, this._size + 1)), this._listeners ? this._listeners instanceof Mn ? (this._deliveryQueue ??= new Io(), this._listeners = [this._listeners, i]) : this._listeners.push(i) : (this._options?.onWillAddFirstListener?.(this), this._listeners = i, this._options?.onDidAddFirstListener?.(this)), this._size++;
      const a = un(() => {
        s?.(), this._removeListener(i);
      });
      return r instanceof Wt ? r.add(a) : Array.isArray(r) && r.push(a), a;
    }, this._event;
  }
  _removeListener(t) {
  ...
  _deliver(t, n) {
    if (!t)
      return;
    const r = this._options?.onListenerError || Ft;
    if (!r) {
      t.value(n);
      return;
    }
   ...
   */
  fire(t) {
    if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners) if (this._listeners instanceof Mn)
...
const Vo = Fa() === "pseudo" || typeof document < "u" && document.location && document.location.hash.indexOf("pseudo=true") >= 0;
function $r(e, t) {
  let n;
...
function X(e, t, ...n) {
  return $r(typeof e == "number" ? Do(e, t) : t, n);
}
function Do(e, t) {
  const n = Fo()?.[e];
  if (typeof n != "string") {
...
const bt = "en";
let jn = !1, Wn = !1, Cn = !1, Va = !1, Cr = !1, Jt, Tn = bt, Br = bt, Oo, De;
const Oe = globalThis;
let ve;
...
const $o = typeof ve?.versions?.electron == "string", Bo = $o && ve?.type === "renderer";
if (typeof ve == "object") {
  jn = ve.platform === "win32", Wn = ve.platform === "darwin", Cn = ve.platform === "linux", Cn && ve.env.SNAP && ve.env.SNAP_REVISION, ve.env.CI || ve.env.BUILD_ARTIFACTSTAGINGDIRECTORY, Jt = bt, Tn = bt;
  const e = ve.env.VSCODE_NLS_CONFIG;
  if (e)
    try {
      const t = JSON.parse(e);
      Jt = t.userLocale, Br = t.osLocale, Tn = t.resolvedLanguage || bt, Oo = t.languagePack?.translationsConfigFile;
    } catch {
    }
  Va = !0;
} else typeof navigator == "object" && !Bo ? (De = navigator.userAgent, jn = De.indexOf("Windows") >= 0, Wn = De.indexOf("Macintosh") >= 0, (De.indexOf("Macintosh") >= 0 || De.indexOf("iPad") >= 0 || De.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints > 0, Cn = De.indexOf("Linux") >= 0, De?.indexOf("Mobi") >= 0, Cr = !0, Tn = Fa() || bt, Jt = navigator.language.toLowerCase(), Br = Jt) : console.error("Unable to resolve platform.");
const Ot = jn, Uo = Wn, qo = Va, jo = Cr, Wo = Cr && typeof Oe.importScripts == "function", Ho = Wo ? Oe.origin : void 0, Fe = De, zo = typeof Oe.postMessage == "function" && !Oe.importScripts;
(() => {
  if (zo) {
    const e = [];
...
const Go = !!(Fe && Fe.indexOf("Chrome") >= 0);
Fe && Fe.indexOf("Firefox") >= 0;
!Go && Fe && Fe.indexOf("Safari") >= 0;
Fe && Fe.indexOf("Edg/") >= 0;
...
class Xo {
  constructor(t, n) {
    this.lastCache = void 0, this.lastArgKey = void 0, typeof t == "function" ? (this._fn = t, this._computeKey = Jo) : (this._fn = n, this._computeKey = t.getCacheKey);
  }
  get(t) {
...
class Ye {
  ...
  static {
    this._locales = new Ur(() => Object.keys(Ye.ambiguousCharacterData.value).filter((t) => !t.startsWith("_")));
  }
  static getLocales() {
...
if (typeof Pn < "u" && typeof Pn.process < "u") {
  ...
  // Supported
  get platform() {
    return Ot ? "win32" : Uo ? "darwin" : "linux";
  },
  get arch() {
  },
  // Unsupported
...
const dn = xt.cwd, sl = xt.env, al = xt.platform, ol = 65, ll = 97, ul = 90, cl = 122, Ke = 46, le = 47, de = 92, je = 58, fl = 63;
...
function hl(e, t) {
  if (e === null || typeof e != "object")
    throw new Oa(t, "Object", e);
}
function Z(e, t) {
  if (typeof e != "string")
    throw new Oa(t, "string", e);
}
const qe = al === "win32";
function U(e) {
  return e === le || e === de;
...
function $a(e, t) {
  hl(t, "pathObject");
  const n = t.dir || t.root, r = t.base || `${t.name || ""}${dl(t.ext)}`;
...
const fe = {
    ...
    for (let i = e.length - 1; i >= -1; i--) {
      ...
      if (i >= 0) {
        if (s = e[i], Z(s, `paths[${i}]`), s.length === 0)
          continue;
      } else t.length === 0 ? s = dn() : (s = sl[`=${t}`] || dn(), (s === void 0 || s.slice(0, 2).toLowerCase() !== t.toLowerCase() && s.charCodeAt(2) === de) && (s = `${t}\\`));
      const a = s.length;
      let l = 0, o = "", u = !1;
  ...
  relative(e, t) {
    ...
    if (d !== h) {
      ...
      a > h && (e.charCodeAt(i + d) === de ? f = d : d === 2 && (f = 3)), f === -1 && (f = 0);
    }
    let m = "";
    for (d = i + f + 1; d <= s; ++d)
      (d === s || e.charCodeAt(d) === de) && (m += m.length === 0 ? ".." : "\\..");
    return l += f, m.length > 0 ? `${m}${r.slice(l, o)}` : (r.charCodeAt(l) === de && ++l, r.slice(l, o));
  },
  toNamespacedPath(e) {
  ...
  resolve(...e) {
    ...
    return t = mn(t, !n, "/", zn), n ? `/${t}` : t.length > 0 ? t : ".";
  },
  normalize(e) {
    if (Z(e, "path"), e.length === 0)
      return ".";
    const t = e.charCodeAt(0) === le, n = e.charCodeAt(e.length - 1) === le;
    return e = mn(e, !t, "/", zn), e.length === 0 ? t ? "/" : n ? "./" : "." : (n && (e += "/"), t ? `/${e}` : e);
  },
  isAbsolute(e) {
...
let Te = class Kt {
  ...
  constructor(t, n, r, i, s, a = !1) {
    typeof t == "object" ? (this.scheme = t.scheme || G, this.authority = t.authority || G, this.path = t.path || G, this.query = t.query || G, this.fragment = t.fragment || G) : (this.scheme = yl(t, a), this.authority = n || G, this.path = wl(this.scheme, r || G), this.query = i || G, this.fragment = s || G, xl(this, a));
  }
  // ---- filesystem path -----------------------
  /**
  ...
  static parse(t, n = !1) {
    const r = _l.exec(t);
    return r ? new lt(r[2] || G, Xt(r[4] || G), Xt(r[5] || G), Xt(r[7] || G), Xt(r[9] || G), n) : new lt(G, G, G, G, G);
  }
  /**
  ...
  static file(t) {
    let n = G;
    if (Ot && (t = t.replace(/\\/g, Ae)), t[0] === Ae && t[1] === Ae) {
  ...
  static joinPath(t, ...n) {
    ...
    let r;
    return Ot && t.scheme === "file" ? r = Kt.file(fe.join(Gn(t, !0), ...n)).path : r = he.join(t.path, ...n), t.with({ path: r });
  }
  ...
  static revive(t) {
    if (t) {
      ...
      {
        const n = new lt(t);
        return n._formatted = t.external ?? null, n._fsPath = t._sep === Ba ? t.fsPath ?? null : null, n;
      }
    } else return t;
  }
};
const Ba = Ot ? 1 : void 0;
class lt extends Te {
  constructor() {
  ...
  toJSON() {
    ...
    return this._fsPath && (t.fsPath = this._fsPath, t._sep = Ba), this._formatted && (t.external = this._formatted), this.path && (t.path = this.path), this.scheme && (t.scheme = this.scheme), this.authority && (t.authority = this.authority), this.query && (t.query = this.query), this.fragment && (t.fragment = this.fragment), t;
  }
}
const Ua = {
  58: "%3A",
...
function Ll(e) {
  ...
  for (let n = 0; n < e.length; n++) {
    const r = e.charCodeAt(n);
    r === 35 || r === 63 ? (t === void 0 && (t = e.substr(0, n)), t += Ua[r]) : t !== void 0 && (t += e[n]);
  }
  return t !== void 0 ? t : e;
}
function Gn(e, t) {
  let n;
  return e.authority && e.path.length > 1 && e.scheme === "file" ? n = `//${e.authority}${e.path}` : e.path.charCodeAt(0) === 47 && (e.path.charCodeAt(1) >= 65 && e.path.charCodeAt(1) <= 90 || e.path.charCodeAt(1) >= 97 && e.path.charCodeAt(1) <= 122) && e.path.charCodeAt(2) === 58 ? t ? n = e.path.substr(1) : n = e.path[1].toLowerCase() + e.path.substr(2) : n = e.path, Ot && (n = n.replace(/\//g, "\\")), n;
}
function Jn(e, t) {
  const n = t ? Ll : qr;
  ...
  return l && (r += "?", r += n(l, !1, !1)), o && (r += "#", r += t ? o : qr(o, !1, !1)), r;
}
function qa(e) {
  try {
...
function Xt(e) {
  return e.match(jr) ? e.replace(jr, (t) => qa(t)) : e;
}
var Ze;
(function(e) {
...
class Sl {
  ...
  rewrite(t) {
    ...
    return typeof s == "string" && (a += `&${Nl}=${encodeURIComponent(s)}`), Te.from({
      scheme: jo ? this._preferredWebSchema : Ze.vscodeRemoteResource,
      authority: `${r}:${i}`,
...
const Al = new Sl(), kl = "vscode-app";
class gn {
  static {
    this.FALLBACK_AUTHORITY = kl;
  }
  /**
   ...
   */
  uriToBrowserUri(t) {
    return t.scheme === Ze.vscodeRemote ? Al.rewrite(t) : (
      // ...only ever for `file` resources
      t.scheme === Ze.file && // ...and we run in native environments
      (qo || // ...or web worker extensions on desktop
      Ho === `${Ze.vscodeFileResource}://${gn.FALLBACK_AUTHORITY}`) ? t.with({
        scheme: Ze.vscodeFileResource,
        // We need to provide an authority here so that it can serve
        // as origin for network and loading matters in chromium.
        // If the URI is not coming with an authority already, we
        // add our own
        authority: t.authority || gn.FALLBACK_AUTHORITY,
        query: null,
        fragment: null
      }) : t
    );
...
const In = "default", Rl = "$initialize";
class El {
...
class Pl {
  ...
  sendMessage(t, n, r) {
    ...
    return new Promise((s, a) => {
      this._pendingReplies[i] = {
        resolve: s,
        reject: a
      }, this._send(new El(this._workerId, i, t, n, r));
    });
  }
  listen(t, n, r) {
    let i = null;
    const s = new _e({
      onWillAddFirstListener: () => {
        i = String(++this._lastSentReq), this._pendingEmitters.set(i, s), this._send(new Ml(this._workerId, i, t, n, r));
      },
      onDidRemoveLastListener: () => {
  ...
  createProxyToRemoteChannel(t, n) {
    const r = {
      get: (i, s) => (typeof s == "string" && !i[s] && (Ha(s) ? i[s] = (a) => this.listen(t, s, a) : Wa(s) ? i[s] = this.listen(t, s, void 0) : s.charCodeAt(0) === 36 && (i[s] = async (...a) => (await n?.(), this.sendMessage(t, s, a)))), i[s])
    };
  ...
  _handleRequestMessage(t) {
    ...
    this._handler.handleMessage(t.channel, t.method, t.args).then((i) => {
      this._send(new Hr(this._workerId, n, i, void 0));
    }, (i) => {
      i.detail instanceof Error && (i.detail = Or(i.detail)), this._send(new Hr(this._workerId, n, void 0, Or(i)));
    });
  }
  _handleSubscribeEventMessage(t) {
    const n = t.req, r = this._handler.handleEvent(t.channel, t.eventName, t.arg)((i) => {
      this._send(new Cl(this._workerId, n, i));
    });
...
function Wa(e) {
  return e[0] === "o" && e[1] === "n" && Da(e.charCodeAt(2));
}
function Ha(e) {
  return /^onDynamic/.test(e) && Da(e.charCodeAt(9));
}
class Il {
  constructor(t, n) {
    this._localChannels = /* @__PURE__ */ new Map(), this._remoteChannels = /* @__PURE__ */ new Map(), this._requestHandlerFactory = n, this._requestHandler = null, this._protocol = new Pl({
      sendMessage: (r, i) => {
        t(r, i);
      },
  ...
  _handleMessage(t, n, r) {
    ...
    const i = t === In ? this._requestHandler : this._localChannels.get(t);
    if (!i)
...
function Vl(e, t, n) {
  return new Qe(new Gr(e), new Gr(t)).ComputeDiff(n).changes;
}
class ut {
  static Assert(t, n) {
    if (!t)
...
class Qe {
  ...
  WALKTRACE(t, n, r, i, s, a, l, o, u, h, f, d, m, g, p, v, w, _) {
    let x = null, y = null, b = new Jr(), L = n, S = r, M = m[0] - v[0] - i, F = -1073741824, O = this.m_forwardHistory.length - 1;
    do {
      const C = M + t;
      C === L || C < S && u[C - 1] < u[C + 1] ? (f = u[C + 1], g = f - M - i, f < F && b.MarkNextChange(), F = f, b.AddModifiedElement(f + 1, g), M = C + 1 - t) : (f = u[C - 1] + 1, g = f - M - i, f < F && b.MarkNextChange(), F = f - 1, b.AddOriginalElement(f, g + 1), M = C - 1 - t), O >= 0 && (u = this.m_forwardHistory[O], t = u[0], L = 1, S = u.length - 1);
    } while (--O >= -1);
    if (x = b.getReverseChanges(), _[0]) {
      ...
      b = new Jr(), L = a, S = l, M = m[0] - v[0] - o, F = 1073741824, O = w ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
      do {
        const C = M + s;
        C === L || C < S && h[C - 1] >= h[C + 1] ? (f = h[C + 1] - 1, g = f - M - o, f > F && b.MarkNextChange(), F = f + 1, b.AddOriginalElement(f + 1, g + 1), M = C + 1 - s) : (f = h[C - 1], g = f - M - o, f > F && b.MarkNextChange(), F = f, b.AddModifiedElement(f + 1, g + 1), M = C - 1 - s), O >= 0 && (h = this.m_reverseHistory[O], s = h[0], L = 1, S = h.length - 1);
      } while (--O >= -1);
      y = b.getChanges();
    }
  ...
  ComputeRecursionPoint(t, n, r, i, s, a, l) {
    ...
    for (let M = 1; M <= g / 2 + 1; M++) {
      let F = 0, O = 0;
      h = this.ClipDiagonalBound(_ - M, M, _, p), f = this.ClipDiagonalBound(_ + M, M, _, p);
      for (let N = h; N <= f; N += 2) {
        N === h || N < f && v[N - 1] < v[N + 1] ? o = v[N + 1] : o = v[N - 1] + 1, u = o - (N - _) - y;
        const k = o;
        for (; o < n && u < i && this.ElementsAreEqual(o + 1, u + 1); )
          o++, u++;
        if (v[N] = o, o + u > F + O && (F = o, O = u), !S && Math.abs(N - x) <= M - 1 && o >= w[N])
          return s[0] = o, a[0] = u, k <= w[N] && M <= 1448 ? this.WALKTRACE(_, h, f, y, x, d, m, b, v, w, o, n, s, u, i, a, S, l) : null;
      }
      const C = (F - t + (O - r) - M) / 2;
      if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(F, C))
        return l[0] = !0, s[0] = F, a[0] = O, C > 0 && M <= 1448 ? this.WALKTRACE(_, h, f, y, x, d, m, b, v, w, o, n, s, u, i, a, S, l) : (t++, r++, [
          new Ge(t, n - t + 1, r, i - r + 1)
        ]);
      ...
      for (let N = d; N <= m; N += 2) {
        ...
        if (w[N] = o, S && Math.abs(N - _) <= M && o <= v[N])
          return s[0] = o, a[0] = u, k >= v[N] && M <= 1448 ? this.WALKTRACE(_, h, f, y, x, d, m, b, v, w, o, n, s, u, i, a, S, l) : null;
      }
      if (M <= 1447) {
        let N = new Int32Array(f - h + 2);
        N[0] = _ - h + 1, ct.Copy2(v, h, N, 1, f - h + 1), this.m_forwardHistory.push(N), N = new Int32Array(m - d + 2), N[0] = x - d + 1, ct.Copy2(w, d, N, 1, m - d + 1), this.m_reverseHistory.push(N);
      }
    }
    return this.WALKTRACE(_, h, f, y, x, d, m, b, v, w, o, n, s, u, i, a, S, l);
  }
  /**
  ...
  PrettifyChanges(t) {
    ...
    if (this._hasStrings)
      for (let n = 1, r = t.length; n < r; n++) {
        const i = t[n - 1], s = t[n], a = s.originalStart - i.originalStart - i.originalLength, l = i.originalStart, o = s.originalStart + s.originalLength, u = o - l, h = i.modifiedStart, f = s.modifiedStart + s.modifiedLength, d = f - h;
        if (a < 5 && u < 20 && d < 20) {
          const m = this._findBetterContiguousSequence(l, u, h, d, a);
          if (m) {
            const [g, p] = m;
            (g !== i.originalStart + i.originalLength || p !== i.modifiedStart + i.modifiedLength) && (i.originalLength = g - i.originalStart, i.modifiedLength = p - i.modifiedStart, s.originalStart = g + a, s.modifiedStart = p + a, s.originalLength = o - s.originalStart, s.modifiedLength = f - s.modifiedStart);
          }
        }
      }
    return t;
    ...
    for (let s = 1, a = t.getLineCount(); s <= a; s++) {
      ...
      for (; u < o; ) {
        ...
        if (d === 13) {
          ...
          x === 1 && (i.push(pn._createLink(r, l, s, h, u)), w = !0);
        } else if (d === 12) {
          let x;
          _ === 91 ? (g = !0, x = 0) : x = r.get(_), x === 1 ? w = !0 : d = 13;
        } else
          d = n.nextState(d, _), d === 0 && (w = !0);
        w && (d = 1, m = !1, g = !1, v = !1, h = u + 1, f = _), u++;
      }
      d === 13 && i.push(pn._createLink(r, l, s, h, o));
    }
    return i;
  }
}
function Ul(e) {
  return !e || typeof e.getLineCount != "function" || typeof e.getLineContent != "function" ? [] : pn.computeLinks(e);
}
class Pr {
  constructor() {
...
(function(e) {
  function t(n) {
    return n === e.None || n === e.Cancelled || n instanceof en ? !0 : !n || typeof n != "object" ? !1 : typeof n.isCancellationRequested == "boolean" && typeof n.onCancellationRequested == "function";
  }
...
class ql {
  ...
  cancel() {
    this._token ? this._token instanceof en && this._token.cancel() : this._token = bn.Cancelled;
  }
  dispose(t = !1) {
    t && this.cancel(), this._parentListener?.dispose(), this._token ? this._token instanceof en && this._token.dispose() : this._token = bn.None;
  }
}
class Ir {
  constructor() {
...
const tn = new Ir(), Xn = new Ir(), Qn = new Ir(), jl = new Array(230), Wl = /* @__PURE__ */ Object.create(null), Hl = /* @__PURE__ */ Object.create(null);
(function() {
  const e = "", t = [
  ...
  for (const i of t) {
    ...
    if (r[a] || (r[a] = !0, Wl[l] = a, Hl[l.toLowerCase()] = a), !n[o]) {
      if (n[o] = !0, !u)
        throw new Error(`String representation missing for key code ${o} around scan code ${l}`);
      tn.define(o, u), Xn.define(o, d || u), Qn.define(o, m || d || u);
    }
    h && (jl[h] = o);
  }
})();
...
(function(e) {
  function t(l) {
    return tn.keyCodeToStr(l);
  }
  e.toString = t;
  function n(l) {
    return tn.strToKeyCode(l);
  }
  e.fromString = n;
  function r(l) {
...
class Ga {
  ...
  register(t, n) {
    return this._tokenizationSupports.set(t, n), this.handleChange([t]), un(() => {
  ...
  registerFactory(t, n) {
    ...
    const r = new Ql(this, t, n);
    return this._factories.set(t, r), un(() => {
...
function lu(e, t, n, r, i) {
  return au(e, t, n, r, i) && ou(e, t, n, r, i);
}
class uu {
  constructor(t, n) {
  ...
  next(t) {
    ...
    do {
      ...
      if (this._prevMatchStartIndex = i, this._prevMatchLength = s, !this._wordSeparators || lu(this._wordSeparators, t, n, i, s))
        return r;
    } while (r);
    return null;
  }
}
function cu(e, t = "Unreachable") {
  throw new Error(t);
}
function xn(e) {
  if (!e()) {
    debugger;
    e(), Ft(new ye("Assertion Failed"));
  }
}
function Ja(e, t) {
  let n = 0;
...
function Fr(e, t, n, r, i) {
  if (t = Qa(t), i || (i = ln.first(Ya)), n.length > i.maxLen) {
    let u = e - i.maxLen / 2;
    return u < 0 ? u = 0 : r += u, n = n.substring(u, e + i.maxLen / 2), Fr(e, t, n, r, i);
  }
...
class mu {
  static computeUnicodeHighlights(t, n, r) {
    const i = r ? r.startLineNumber : 1, s = r ? r.endLineNumber : t.getLineCount(), a = new rs(n), l = a.getCandidateCodePoints();
    let o;
    l === "allNonBasicAscii" ? o = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : o = new RegExp(`${gu(Array.from(l))}`, "g");
    const u = new uu(null, o), h = [];
    ...
    e: for (let v = i, w = s; v <= w; v++) {
      ...
      do
        if (d = u.next(_), d) {
          ...
          if (M !== 0) {
            if (M === 3 ? m++ : M === 2 ? g++ : M === 1 ? p++ : cu(), h.length >= 1e3) {
              f = !0;
              break e;
            }
...
function gu(e, t) {
  return `[${Qo(e.map((r) => String.fromCodePoint(r)).join(""))}]`;
}
class rs {
  constructor(t) {
  ...
  shouldHighlightNonBasicASCII(t, n) {
    ...
    if (n)
      for (const a of n) {
        const l = a.codePointAt(0), o = il(a);
    ...
    return (
      ...
      s ? 0 : this.options.invisibleCharacters && !is(t) && nt.isInvisibleCharacter(r) ? 2 : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(r) ? 3 : 0
    );
  }
}
function is(e) {
...
class Pe {
  ...
  addRange(t) {
    if (t.length === 0)
      return;
    const n = tr(this._normalizedRanges, (i) => i.endLineNumberExclusive >= t.startLineNumber), r = $t(this._normalizedRanges, (i) => i.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === r)
  ...
  getUnion(t) {
    ...
    for (; r < this._normalizedRanges.length || i < t._normalizedRanges.length; ) {
      ...
      s === null ? s = a : s.endLineNumberExclusive >= a.startLineNumber ? s = new B(s.startLineNumber, Math.max(s.endLineNumberExclusive, a.endLineNumberExclusive)) : (n.push(s), s = a);
    }
   ...
   */
  subtractFrom(t) {
    const n = tr(this._normalizedRanges, (a) => a.endLineNumberExclusive >= t.startLineNumber), r = $t(this._normalizedRanges, (a) => a.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === r)
      return new Pe([t]);
    const i = [];
    ...
    return s < t.endLineNumberExclusive && i.push(new B(s, t.endLineNumberExclusive)), new Pe(i);
  }
  toString() {
...
class Ne {
  static inverse(t, n, r) {
    ...
    let s = 1, a = 1;
    for (const o of t) {
      const u = new Ne(new B(s, o.original.startLineNumber), new B(a, o.modified.startLineNumber));
  ...
  */
  toRangeMapping2(t, n) {
    if (ss(this.original.endLineNumberExclusive, t) && ss(this.modified.endLineNumberExclusive, n))
      return new ke(new z(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new z(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
...
class $e extends Ne {
  static fromRangeMappings(t) {
    const n = B.join(t.map((i) => B.fromRangeInclusive(i.originalRange))), r = B.join(t.map((i) => B.fromRangeInclusive(i.modifiedRange)));
    return new $e(n, r, t);
  }
  constructor(t, n, r) {
  ...
  flip() {
    return new $e(this.modified, this.original, this.innerChanges?.map((t) => t.flip()));
  }
...
class yu {
  computeDiff(t, n, r) {
    ...
    for (const o of s.changes) {
      let u;
      o.originalEndLineNumber === 0 ? u = new B(o.originalStartLineNumber + 1, o.originalStartLineNumber + 1) : u = new B(o.originalStartLineNumber, o.originalEndLineNumber + 1);
      let h;
      o.modifiedEndLineNumber === 0 ? h = new B(o.modifiedStartLineNumber + 1, o.modifiedStartLineNumber + 1) : h = new B(o.modifiedStartLineNumber, o.modifiedEndLineNumber + 1);
      let f = new $e(u, h, o.charChanges?.map((d) => new ke(new z(d.originalStartLineNumber, d.originalStartColumn, d.originalEndLineNumber, d.originalEndColumn), new z(d.modifiedStartLineNumber, d.modifiedStartColumn, d.modifiedEndLineNumber, d.modifiedEndColumn))));
      l && (l.modified.endLineNumberExclusive === f.modified.startLineNumber || l.original.endLineNumberExclusive === f.original.startLineNumber) && (f = new $e(l.original.join(f.original), l.modified.join(f.modified), l.innerChanges && f.innerChanges ? l.innerChanges.concat(f.innerChanges) : void 0), a.pop()), a.push(f), l = f;
    }
    return xn(() => Ja(a, (o, u) => u.original.startLineNumber - o.original.endLineNumberExclusive === u.modified.startLineNumber - o.modified.endLineNumberExclusive && // There has to be an unchanged line in between (otherwise both diffs should have been joined)
    o.original.endLineNumberExclusive < u.original.startLineNumber && o.modified.endLineNumberExclusive < u.modified.startLineNumber)), new nn(a, [], s.quitEarly);
  }
}
function Za(e, t, n, r) {
...
function _u(e) {
  ...
  for (let r = 1, i = e.length; r < i; r++) {
    ...
    Math.min(a, l) < xu ? (n.originalLength = s.originalStart + s.originalLength - n.originalStart, n.modifiedLength = s.modifiedStart + s.modifiedLength - n.modifiedStart) : (t.push(s), n = s);
  }
  return t;
}
class Vt {
...
class Lu {
  ...
  computeDiff() {
    ...
    const t = Za(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), n = t.changes, r = t.quitEarly;
    if (this.shouldIgnoreTrimWhitespace) {
      const l = [];
      for (let o = 0, u = n.length; o < u; o++)
        l.push(Vt.createFromDiffResult(this.shouldIgnoreTrimWhitespace, n[o], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
      return {
        quitEarly: r,
        changes: l
      };
    ...
    for (let l = -1, o = n.length; l < o; l++) {
      ...
      u && (i.push(Vt.createFromDiffResult(this.shouldIgnoreTrimWhitespace, u, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), s += u.originalLength, a += u.modifiedLength);
    }
    return {
      quitEarly: r,
      changes: i
  ...
  _pushTrimWhitespaceCharChange(t, n, r, i, s, a, l) {
    if (this._mergeTrimWhitespaceCharChange(t, n, r, i, s, a, l))
      return;
    let o;
    this.shouldComputeCharChanges && (o = [new yt(n, r, n, i, s, a, s, l)]), t.push(new Vt(n, n, s, s, o));
  }
...
class an {
  ...
  filter(t) {
    return new an((n) => this.iterate((r) => t(r) ? n(r) : !0));
  }
  map(t) {
    return new an((n) => this.iterate((r) => n(t(r))));
  }
  findLast(t) {
    let n;
...
class Be {
  static trivial(t, n) {
    return new Be([new Q(W.ofLength(t.length), W.ofLength(n.length))], !1);
  }
  static trivialTimedOut(t, n) {
    return new Be([new Q(W.ofLength(t.length), W.ofLength(n.length))], !0);
  }
  constructor(t, n) {
...
class Cu {
  compute(t, n, r = Ht.instance, i) {
    if (t.length === 0 || n.length === 0)
      return Be.trivial(t, n);
    const s = new Vn(t.length, n.length), a = new Vn(t.length, n.length), l = new Vn(t.length, n.length);
    ...
    return f(-1, -1), o.reverse(), new Be(o, !1);
  }
}
class Ka {
  compute(t, n, r = Ht.instance) {
    if (t.length === 0 || n.length === 0)
      return Be.trivial(t, n);
    const i = t, s = n;
    function a(p, v) {
    ...
    o.set(0, a(0, 0));
    const u = new Pu();
    u.set(0, o.get(0) === 0 ? null : new ls(null, 0, 0, o.get(0)));
    let h = 0;
    e: for (; ; ) {
      if (l++, !r.isValid())
      ...
      for (h = p; h <= v; h += 2) {
        ...
        if (u.set(h, b !== x ? new ls(L, x, y, b - x) : L), o.get(h) === i.length && o.get(h) - h === s.length)
          break e;
      }
    }
    let f = u.get(h);
    ...
    for (; ; ) {
      ...
      if ((p !== m || v !== g) && d.push(new Q(new W(p, m), new W(v, g))), !f)
        break;
...
class yn {
  ...
  getBoundaryScore(t) {
    const n = cs(t > 0 ? this.elements[t - 1] : -1), r = cs(t < this.elements.length ? this.elements[t] : -1);
    if (n === 7 && r === 8)
      return 0;
    if (n === 8)
      return 150;
    let i = 0;
    return n !== r && (i += 10, n === 0 && r === 1 && (i += 1)), i += us(n), i += us(r), i;
  }
  ...
  extendToFullLines(t) {
    const n = Lt(this.firstElementOffsetByLineIdx, (i) => i <= t.start) ?? 0, r = bu(this.firstElementOffsetByLineIdx, (i) => t.endExclusive <= i) ?? this.elements.length;
    return new W(n, r);
  }
}
function Dn(e) {
...
function Fu(e, t, n, r, i, s) {
  let { moves: a, excludedChanges: l } = Du(e, t, n, s);
  if (!s.isValid())
    return [];
  const o = e.filter((h) => !l.has(h)), u = Ou(o, r, i, t, n, s);
  return Ru(a, u), a = $u(a), a = a.filter((h) => {
    const f = h.original.toOffsetRange().slice(t).map((m) => m.trim());
    return f.join(`
`).length >= 15 && Vu(f, (m) => m.length >= 2) >= 2;
  }), a = Bu(e, a), a;
}
function Vu(e, t) {
  let n = 0;
...
function Du(e, t, n, r) {
  const i = [], s = e.filter((o) => o.modified.isEmpty && o.original.length >= 3).map((o) => new Bt(o.original, t, o)), a = new Set(e.filter((o) => o.original.isEmpty && o.modified.length >= 3).map((o) => new Bt(o.modified, n, o))), l = /* @__PURE__ */ new Set();
  for (const o of s) {
    let u = -1, h;
    for (const f of a) {
...
function Ou(e, t, n, r, i, s) {
  ...
  const o = [];
  e.sort(rn((d) => d.modified.startLineNumber, sn));
  for (const d of e) {
    let m = [];
    for (let g = d.modified.startLineNumber; g < d.modified.endLineNumberExclusive - 2; g++) {
      const p = `${n[g - 1]}:${n[g + 1 - 1]}:${n[g + 2 - 1]}`, v = new B(g, g + 3), w = [];
      l.forEach(p, ({ range: _ }) => {
        for (const y of m)
          if (y.originalLineRange.endLineNumberExclusive + 1 === _.endLineNumberExclusive && y.modifiedLineRange.endLineNumberExclusive + 1 === v.endLineNumberExclusive) {
            y.originalLineRange = new B(y.originalLineRange.startLineNumber, _.endLineNumberExclusive), y.modifiedLineRange = new B(y.modifiedLineRange.startLineNumber, v.endLineNumberExclusive), w.push(y);
            return;
          }
        const x = {
          modifiedLineRange: v,
  ...
  o.sort(Eu(rn((d) => d.modifiedLineRange.length, sn)));
  ...
  a.sort(rn((d) => d.original.startLineNumber, sn));
  const f = new En(e);
  for (let d = 0; d < a.length; d++) {
    const m = a[d], g = f.findLastMonotonous((L) => L.original.startLineNumber <= m.original.startLineNumber), p = Lt(e, (L) => L.modified.startLineNumber <= m.modified.startLineNumber), v = Math.max(m.original.startLineNumber - g.original.startLineNumber, m.modified.startLineNumber - p.modified.startLineNumber), w = f.findLastMonotonous((L) => L.original.startLineNumber < m.original.endLineNumberExclusive), _ = Lt(e, (L) => L.modified.startLineNumber < m.modified.endLineNumberExclusive), x = Math.max(w.original.endLineNumberExclusive - m.original.endLineNumberExclusive, _.modified.endLineNumberExclusive - m.modified.endLineNumberExclusive);
    let y;
    for (y = 0; y < v; y++) {
      const L = m.original.startLineNumber - y - 1, S = m.modified.startLineNumber - y - 1;
      if (L > r.length || S > i.length || u.contains(S) || h.contains(L) || !fs(r[L - 1], i[S - 1], s))
        break;
    }
    y > 0 && (h.addRange(new B(m.original.startLineNumber - y, m.original.startLineNumber)), u.addRange(new B(m.modified.startLineNumber - y, m.modified.startLineNumber)));
    let b;
    for (b = 0; b < x; b++) {
    ...
    b > 0 && (h.addRange(new B(m.original.endLineNumberExclusive, m.original.endLineNumberExclusive + b)), u.addRange(new B(m.modified.endLineNumberExclusive, m.modified.endLineNumberExclusive + b))), (y > 0 || b > 0) && (a[d] = new Ne(new B(m.original.startLineNumber - y, m.original.endLineNumberExclusive + b), new B(m.modified.startLineNumber - y, m.modified.endLineNumberExclusive + b)));
  }
  return a;
}
function fs(e, t, n) {
  ...
  if (e.length > 300 && t.length > 300)
    return !1;
  const i = new Ka().compute(new yn([e], new z(1, 1, 1, e.length), !1), new yn([t], new z(1, 1, 1, t.length), !1), n);
  let s = 0;
...
function Bu(e, t) {
  const n = new En(e);
  return t = t.filter((r) => {
    const i = n.findLastMonotonous((l) => l.original.startLineNumber < r.original.endLineNumberExclusive) || new Ne(new B(1, 1), new B(1, 1)), s = Lt(e, (l) => l.modified.startLineNumber < r.modified.endLineNumberExclusive);
    return i !== s;
  }), t;
}
function hs(e, t, n) {
  let r = n;
  return r = ds(e, t, r), r = ds(e, t, r), r = Uu(e, t, r), r;
}
function ds(e, t, n) {
  if (n.length === 0)
    return n;
...
function Uu(e, t, n) {
  ...
  for (let r = 0; r < n.length; r++) {
    ...
    s.seq1Range.isEmpty ? n[r] = ms(s, e, t, l, o) : s.seq2Range.isEmpty && (n[r] = ms(s.swap(), t, e, o, l).swap());
  }
  return n;
}
...
function zu(e, t, n) {
  ...
  do {
    ...
    for (let u = 1; u < r.length; u++) {
      let d = function(g, p) {
        const v = new W(f.seq1Range.endExclusive, h.seq1Range.start);
      ...
      d(f, h) ? (s = !0, o[o.length - 1] = o[o.length - 1].join(h)) : o.push(h);
    }
    r = o;
  } while (i++ < 10 && s);
  const a = [];
  return ku(r, (o, u, h) => {
    ...
    const v = Q.fromOffsetPairs(o ? o.getEndExclusives() : Me.zero, h ? h.getStarts() : Me.max), w = f.intersect(v);
...
class gs {
  ...
  getBoundaryScore(t) {
    const n = t === 0 ? 0 : ps(this.lines[t - 1]), r = t === this.lines.length ? 0 : ps(this.lines[t]);
    return 1e3 - (n + r);
  }
  getText(t) {
...
class Gu {
  constructor() {
    this.dynamicProgrammingDiffing = new Cu(), this.myersDiffingAlgorithm = new Ka();
  }
  computeDiff(t, n, r) {
    if (t.length <= 1 && Nu(t, n, (b, L) => b === L))
      return new nn([], [], !1);
    if (t.length === 1 && t[0].length === 0 || n.length === 1 && n[0].length === 0)
      return new nn([
        new $e(new B(1, t.length + 1), new B(1, n.length + 1), [
          new ke(new z(1, 1, t.length, t[t.length - 1].length + 1), new z(1, 1, n.length, n[n.length - 1].length + 1))
        ])
      ], [], !1);
    const i = r.maxComputationTimeMs === 0 ? Ht.instance : new Mu(r.maxComputationTimeMs), s = !r.ignoreTrimWhitespace, a = /* @__PURE__ */ new Map();
    function l(b) {
      let L = a.get(b);
      return L === void 0 && (L = a.size, a.set(b, L)), L;
    }
    const o = t.map((b) => l(b.trim())), u = n.map((b) => l(b.trim())), h = new gs(o, t), f = new gs(u, n), d = h.length + f.length < 1700 ? this.dynamicProgrammingDiffing.compute(h, f, i, (b, L) => t[b] === n[L] ? n[L].length === 0 ? 0.1 : 1 + Math.log(1 + n[L].length) : 0.99) : this.myersDiffingAlgorithm.compute(h, f, i);
    let m = d.diffs, g = d.hitTimeout;
    m = hs(h, f, m), m = Hu(h, f, m);
    const p = [], v = (b) => {
      if (s)
        for (let L = 0; L < b; L++) {
          const S = w + L, M = _ + L;
    ...
    let w = 0, _ = 0;
    for (const b of m) {
      xn(() => b.seq1Range.start - w === b.seq2Range.start - _);
    ...
    const x = bs(p, t, n);
    let y = [];
    return r.computeMoves && (y = this.computeMoves(x, t, n, o, u, i, s)), xn(() => {
      function b(S, M) {
  ...
  computeMoves(t, n, r, i, s, a, l) {
    return Fu(t, n, r, i, s, a).map((h) => {
      const f = this.refineDiff(n, r, new Q(h.original.toOffsetRange(), h.modified.toOffsetRange()), a, l), d = bs(f.mappings, n, r, !0);
      return new pu(h, d);
    });
  }
  refineDiff(t, n, r, i, s) {
    const l = Xu(r).toRangeMapping2(t, n), o = new yn(t, l.originalRange, s), u = new yn(n, l.modifiedRange, s), h = o.length + u.length < 500 ? this.dynamicProgrammingDiffing.compute(o, u, i) : this.myersDiffingAlgorithm.compute(o, u, i);
    let f = h.diffs;
    return f = hs(o, u, f), f = ju(o, u, f), f = qu(o, u, f), f = zu(o, u, f), {
      mappings: f.map((m) => new ke(o.translateRange(m.seq1Range), u.translateRange(m.seq2Range))),
...
function bs(e, t, n, r = !1) {
  const i = [];
  for (const s of Su(e.map((a) => Ju(a, t, n)), (a, l) => a.original.overlapOrTouch(l.original) || a.modified.overlapOrTouch(l.modified))) {
    const a = s[0], l = s[s.length - 1];
    i.push(new $e(a.original.join(l.original), a.modified.join(l.modified), s.map((o) => o.innerChanges[0])));
  }
  return xn(() => !r && i.length > 0 && (i[0].modified.startLineNumber !== i[0].original.startLineNumber || n.length - i[i.length - 1].modified.endLineNumberExclusive !== t.length - i[i.length - 1].original.endLineNumberExclusive) ? !1 : Ja(i, (s, a) => a.original.startLineNumber - s.original.endLineNumberExclusive === a.modified.startLineNumber - s.modified.endLineNumberExclusive && // There has to be an unchanged line in between (otherwise both diffs should have been joined)
...
function Ju(e, t, n) {
  ...
  const s = new B(e.originalRange.startLineNumber + r, e.originalRange.endLineNumber + 1 + i), a = new B(e.modifiedRange.startLineNumber + r, e.modifiedRange.endLineNumber + 1 + i);
  return new $e(s, a, [e]);
}
function Xu(e) {
  return new Ne(new B(e.seq1Range.start + 1, e.seq1Range.endExclusive + 1), new B(e.seq2Range.start + 1, e.seq2Range.endExclusive + 1));
}
const vs = {
  getLegacy: () => new yu(),
  getDefault: () => new Gu()
...
class vt {
  ...
  static toRGBA(t) {
    ...
    let [u, h, f] = [0, 0, 0];
    return n < 60 ? (u = a, h = l) : n < 120 ? (u = l, h = a) : n < 180 ? (h = a, f = l) : n < 240 ? (h = l, f = a) : n < 300 ? (u = l, f = a) : n <= 360 && (u = a, f = l), u = Math.round((u + o) * 255), h = Math.round((h + o) * 255), f = Math.round((f + o) * 255), new ae(u, h, f, s);
  }
}
let wn = class re {
  static fromHex(t) {
...
function Qu(e, t) {
  if (!e)
    return;
  const n = wn.Format.CSS.parseHex(t);
  if (n)
    return {
      range: e,
      color: Vr(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a)
    };
}
function xs(e, t, n) {
  if (!e || t.length !== 1)
  ...
  return {
    range: e,
    color: Vr(s[0], s[1], s[2], n ? s[3] : 1)
  };
}
function ys(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const i = t[0].values(), s = eo(i), a = new wn(new Le(s[0], s[1] / 100, s[2] / 100, n ? s[3] : 1));
  return {
    range: e,
    color: Vr(a.rgba.r, a.rgba.g, a.rgba.b, a.rgba.a)
  };
}
function Ct(e, t) {
...
function Yu(e) {
  const t = [], r = Ct(e, /\b(rgb|rgba|hsl|hsla)(\([0-9\s,.\%]*\))|(#)([A-Fa-f0-9]{3})\b|(#)([A-Fa-f0-9]{4})\b|(#)([A-Fa-f0-9]{6})\b|(#)([A-Fa-f0-9]{8})\b/gm);
  if (r.length > 0)
    for (const i of r) {
...
function to(e) {
  ...
  return e = e.replace(Ku, ""), { text: e, hasSeparatorLine: t };
}
var _s;
(function(e) {
  async function t(r) {
...
class oc {
  ...
  $acceptNewModel(t) {
    this._models[t.url] = new lc(Te.parse(t.url), t.lines, t.EOL, t.versionId);
  }
...
class lc extends ac {
  ...
  getWordAtPosition(t, n) {
    const r = Fr(t.column, Qa(n), this._lines[t.lineNumber - 1], 0);
...
class uc {
  constructor() {
    this._workerTextModelSyncServer = new oc();
  }
  dispose() {
  }
  _getModel(t) {
  ...
  async $computeUnicodeHighlights(t, n, r) {
    ...
    return i ? mu.computeUnicodeHighlights(i, n, r) : { ranges: [], hasMore: !1, ambiguousCharacterCount: 0, invisibleCharacterCount: 0, nonBasicAsciiCharacterCount: 0 };
  }
  ...
  async $computeDiff(t, n, r, i) {
    ...
    return !s || !a ? null : on.computeDiff(s, a, r, i);
  }
  static computeDiff(t, n, r, i) {
    const s = i === "advanced" ? vs.getDefault() : vs.getLegacy(), a = t.getLinesContent(), l = n.getLinesContent(), o = s.computeDiff(a, l, r), u = o.changes.length > 0 ? !1 : this._modelsAreIdentical(t, n);
    function h(f) {
      return f.map((d) => [d.original.startLineNumber, d.original.endLineNumberExclusive, d.modified.startLineNumber, d.modified.endLineNumberExclusive, d.innerChanges?.map((m) => [
  ...
  async $computeMoreMinimalEdits(t, n, r) {
    ...
    for (let { range: o, text: u, eol: h } of n) {
      ...
      if (u = u.replace(/\r\n|\n|\r/g, i.eol), f === u)
        continue;
      if (Math.max(u.length, f.length) > on._diffLimit) {
        s.push({ range: o, text: u });
        continue;
      }
      const d = Vl(f, u, r), m = i.offsetAt(z.lift(o).getStartPosition());
      for (const g of d) {
  ...
  async $textualSuggest(t, n, r, i) {
    const s = new Rn(), a = new RegExp(r, i), l = /* @__PURE__ */ new Set();
    e: for (const o of t) {
      const u = this._getModel(o);
      if (u) {
        for (const h of u.words(a))
          if (!(h === n || !isNaN(Number(h))) && (l.add(h), l.size > on._suggestionsLimit))
            break e;
      }
    }
  ...
  async $navigateValueSet(t, n, r, i, s) {
    ...
    return Pr.INSTANCE.navigateValueSet(n, o, u, h, r);
  }
}
class on extends uc {
  constructor(t, n) {
  ...
  $loadForeignModule(t, n, r) {
    const a = {
      host: su(r, (l, o) => this._host.$fhr(l, o)),
      getMirrorModels: () => this._getModels()
    };
    return this._foreignModuleFactory ? (this._foreignModule = this._foreignModuleFactory(a, n), Promise.resolve(Ki(this._foreignModule))) : new Promise((l, o) => {
      const u = (h) => {
        this._foreignModule = h.create(a, n), l(Ki(this._foreignModule));
      };
...
typeof importScripts == "function" && (globalThis.monaco = Kl());
let ar = !1;
function no(e) {
  if (ar)
    return;
...
`;
          ...
          case 117:
            const S = d(4);
            S >= 0 ? x += String.fromCharCode(S) : f = 4;
            break;
          default:
            f = 5;
        }
      ...
      case 47:
        ...
        if (e.charCodeAt(r + 1) === 42) {
          ...
          for (; r < b; ) {
            ...
            r++, Tt(S) && (S === 13 && e.charCodeAt(r) === 10 && r++, l++, u = r);
          }
          return L || (r++, f = 1), i = e.substring(y, r), a = 13;
        }
...
var we = new Array(20).fill(0).map((e, t) => " ".repeat(t)), mt = 200, Ns = {
  " ": {
...
function fc(e, t, n) {
  let r, i, s, a, l;
  if (t) {
    for (a = t.offset, l = a + t.length, s = a; s > 0 && !Ss(e, s - 1); )
      s--;
    let b = l;
    for (; b < e.length && !Ss(e, b); )
      b++;
    i = e.substring(s, b), r = hc(i, n);
  } else
    i = e, r = 0, s = 0, a = 0, l = e.length;
  const o = dc(n, e), u = cc.includes(o);
  let h = 0, f = 0, d;
  ...
  function v() {
    if (h > 1)
      return gt(o, h) + gt(d, r + f);
    const b = d.length * (r + f);
    return !u || b > Ns[m][o].length ? o + gt(d, r + f) : b <= 0 ? o : Ns[m][o][b];
  }
  function w() {
    let b = g.scan();
    for (h = 0; b === 15 || b === 14; )
  ...
  for (; y !== 17; ) {
    ...
    if (L === 2)
      y !== 1 && f--, n.keepLines && h > 0 || !n.keepLines && y !== 1 ? S = v() : n.keepLines && (S = we[1]);
    else if (L === 4)
      y !== 3 && f--, n.keepLines && h > 0 || !n.keepLines && y !== 3 ? S = v() : n.keepLines && (S = we[1]);
    else {
      switch (y) {
        case 3:
        case 1:
          f++, n.keepLines && h > 0 || !n.keepLines ? S = v() : S = we[1];
          break;
        case 5:
...
function pc(e, t, n = _n.DEFAULT) {
  ...
  const u = a(t.onObjectBegin), h = o(t.onObjectProperty), f = s(t.onObjectEnd), d = a(t.onArrayBegin), m = s(t.onArrayEnd), g = o(t.onLiteralValue), p = l(t.onSeparator), v = s(t.onComment), w = l(t.onError), _ = n && n.disallowComments, x = n && n.allowTrailingComma;
  function y() {
    for (; ; ) {
      const N = r.scan();
...
var bc = mc, vc = io, xc = ro, yc = or, Rs;
(function(e) {
...
(function(e) {
  function t(r, i) {
    return r === Number.MAX_VALUE && (r = Nn.MAX_VALUE), i === Number.MAX_VALUE && (i = Nn.MAX_VALUE), { line: r, character: i };
  }
  e.create = t;
  function n(r) {
    let i = r;
...
(function(e) {
  ...
  function n(r) {
    const i = r;
    return A.objectLiteral(i) && q.is(i.range) && ur.is(i.color);
  }
  e.is = n;
})(Ps || (Ps = {}));
var Is;
...
(function(e) {
  ...
  function i(s) {
    const a = s;
    return Ve.is(a) && (fr.is(a.annotationId) || At.is(a.annotationId));
  }
  e.is = i;
})(Os || (Os = {}));
var hr;
...
(function(e) {
  function t(n) {
    let r = n;
    return r && (r.changes !== void 0 || r.documentChanges !== void 0) && (r.documentChanges === void 0 || r.documentChanges.every((i) => A.string(i.kind) ? dr.is(i) || mr.is(i) || gr.is(i) : hr.is(i)));
  }
  e.is = t;
})(pr || (pr = {}));
var $s;
...
(function(e) {
  function t(n) {
    let r = n;
    return !!r && A.objectLiteral(r) && (qt.is(r.contents) || Sn.is(r.contents) || A.typedArray(r.contents, Sn.is)) && (n.range === void 0 || q.is(n.range));
  }
  e.is = t;
})(Gs || (Gs = {}));
var Js;
...
(function(e) {
  ...
  function n(r) {
    let i = r;
    return A.defined(i) && A.typedArray(i.diagnostics, Ue.is) && (i.only === void 0 || A.typedArray(i.only, A.string)) && (i.triggerKind === void 0 || i.triggerKind === An.Invoked || i.triggerKind === An.Automatic);
  }
  e.is = n;
})(ra || (ra = {}));
var ia;
(function(e) {
  ...
  function n(r) {
    let i = r;
    return i && A.string(i.title) && (i.diagnostics === void 0 || A.typedArray(i.diagnostics, Ue.is)) && (i.kind === void 0 || A.string(i.kind)) && (i.edit !== void 0 || i.command !== void 0) && (i.command === void 0 || St.is(i.command)) && (i.isPreferred === void 0 || A.boolean(i.isPreferred)) && (i.edit === void 0 || pr.is(i.edit));
  }
  e.is = n;
})(ia || (ia = {}));
var sa;
...
(function(e) {
  ...
  function n(r) {
    const i = r;
    return A.objectLiteral(i) && (i.tooltip === void 0 || A.string(i.tooltip) || qt.is(i.tooltip)) && (i.location === void 0 || Nt.is(i.location)) && (i.command === void 0 || St.is(i.command));
  }
  e.is = n;
})(yr || (yr = {}));
var ga;
(function(e) {
  ...
  function n(r) {
    const i = r;
    return A.objectLiteral(i) && Y.is(i.position) && (A.string(i.label) || A.typedArray(i.label, yr.is)) && (i.kind === void 0 || xr.is(i.kind)) && i.textEdits === void 0 || A.typedArray(i.textEdits, Ve.is) && (i.tooltip === void 0 || A.string(i.tooltip) || qt.is(i.tooltip)) && (i.paddingLeft === void 0 || A.boolean(i.paddingLeft)) && (i.paddingRight === void 0 || A.boolean(i.paddingRight));
  }
  e.is = n;
})(ga || (ga = {}));
var pa;
...
(function(e) {
  ...
  function r(s, a) {
    ...
    for (let h = o.length - 1; h >= 0; h--) {
      let f = o[h], d = s.offsetAt(f.range.start), m = s.offsetAt(f.range.end);
      if (m <= u)
  ...
  update(t, n) {
    for (let r of t)
      if (wr.isIncremental(r)) {
        const i = ao(r.range), s = this.offsetAt(i.start), a = this.offsetAt(i.end);
...
(function(e) {
  ...
  e.update = n;
  function r(i, s) {
    let a = i.getText(), l = _r(s.map(Nc), (h, f) => {
      let d = h.range.start.line - f.range.start.line;
      return d === 0 ? h.range.start.character - f.range.start.character : d;
    }), o = 0;
    const u = [];
...
var Sc = /{([^}]+)}/g;
function Ac(e, t) {
  return Object.keys(t).length === 0 ? e : e.replace(Sc, (n, r) => t[r] ?? n);
}
var kc = {
...
var Pc = {
  ...
  include(t) {
    return (this.focusOffset === -1 || lo(t, this.focusOffset)) && t !== this.exclude;
  }
  newSub() {
    return new oo(-1, this.exclude);
  }
}, jt = class {
  constructor() {
  }
...
var uo = class {
  ...
  validate(e, t, n = xe.Warning, r) {
    if (this.root && t) {
      const i = new ce();
      return oe(this.root, t, i, jt.instance, new Ra(r ?? Ea(t))), i.problems.map((s) => {
  ...
  getMatchingSchemas(e, t = -1, n) {
    if (this.root && e) {
      const r = new Ic(t, n), i = Ea(e), s = new Ra(i);
      return oe(this.root, e, new ce(), r, s), r.schemas;
    }
    return [];
  }
};
function Ea(e, t = Re.v2020_12) {
  let n = e.$schema;
  return n ? Pc[n] ?? t : t;
}
function oe(e, t, n, r, i) {
  ...
  function o(f) {
    if (ue(t.minLength) && Es(f.value) < t.minLength && n.problems.push({
      location: { offset: f.offset, length: f.length },
      message: E("String is shorter than the minimum length of {0}.", t.minLength)
    }), ue(t.maxLength) && Es(f.value) > t.maxLength && n.problems.push({
      location: { offset: f.offset, length: f.length },
      message: E("String is longer than the maximum length of {0}.", t.maxLength)
    }), so(t.pattern) && (Ln(t.pattern)?.test(f.value) || n.problems.push({
      location: { offset: f.offset, length: f.length },
  ...
  function u(f) {
    ...
    let g = 0;
    if (d !== void 0) {
      const w = Math.min(d.length, f.items.length);
      for (; g < w; g++) {
        const _ = d[g], x = ge(_), y = new ce(), b = f.items[g];
    ...
    if (m !== void 0 && g < f.items.length)
      if (typeof m == "boolean")
        ...
        for (; g < f.items.length; g++) {
          const w = new ce();
          oe(f.items[g], m, w, r, i), n.mergePropertyMatch(w), n.processedProperties.add(String(g));
        }
    const p = ge(t.contains);
    if (p) {
      let w = 0;
      for (let _ = 0; _ < f.items.length; _++) {
        const x = f.items[_], y = new ce();
        oe(x, p, y, jt.instance, i), y.hasProblems() || (w++, i.schemaDraft >= Re.v2020_12 && n.processedProperties.add(String(_)));
      }
      ...
      for (let w = 0; w < f.items.length; w++) {
        if (!n.processedProperties.has(String(w)))
          if (v === !1)
            ...
            const _ = new ce();
            oe(f.items[w], t.unevaluatedItems, _, r, i), n.mergePropertyMatch(_);
          }
        n.processedProperties.add(String(w)), n.propertiesValueMatches++;
      }
    if (ue(t.minItems) && f.items.length < t.minItems && n.problems.push({
      location: { offset: f.offset, length: f.length },
      message: E("Array has too few items. Expected {0} or more.", t.minItems)
    }), ue(t.maxItems) && f.items.length > t.maxItems && n.problems.push({
      location: { offset: f.offset, length: f.length },
  ...
  function h(f) {
    ...
    if (Array.isArray(t.required)) {
      for (const x of t.required)
        if (!d[x]) {
          const y = f.parent && f.parent.type === "property" && f.parent.keyNode, b = y ? { offset: y.offset, length: y.length } : { offset: f.offset, length: 1 };
          n.problems.push({
            location: b,
    ...
    if (ue(t.maxProperties) && f.properties.length > t.maxProperties && n.problems.push({
      location: { offset: f.offset, length: f.length },
      message: E("Object has more properties than limit of {0}.", t.maxProperties)
    }), ue(t.minProperties) && f.properties.length < t.minProperties && n.problems.push({
      location: { offset: f.offset, length: f.length },
    ...
    function _(x, y) {
      if (Array.isArray(y))
        ...
        if (b) {
          const L = new ce();
          oe(f, b, L, r, i), n.mergePropertyMatch(L);
        }
      }
    }
  }
...
function Vc(e, t) {
  ...
  function u(L, S, M = void 0, F = [], O = []) {
    ...
    if (o(L, S, C, N), M && f(M, !1), F.length + O.length > 0) {
      let k = s.getToken();
      for (; k !== 17; ) {
        if (F.indexOf(k) !== -1) {
          l();
  ...
  function d(L) {
    if (s.getToken() !== 3)
      return;
    const S = new Ec(L, s.getTokenOffset());
    l();
    let M = !1;
    ...
    return s.getToken() !== 4 ? u(E("Expected comma or closing bracket"), H.CommaOrCloseBacketExpected, S) : f(S, !0);
  }
  const m = new $n(void 0, 0, 0);
  function g(L, S) {
    const M = new Cc(L, s.getTokenOffset(), m);
    let F = v(M);
    if (!F)
      if (s.getToken() === 16) {
        u(E("Property keys must be doublequoted"), H.PropertyKeysMustBeDoublequoted);
        const C = new $n(M, s.getTokenOffset(), s.getTokenLength());
  ...
  function p(L) {
    if (s.getToken() !== 1)
      return;
    const S = new Tc(L, s.getTokenOffset()), M = /* @__PURE__ */ Object.create(null);
    l();
    let F = !1;
    ...
    return s.getToken() !== 2 ? u(E("Expected comma or closing brace"), H.CommaOrCloseBraceExpected, S) : f(S, !0);
  }
  function v(L) {
    if (s.getToken() !== 10)
      return;
    const S = new $n(L, s.getTokenOffset());
    return S.value = s.getTokenValue(), f(S, !0);
  }
  function w(L) {
    if (s.getToken() !== 11)
      return;
    const S = new Mc(L, s.getTokenOffset());
  ...
  function _(L) {
    switch (s.getToken()) {
      case 7:
        return f(new Rc(L, s.getTokenOffset()), !0);
      case 8:
        return f(new Aa(L, !0, s.getTokenOffset()), !0);
      case 9:
        return f(new Aa(L, !1, s.getTokenOffset()), !0);
      default:
        return;
    }
  }
  ...
  let y;
  return l() !== 17 && (y = x(y), y ? s.getToken() !== 17 && u(E("End of file expected."), H.Undefined) : u(E("Expected a JSON object, array or literal."), H.Undefined)), new uo(y, n, a);
}
function Sr(e, t, n) {
  if (e !== null && typeof e == "object") {
    const r = t + "	";
...
`;
      for (let s = 0; s < e.length; s++)
        i += r + Sr(e[s], r, n), s < e.length - 1 && (i += ","), i += `
`;
      return i += t + "]", i;
    } else {
...
`;
      for (let a = 0; a < i.length; a++) {
        const l = i[a];
        s += r + JSON.stringify(l) + ": " + Sr(e[l], r, n), a < i.length - 1 && (s += ","), s += `
`;
      }
      return s += t + "}", s;
    }
...
var Dc = class {
    ...
    const u = /* @__PURE__ */ new Map(), h = {
      add: (f) => {
        ...
        if (m)
          ...
          f.textEdit = Ve.replace(o, f.insertText), f.label = d, u.set(d, f), r.items.push(f);
        }
      },
      setAsIncomplete: () => {
        r.isIncomplete = !0;
    ...
    return this.schemaService.getSchemaForResource(e.uri, n).then((f) => {
      ...
      if (a && a.type === "object") {
        ...
        a.properties.forEach((y) => {
          (!p || p !== y) && u.set(y.keyNode.value, vr.create("__"));
        });
        let _ = "";
        m && (_ = this.evaluateSeparatorAfter(e, e.offsetAt(o.end))), f ? this.getPropertyCompletions(f, n, a, m, _, h) : this.getSchemaLessPropertyCompletions(n, a, g, h);
        const x = Nr(a);
      ...
      const v = {};
      return f ? this.getValueCompletions(f, n, a, s, e, h, v) : this.getSchemaLessValueCompletions(n, a, s, e, h), this.contributions.length > 0 && this.getContributedValueCompletions(n, a, s, e, h, d), this.promiseConstructor.all(d).then(() => {
      ...
      if (l.node === n && !l.inverted) {
        ...
        o && Object.keys(o).forEach((h) => {
          ...
          if (typeof f == "object" && !f.deprecationMessage && !f.doNotSuggest) {
            ...
            f.suggestSortText !== void 0 && (d.sortText = f.suggestSortText), d.insertText && Ut(d.insertText, `$1${i}`) && (d.command = {
              title: "Suggest",
        ...
        if (typeof u == "object" && !u.deprecationMessage && !u.doNotSuggest) {
          const h = (f, d = void 0) => {
            ...
            u.suggestSortText !== void 0 && (m.sortText = u.suggestSortText), m.insertText && Ut(m.insertText, `$1${i}`) && (m.command = {
              title: "Suggest",
              command: "editor.action.triggerSuggest"
            }), s.add(m);
          };
          if (u.enum)
            for (let f = 0; f < u.enum.length; f++) {
              let d;
              u.markdownEnumDescriptions && f < u.markdownEnumDescriptions.length ? d = this.fromMarkup(u.markdownEnumDescriptions[f]) : u.enumDescriptions && f < u.enumDescriptions.length && (d = u.enumDescriptions[f]), h(u.enum[f], d);
            }
          u.const && h(u.const);
        }
      }
  ...
  getSchemaLessValueCompletions(e, t, n, r, i) {
    ...
    const a = this.evaluateSeparatorAfter(r, s), l = (o) => {
      o.parent && !lo(o.parent, n, !0) && i.add({
...
` + m) + d + t, o = o || u, h = u.replace(/[\n]/g, "");
  ...
  getInsertTextForSnippetValue(e, t) {
    return Sr(e, "", (r) => typeof r == "string" && r[0] === "^" ? r.substr(1) : JSON.stringify(r)) + t;
  }
  ...
  doHover(e, t, n) {
    ...
    return this.schemaService.getSchemaForResource(e.uri, n).then((u) => {
      if (u && i) {
        ...
        let f, d, m, g;
        h.every((v) => {
          if (v.node === i && !v.inverted && v.schema && (f = f || v.schema.title, d = d || v.schema.markdownDescription || Bn(v.schema.description), v.schema.enum)) {
            const w = v.schema.enum.indexOf(it(i));
            v.schema.markdownEnumDescriptions ? m = v.schema.markdownEnumDescriptions[w] : v.schema.enumDescriptions && (m = Bn(v.schema.enumDescriptions[w])), m && (g = v.schema.enum[w], typeof g != "string" && (g = JSON.stringify(g)));
          }
          return !0;
        });
        let p = "";
        return f && (p = Bn(f)), d && (p.length > 0 && (p += `
...
var Bc = class {
  ...
  doValidation(e, t, n, r) {
    ...
    const i = [], s = {}, a = (o) => {
      ...
      let u = n?.trailingCommas ? Qt(n.trailingCommas) : xe.Error, h = n?.comments ? Qt(n.comments) : this.commentSeverity, f = n?.schemaValidation ? Qt(n.schemaValidation) : xe.Warning, d = n?.schemaRequest ? Qt(n.schemaRequest) : xe.Warning;
      if (o) {
        const m = (g, p) => {
          if (t.root && d) {
        ...
        if (o.errors.length)
          ...
          const g = t.validate(e, o.schema, f, n?.schemaDraft);
          g && g.forEach(a);
        }
...
var Ma = 48, qc = 57, jc = 65, Yt = 97, Wc = 102;
function te(e) {
  return e < Ma ? 0 : e <= qc ? e - Ma : (e < Yt && (e += Yt - jc), e >= Yt && e <= Wc ? e - Yt + 10 : 0);
}
function Hc(e) {
  if (e[0] === "#")
    switch (e.length) {
...
var zc = class {
  ...
  findDocumentSymbols(e, t, n = { resultLimit: Number.MAX_VALUE }) {
    ...
    const s = e.uri;
    if ((s === "vscode://defaultsettings/keybindings.json" || Ut(s.toLowerCase(), "/user/keybindings.json")) && r.type === "array") {
      const f = [];
        ...
        if (d.type === "object") {
          for (const m of d.properties)
            if (m.keyNode.value === "key" && m.valueNode) {
              ...
              if (f.push({ name: Ca(m.valueNode), kind: Ce.Function, location: g }), i--, i <= 0)
        ...
        if (d.type === "object") {
          for (const m of d.properties)
            if (m.keyNode.value === "key" && m.valueNode) {
              ...
              if (f.push({ name: Ca(m.valueNode), kind: Ce.Function, range: g, selectionRange: p }), i--, i <= 0)
                return n && n.onResultLimitExceeded && n.onResultLimitExceeded(s), f;
            }
        }
      return f;
...
for (const e in Ar.schemas) {
  const t = Ar.schemas[e];
...
(() => {
  var e = { 470: (i) => {
    ...
    function a(o, u) {
      for (var h, f = "", d = 0, m = -1, g = 0, p = 0; p <= o.length; ++p) {
        if (p < o.length)
          h = o.charCodeAt(p);
        else {
          if (h === 47)
            ...
            if (m !== p - 1 && g === 2) {
              if (f.length < 2 || d !== 2 || f.charCodeAt(f.length - 1) !== 46 || f.charCodeAt(f.length - 2) !== 46) {
                if (f.length > 2) {
                  var v = f.lastIndexOf("/");
                  if (v !== f.length - 1) {
                    v === -1 ? (f = "", d = 0) : d = (f = f.slice(0, v)).length - 1 - f.lastIndexOf("/"), m = p, g = 0;
                    continue;
                  }
              ...
              f.length > 0 ? f += "/" + o.slice(m + 1, p) : f = o.slice(m + 1, p), d = p - m - 1;
          m = p, g = 0;
        } else
          h === 46 && g !== -1 ? ++g : g = -1;
      }
    ...
    var l = { resolve: function() {
      for (var o, u = "", h = !1, f = arguments.length - 1; f >= -1 && !h; f--) {
        var d;
        f >= 0 ? d = arguments[f] : (o === void 0 && (o = process.cwd()), d = o), s(d), d.length !== 0 && (u = d + "/" + u, h = d.charCodeAt(0) === 47);
      }
      ...
      for (var h = 1; h < o.length && o.charCodeAt(h) === 47; ++h)
        ;
      for (var f = o.length, d = f - h, m = 1; m < u.length && u.charCodeAt(m) === 47; ++m)
        ;
      ...
      var x = "";
      for (w = h + v + 1; w <= f; ++w)
        w !== f && o.charCodeAt(w) !== 47 || (x.length === 0 ? x += ".." : x += "/..");
      ...
      if (s(o), o.length === 0)
        return ".";
      for (var u = o.charCodeAt(0), h = u === 47, f = -1, d = !0, m = o.length - 1; m >= 1; --m)
      ...
      if (u !== void 0 && u.length > 0 && u.length <= o.length) {
        ...
        return f === d ? d = p : d === -1 && (d = o.length), o.slice(f, d);
      }
      for (h = o.length - 1; h >= 0; --h)
      ...
      s(o);
      for (var u = -1, h = 0, f = -1, d = !0, m = 0, g = o.length - 1; g >= 0; --g) {
        var p = o.charCodeAt(g);
        if (p !== 47)
          f === -1 && (d = !1, f = g + 1), p === 46 ? u === -1 ? u = g : m !== 1 && (m = 1) : u !== -1 && (m = -1);
        else if (!d) {
          h = g + 1;
          break;
        }
      ...
      if (o.length === 0)
        return u;
      var h, f = o.charCodeAt(0), d = f === 47;
      d ? (u.root = "/", h = 1) : h = 0;
      for (var m = -1, g = 0, p = -1, v = !0, w = o.length - 1, _ = 0; w >= h; --w)
        if ((f = o.charCodeAt(w)) !== 47)
          p === -1 && (v = !1, p = w + 1), f === 46 ? m === -1 ? m = w : _ !== 1 && (_ = 1) : m !== -1 && (_ = -1);
        else if (!v) {
          g = w + 1;
          break;
        }
  ...
  (() => {
    ...
    class d {
      ...
      constructor(N, k, R, I, T, P = !1) {
        typeof N == "object" ? (this.scheme = N.scheme || u, this.authority = N.authority || u, this.path = N.path || u, this.query = N.query || u, this.fragment = N.fragment || u) : (this.scheme = /* @__PURE__ */ function(D, $) {
          return D || $ ? D : "file";
        }(N, P), this.authority = k || u, this.path = function(D, $) {
          switch (D) {
            case "https":
            case "http":
            case "file":
    ...
    function x(C, N) {
      const k = N ? w : v;
      let R = "", { scheme: I, authority: T, path: P, query: D, fragment: $ } = C;
      ...
      return D && (R += "?", R += k(D, !1, !1)), $ && (R += "#", R += N ? $ : v($, !1, !1)), R;
    }
    function y(C) {
      try {
...
var Xc = "!", Qc = "/", Yc = class {
    ...
    try {
      for (let r of e) {
        ...
        i || (r = r.substring(1)), r.length > 0 && (r[0] === Qc && (r = r.substring(1)), this.globWrappers.push({
          regexp: Jc("**/" + r, { extended: !0, globstar: !0 }),
          include: i
        }));
      }
      t && (t = mo(t), t.endsWith("/") || (t = t + "/"), this.folderUri = t);
    } catch {
  ...
  constructor(e, t, n) {
    this.service = e, this.uri = t, this.dependencies = /* @__PURE__ */ new Set(), this.anchors = void 0, n && (this.unresolvedSchema = this.service.promise.resolve(new It(n)));
  }
  getUnresolvedSchema() {
  ...
  loadSchema(e) {
    ...
    return e.startsWith("http://json-schema.org/") && (e = "https" + e.substring(4)), this.requestService(e).then((t) => {
      ...
      let r = {};
      const i = [];
      return r = bc(t, i), i.length && n.push(E("Unable to parse content from '{0}': Parse error at offset {1}.", Pt(e), i[0].offset)), new It(r, n);
    }, (t) => {
      let n = t.toString();
      const r = t.toString().split("Error: ");
      return r.length > 1 && (n = r[1]), Ut(n, ".") && (n = n.substr(0, n.length - 1)), new It({}, [E("Unable to load schema from '{0}': {1}.", Pt(e), n)]);
    });
  }
  resolveSchemaContent(e, t) {
    ...
    if (i === "http://json-schema.org/draft-03/schema")
      return this.promise.resolve(new Ta({}, [E("Draft-03 schemas are not supported.")], [], i));
    ...
    const a = this.contextService, l = (g, p) => {
      ...
      return this.traverseNodes(g, (v) => {
        const w = v.$id || v.id, _ = so(w) && w.charAt(0) === "#" ? w.substring(1) : v.$anchor;
  ...
  getAssociatedSchemas(e) {
    const t = /* @__PURE__ */ Object.create(null), n = [], r = mo(e);
  ...
  getMatchingSchemas(e, t, n) {
    if (n) {
      const r = n.id || "schemaservice://untitled/matchingSchemas/" + e1++;
  ...
  for (; l !== 17; ) {
    switch (l) {
      ...
      case 13: {
        ...
        a.getTokenError() === 1 && g + 1 < e.lineCount ? a.setPosition(e.offsetAt(Y.create(g + 1, 0))) : g < p && (o({ startLine: g, endLine: p, kind: Dt.Comment }), s = g);
        break;
      }
      case 12: {
        ...
        if (p) {
          ...
          if (p[1]) {
            const w = { startLine: v, endLine: v, kind: Dt.Region };
            i.push(w);
          } else {
            let w = i.length - 1;
            for (; w >= 0 && i[w].kind !== Dt.Region; )
              w--;
            if (w >= 0) {
              const _ = i[w];
...
function n1(e, t, n) {
  function r(l) {
    ...
    for (let d = h.length - 1; d >= 0; d--)
      f = kn.create(h[d], f);
    return f || (f = kn.create(q.create(l, l))), f;
  }
  function i(l, o) {
...
`,
  ...
  return wc(e.getText(), r, i).map((s) => Ve.replace(q.create(e.positionAt(s.offset), e.positionAt(s.offset + s.length)), s.content));
}
var se;
(function(e) {
...
var Zt = class {
  ...
  addChildProperty(e) {
    if (e.parent = this, this.childrenProperties.length > 0) {
      let t = 0;
      e.noKeyName ? t = this.childrenProperties.length : t = i1(this.childrenProperties, e, r1), t < 0 && (t = t * -1 - 1), this.childrenProperties.splice(t, 0, e);
    } else
...
function s1(e, t) {
  ...
  }, r = Ee.applyEdits(e, kr(e, n, void 0)), i = Ee.create("test://test.json", "json", 0, r), s = a1(i), a = o1(i, s), l = kr(a, n, void 0), o = Ee.applyEdits(a, l);
  return [Ve.replace(q.create(Y.create(0, 0), e.positionAt(e.getText().length)), o)];
}
function a1(e) {
  const t = e.getText(), n = rt(t, !1);
  let r = new Zt(), i = r, s = r, a = r, l, o = 0, u = 0, h, f, d = -1, m = -1, g = 0, p = 0, v = [], w = !1, _ = !1;
  for (; (l = n.scan()) !== 17; ) {
    if (w === !0 && l !== 14 && l !== 15 && l !== 12 && l !== 13 && s.endLineNumber === void 0) {
      let x = n.getTokenStartLine();
      f === 2 || f === 4 ? a.endLineNumber = x - 1 : s.endLineNumber = x - 1, g = x, w = !1;
    }
    ...
    switch (l) {
      case 10: {
        if (h === void 0 || h === 1 || h === 5 && v[v.length - 1] === se.Object) {
          const x = new Zt(n.getTokenValue(), g);
      ...
      case 13: {
        h === 5 && d === n.getTokenStartLine() && (v[v.length - 1] === se.Array && (f === 2 || f === 4) || v[v.length - 1] === se.Object) && (v[v.length - 1] === se.Array && (f === 2 || f === 4) || v[v.length - 1] === se.Object) && (s.endLineNumber = void 0, w = !0), (h === 1 || h === 3) && d === n.getTokenStartLine() && (_ = !0);
        break;
      }
    }
    l !== 14 && l !== 13 && l !== 12 && l !== 15 && (f = h, h = l, d = n.getTokenStartLine(), m = n.getTokenOffset() + n.getTokenLength() - u);
  }
  return r;
}
function o1(e, t) {
  ...
  for (Pa(r, t, t.beginningLineNumber); r.length > 0; ) {
    const i = r.shift(), s = i.propertyTreeArray;
    let a = i.beginningLineNumber;
    for (let l = 0; l < s.length; l++) {
      const o = s[l], u = q.create(Y.create(o.beginningLineNumber, 0), Y.create(o.endLineNumber + 1, 0)), h = e.getText(u), f = Ee.create("test://test.json", "json", 0, h);
      ...
      Ee.update(n, [m], 1), Pa(r, o, a), a = a + d;
    }
  }
  return n;
}
function Pa(e, t, n) {
  if (t.childrenProperties.length !== 0)
    if (t.type === se.Object) {
      ...
      n = n + i, e.push(new po(n, t.childrenProperties));
    } else t.type === se.Array && go(e, t, n);
}
function go(e, t, n) {
  for (const r of t.childrenProperties) {
    if (r.type === se.Object) {
      ...
      e.push(new po(n + r.beginningLineNumber - t.beginningLineNumber + s, r.childrenProperties));
    }
    r.type === se.Array && go(e, r, n + r.beginningLineNumber - t.beginningLineNumber);
  }
}
var po = class {
  constructor(e, t) {
...
function Rr(e, t) {
  ...
  if (t && t.type === "object") {
    ...
    return r ? Rr(e, r.valueNode) : null;
  } else if (t && t.type === "array" && n.match(/^(0|[1-9][0-9]*)$/)) {
    const r = Number.parseInt(n), i = t.items[r];
    return i ? Rr(e, i) : null;
  }
  return null;
}
function f1(e) {
  return e === "#" ? [] : e[0] !== "#" || e[1] !== "/" ? null : e.substring(2).split(/\//).map(h1);
}
function h1(e) {
...
function d1(e) {
  ...
  const r = new Dc(n, e.contributions, t, e.clientCapabilities), i = new Oc(n, e.contributions, t), s = new zc(n), a = new Bc(n, t);
  return {
    configure: (l) => {
    ...
    parseJSONDocument: (l) => Vc(l, { collectComments: !0 }),
    newJSONDocument: (l, o) => Fc(l, o),
...
var m1 = class {
  constructor(e, t) {
    this._ctx = e, this._languageSettings = t.languageSettings, this._languageId = t.languageId, this._languageService = d1({
      workspaceContext: {
...
function p1(e) {
  return e.charCodeAt(0) === g1;
}
function b1(e, t) {
  if (p1(t)) {
    const n = kt.parse(e), r = t.split("/");
    return n.with({ path: vo(r) }).toString();
  }
  return v1(e, t);
}
function vo(e) {
