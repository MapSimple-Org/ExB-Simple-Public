...
const Dt = "Canceled";
function ws(e) {
  return e instanceof Ls ? !0 : e instanceof Error && e.name === Dt && e.message === Dt;
}
...
class Ze {
  ...
  add(t) {
    ...
    return this._isDisposed ? Ze.DISABLE_DISPOSED_WARNING || console.warn(new Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!").stack) : this._toDispose.add(t), t;
  }
  /**
...
class dt {
  ...
  constructor() {
    this._store = new Ze(), this._store;
  }
  dispose() {
    this._store.dispose();
  }
...
(function(e) {
  ...
  function n(C) {
    return (w, E = null, A) => {
      ...
      return I = C((U) => {
        if (!P)
          return I ? I.dispose() : P = !0, w.call(E, U);
      }, null, A), P && I.dispose(), I;
    };
  }
  e.once = n;
  function r(C, w) {
  ...
  e.onceIf = r;
  function s(C, w, E) {
    return f((A, P = null, I) => C((U) => A.call(P, w(U)), null, I), E);
  }
  e.map = s;
  function i(C, w, E) {
    return f((A, P = null, I) => C((U) => {
      w(U), A.call(P, U);
    }, null, I), E);
  }
  e.forEach = i;
  function o(C, w, E) {
    return f((A, P = null, I) => C((U) => w(U) && A.call(P, U), null, I), E);
  }
  e.filter = o;
  function l(C) {
    return C;
  ...
  function u(...C) {
    return (w, E = null, A) => {
      const P = Ns(...C.map((I) => I((U) => w.call(E, U))));
      return h(P, A);
    };
  }
  e.any = u;
  ...
  function d(C, w, E = 100, A = !1, P = !1, I, U) {
    let Y, Z, Me, et = 0, We;
    const gs = {
      leakWarningThreshold: I,
      onWillAddFirstListener() {
        Y = C((bs) => {
          et++, Z = w(Z, bs), A && !Me && (tt.fire(Z), Z = void 0), We = () => {
            const ps = Z;
            Z = void 0, Me = void 0, (!A || et > 1) && tt.fire(ps), et = 0;
  ...
  e.debounce = d;
  function m(C, w = 0, E) {
    return e.debounce(C, (A, P) => A ? (A.push(P), A) : [P], w, void 0, !0, void 0, E);
  }
  e.accumulate = m;
  function g(C, w = (A, P) => A === P, E) {
    let A = !0, P;
    return o(C, (I) => {
      const U = A || !w(I, P);
      return A = !1, P = I, U;
  ...
  class N {
    ...
    reduce(w, E) {
      let A = E;
      return this.steps.push((P) => (A = w(A, P), A)), this;
    }
    latch(w = (E, A) => E === A) {
      let E = !0, A;
      return this.steps.push((P) => {
        const I = E || !w(P, A);
        return E = !1, A = P, I ? P : S;
      }), this;
    }
    evaluate(w) {
  ...
  function x(C, w, E = (A) => A) {
    const A = (...Y) => U.fire(E(...Y)), P = () => C.on(w, A), I = () => C.removeListener(w, A), U = new oe({ onWillAddFirstListener: P, onDidRemoveLastListener: I });
    return U.event;
  }
  e.fromNodeEventEmitter = x;
  function p(C, w, E = (A) => A) {
    const A = (...Y) => U.fire(E(...Y)), P = () => C.addEventListener(w, A), I = () => C.removeEventListener(w, A), U = new oe({ onWillAddFirstListener: P, onDidRemoveLastListener: I });
    return U.event;
  }
  ...
  class Q {
    constructor(w, E) {
      ...
      this.emitter = new oe(A), E && E.add(this.emitter);
    }
    beginUpdate(w) {
      this._counter++;
    }
  ...
  function F(C) {
    return (w, E, A) => {
      ...
      const U = {
        ...
        endUpdate() {
          P--, P === 0 && (C.reportChanges(), I && (I = !1, w.call(E)));
        },
      ...
      return A instanceof Ze ? A.add(Y) : Array.isArray(A) && A.push(Y), Y;
    };
  }
...
class Kt {
  ...
  constructor(t, n, r = (Kt._idPool++).toString(16).padStart(3, "0")) {
...
class oe {
  constructor(t) {
    this._size = 0, this._options = t, this._leakageMon = this._options?.leakWarningThreshold ? new Kt(t?.onListenerError ?? je, this._options?.leakWarningThreshold ?? Rs) : void 0, this._perfMon = this._options?._profName ? new gt(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue;
  }
  dispose() {
  ...
  get event() {
    return this._event ??= (t, n, r) => {
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        ...
        console.warn(l);
        const u = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], c = new ys(`${l}. HINT: Stack shows most frequent listener (${u[1]}-times)`, u[0]);
        return (this._options?.onListenerError || je)(c), dt.None;
      }
      if (this._disposed)
        return dt.None;
      n && (t = t.bind(n));
      const s = new Rt(t);
      let i;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (s.stack = en.create(), i = this._leakageMon.check(s.stack, this._size + 1)), this._listeners ? this._listeners instanceof Rt ? (this._deliveryQueue ??= new Ms(), this._listeners = [this._listeners, s]) : this._listeners.push(s) : (this._options?.onWillAddFirstListener?.(this), this._listeners = s, this._options?.onDidAddFirstListener?.(this)), this._size++;
      const o = ft(() => {
        i?.(), this._removeListener(s);
      });
      return r instanceof Ze ? r.add(o) : Array.isArray(r) && r.push(o), o;
    }, this._event;
  }
  _removeListener(t) {
    ...
    if (this._size * Es <= n.length) {
      let i = 0;
      for (let o = 0; o < n.length; o++)
        n[o] ? n[i++] = n[o] : s && (this._deliveryQueue.end--, i < this._deliveryQueue.i && this._deliveryQueue.i--);
      n.length = i;
    }
  }
  _deliver(t, n) {
    if (!t)
      return;
    const r = this._options?.onListenerError || je;
    if (!r) {
      t.value(n);
      return;
    }
   ...
   */
  fire(t) {
    if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners) if (this._listeners instanceof Rt)
...
const Ps = Xr() === "pseudo" || typeof document < "u" && document.location && document.location.hash.indexOf("pseudo=true") >= 0;
function un(e, t) {
  let n;
  ...
  }), Ps && (n = "［" + n.replace(/[aouei]/g, "$&$&") + "］"), n;
}
function z(e, t, ...n) {
  return un(typeof e == "number" ? Fs(e, t) : t, n);
}
function Fs(e, t) {
  const n = ks()?.[e];
  if (typeof n != "string") {
...
const Ve = "en";
let Tt = !1, It = !1, At = !1, Qr = !1, tn = !1, nt, yt = Ve, cn = Ve, Ds, ge;
const be = globalThis;
let ie;
...
const Ts = typeof ie?.versions?.electron == "string", Is = Ts && ie?.type === "renderer";
if (typeof ie == "object") {
  Tt = ie.platform === "win32", It = ie.platform === "darwin", At = ie.platform === "linux", At && ie.env.SNAP && ie.env.SNAP_REVISION, ie.env.CI || ie.env.BUILD_ARTIFACTSTAGINGDIRECTORY, nt = Ve, yt = Ve;
  const e = ie.env.VSCODE_NLS_CONFIG;
  if (e)
    try {
      const t = JSON.parse(e);
      nt = t.userLocale, cn = t.osLocale, yt = t.resolvedLanguage || Ve, Ds = t.languagePack?.translationsConfigFile;
    } catch {
    }
  Qr = !0;
} else typeof navigator == "object" && !Is ? (ge = navigator.userAgent, Tt = ge.indexOf("Windows") >= 0, It = ge.indexOf("Macintosh") >= 0, (ge.indexOf("Macintosh") >= 0 || ge.indexOf("iPad") >= 0 || ge.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints > 0, At = ge.indexOf("Linux") >= 0, ge?.indexOf("Mobi") >= 0, tn = !0, yt = Xr() || Ve, nt = navigator.language.toLowerCase(), cn = nt) : console.error("Unable to resolve platform.");
const Qe = Tt, Vs = It, Bs = Qr, qs = tn, Us = tn && typeof be.importScripts == "function", $s = Us ? be.origin : void 0, me = ge, Hs = typeof be.postMessage == "function" && !be.importScripts;
(() => {
  if (Hs) {
    const e = [];
...
const Ws = !!(me && me.indexOf("Chrome") >= 0);
me && me.indexOf("Firefox") >= 0;
!Ws && me && me.indexOf("Safari") >= 0;
me && me.indexOf("Edg/") >= 0;
...
class Os {
  constructor(t, n) {
    this.lastCache = void 0, this.lastArgKey = void 0, typeof t == "function" ? (this._fn = t, this._computeKey = zs) : (this._fn = n, this._computeKey = t.getCacheKey);
  }
  get(t) {
...
class Ce {
  ...
  static {
    this.cache = new Os({ getCacheKey: JSON.stringify }, (t) => {
      function n(f) {
  ...
  static {
    this._locales = new hn(() => Object.keys(Ce.ambiguousCharacterData.value).filter((t) => !t.startsWith("_")));
  }
  static getLocales() {
...
if (typeof Et < "u" && typeof Et.process < "u") {
  ...
  // Supported
  get platform() {
    return Qe ? "win32" : Vs ? "darwin" : "linux";
  },
  get arch() {
  },
  // Unsupported
...
const bt = qe.cwd, ti = qe.env, ni = qe.platform, ri = 65, si = 97, ii = 90, ai = 122, Ae = 46, J = 47, te = 92, we = 58, oi = 63;
...
function li(e, t) {
  if (e === null || typeof e != "object")
    throw new Jr(t, "Object", e);
}
function j(e, t) {
  if (typeof e != "string")
    throw new Jr(t, "string", e);
}
const _e = ni === "win32";
function T(e) {
  return e === J || e === te;
...
function pt(e, t, n, r) {
  ...
  for (let c = 0; c <= e.length; ++c) {
    ...
    if (r(u)) {
      if (!(o === c - 1 || l === 1)) if (l === 2) {
        if (s.length < 2 || i !== 2 || s.charCodeAt(s.length - 1) !== Ae || s.charCodeAt(s.length - 2) !== Ae) {
          if (s.length > 2) {
            const f = s.lastIndexOf(n);
            f === -1 ? (s = "", i = 0) : (s = s.slice(0, f), i = s.length - 1 - s.lastIndexOf(n)), o = c, l = 0;
            continue;
          } else if (s.length !== 0) {
            s = "", i = 0, o = c, l = 0;
            continue;
        ...
        s.length > 0 ? s += `${n}${e.slice(o + 1, c)}` : s = e.slice(o + 1, c), i = c - o - 1;
      o = c, l = 0;
    } else u === Ae && l !== -1 ? ++l : l = -1;
  }
  return s;
...
function Zr(e, t) {
  li(t, "pathObject");
  const n = t.dir || t.root, r = t.base || `${t.name || ""}${ui(t.ext)}`;
...
const K = {
  ...
  resolve(...e) {
    ...
    for (let s = e.length - 1; s >= -1; s--) {
      let i;
      if (s >= 0) {
        if (i = e[s], j(i, `paths[${s}]`), i.length === 0)
          continue;
      } else t.length === 0 ? i = bt() : (i = ti[`=${t}`] || bt(), (i === void 0 || i.slice(0, 2).toLowerCase() !== t.toLowerCase() && i.charCodeAt(2) === te) && (i = `${t}\\`));
      const o = i.length;
      let l = 0, u = "", c = !1;
  ...
  normalize(e) {
    ...
    if (T(i))
      if (s = !0, T(e.charCodeAt(1))) {
        ...
        n = 1;
    else Le(i) && e.charCodeAt(1) === we && (r = e.slice(0, 2), n = 2, t > 2 && T(e.charCodeAt(2)) && (s = !0, n = 3));
    let o = n < t ? pt(e.slice(n), !s, "\\", T) : "";
    return o.length === 0 && !s && (o = "."), o.length > 0 && T(e.charCodeAt(t - 1)) && (o += "\\"), r === void 0 ? s ? `\\${o}` : o : s ? `${r}\\${o}` : `${r}${o}`;
  },
  isAbsolute(e) {
    j(e, "path");
    const t = e.length;
  ...
  join(...e) {
    ...
    if (typeof n == "string" && T(n.charCodeAt(0))) {
      ++s;
      const i = n.length;
      i > 1 && T(n.charCodeAt(1)) && (++s, i > 2 && (T(n.charCodeAt(2)) ? ++s : r = !1));
    }
    if (r) {
      for (; s < t.length && T(t.charCodeAt(s)); )
        s++;
      s >= 2 && (t = `\\${t.slice(s)}`);
    }
  ...
  relative(e, t) {
    ...
    if (n === r || (e = n.toLowerCase(), t = r.toLowerCase(), e === t))
      return "";
    let s = 0;
    for (; s < e.length && e.charCodeAt(s) === te; )
      s++;
    let i = e.length;
    for (; i - 1 > s && e.charCodeAt(i - 1) === te; )
      i--;
    const o = i - s;
    let l = 0;
    ...
    if (d !== f) {
      ...
      o > f && (e.charCodeAt(s + d) === te ? h = d : d === 2 && (h = 3)), h === -1 && (h = 0);
    }
    let m = "";
    for (d = s + h + 1; d <= i; ++d)
      (d === i || e.charCodeAt(d) === te) && (m += m.length === 0 ? ".." : "\\..");
    return l += h, m.length > 0 ? `${m}${r.slice(l, u)}` : (r.charCodeAt(l) === te && ++l, r.slice(l, u));
  },
  toNamespacedPath(e) {
  ...
  dirname(e) {
    ...
    } else Le(s) && e.charCodeAt(1) === we && (n = t > 2 && T(e.charCodeAt(2)) ? 3 : 2, r = n);
    let i = -1, o = !0;
    for (let l = t - 1; l >= r; --l)
      if (T(e.charCodeAt(l))) {
        if (!o) {
    ...
    if (e.length >= 2 && Le(e.charCodeAt(0)) && e.charCodeAt(1) === we && (n = 2), t !== void 0 && t.length > 0 && t.length <= e.length) {
      ...
      for (i = e.length - 1; i >= n; --i) {
        ...
        if (T(u)) {
          ...
          l === -1 && (s = !1, l = i + 1), o >= 0 && (u === t.charCodeAt(o) ? --o === -1 && (r = i) : (o = -1, r = l));
      }
  ...
  extname(e) {
    ...
    e.length >= 2 && e.charCodeAt(1) === we && Le(e.charCodeAt(0)) && (t = r = 2);
    for (let l = e.length - 1; l >= t; --l) {
      ...
      s === -1 && (i = !1, s = l + 1), u === Ae ? n === -1 ? n = l : o !== 1 && (o = 1) : n !== -1 && (o = -1);
    }
  ...
  parse(e) {
    ...
    if (n === 1)
      return T(s) ? (t.root = t.dir = e, t) : (t.base = t.name = e, t);
    if (T(s)) {
      if (r = 1, T(e.charCodeAt(1))) {
        let h = 2, d = h;
    ...
    } else if (Le(s) && e.charCodeAt(1) === we) {
      if (n <= 2)
        return t.root = t.dir = e, t;
      if (r = 2, T(e.charCodeAt(2))) {
        if (n === 3)
          return t.root = t.dir = e, t;
        r = 3;
      }
    ...
    let i = -1, o = r, l = -1, u = !0, c = e.length - 1, f = 0;
    for (; c >= r; --c) {
      if (s = e.charCodeAt(c), T(s)) {
        if (!u) {
          o = c + 1;
          break;
        }
      ...
      l === -1 && (u = !1, l = c + 1), s === Ae ? i === -1 ? i = c : f !== 1 && (f = 1) : i !== -1 && (f = -1);
    }
    return l !== -1 && (i === -1 || // We saw a non-dot character immediately before the dot
    f === 0 || // The (right-most) trimmed path component is exactly '..'
    f === 1 && i === l - 1 && i === o + 1 ? t.base = t.name = e.slice(o, l) : (t.name = e.slice(o, i), t.base = e.slice(o, l), t.ext = e.slice(i, l))), o > 0 && o !== r ? t.dir = e.slice(0, o - 1) : t.dir = t.root, t;
  },
  sep: "\\",
  delimiter: ";",
  win32: null,
  ...
  resolve(...e) {
    ...
    for (let r = e.length - 1; r >= -1 && !n; r--) {
      const s = r >= 0 ? e[r] : ci();
      j(s, `paths[${r}]`), s.length !== 0 && (t = `${s}/${t}`, n = s.charCodeAt(0) === J);
    }
    return t = pt(t, !n, "/", Bt), n ? `/${t}` : t.length > 0 ? t : ".";
  },
  normalize(e) {
    if (j(e, "path"), e.length === 0)
      return ".";
    const t = e.charCodeAt(0) === J, n = e.charCodeAt(e.length - 1) === J;
    return e = pt(e, !t, "/", Bt), e.length === 0 ? t ? "/" : n ? "./" : "." : (n && (e += "/"), t ? `/${e}` : e);
  },
  isAbsolute(e) {
  ...
  join(...e) {
    ...
    for (let n = 0; n < e.length; ++n) {
      const r = e[n];
      j(r, "path"), r.length > 0 && (t === void 0 ? t = r : t += `/${r}`);
    }
  ...
  relative(e, t) {
    ...
    let f = "";
    for (c = n + u + 1; c <= r; ++c)
      (c === r || e.charCodeAt(c) === J) && (f += f.length === 0 ? ".." : "/..");
  ...
  extname(e) {
    ...
    for (let o = e.length - 1; o >= 0; --o) {
      ...
      r === -1 && (s = !1, r = o + 1), l === Ae ? t === -1 ? t = o : i !== 1 && (i = 1) : t !== -1 && (i = -1);
    }
  ...
  parse(e) {
    ...
    for (; u >= r; --u) {
      ...
      o === -1 && (l = !1, o = u + 1), f === Ae ? s === -1 ? s = u : c !== 1 && (c = 1) : s !== -1 && (c = -1);
    }
    if (o !== -1) {
      const f = i === 0 && n ? 1 : i;
      s === -1 || // We saw a non-dot character immediately before the dot
      c === 0 || // The (right-most) trimmed path component is exactly '..'
      c === 1 && s === o - 1 && s === i + 1 ? t.base = t.name = e.slice(f, o) : (t.name = e.slice(f, s), t.base = e.slice(f, o), t.ext = e.slice(s, o));
    }
...
ee.win32 = K.win32 = K;
ee.posix = K.posix = ee;
_e ? K.normalize : ee.normalize;
const hi = _e ? K.join : ee.join;
_e ? K.resolve : ee.resolve;
_e ? K.relative : ee.relative;
_e ? K.dirname : ee.dirname;
_e ? K.basename : ee.basename;
_e ? K.extname : ee.extname;
_e ? K.sep : ee.sep;
const fi = /^\w[\w\d+.-]*$/, di = /^\//, mi = /^\/\//;
function gi(e, t) {
  if (!e.scheme && t)
    throw new Error(`[UriError]: Scheme is missing: {scheme: "", authority: "${e.authority}", path: "${e.path}", query: "${e.query}", fragment: "${e.fragment}"}`);
  if (e.scheme && !fi.test(e.scheme))
    throw new Error("[UriError]: Scheme contains illegal characters.");
  if (e.path) {
    if (e.authority) {
      if (!di.test(e.path))
        throw new Error('[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash ("/") character');
    } else if (mi.test(e.path))
...
class ne {
  ...
  constructor(t, n, r, s, i, o = !1) {
    typeof t == "object" ? (this.scheme = t.scheme || H, this.authority = t.authority || H, this.path = t.path || H, this.query = t.query || H, this.fragment = t.fragment || H) : (this.scheme = bi(t, o), this.authority = n || H, this.path = pi(this.scheme, r || H), this.query = s || H, this.fragment = i || H, gi(this, o));
  }
  // ---- filesystem path -----------------------
  /**
  ...
  with(t) {
    ...
    return n === void 0 ? n = this.scheme : n === null && (n = H), r === void 0 ? r = this.authority : r === null && (r = H), s === void 0 ? s = this.path : s === null && (s = H), i === void 0 ? i = this.query : i === null && (i = H), o === void 0 ? o = this.fragment : o === null && (o = H), n === this.scheme && r === this.authority && s === this.path && i === this.query && o === this.fragment ? this : new ke(n, r, s, i, o);
  }
  // ---- parse & validate ------------------------
  /**
  ...
  static parse(t, n = !1) {
    const r = xi.exec(t);
    return r ? new ke(r[2] || H, rt(r[4] || H), rt(r[5] || H), rt(r[7] || H), rt(r[9] || H), n) : new ke(H, H, H, H, H);
  }
  /**
  ...
  static joinPath(t, ...n) {
    ...
    let r;
    return Qe && t.scheme === "file" ? r = ne.file(K.join(qt(t, !0), ...n)).path : r = ee.join(t.path, ...n), t.with({ path: r });
  }
  ...
  static revive(t) {
    if (t) {
      ...
      {
        const n = new ke(t);
        return n._formatted = t.external ?? null, n._fsPath = t._sep === Kr ? t.fsPath ?? null : null, n;
      }
    } else return t;
  }
}
const Kr = Qe ? 1 : void 0;
class ke extends ne {
  constructor() {
...
function _i(e) {
  ...
  for (let n = 0; n < e.length; n++) {
    const r = e.charCodeAt(n);
    r === 35 || r === 63 ? (t === void 0 && (t = e.substr(0, n)), t += es[r]) : t !== void 0 && (t += e[n]);
  }
  return t !== void 0 ? t : e;
}
function qt(e, t) {
...
function Ut(e, t) {
  ...
  return l && (r += "?", r += n(l, !1, !1)), u && (r += "#", r += t ? u : fn(u, !1, !1)), r;
}
function ts(e) {
  try {
    return decodeURIComponent(e);
  } catch {
    return e.length > 3 ? e.substr(0, 3) + ts(e.substr(3)) : e;
  }
}
const dn = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
function rt(e) {
  return e.match(dn) ? e.replace(dn, (t) => ts(t)) : e;
}
var Re;
(function(e) {
...
class Li {
  ...
  get _remoteResourcesPath() {
    return ee.join(this._serverRootPath, Re.vscodeRemoteResource);
  }
  rewrite(t) {
    if (this._delegate)
      try {
    ...
    return typeof i == "string" && (o += `&${wi}=${encodeURIComponent(i)}`), ne.from({
      scheme: qs ? this._preferredWebSchema : Re.vscodeRemoteResource,
      authority: `${r}:${s}`,
...
const vi = new Li(), Ni = "vscode-app";
class xt {
  static {
    this.FALLBACK_AUTHORITY = Ni;
  }
  /**
   ...
   */
  uriToBrowserUri(t) {
    return t.scheme === Re.vscodeRemote ? vi.rewrite(t) : (
      // ...only ever for `file` resources
      t.scheme === Re.file && // ...and we run in native environments
      (Bs || // ...or web worker extensions on desktop
      $s === `${Re.vscodeFileResource}://${xt.FALLBACK_AUTHORITY}`) ? t.with({
  ...
  toUri(t, n) {
    ...
    if (globalThis._VSCODE_FILE_ROOT) {
      ...
      if (/^\w[\w\d+.-]*:\/\//.test(r))
        return ne.joinPath(ne.parse(r, !0), t);
      const s = hi(r, t);
      return ne.file(s);
    }
...
const Mt = "default", Si = "$initialize";
class Ci {
...
class Ei {
  ...
  sendMessage(t, n, r) {
    ...
    return new Promise((i, o) => {
      this._pendingReplies[s] = {
        resolve: i,
        reject: o
      }, this._send(new Ci(this._workerId, s, t, n, r));
    });
  }
  listen(t, n, r) {
    let s = null;
    const i = new oe({
      onWillAddFirstListener: () => {
        s = String(++this._lastSentReq), this._pendingEmitters.set(s, i), this._send(new Ri(this._workerId, s, t, n, r));
      },
      onDidRemoveLastListener: () => {
        this._pendingEmitters.delete(s), this._send(new yi(this._workerId, s)), s = null;
      }
    });
    return i.event;
  }
  ...
  createProxyToRemoteChannel(t, n) {
    const r = {
      get: (s, i) => (typeof i == "string" && !s[i] && (ss(i) ? s[i] = (o) => this.listen(t, i, o) : rs(i) ? s[i] = this.listen(t, i, void 0) : i.charCodeAt(0) === 36 && (s[i] = async (...o) => (await n?.(), this.sendMessage(t, i, o)))), s[i])
    };
  ...
  _handleRequestMessage(t) {
    ...
    this._handler.handleMessage(t.channel, t.method, t.args).then((s) => {
      this._send(new gn(this._workerId, n, s, void 0));
    }, (s) => {
      s.detail instanceof Error && (s.detail = ln(s.detail)), this._send(new gn(this._workerId, n, void 0, ln(s)));
    });
  }
...
class Mi {
  constructor(t, n) {
    this._localChannels = /* @__PURE__ */ new Map(), this._remoteChannels = /* @__PURE__ */ new Map(), this._requestHandlerFactory = n, this._requestHandler = null, this._protocol = new Ei({
      sendMessage: (r, s) => {
        t(r, s);
      },
  ...
  _handleMessage(t, n, r) {
    ...
    const s = t === Mt ? this._requestHandler : this._localChannels.get(t);
    if (!s)
  ...
  async initialize(t, n, r) {
    ...
    return n && (typeof n.baseUrl < "u" && delete n.baseUrl, typeof n.paths < "u" && typeof n.paths.vs < "u" && delete n.paths.vs, typeof n.trustedTypesPolicy < "u" && delete n.trustedTypesPolicy, n.catchError = !0, globalThis.require.config(n)), import(`${ns.asBrowserUri(`${r}.js`).toString(!0)}`).then((i) => {
...
function Pi(e, t, n) {
  return new Se(new pn(e), new pn(t)).ComputeDiff(n).changes;
}
class Pe {
  static Assert(t, n) {
    if (!t)
...
class Se {
  ...
  constructor(t, n, r = null) {
    ...
    const [s, i, o] = Se._getElements(t), [l, u, c] = Se._getElements(n);
  ...
  ElementsAreStrictEqual(t, n) {
    if (!this.ElementsAreEqual(t, n))
      return !1;
    const r = Se._getStrictElement(this._originalSequence, t), s = Se._getStrictElement(this._modifiedSequence, n);
    return r === s;
  }
  ...
  ComputeDiffRecursive(t, n, r, s, i) {
    ...
    if (t > n || r > s) {
      let h;
      return r <= s ? (Pe.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), h = [
        new ve(t, 0, r, s - r + 1)
      ]) : t <= n ? (Pe.Assert(r === s + 1, "modifiedStart should only be one more than modifiedEnd"), h = [
        new ve(t, n - t + 1, r, 0)
      ]) : (Pe.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), Pe.Assert(r === s + 1, "modifiedStart should only be one more than modifiedEnd"), h = []), h;
    }
    const o = [0], l = [0], u = this.ComputeRecursionPoint(t, n, r, s, o, l, i), c = o[0], f = l[0];
    if (u !== null)
      return u;
    if (!i[0]) {
      ...
      let d = [];
      return i[0] ? d = [
        new ve(c + 1, n - (c + 1) + 1, f + 1, s - (f + 1) + 1)
      ] : d = this.ComputeDiffRecursive(c + 1, n, f + 1, s, i), this.ConcatenateChanges(h, d);
    }
    return [
      new ve(t, n - t + 1, r, s - r + 1)
    ];
  }
  WALKTRACE(t, n, r, s, i, o, l, u, c, f, h, d, m, g, b, _, v, S) {
    let N = null, x = null, p = new xn(), L = n, R = r, y = m[0] - _[0] - s, B = -1073741824, Q = this.m_forwardHistory.length - 1;
    do {
      const q = y + t;
      q === L || q < R && c[q - 1] < c[q + 1] ? (h = c[q + 1], g = h - y - s, h < B && p.MarkNextChange(), B = h, p.AddModifiedElement(h + 1, g), y = q + 1 - t) : (h = c[q - 1] + 1, g = h - y - s, h < B && p.MarkNextChange(), B = h - 1, p.AddOriginalElement(h, g + 1), y = q - 1 - t), Q >= 0 && (c = this.m_forwardHistory[Q], t = c[0], L = 1, R = c.length - 1);
    } while (--Q >= -1);
    if (N = p.getReverseChanges(), S[0]) {
      ...
      p = new xn(), L = o, R = l, y = m[0] - _[0] - u, B = 1073741824, Q = v ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
      do {
        const q = y + i;
        q === L || q < R && f[q - 1] >= f[q + 1] ? (h = f[q + 1] - 1, g = h - y - u, h > B && p.MarkNextChange(), B = h + 1, p.AddOriginalElement(h + 1, g + 1), y = q + 1 - i) : (h = f[q - 1], g = h - y - u, h > B && p.MarkNextChange(), B = h, p.AddModifiedElement(h + 1, g + 1), y = q - 1 - i), Q >= 0 && (f = this.m_reverseHistory[Q], i = f[0], L = 1, R = f.length - 1);
      } while (--Q >= -1);
      x = p.getChanges();
    }
  ...
  ComputeRecursionPoint(t, n, r, s, i, o, l) {
    ...
    const g = n - t + (s - r), b = g + 1, _ = new Int32Array(b), v = new Int32Array(b), S = s - r, N = n - t, x = t - r, p = n - s, R = (N - S) % 2 === 0;
    _[S] = t, v[N] = n, l[0] = !1;
    for (let y = 1; y <= g / 2 + 1; y++) {
      let B = 0, Q = 0;
      f = this.ClipDiagonalBound(S - y, y, S, b), h = this.ClipDiagonalBound(S + y, y, S, b);
      for (let F = f; F <= h; F += 2) {
        F === f || F < h && _[F - 1] < _[F + 1] ? u = _[F + 1] : u = _[F - 1] + 1, c = u - (F - S) - x;
        const C = u;
        for (; u < n && c < s && this.ElementsAreEqual(u + 1, c + 1); )
          u++, c++;
        if (_[F] = u, u + c > B + Q && (B = u, Q = c), !R && Math.abs(F - N) <= y - 1 && u >= v[F])
          return i[0] = u, o[0] = c, C <= v[F] && y <= 1448 ? this.WALKTRACE(S, f, h, x, N, d, m, p, _, v, u, n, i, c, s, o, R, l) : null;
      }
      const q = (B - t + (Q - r) - y) / 2;
      if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(B, q))
        return l[0] = !0, i[0] = B, o[0] = Q, q > 0 && y <= 1448 ? this.WALKTRACE(S, f, h, x, N, d, m, p, _, v, u, n, i, c, s, o, R, l) : (t++, r++, [
          new ve(t, n - t + 1, r, s - r + 1)
        ]);
      d = this.ClipDiagonalBound(N - y, y, N, b), m = this.ClipDiagonalBound(N + y, y, N, b);
      for (let F = d; F <= m; F += 2) {
        F === d || F < m && v[F - 1] >= v[F + 1] ? u = v[F + 1] - 1 : u = v[F - 1], c = u - (F - N) - p;
        const C = u;
        for (; u > t && c > r && this.ElementsAreEqual(u, c); )
          u--, c--;
        if (v[F] = u, R && Math.abs(F - S) <= y && u <= _[F])
          return i[0] = u, o[0] = c, C >= _[F] && y <= 1448 ? this.WALKTRACE(S, f, h, x, N, d, m, p, _, v, u, n, i, c, s, o, R, l) : null;
      }
      if (y <= 1447) {
        let F = new Int32Array(h - f + 2);
        F[0] = S - f + 1, Fe.Copy2(_, f, F, 1, h - f + 1), this.m_forwardHistory.push(F), F = new Int32Array(m - d + 2), F[0] = N - d + 1, Fe.Copy2(v, d, F, 1, m - d + 1), this.m_reverseHistory.push(F);
      }
    }
    return this.WALKTRACE(S, f, h, x, N, d, m, p, _, v, u, n, i, c, s, o, R, l);
  }
  /**
  ...
  PrettifyChanges(t) {
    ...
    for (let n = t.length - 1; n >= 0; n--) {
      ...
      for (let h = 1; ; h++) {
        const d = r.originalStart - h, m = r.modifiedStart - h;
        if (d < s || m < i || o && !this.OriginalElementsAreEqual(d, d + r.originalLength) || l && !this.ModifiedElementsAreEqual(m, m + r.modifiedLength))
          break;
    ...
    if (this._hasStrings)
      for (let n = 1, r = t.length; n < r; n++) {
        const s = t[n - 1], i = t[n], o = i.originalStart - s.originalStart - s.originalLength, l = s.originalStart, u = i.originalStart + i.originalLength, c = u - l, f = s.modifiedStart, h = i.modifiedStart + i.modifiedLength, d = h - f;
        if (o < 5 && c < 20 && d < 20) {
          const m = this._findBetterContiguousSequence(l, c, f, d, o);
          if (m) {
            const [g, b] = m;
            (g !== s.originalStart + s.originalLength || b !== s.modifiedStart + s.modifiedLength) && (s.originalLength = g - s.originalStart, s.modifiedLength = b - s.modifiedStart, i.originalStart = g + o, i.modifiedStart = b + o, i.originalLength = u - i.originalStart, i.modifiedLength = h - i.modifiedStart);
          }
        }
      }
    return t;
  ...
  _boundaryScore(t, n, r, s) {
    const i = this._OriginalRegionIsBoundary(t, n) ? 1 : 0, o = this._ModifiedRegionIsBoundary(r, s) ? 1 : 0;
    return i + o;
  }
  /**
  ...
  ConcatenateChanges(t, n) {
    ...
    if (this.ChangesOverlap(t[t.length - 1], n[0], r)) {
      ...
      return Fe.Copy(t, 0, s, 0, t.length - 1), s[t.length - 1] = r[0], Fe.Copy(n, 1, s, t.length, n.length - 1), s;
    } else {
      const s = new Array(t.length + n.length);
      return Fe.Copy(t, 0, s, 0, t.length), Fe.Copy(n, 0, s, t.length, n.length), s;
    }
  }
  /**
  ...
  ChangesOverlap(t, n, r) {
    if (Pe.Assert(t.originalStart <= n.originalStart, "Left change is not less than or equal to right change"), Pe.Assert(t.modifiedStart <= n.modifiedStart, "Left change is not less than or equal to right change"), t.originalStart + t.originalLength >= n.originalStart || t.modifiedStart + t.modifiedLength >= n.modifiedStart) {
      ...
      return t.originalStart + t.originalLength >= n.originalStart && (i = n.originalStart + n.originalLength - t.originalStart), t.modifiedStart + t.modifiedLength >= n.modifiedStart && (l = n.modifiedStart + n.modifiedLength - t.modifiedStart), r[0] = new ve(s, i, o, l), !0;
    } else
      return r[0] = null, !1;
  }
  /**
...
class k {
  ...
  static intersectRanges(t, n) {
    ...
    return r < l ? (r = l, s = u) : r === l && (s = Math.max(s, u)), i > c ? (i = c, o = f) : i === c && (o = Math.min(o, f)), r > i || r === i && s > o ? null : new k(r, s, i, o);
  }
  /**
    ...
    for (let i = 1, o = t.getLineCount(); i <= o; i++) {
      ...
      for (; c < u; ) {
        ...
        if (d === 13) {
          ...
          N === 1 && (s.push(_t._createLink(r, l, i, f, c)), v = !0);
        } else if (d === 12) {
          let N;
          S === 91 ? (g = !0, N = 0) : N = r.get(S), N === 1 ? v = !0 : d = 13;
        } else
          d = n.nextState(d, S), d === 0 && (v = !0);
        v && (d = 1, m = !1, g = !1, _ = !1, f = c + 1, h = S), c++;
      }
      d === 13 && s.push(_t._createLink(r, l, i, f, u));
    }
    return s;
  }
}
function Vi(e) {
  return !e || typeof e.getLineCount != "function" || typeof e.getLineContent != "function" ? [] : _t.computeLinks(e);
}
class rn {
  constructor() {
...
const is = Object.freeze(function(e, t) {
...
class st {
  ...
  get onCancellationRequested() {
    return this._isCancelled ? is : (this._emitter || (this._emitter = new oe()), this._emitter.event);
  }
  dispose() {
...
class Bi {
  ...
  cancel() {
    this._token ? this._token instanceof st && this._token.cancel() : this._token = wt.Cancelled;
  }
  dispose(t = !1) {
    t && this.cancel(), this._parentListener?.dispose(), this._token ? this._token instanceof st && this._token.dispose() : this._token = wt.None;
  }
}
class sn {
  constructor() {
...
const it = new sn(), $t = new sn(), Ht = new sn(), qi = new Array(230), Ui = /* @__PURE__ */ Object.create(null), $i = /* @__PURE__ */ Object.create(null);
(function() {
  const e = "", t = [
  ...
  for (const s of t) {
    ...
    if (r[o] || (r[o] = !0, Ui[l] = o, $i[l.toLowerCase()] = o), !n[u]) {
      if (n[u] = !0, !c)
        throw new Error(`String representation missing for key code ${u} around scan code ${l}`);
      it.define(u, c), $t.define(u, d || c), Ht.define(u, m || d || c);
    }
    f && (qi[f] = u);
  }
})();
...
(function(e) {
  ...
  function i(l) {
    return $t.strToKeyCode(l) || Ht.strToKeyCode(l);
  }
...
class se extends k {
   ...
   */
  setEndPosition(t, n) {
    return this.getDirection() === 0 ? new se(this.startLineNumber, this.startColumn, t, n) : new se(t, n, this.startLineNumber, this.startColumn);
  }
  /**
  ...
  */
   ...
   */
  setStartPosition(t, n) {
    return this.getDirection() === 0 ? new se(t, n, this.endLineNumber, this.endColumn) : new se(this.endLineNumber, this.endColumn, t, n);
  }
  // ----
  /**
  ...
  static fromRange(t, n) {
    return n === 0 ? new se(t.startLineNumber, t.startColumn, t.endLineNumber, t.endColumn) : new se(t.endLineNumber, t.endColumn, t.startLineNumber, t.startColumn);
  }
  /**
   * Create a `Selection` from an `ISelection`.
   */
  static liftSelection(t) {
    return new se(t.selectionStartLineNumber, t.selectionStartColumn, t.positionLineNumber, t.positionColumn);
  }
  /**
   * `a` equals `b`.
   */
  ...
  static createWithDirection(t, n, r, s, i) {
    return i === 0 ? new se(t, n, r, s) : new se(r, s, t, n);
  }
}
function Wi(e) {
...
class Lt {
  ...
  static getChannel(t) {
    return t.getChannel(Lt.CHANNEL_NAME);
  }
  static setChannel(t, n) {
    t.setChannel(Lt.CHANNEL_NAME, n);
  }
}
var vr;
class Yi {
  constructor() {
    this[vr] = "LinkedMap", this._map = /* @__PURE__ */ new Map(), this._head = void 0, this._tail = void 0, this._size = 0, this._state = 0;
  }
  clear() {
...
function sa(e, t, n, r, s) {
  return na(e, t, n, r, s) && ra(e, t, n, r, s);
}
class ia {
  constructor(t, n) {
  ...
  next(t) {
    ...
    do {
      ...
      if (s === this._prevMatchStartIndex && i === this._prevMatchLength) {
        if (i === 0) {
          Zs(t, n, this._searchRegex.lastIndex) > 65535 ? this._searchRegex.lastIndex += 2 : this._searchRegex.lastIndex += 1;
          continue;
        }
        return null;
      }
      if (this._prevMatchStartIndex = s, this._prevMatchLength = i, !this._wordSeparators || sa(this._wordSeparators, t, n, s, i))
        return r;
    } while (r);
    return null;
  }
...
function an(e, t, n, r, s) {
  if (t = us(t), s || (s = ht.first(cs)), n.length > s.maxLen) {
    let c = e - s.maxLen / 2;
    return c < 0 ? c = 0 : r += c, n = n.substring(c, e + s.maxLen / 2), an(e, t, n, r, s);
  }
...
class ca {
  static computeUnicodeHighlights(t, n, r) {
    const s = r ? r.startLineNumber : 1, i = r ? r.endLineNumber : t.getLineCount(), o = new Ar(n), l = o.getCandidateCodePoints();
    let u;
    l === "allNonBasicAscii" ? u = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : u = new RegExp(`${ha(Array.from(l))}`, "g");
    const c = new ia(null, u), f = [];
    let h = !1, d, m = 0, g = 0, b = 0;
    e: for (let _ = s, v = i; _ <= v; _++) {
      ...
      do
        if (d = c.next(S), d) {
          ...
          let R = an(x + 1, ls, S, 0);
          R && R.endColumn <= x + 1 && (R = null);
          const y = o.shouldHighlightNonBasicASCII(L, R ? R.word : null);
          if (y !== 0) {
            if (y === 3 ? m++ : y === 2 ? g++ : y === 1 ? b++ : aa(), f.length >= 1e3) {
              h = !0;
              break e;
            }
  ...
  static computeUnicodeHighlightReason(t, n) {
    ...
    switch (r.shouldHighlightNonBasicASCII(t, null)) {
      ...
      case 3: {
        const i = t.codePointAt(0), o = r.ambiguousCharacters.getPrimaryConfusable(i), l = Ce.getLocales().filter((u) => !Ce.getInstance(/* @__PURE__ */ new Set([...n.allowedLocales, u])).isAmbiguous(i));
...
class Ar {
  ...
  getCandidateCodePoints() {
    ...
    if (this.options.invisibleCharacters)
      for (const n of Ee.codePoints)
        yr(String.fromCodePoint(n)) || t.add(n);
  ...
  shouldHighlightNonBasicASCII(t, n) {
    ...
    if (n)
      for (const o of n) {
        const l = o.codePointAt(0), u = ei(o);
    ...
    return (
      ...
      i ? 0 : this.options.invisibleCharacters && !yr(t) && Ee.isInvisibleCharacter(r) ? 2 : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(r) ? 3 : 0
    );
  }
}
function yr(e) {
...
function Ye(e, t, n = 0, r = e.length) {
  let s = n, i = r;
  for (; s < i; ) {
...
function jt(e, t, n = 0, r = e.length) {
  let s = n, i = r;
  for (; s < i; ) {
    const o = Math.floor((s + i) / 2);
    t(e[o]) ? i = o : s = o + 1;
...
class Ct {
  ...
  findLastMonotonous(t) {
    ...
    const n = Ye(this._array, t, this._findLastMonotonousLastIdx);
...
class de {
  ...
  addRange(t) {
    if (t.length === 0)
      return;
    const n = jt(this._normalizedRanges, (s) => s.endLineNumberExclusive >= t.startLineNumber), r = Ye(this._normalizedRanges, (s) => s.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === r)
  ...
  contains(t) {
    const n = He(this._normalizedRanges, (r) => r.startLineNumber <= t);
    return !!n && n.endLineNumberExclusive > t;
  }
  intersects(t) {
    const n = He(this._normalizedRanges, (r) => r.startLineNumber < t.endLineNumberExclusive);
   ...
   */
  subtractFrom(t) {
    const n = jt(this._normalizedRanges, (o) => o.endLineNumberExclusive >= t.startLineNumber), r = Ye(this._normalizedRanges, (o) => o.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === r)
      return new de([t]);
    const s = [];
    ...
    for (let o = n; o < r; o++) {
      ...
      l.startLineNumber > i && s.push(new D(i, l.startLineNumber)), i = l.endLineNumberExclusive;
    }
    return i < t.endLineNumberExclusive && s.push(new D(i, t.endLineNumberExclusive)), new de(s);
  }
  toString() {
...
class ue {
  static inverse(t, n, r) {
    ...
    const l = new ue(new D(i, n + 1), new D(o, r + 1));
  ...
  static clip(t, n, r) {
    ...
    for (const i of t) {
      ...
      o && !o.isEmpty && l && !l.isEmpty && s.push(new ue(o, l));
    }
    return s;
  }
  constructor(t, n) {
  ...
  */
  toRangeMapping2(t, n) {
    if (Er(this.original.endLineNumberExclusive, t) && Er(this.modified.endLineNumberExclusive, n))
      return new he(new k(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new k(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
    if (!this.original.isEmpty && !this.modified.isEmpty)
      return new he(k.fromPositions(new $(this.original.startLineNumber, 1), Te(new $(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), k.fromPositions(new $(this.modified.startLineNumber, 1), Te(new $(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1)
      return new he(k.fromPositions(Te(new $(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), t), Te(new $(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), k.fromPositions(Te(new $(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), n), Te(new $(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
    throw new ae();
  }
}
function Te(e, t) {
...
class pe extends ue {
  static fromRangeMappings(t) {
    const n = D.join(t.map((s) => D.fromRangeInclusive(s.originalRange))), r = D.join(t.map((s) => D.fromRangeInclusive(s.modifiedRange)));
    return new pe(n, r, t);
  }
  constructor(t, n, r) {
  ...
  flip() {
    return new pe(this.modified, this.original, this.innerChanges?.map((t) => t.flip()));
  }
  withInnerChangesFromLineRanges() {
    return new pe(this.original, this.modified, [this.toRangeMapping()]);
  }
}
class he {
  ...
  */
  toTextEdit(t) {
    ...
    return new ma(this.originalRange, n);
  }
}
const ga = 3;
class ba {
  computeDiff(t, n, r) {
    ...
    for (const u of i.changes) {
      ...
      let h = new pe(c, f, u.charChanges?.map((d) => new he(new k(d.originalStartLineNumber, d.originalStartColumn, d.originalEndLineNumber, d.originalEndColumn), new k(d.modifiedStartLineNumber, d.modifiedStartColumn, d.modifiedEndLineNumber, d.modifiedEndColumn))));
      l && (l.modified.endLineNumberExclusive === h.modified.startLineNumber || l.original.endLineNumberExclusive === h.original.startLineNumber) && (h = new pe(l.original.join(h.original), l.modified.join(h.modified), l.innerChanges && h.innerChanges ? l.innerChanges.concat(h.innerChanges) : void 0), o.pop()), o.push(h), l = h;
    }
    return vt(() => os(o, (u, c) => c.original.startLineNumber - u.original.endLineNumberExclusive === c.modified.startLineNumber - u.modified.endLineNumberExclusive && // There has to be an unchanged line in between (otherwise both diffs should have been joined)
    u.original.endLineNumberExclusive < c.original.startLineNumber && u.modified.endLineNumberExclusive < c.modified.startLineNumber)), new at(o, [], i.quitEarly);
  }
}
function hs(e, t, n, r) {
  return new Se(e, t, n).ComputeDiff(r);
}
let Mr = class {
  constructor(t) {
    const n = [], r = [];
    for (let s = 0, i = t.length; s < i; s++)
      n[s] = Xt(t[s], 1), r[s] = Qt(t[s], 1);
...
function xa(e) {
  ...
  for (let r = 1, s = e.length; r < s; r++) {
    ...
    Math.min(o, l) < ga ? (n.originalLength = i.originalStart + i.originalLength - n.originalStart, n.modifiedLength = i.modifiedStart + i.modifiedLength - n.modifiedStart) : (t.push(i), n = i);
  }
  return t;
}
class Xe {
  ...
  static createFromDiffResult(t, n, r, s, i, o, l) {
    ...
    if (n.originalLength === 0 ? (u = r.getStartLineNumber(n.originalStart) - 1, c = 0) : (u = r.getStartLineNumber(n.originalStart), c = r.getEndLineNumber(n.originalStart + n.originalLength - 1)), n.modifiedLength === 0 ? (f = s.getStartLineNumber(n.modifiedStart) - 1, h = 0) : (f = s.getStartLineNumber(n.modifiedStart), h = s.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), o && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && i()) {
      ...
      if (m.getElements().length > 0 && g.getElements().length > 0) {
        let b = hs(m, g, i, !0).changes;
        l && (b = xa(b)), d = [];
        for (let _ = 0, v = b.length; _ < v; _++)
          d.push(Ue.createFromDiffChange(b[_], m, g));
      }
    }
...
class _a {
  constructor(t, n, r) {
    this.shouldComputeCharChanges = r.shouldComputeCharChanges, this.shouldPostProcessCharChanges = r.shouldPostProcessCharChanges, this.shouldIgnoreTrimWhitespace = r.shouldIgnoreTrimWhitespace, this.shouldMakePrettyDiff = r.shouldMakePrettyDiff, this.originalLines = t, this.modifiedLines = n, this.original = new Mr(t), this.modified = new Mr(n), this.continueLineDiff = kr(r.maxComputationTime), this.continueCharDiff = kr(r.maxComputationTime === 0 ? 0 : Math.min(r.maxComputationTime, 5e3));
  }
  computeDiff() {
    ...
    const t = hs(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), n = t.changes, r = t.quitEarly;
    if (this.shouldIgnoreTrimWhitespace) {
      const l = [];
      for (let u = 0, c = n.length; u < c; u++)
        l.push(Xe.createFromDiffResult(this.shouldIgnoreTrimWhitespace, n[u], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
      return {
        quitEarly: r,
        changes: l
      };
        ...
        if (d !== m) {
          {
            ...
            (g > 1 || b > 1) && this._pushTrimWhitespaceCharChange(s, i + 1, 1, g, o + 1, 1, b);
          }
          {
            let g = Qt(d, 1), b = Qt(m, 1);
            ...
            (g < _ || b < v) && this._pushTrimWhitespaceCharChange(s, i + 1, g, _, o + 1, b, v);
          }
        }
        i++, o++;
      }
      c && (s.push(Xe.createFromDiffResult(this.shouldIgnoreTrimWhitespace, c, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), i += c.originalLength, o += c.modifiedLength);
    }
    return {
      quitEarly: r,
      changes: s
  ...
  _pushTrimWhitespaceCharChange(t, n, r, s, i, o, l) {
    if (this._mergeTrimWhitespaceCharChange(t, n, r, s, i, o, l))
      return;
    let u;
    this.shouldComputeCharChanges && (u = [new Ue(n, r, n, s, i, o, i, l)]), t.push(new Xe(n, n, i, i, u));
  }
...
class xe {
  static trivial(t, n) {
    return new xe([new G(V.ofLength(t.length), V.ofLength(n.length))], !1);
  }
  static trivialTimedOut(t, n) {
    return new xe([new G(V.ofLength(t.length), V.ofLength(n.length))], !0);
  }
  constructor(t, n) {
...
class G {
  static invert(t, n) {
    const r = [];
    return va(t, (s, i) => {
      r.push(G.fromOffsetPairs(s ? s.getEndExclusives() : fe.zero, i ? i.getStarts() : new fe(n, (s ? s.seq2Range.endExclusive - s.seq1Range.endExclusive : 0) + n)));
    }), r;
  }
  static fromOffsetPairs(t, n) {
    return new G(new V(t.offset1, n.offset1), new V(t.offset2, n.offset2));
  }
  static assertSorted(t) {
    let n;
    for (const r of t) {
...
class Aa {
  compute(t, n, r = Ke.instance, s) {
    if (t.length === 0 || n.length === 0)
      return xe.trivial(t, n);
    const i = new Pt(t.length, n.length), o = new Pt(t.length, n.length), l = new Pt(t.length, n.length);
    for (let g = 0; g < t.length; g++)
      for (let b = 0; b < n.length; b++) {
        if (!r.isValid())
          return xe.trivialTimedOut(t, n);
        const _ = g === 0 ? 0 : i.get(g - 1, b), v = b === 0 ? 0 : i.get(g, b - 1);
        let S;
        t.getElement(g) === n.getElement(b) ? (g === 0 || b === 0 ? S = 0 : S = i.get(g - 1, b - 1), g > 0 && b > 0 && o.get(g - 1, b - 1) === 3 && (S += l.get(g - 1, b - 1)), S += s ? s(g, b) : 1) : S = -1;
        const N = Math.max(_, v, S);
        if (N === S) {
          const x = g > 0 && b > 0 ? l.get(g - 1, b - 1) : 0;
          l.set(g, b, x + 1), o.set(g, b, 3);
        } else N === _ ? (l.set(g, b, 0), o.set(g, b, 1)) : N === v && (l.set(g, b, 0), o.set(g, b, 2));
        i.set(g, b, N);
      }
    const u = [];
    let c = t.length, f = n.length;
    function h(g, b) {
      (g + 1 !== c || b + 1 !== f) && u.push(new G(new V(g + 1, c), new V(b + 1, f))), c = g, f = b;
    }
    let d = t.length - 1, m = n.length - 1;
    for (; d >= 0 && m >= 0; )
      o.get(d, m) === 3 ? (h(d, m), d--, m--) : o.get(d, m) === 1 ? d-- : m--;
    return h(-1, -1), u.reverse(), new xe(u, !1);
  }
}
class fs {
  compute(t, n, r = Ke.instance) {
    if (t.length === 0 || n.length === 0)
      return xe.trivial(t, n);
    const s = t, i = n;
    function o(b, _) {
      for (; b < s.length && _ < i.length && s.getElement(b) === i.getElement(_); )
        b++, _++;
      return b;
    }
    let l = 0;
    ...
    e: for (; ; ) {
      if (l++, !r.isValid())
        return xe.trivialTimedOut(s, i);
      const b = -Math.min(l, i.length + l % 2), _ = Math.min(l, s.length + l % 2);
      for (f = b; f <= _; f += 2) {
        const v = f === _ ? -1 : u.get(f + 1), S = f === b ? -1 : u.get(f - 1) + 1, N = Math.min(Math.max(v, S), s.length), x = N - f;
        if (N > s.length || x > i.length)
          continue;
        const p = o(N, x);
        u.set(f, p);
        const L = N === v ? c.get(f + 1) : c.get(f - 1);
        if (c.set(f, p !== N ? new Pr(L, N, x, p - N) : L), u.get(f) === s.length && u.get(f) - f === i.length)
          break e;
      }
    }
    let h = c.get(f);
    const d = [];
    let m = s.length, g = i.length;
    for (; ; ) {
      const b = h ? h.x + h.length : 0, _ = h ? h.y + h.length : 0;
      if ((b !== m || _ !== g) && d.push(new G(new V(b, m), new V(_, g))), !h)
        break;
      m = h.x, g = h.y, h = h.prev;
    }
    return d.reverse(), new xe(d, !1);
  }
}
class Pr {
  constructor(t, n, r, s) {
...
class Nt {
  ...
  getBoundaryScore(t) {
    const n = Dr(t > 0 ? this.elements[t - 1] : -1), r = Dr(t < this.elements.length ? this.elements[t] : -1);
    if (n === 7 && r === 8)
      return 0;
    if (n === 8)
      return 150;
    let s = 0;
    return n !== r && (s += 10, n === 0 && r === 1 && (s += 1)), s += Fr(n), s += Fr(r), s;
  }
  translateOffset(t, n = "right") {
    const r = Ye(this.firstElementOffsetByLineIdx, (i) => i <= t), s = t - this.firstElementOffsetByLineIdx[r];
    return new $(this.range.startLineNumber + r, 1 + this.lineStartOffsets[r] + s + (s === 0 && n === "left" ? 0 : this.trimmedWsLengthsByLineIdx[r]));
  }
  translateRange(t) {
    const n = this.translateOffset(t.start, "right"), r = this.translateOffset(t.endExclusive, "left");
    return r.isBefore(n) ? k.fromPositions(r, r) : k.fromPositions(n, r);
  }
  /**
  ...
  findWordContaining(t) {
    ...
    for (; n > 0 && Ft(this.elements[n - 1]); )
      n--;
    let r = t;
    for (; r < this.elements.length && Ft(this.elements[r]); )
      r++;
    return new V(n, r);
  }
  countLinesIn(t) {
  ...
  extendToFullLines(t) {
    const n = He(this.firstElementOffsetByLineIdx, (s) => s <= t.start) ?? 0, r = da(this.firstElementOffsetByLineIdx, (s) => t.endExclusive <= s) ?? this.elements.length;
    return new V(n, r);
  }
}
function Ft(e) {
...
function Dr(e) {
  return e === 10 ? 8 : e === 13 ? 7 : Jt(e) ? 6 : e >= 97 && e <= 122 ? 0 : e >= 65 && e <= 90 ? 1 : e >= 48 && e <= 57 ? 2 : e === -1 ? 3 : e === 44 || e === 59 ? 5 : 4;
}
function ka(e, t, n, r, s, i) {
  let { moves: o, excludedChanges: l } = Fa(e, t, n, i);
  if (!i.isValid())
    return [];
  const u = e.filter((f) => !l.has(f)), c = Da(u, r, s, t, n, i);
  return Sa(o, c), o = Ta(o), o = o.filter((f) => {
    const h = f.original.toOffsetRange().slice(t).map((m) => m.trim());
    return h.join(`
`).length >= 15 && Pa(h, (m) => m.length >= 2) >= 2;
  }), o = Ia(e, o), o;
}
function Pa(e, t) {
  let n = 0;
...
function Fa(e, t, n, r) {
  const s = [], i = e.filter((u) => u.modified.isEmpty && u.original.length >= 3).map((u) => new Je(u.original, t, u)), o = new Set(e.filter((u) => u.original.isEmpty && u.modified.length >= 3).map((u) => new Je(u.modified, n, u))), l = /* @__PURE__ */ new Set();
  for (const u of i) {
    let c = -1, f;
    for (const h of o) {
    ...
    if (c > 0.9 && f && (o.delete(f), s.push(new ue(u.range, f.range)), l.add(u.source), l.add(f.source)), !r.isValid())
...
function Da(e, t, n, r, s, i) {
  ...
  const u = [];
  e.sort(ot((d) => d.modified.startLineNumber, lt));
  for (const d of e) {
    let m = [];
  ...
  u.sort(Ca(ot((d) => d.modifiedLineRange.length, lt)));
  ...
  o.sort(ot((d) => d.original.startLineNumber, lt));
  const h = new Ct(e);
  for (let d = 0; d < o.length; d++) {
    const m = o[d], g = h.findLastMonotonous((L) => L.original.startLineNumber <= m.original.startLineNumber), b = He(e, (L) => L.modified.startLineNumber <= m.modified.startLineNumber), _ = Math.max(m.original.startLineNumber - g.original.startLineNumber, m.modified.startLineNumber - b.modified.startLineNumber), v = h.findLastMonotonous((L) => L.original.startLineNumber < m.original.endLineNumberExclusive), S = He(e, (L) => L.modified.startLineNumber < m.modified.endLineNumberExclusive), N = Math.max(v.original.endLineNumberExclusive - m.original.endLineNumberExclusive, S.modified.endLineNumberExclusive - m.modified.endLineNumberExclusive);
    let x;
    for (x = 0; x < _; x++) {
      const L = m.original.startLineNumber - x - 1, R = m.modified.startLineNumber - x - 1;
      if (L > r.length || R > s.length || c.contains(R) || f.contains(L) || !Tr(r[L - 1], s[R - 1], i))
        break;
    }
    ...
    let p;
    for (p = 0; p < N; p++) {
      const L = m.original.endLineNumberExclusive + p, R = m.modified.endLineNumberExclusive + p;
      if (L > r.length || R > s.length || c.contains(R) || f.contains(L) || !Tr(r[L - 1], s[R - 1], i))
        break;
    }
    p > 0 && (f.addRange(new D(m.original.endLineNumberExclusive, m.original.endLineNumberExclusive + p)), c.addRange(new D(m.modified.endLineNumberExclusive, m.modified.endLineNumberExclusive + p))), (x > 0 || p > 0) && (o[d] = new ue(new D(m.original.startLineNumber - x, m.original.endLineNumberExclusive + p), new D(m.modified.startLineNumber - x, m.modified.endLineNumberExclusive + p)));
  }
  return o;
}
function Tr(e, t, n) {
  ...
  if (e.length > 300 && t.length > 300)
    return !1;
  const s = new fs().compute(new Nt([e], new k(1, 1, 1, e.length), !1), new Nt([t], new k(1, 1, 1, t.length), !1), n);
  let i = 0;
  const o = G.invert(s.diffs, e.length);
  for (const f of o)
...
function Ta(e) {
  if (e.length === 0)
    return e;
  e.sort(ot((n) => n.original.startLineNumber, lt));
  const t = [e[0]];
...
function Ia(e, t) {
  const n = new Ct(e);
  return t = t.filter((r) => {
    const s = n.findLastMonotonous((l) => l.original.startLineNumber < r.original.endLineNumberExclusive) || new ue(new D(1, 1), new D(1, 1)), i = He(e, (l) => l.modified.startLineNumber < r.modified.endLineNumberExclusive);
    return s !== i;
  }), t;
}
function Ir(e, t, n) {
  let r = n;
  return r = Vr(e, t, r), r = Vr(e, t, r), r = Va(e, t, r), r;
}
function Vr(e, t, n) {
  if (n.length === 0)
    return n;
  ...
  for (let i = 1; i < n.length; i++) {
    ...
    if (l.seq1Range.isEmpty || l.seq2Range.isEmpty) {
      ...
      for (c = 1; c <= u && !(e.getElement(l.seq1Range.start - c) !== e.getElement(l.seq1Range.endExclusive - c) || t.getElement(l.seq2Range.start - c) !== t.getElement(l.seq2Range.endExclusive - c)); c++)
        ;
      if (c--, c === u) {
        r[r.length - 1] = new G(new V(o.seq1Range.start, l.seq1Range.endExclusive - u), new V(o.seq2Range.start, l.seq2Range.endExclusive - u));
        continue;
      }
      l = l.delta(-c);
    }
  ...
  for (let i = 0; i < r.length - 1; i++) {
    ...
    if (l.seq1Range.isEmpty || l.seq2Range.isEmpty) {
      ...
      for (c = 0; c < u && !(!e.isStronglyEqual(l.seq1Range.start + c, l.seq1Range.endExclusive + c) || !t.isStronglyEqual(l.seq2Range.start + c, l.seq2Range.endExclusive + c)); c++)
        ;
      if (c === u) {
        r[i + 1] = new G(new V(l.seq1Range.start + u, o.seq1Range.endExclusive), new V(l.seq2Range.start + u, o.seq2Range.endExclusive));
        continue;
      }
      c > 0 && (l = l.delta(c));
    }
...
function Va(e, t, n) {
  ...
  for (let r = 0; r < n.length; r++) {
    const s = r > 0 ? n[r - 1] : void 0, i = n[r], o = r + 1 < n.length ? n[r + 1] : void 0, l = new V(s ? s.seq1Range.endExclusive + 1 : 0, o ? o.seq1Range.start - 1 : e.length), u = new V(s ? s.seq2Range.endExclusive + 1 : 0, o ? o.seq2Range.start - 1 : t.length);
    i.seq1Range.isEmpty ? n[r] = Br(i, e, t, l, u) : i.seq2Range.isEmpty && (n[r] = Br(i.swap(), t, e, u, l).swap());
  }
  return n;
}
function Br(e, t, n, r, s) {
  let o = 1;
  for (; e.seq1Range.start - o >= r.start && e.seq2Range.start - o >= s.start && n.isStronglyEqual(e.seq2Range.start - o, e.seq2Range.endExclusive - o) && o < 100; )
    o++;
  o--;
  let l = 0;
  for (; e.seq1Range.start + l < r.endExclusive && e.seq2Range.endExclusive + l < s.endExclusive && n.isStronglyEqual(e.seq2Range.start + l, e.seq2Range.endExclusive + l) && l < 100; )
    l++;
  if (o === 0 && l === 0)
    return e;
  let u = 0, c = -1;
...
function Ba(e, t, n) {
  ...
  for (const s of n) {
    ...
    s.seq1Range.start - i.seq1Range.endExclusive <= 2 || s.seq2Range.start - i.seq2Range.endExclusive <= 2 ? r[r.length - 1] = new G(i.seq1Range.join(s.seq1Range), i.seq2Range.join(s.seq2Range)) : r.push(s);
  }
  return r;
}
function qa(e, t, n) {
  const r = G.invert(n, e.length), s = [];
  let i = new fe(0, 0);
  function o(u, c) {
    ...
    for (; r.length > 0; ) {
      ...
      if (!(_.seq1Range.intersects(d.seq1Range) || _.seq2Range.intersects(d.seq2Range)))
        break;
      const S = e.findWordContaining(_.seq1Range.start), N = t.findWordContaining(_.seq2Range.start), x = new G(S, N), p = x.intersect(_);
      if (g += p.seq1Range.length, b += p.seq2Range.length, d = d.join(x), d.seq1Range.endExclusive >= _.seq1Range.endExclusive)
        r.shift();
      else
        break;
    }
    g + b < (d.seq1Range.length + d.seq2Range.length) * 2 / 3 && s.push(d), i = d.getEndExclusives();
  }
  for (; r.length > 0; ) {
    const u = r.shift();
...
function Ha(e, t, n) {
  ...
  do {
    ...
    for (let c = 1; c < r.length; c++) {
      let d = function(g, b) {
        const _ = new V(h.seq1Range.endExclusive, f.seq1Range.start);
        if (e.countLinesIn(_) > 5 || _.length > 500)
          return !1;
        const S = e.getText(_).trim();
        if (S.length > 20 || S.split(/\r\n|\r|\n/).length > 1)
          return !1;
        const N = e.countLinesIn(g.seq1Range), x = g.seq1Range.length, p = t.countLinesIn(g.seq2Range), L = g.seq2Range.length, R = e.countLinesIn(b.seq1Range), y = b.seq1Range.length, B = t.countLinesIn(b.seq2Range), Q = b.seq2Range.length, q = 2 * 40 + 50;
        function F(C) {
          return Math.min(C, q);
        }
        return Math.pow(Math.pow(F(N * 40 + x), 1.5) + Math.pow(F(p * 40 + L), 1.5), 1.5) + Math.pow(Math.pow(F(R * 40 + y), 1.5) + Math.pow(F(B * 40 + Q), 1.5), 1.5) > (q ** 1.5) ** 1.5 * 1.3;
      };
      var l = d;
  ...
  return Na(r, (u, c, f) => {
    ...
    const m = e.extendToFullLines(c.seq1Range), g = e.getText(new V(m.start, c.seq1Range.start));
    d(g) && (h = h.deltaStart(-g.length));
    const b = e.getText(new V(c.seq1Range.endExclusive, m.endExclusive));
    d(b) && (h = h.deltaEnd(b.length));
    const _ = G.fromOffsetPairs(u ? u.getEndExclusives() : fe.zero, f ? f.getStarts() : fe.max), v = h.intersect(_);
...
class qr {
  ...
  getBoundaryScore(t) {
    const n = t === 0 ? 0 : Ur(this.lines[t - 1]), r = t === this.lines.length ? 0 : Ur(this.lines[t]);
    return 1e3 - (n + r);
  }
  getText(t) {
...
class Wa {
  constructor() {
    this.dynamicProgrammingDiffing = new Aa(), this.myersDiffingAlgorithm = new fs();
  }
  computeDiff(t, n, r) {
    if (t.length <= 1 && wa(t, n, (p, L) => p === L))
      return new at([], [], !1);
    if (t.length === 1 && t[0].length === 0 || n.length === 1 && n[0].length === 0)
      return new at([
        new pe(new D(1, t.length + 1), new D(1, n.length + 1), [
          new he(new k(1, 1, t.length, t[t.length - 1].length + 1), new k(1, 1, n.length, n[n.length - 1].length + 1))
        ])
      ], [], !1);
    const s = r.maxComputationTimeMs === 0 ? Ke.instance : new Ra(r.maxComputationTimeMs), i = !r.ignoreTrimWhitespace, o = /* @__PURE__ */ new Map();
    function l(p) {
      let L = o.get(p);
      return L === void 0 && (L = o.size, o.set(p, L)), L;
    }
    const u = t.map((p) => l(p.trim())), c = n.map((p) => l(p.trim())), f = new qr(u, t), h = new qr(c, n), d = f.length + h.length < 1700 ? this.dynamicProgrammingDiffing.compute(f, h, s, (p, L) => t[p] === n[L] ? n[L].length === 0 ? 0.1 : 1 + Math.log(1 + n[L].length) : 0.99) : this.myersDiffingAlgorithm.compute(f, h, s);
    let m = d.diffs, g = d.hitTimeout;
    m = Ir(f, h, m), m = $a(f, h, m);
    const b = [], _ = (p) => {
      if (i)
        for (let L = 0; L < p; L++) {
          const R = v + L, y = S + L;
          if (t[R] !== n[y]) {
            const B = this.refineDiff(t, n, new G(new V(R, R + 1), new V(y, y + 1)), s, i);
    ...
    let v = 0, S = 0;
    for (const p of m) {
      vt(() => p.seq1Range.start - v === p.seq2Range.start - S);
      const L = p.seq1Range.start - v;
      _(L), v = p.seq1Range.endExclusive, S = p.seq2Range.endExclusive;
      const R = this.refineDiff(t, n, p, s, i);
      R.hitTimeout && (g = !0);
      for (const y of R.mappings)
        b.push(y);
    }
    _(t.length - v);
    const N = $r(b, t, n);
    let x = [];
    return r.computeMoves && (x = this.computeMoves(N, t, n, u, c, s, i)), vt(() => {
      function p(R, y) {
        if (R.lineNumber < 1 || R.lineNumber > y.length)
          return !1;
        const B = y[R.lineNumber - 1];
        return !(R.column < 1 || R.column > B.length + 1);
      }
      function L(R, y) {
        return !(R.startLineNumber < 1 || R.startLineNumber > y.length + 1 || R.endLineNumberExclusive < 1 || R.endLineNumberExclusive > y.length + 1);
      }
      for (const R of N) {
        if (!R.innerChanges)
          return !1;
        for (const y of R.innerChanges)
          if (!(p(y.modifiedRange.getStartPosition(), n) && p(y.modifiedRange.getEndPosition(), n) && p(y.originalRange.getStartPosition(), t) && p(y.originalRange.getEndPosition(), t)))
            return !1;
        if (!L(R.modified, n) || !L(R.original, t))
          return !1;
      }
      return !0;
    }), new at(N, x, g);
  ...
  computeMoves(t, n, r, s, i, o, l) {
    return ka(t, n, r, s, i, o).map((f) => {
      const h = this.refineDiff(n, r, new G(f.original.toOffsetRange(), f.modified.toOffsetRange()), o, l), d = $r(h.mappings, n, r, !0);
      return new fa(f, d);
    });
  }
  refineDiff(t, n, r, s, i) {
    const l = Oa(r).toRangeMapping2(t, n), u = new Nt(t, l.originalRange, i), c = new Nt(n, l.modifiedRange, i), f = u.length + c.length < 500 ? this.dynamicProgrammingDiffing.compute(u, c, s) : this.myersDiffingAlgorithm.compute(u, c, s);
    let h = f.diffs;
    return h = Ir(u, c, h), h = qa(u, c, h), h = Ba(u, c, h), h = Ha(u, c, h), {
...
function $r(e, t, n, r = !1) {
  const s = [];
  for (const i of La(e.map((o) => za(o, t, n)), (o, l) => o.original.overlapOrTouch(l.original) || o.modified.overlapOrTouch(l.modified))) {
    const o = i[0], l = i[i.length - 1];
    s.push(new pe(o.original.join(l.original), o.modified.join(l.modified), i.map((u) => u.innerChanges[0])));
  }
  return vt(() => !r && s.length > 0 && (s[0].modified.startLineNumber !== s[0].original.startLineNumber || n.length - s[s.length - 1].modified.endLineNumberExclusive !== t.length - s[s.length - 1].original.endLineNumberExclusive) ? !1 : os(s, (i, o) => o.original.startLineNumber - i.original.endLineNumberExclusive === o.modified.startLineNumber - i.modified.endLineNumberExclusive && // There has to be an unchanged line in between (otherwise both diffs should have been joined)
...
function za(e, t, n) {
  ...
  const i = new D(e.originalRange.startLineNumber + r, e.originalRange.endLineNumber + 1 + s), o = new D(e.modifiedRange.startLineNumber + r, e.modifiedRange.endLineNumber + 1 + s);
  return new pe(i, o, [e]);
}
function Oa(e) {
...
class X {
  constructor(t, n, r, s = 1) {
    this._rgbaBrand = void 0, this.r = Math.min(255, Math.max(0, t)) | 0, this.g = Math.min(255, Math.max(0, n)) | 0, this.b = Math.min(255, Math.max(0, r)) | 0, this.a = ye(Math.max(Math.min(1, s), 0), 3);
  }
  static equals(t, n) {
...
class le {
  constructor(t, n, r, s) {
    this._hslaBrand = void 0, this.h = Math.max(Math.min(360, t), 0) | 0, this.s = ye(Math.max(Math.min(1, n), 0), 3), this.l = ye(Math.max(Math.min(1, r), 0), 3), this.a = ye(Math.max(Math.min(1, s), 0), 3);
  }
  static equals(t, n) {
...
class Be {
  constructor(t, n, r, s) {
    this._hsvaBrand = void 0, this.h = Math.max(Math.min(360, t), 0) | 0, this.s = ye(Math.max(Math.min(1, n), 0), 3), this.v = ye(Math.max(Math.min(1, r), 0), 3), this.a = ye(Math.max(Math.min(1, s), 0), 3);
  }
  static equals(t, n) {
  ...
  static fromRGBA(t) {
    const n = t.r / 255, r = t.g / 255, s = t.b / 255, i = Math.max(n, r, s), o = Math.min(n, r, s), l = i - o, u = i === 0 ? 0 : l / i;
    let c;
    return l === 0 ? c = 0 : i === n ? c = ((r - s) / l % 6 + 6) % 6 : i === r ? c = (s - n) / l + 2 : c = (n - r) / l + 4, new Be(Math.round(c * 60), u, i, t.a);
  }
...
class O {
  ...
  getRelativeLuminance() {
    const t = O._relativeLuminanceForComponent(this.rgba.r), n = O._relativeLuminanceForComponent(this.rgba.g), r = O._relativeLuminanceForComponent(this.rgba.b), s = 0.2126 * t + 0.7152 * n + 0.0722 * r;
    return ye(s, 4);
  }
  ...
  makeOpaque(t) {
    if (this.isOpaque() || t.rgba.a !== 1)
      return this;
    const { r: n, g: r, b: s, a: i } = this.rgba;
    return new O(new X(t.rgba.r - i * (t.rgba.r - n), t.rgba.g - i * (t.rgba.g - r), t.rgba.b - i * (t.rgba.b - s), 1));
  }
  toString() {
...
function Ga(e, t) {
  ...
  if (n)
    return {
      range: e,
      color: on(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a)
    };
}
function Wr(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const s = t[0].values(), i = ds(s);
  return {
    range: e,
    color: on(i[0], i[1], i[2], n ? i[3] : 1)
  };
}
function zr(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const s = t[0].values(), i = ds(s), o = new O(new le(i[0], i[1] / 100, i[2] / 100, n ? i[3] : 1));
  return {
    range: e,
    color: on(o.rgba.r, o.rgba.g, o.rgba.b, o.rgba.a)
  };
}
function Ge(e, t) {
...
function ja(e) {
  const t = [], r = Ge(e, /\b(rgb|rgba|hsl|hsla)(\([0-9\s,.\%]*\))|(#)([A-Fa-f0-9]{3})\b|(#)([A-Fa-f0-9]{4})\b|(#)([A-Fa-f0-9]{6})\b|(#)([A-Fa-f0-9]{8})\b/gm);
  if (r.length > 0)
    for (const s of r) {
...
function Ka(e, t, n) {
  ...
  const r = Or.exec(e);
  if (r) {
    const s = r.indices[1][0] + 1, i = r.indices[1][1] + 1, o = { startLineNumber: t, startColumn: s, endLineNumber: t, endColumn: i };
...
function ms(e) {
  ...
  return e = e.replace(Qa, ""), { text: e, hasSeparatorLine: t };
}
var Gr;
(function(e) {
  async function t(r) {
...
class e1 {
  ...
  getIndexOf(t) {
    ...
    for (; n <= r; )
      if (s = n + (r - n) / 2 | 0, i = this.prefixSum[s], o = i - this.values[s], t < o)
        r = s - 1;
      else if (t >= i)
        n = s + 1;
      else
...
class r1 {
  ...
  $acceptNewModel(t) {
    this._models[t.url] = new s1(ne.parse(t.url), t.lines, t.EOL, t.versionId);
  }
...
class s1 extends n1 {
  ...
  findMatches(t) {
    ...
    for (let r = 0; r < this._lines.length; r++) {
      const s = this._lines[r], i = this.offsetAt(new $(r + 1, 1)), o = s.matchAll(t);
      for (const l of o)
  ...
  getWordAtPosition(t, n) {
    const r = an(t.column, us(n), this._lines[t.lineNumber - 1], 0);
...
class i1 {
  ...
  async $computeDiff(t, n, r, s) {
    ...
    return !i || !o ? null : ct.computeDiff(i, o, r, s);
  }
  static computeDiff(t, n, r, s) {
    const i = s === "advanced" ? Hr.getDefault() : Hr.getLegacy(), o = t.getLinesContent(), l = n.getLinesContent(), u = i.computeDiff(o, l, r), c = u.changes.length > 0 ? !1 : this._modelsAreIdentical(t, n);
    function f(h) {
  ...
  async $computeMoreMinimalEdits(t, n, r) {
    ...
    for (let { range: u, text: c, eol: f } of n) {
      ...
      if (c = c.replace(/\r\n|\n|\r/g, s.eol), h === c)
        continue;
      if (Math.max(c.length, h.length) > ct._diffLimit) {
        i.push({ range: u, text: c });
        continue;
      }
      const d = Pi(h, c, r), m = s.offsetAt(k.lift(u).getStartPosition());
      for (const g of d) {
        const b = s.positionAt(m + g.originalStart), _ = s.positionAt(m + g.originalStart + g.originalLength), v = {
  ...
  async $textualSuggest(t, n, r, s) {
    const i = new St(), o = new RegExp(r, s), l = /* @__PURE__ */ new Set();
    e: for (const u of t) {
      const c = this._getModel(u);
      if (c) {
        for (const f of c.words(o))
          if (!(f === n || !isNaN(Number(f))) && (l.add(f), l.size > ct._suggestionsLimit))
            break e;
      }
    }
  ...
  async $navigateValueSet(t, n, r, s, i) {
    ...
    return rn.INSTANCE.navigateValueSet(n, u, c, f, r);
  }
}
class ct extends i1 {
  constructor(t, n) {
  ...
  $loadForeignModule(t, n, r) {
    const o = {
      host: ta(r, (l, u) => this._host.$fhr(l, u)),
      getMirrorModels: () => this._getModels()
    };
    return this._foreignModuleFactory ? (this._foreignModule = this._foreignModuleFactory(o, n), Promise.resolve(Nr(this._foreignModule))) : new Promise((l, u) => {
      const c = (f) => {
        this._foreignModule = f.create(o, n), l(Nr(this._foreignModule));
      };
      import(`${ns.asBrowserUri(`${t}.js`).toString(!0)}`).then(c).catch(u);
    });
  }
...
typeof importScripts == "function" && (globalThis.monaco = Qi());
let Zt = !1;
function a1(e) {
  if (Zt)
    return;
