...
const xn = "Canceled";
function Ba(e) {
  return e instanceof qa ? !0 : e instanceof Error && e.name === xn && e.message === xn;
}
class qa extends Error {
  constructor() {
    super(xn), this.name = this.message;
  }
}
...
const $a = globalThis.performance && typeof globalThis.performance.now == "function";
class un {
  static create(t) {
    return new un(t);
  }
  constructor(t) {
    this._now = $a && t === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance), this._startTime = this._now(), this._stopTime = -1;
  }
  stop() {
...
(function(e) {
  ...
  function n(E) {
    return (w, A = null, R) => {
      ...
      return P = E((U) => {
        if (!I)
          return P ? P.dispose() : I = !0, w.call(A, U);
      }, null, R), I && P.dispose(), P;
    };
  }
  e.once = n;
  function i(E, w) {
  ...
  e.onceIf = i;
  function r(E, w, A) {
    return c((R, I = null, P) => E((U) => R.call(I, w(U)), null, P), A);
  }
  e.map = r;
  function s(E, w, A) {
    return c((R, I = null, P) => E((U) => {
      w(U), R.call(I, U);
    }, null, P), A);
  }
  e.forEach = s;
  function o(E, w, A) {
    return c((R, I = null, P) => E((U) => w(U) && R.call(I, U), null, P), A);
  }
  e.filter = o;
  function l(E) {
    return E;
  ...
  function a(...E) {
    return (w, A = null, R) => {
      const I = Va(...E.map((P) => P((U) => w.call(A, U))));
      return d(I, R);
    };
  }
  e.any = a;
  ...
  function m(E, w, A = 100, R = !1, I = !1, P, U) {
    let W, q, X, se = 0, _e;
    const hn = {
      leakWarningThreshold: P,
      onWillAddFirstListener() {
        W = E((Ua) => {
          se++, q = w(q, Ua), R && !X && (At.fire(q), q = void 0), _e = () => {
            const Wa = q;
            q = void 0, X = void 0, (!R || se > 1) && At.fire(Wa), se = 0;
  ...
  function M(E, w, A = (R) => R) {
    const R = (...W) => U.fire(A(...W)), I = () => E.on(w, R), P = () => E.removeListener(w, R), U = new we({ onWillAddFirstListener: I, onDidRemoveLastListener: P });
    return U.event;
  }
  e.fromNodeEventEmitter = M;
  function D(E, w, A = (R) => R) {
    const R = (...W) => U.fire(A(...W)), I = () => E.addEventListener(w, R), P = () => E.removeEventListener(w, R), U = new we({ onWillAddFirstListener: I, onDidRemoveLastListener: P });
    return U.event;
  }
  ...
  function T(E) {
    return (w, A, R) => {
      ...
      const U = {
        ...
        endUpdate() {
          I--, I === 0 && (E.reportChanges(), P && (P = !1, w.call(A)));
        },
      ...
      return R instanceof Tt ? R.add(W) : Array.isArray(R) && R.push(W), W;
    };
  }
...
class qt {
  ...
  start(t) {
    this._stopWatch = new un(), this.listenerCount = t;
  }
  stop() {
    if (this._stopWatch) {
...
class we {
  constructor(t) {
    this._size = 0, this._options = t, this._leakageMon = this._options?.leakWarningThreshold ? new oi(t?.onListenerError ?? pt, this._options?.leakWarningThreshold ?? Ga) : void 0, this._perfMon = this._options?._profName ? new qt(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue;
  }
  dispose() {
  ...
  get event() {
    return this._event ??= (t, n, i) => {
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        ...
        console.warn(l);
        const a = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], u = new Ya(`${l}. HINT: Stack shows most frequent listener (${a[1]}-times)`, a[0]);
        return (this._options?.onListenerError || pt)(u), Ft.None;
      }
      if (this._disposed)
        return Ft.None;
      n && (t = t.bind(n));
      const r = new dn(t);
      let s;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (r.stack = li.create(), s = this._leakageMon.check(r.stack, this._size + 1)), this._listeners ? this._listeners instanceof dn ? (this._deliveryQueue ??= new Qa(), this._listeners = [this._listeners, r]) : this._listeners.push(r) : (this._options?.onWillAddFirstListener?.(this), this._listeners = r, this._options?.onDidAddFirstListener?.(this)), this._size++;
      const o = Pt(() => {
        s?.(), this._removeListener(r);
      });
      return i instanceof Tt ? i.add(o) : Array.isArray(i) && i.push(o), o;
    }, this._event;
  }
  _removeListener(t) {
    ...
    if (this._size * Ja <= n.length) {
      let s = 0;
      for (let o = 0; o < n.length; o++)
        n[o] ? n[s++] = n[o] : r && (this._deliveryQueue.end--, s < this._deliveryQueue.i && this._deliveryQueue.i--);
      n.length = s;
    }
  }
  _deliver(t, n) {
    if (!t)
      return;
    const i = this._options?.onListenerError || pt;
    if (!i) {
      t.value(n);
      return;
    }
   ...
   */
  fire(t) {
    if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners) if (this._listeners instanceof dn)
...
const Ka = la() === "pseudo" || typeof document < "u" && document.location && document.location.hash.indexOf("pseudo=true") >= 0;
function gi(e, t) {
  let n;
  ...
  }), Ka && (n = "［" + n.replace(/[aouei]/g, "$&$&") + "］"), n;
}
function J(e, t, ...n) {
  return gi(typeof e == "number" ? eo(e, t) : t, n);
}
function eo(e, t) {
  const n = Za()?.[e];
  if (typeof n != "string") {
...
const it = "en";
let Tn = !1, kn = !1, mn = !1, ua = !1, ui = !1, St, fn = it, bi = it, to, Me;
const De = globalThis;
let pe;
...
const no = typeof pe?.versions?.electron == "string", io = no && pe?.type === "renderer";
if (typeof pe == "object") {
  Tn = pe.platform === "win32", kn = pe.platform === "darwin", mn = pe.platform === "linux", mn && pe.env.SNAP && pe.env.SNAP_REVISION, pe.env.CI || pe.env.BUILD_ARTIFACTSTAGINGDIRECTORY, St = it, fn = it;
  const e = pe.env.VSCODE_NLS_CONFIG;
  if (e)
    try {
      const t = JSON.parse(e);
      St = t.userLocale, bi = t.osLocale, fn = t.resolvedLanguage || it, to = t.languagePack?.translationsConfigFile;
    } catch {
    }
  ua = !0;
} else typeof navigator == "object" && !io ? (Me = navigator.userAgent, Tn = Me.indexOf("Windows") >= 0, kn = Me.indexOf("Macintosh") >= 0, (Me.indexOf("Macintosh") >= 0 || Me.indexOf("iPad") >= 0 || Me.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints > 0, mn = Me.indexOf("Linux") >= 0, Me?.indexOf("Mobi") >= 0, ui = !0, fn = la() || it, St = navigator.language.toLowerCase(), bi = St) : console.error("Unable to resolve platform.");
const wt = Tn, ro = kn, so = ua, ao = ui, oo = ui && typeof De.importScripts == "function", lo = oo ? De.origin : void 0, Re = Me, uo = typeof De.postMessage == "function" && !De.importScripts;
(() => {
  if (uo) {
    const e = [];
...
const co = !!(Re && Re.indexOf("Chrome") >= 0);
Re && Re.indexOf("Firefox") >= 0;
!co && Re && Re.indexOf("Safari") >= 0;
Re && Re.indexOf("Edg/") >= 0;
...
class mo {
  constructor(t, n) {
    this.lastCache = void 0, this.lastArgKey = void 0, typeof t == "function" ? (this._fn = t, this._computeKey = ho) : (this._fn = n, this._computeKey = t.getCacheKey);
  }
  get(t) {
...
class qe {
  ...
  static {
    this._locales = new _i(() => Object.keys(qe.ambiguousCharacterData.value).filter((t) => !t.startsWith("_")));
  }
  static getLocales() {
...
if (typeof pn < "u" && typeof pn.process < "u") {
  ...
  // Supported
  get platform() {
    return wt ? "win32" : ro ? "darwin" : "linux";
  },
  get arch() {
  },
  // Unsupported
...
const Ot = st.cwd, To = st.env, ko = st.platform, Ao = 65, So = 97, Lo = 90, Co = 122, Ve = 46, ae = 47, ce = 92, Ue = 58, Eo = 63;
...
function We(e) {
  return e >= Ao && e <= Lo || e >= So && e <= Co;
}
function Vt(e, t, n, i) {
  let r = "", s = 0, o = -1, l = 0, a = 0;
      ...
      if (!(o === u - 1 || l === 1)) if (l === 2) {
        if (r.length < 2 || s !== 2 || r.charCodeAt(r.length - 1) !== Ve || r.charCodeAt(r.length - 2) !== Ve) {
          if (r.length > 2) {
            ...
            c === -1 ? (r = "", s = 0) : (r = r.slice(0, c), s = r.length - 1 - r.lastIndexOf(n)), o = u, l = 0;
            continue;
          } else if (r.length !== 0) {
            r = "", s = 0, o = u, l = 0;
            continue;
        ...
        r.length > 0 ? r += `${n}${e.slice(o + 1, u)}` : r = e.slice(o + 1, u), s = u - o - 1;
      o = u, l = 0;
    } else a === Ve && l !== -1 ? ++l : l = -1;
  }
  return r;
...
function da(e, t) {
  Ro(t, "pathObject");
  const n = t.dir || t.root, i = t.base || `${t.name || ""}${Mo(t.ext)}`;
...
const le = {
    ...
    for (let r = e.length - 1; r >= -1; r--) {
      ...
      if (r >= 0) {
        if (s = e[r], K(s, `paths[${r}]`), s.length === 0)
          continue;
      } else t.length === 0 ? s = Ot() : (s = To[`=${t}`] || Ot(), (s === void 0 || s.slice(0, 2).toLowerCase() !== t.toLowerCase() && s.charCodeAt(2) === ce) && (s = `${t}\\`));
      const o = s.length;
      let l = 0, a = "", u = !1;
      ...
      if (o === 1)
        ...
        if (u = !0, V(s.charCodeAt(1))) {
          let d = 2, m = d;
          for (; d < o && !V(s.charCodeAt(d)); )
            d++;
          if (d < o && d !== m) {
            const f = s.slice(m, d);
            for (m = d; d < o && V(s.charCodeAt(d)); )
              d++;
            if (d < o && d !== m) {
              for (m = d; d < o && !V(s.charCodeAt(d)); )
                d++;
              (d === o || d !== m) && (a = `\\\\${f}\\${s.slice(m, d)}`, l = d);
            }
          }
        } else
          l = 1;
      else We(c) && s.charCodeAt(1) === Ue && (a = s.slice(0, 2), l = 2, o > 2 && V(s.charCodeAt(2)) && (u = !0, l = 3));
      if (a.length > 0)
        if (t.length > 0) {
      ...
      if (r = !0, V(e.charCodeAt(1))) {
        ...
        if (l < t && l !== a) {
          ...
          if (l < t && l !== a) {
            ...
            if (l === t)
              return `\\\\${u}\\${e.slice(a)}\\`;
            l !== a && (i = `\\\\${u}\\${e.slice(a, l)}`, n = l);
          }
        }
      } else
        n = 1;
    else We(s) && e.charCodeAt(1) === Ue && (i = e.slice(0, 2), n = 2, t > 2 && V(e.charCodeAt(2)) && (r = !0, n = 3));
    let o = n < t ? Vt(e.slice(n), !r, "\\", V) : "";
    return o.length === 0 && !r && (o = "."), o.length > 0 && V(e.charCodeAt(t - 1)) && (o += "\\"), i === void 0 ? r ? `\\${o}` : o : r ? `${i}\\${o}` : `${i}${o}`;
  },
  isAbsolute(e) {
    K(e, "path");
    const t = e.length;
  ...
  join(...e) {
    ...
    for (let s = 0; s < e.length; ++s) {
      const o = e[s];
      K(o, "path"), o.length > 0 && (t === void 0 ? t = n = o : t += `\\${o}`);
    }
    if (t === void 0)
      return ".";
    let i = !0, r = 0;
  ...
  relative(e, t) {
    ...
    for (; l < t.length && t.charCodeAt(l) === ce; )
      l++;
    let a = t.length;
    for (; a - 1 > l && t.charCodeAt(a - 1) === ce; )
      a--;
    const u = a - l, c = o < u ? o : u;
    let d = -1, m = 0;
    for (; m < c; m++) {
    ...
    if (m !== c) {
      ...
      o > c && (e.charCodeAt(r + m) === ce ? d = m : m === 2 && (d = 3)), d === -1 && (d = 0);
    }
    let f = "";
    for (m = r + d + 1; m <= s; ++m)
      (m === s || e.charCodeAt(m) === ce) && (f += f.length === 0 ? ".." : "\\..");
    return l += d, f.length > 0 ? `${f}${i.slice(l, a)}` : (i.charCodeAt(l) === ce && ++l, i.slice(l, a));
  },
  toNamespacedPath(e) {
    ...
    if (e.length >= 2 && We(e.charCodeAt(0)) && e.charCodeAt(1) === Ue && (n = 2), t !== void 0 && t.length > 0 && t.length <= e.length) {
      ...
      for (s = e.length - 1; s >= n; --s) {
        ...
        if (V(a)) {
          ...
          l === -1 && (r = !1, l = s + 1), o >= 0 && (a === t.charCodeAt(o) ? --o === -1 && (i = s) : (o = -1, i = l));
      }
  ...
  parse(e) {
    ...
    let s = -1, o = i, l = -1, a = !0, u = e.length - 1, c = 0;
    for (; u >= i; --u) {
      ...
      l === -1 && (a = !1, l = u + 1), r === Ve ? s === -1 ? s = u : c !== 1 && (c = 1) : s !== -1 && (c = -1);
    }
    return l !== -1 && (s === -1 || // We saw a non-dot character immediately before the dot
    c === 0 || // The (right-most) trimmed path component is exactly '..'
    c === 1 && s === l - 1 && s === o + 1 ? t.base = t.name = e.slice(o, l) : (t.name = e.slice(o, s), t.base = e.slice(o, l), t.ext = e.slice(s, l))), o > 0 && o !== i ? t.dir = e.slice(0, o - 1) : t.dir = t.root, t;
  },
  sep: "\\",
  delimiter: ";",
  win32: null,
  ...
  resolve(...e) {
    ...
    return t = Vt(t, !n, "/", Sn), n ? `/${t}` : t.length > 0 ? t : ".";
  },
  normalize(e) {
    if (K(e, "path"), e.length === 0)
      return ".";
    const t = e.charCodeAt(0) === ae, n = e.charCodeAt(e.length - 1) === ae;
    return e = Vt(e, !t, "/", Sn), e.length === 0 ? t ? "/" : n ? "./" : "." : (n && (e += "/"), t ? `/${e}` : e);
  },
  isAbsolute(e) {
  ...
  relative(e, t) {
    if (K(e, "from"), K(t, "to"), e === t || (e = ue.resolve(e), t = ue.resolve(t), e === t))
      return "";
    const n = 1, i = e.length, r = i - n, s = 1, o = t.length - s, l = r < o ? r : o;
    let a = -1, u = 0;
    for (; u < l; u++) {
    ...
    if (u === l)
      if (o > l) {
        ...
        if (u === 0)
          return t.slice(s + u);
      } else r > l && (e.charCodeAt(n + u) === ae ? a = u : u === 0 && (a = 0));
    let c = "";
    for (u = n + a + 1; u <= i; ++u)
  ...
  extname(e) {
    ...
    for (let o = e.length - 1; o >= 0; --o) {
      ...
      i === -1 && (r = !1, i = o + 1), l === Ve ? t === -1 ? t = o : s !== 1 && (s = 1) : t !== -1 && (s = -1);
    }
  ...
  parse(e) {
    ...
    let i;
    n ? (t.root = "/", i = 1) : i = 0;
    let r = -1, s = 0, o = -1, l = !0, a = e.length - 1, u = 0;
    for (; a >= i; --a) {
      ...
      o === -1 && (l = !1, o = a + 1), c === Ve ? r === -1 ? r = a : u !== 1 && (u = 1) : r !== -1 && (u = -1);
    }
    if (o !== -1) {
      const c = s === 0 && n ? 1 : s;
      r === -1 || // We saw a non-dot character immediately before the dot
      u === 0 || // The (right-most) trimmed path component is exactly '..'
      u === 1 && r === o - 1 && r === s + 1 ? t.base = t.name = e.slice(c, o) : (t.name = e.slice(c, r), t.base = e.slice(c, o), t.ext = e.slice(r, o));
    }
...
let Ce = class Rt {
  static isUri(t) {
    return t instanceof Rt ? !0 : t ? typeof t.authority == "string" && typeof t.fragment == "string" && typeof t.path == "string" && typeof t.query == "string" && typeof t.scheme == "string" && typeof t.fsPath == "string" && typeof t.with == "function" && typeof t.toString == "function" : !1;
  }
  /**
   * @internal
   */
  constructor(t, n, i, r, s, o = !1) {
    typeof t == "object" ? (this.scheme = t.scheme || Y, this.authority = t.authority || Y, this.path = t.path || Y, this.query = t.query || Y, this.fragment = t.fragment || Y) : (this.scheme = Wo(t, o), this.authority = n || Y, this.path = Po(this.scheme, i || Y), this.query = r || Y, this.fragment = s || Y, Uo(this, o));
  }
  // ---- filesystem path -----------------------
  /**
  ...
  with(t) {
    ...
    return n === void 0 ? n = this.scheme : n === null && (n = Y), i === void 0 ? i = this.authority : i === null && (i = Y), r === void 0 ? r = this.path : r === null && (r = Y), s === void 0 ? s = this.query : s === null && (s = Y), o === void 0 ? o = this.fragment : o === null && (o = Y), n === this.scheme && i === this.authority && r === this.path && s === this.query && o === this.fragment ? this : new Je(n, i, r, s, o);
  }
  // ---- parse & validate ------------------------
  /**
  ...
  static parse(t, n = !1) {
    const i = Fo.exec(t);
    return i ? new Je(i[2] || Y, Lt(i[4] || Y), Lt(i[5] || Y), Lt(i[7] || Y), Lt(i[9] || Y), n) : new Je(Y, Y, Y, Y, Y);
  }
  /**
  ...
  static joinPath(t, ...n) {
    ...
    let i;
    return wt && t.scheme === "file" ? i = Rt.file(le.join(Ln(t, !0), ...n)).path : i = ue.join(t.path, ...n), t.with({ path: i });
  }
  ...
  static revive(t) {
    if (t) {
      ...
      {
        const n = new Je(t);
        return n._formatted = t.external ?? null, n._fsPath = t._sep === ma ? t.fsPath ?? null : null, n;
      }
    } else return t;
  }
};
const ma = wt ? 1 : void 0;
class Je extends Ce {
  constructor() {
    super(...arguments), this._formatted = null, this._fsPath = null;
  }
  get fsPath() {
    return this._fsPath || (this._fsPath = Ln(this, !1)), this._fsPath;
  }
  toString(t = !1) {
  ...
  toJSON() {
    ...
    return this._fsPath && (t.fsPath = this._fsPath, t._sep = ma), this._formatted && (t.external = this._formatted), this.path && (t.path = this.path), this.scheme && (t.scheme = this.scheme), this.authority && (t.authority = this.authority), this.query && (t.query = this.query), this.fragment && (t.fragment = this.fragment), t;
  }
}
const fa = {
  58: "%3A",
...
function Cn(e, t) {
  const n = t ? Bo : wi;
  let i = "", { scheme: r, authority: s, path: o, query: l, fragment: a } = e;
  ...
  return l && (i += "?", i += n(l, !1, !1)), a && (i += "#", i += t ? a : wi(a, !1, !1)), i;
}
function pa(e) {
  try {
...
function Lt(e) {
  return e.match(vi) ? e.replace(vi, (t) => pa(t)) : e;
}
var Oe;
(function(e) {
...
class Oo {
  ...
  rewrite(t) {
    ...
    return typeof s == "string" && (o += `&${qo}=${encodeURIComponent(s)}`), Ce.from({
      scheme: ao ? this._preferredWebSchema : Oe.vscodeRemoteResource,
      authority: `${i}:${r}`,
...
const Vo = new Oo(), jo = "vscode-app";
class jt {
  static {
    this.FALLBACK_AUTHORITY = jo;
  }
  /**
   ...
   */
  uriToBrowserUri(t) {
    return t.scheme === Oe.vscodeRemote ? Vo.rewrite(t) : (
      // ...only ever for `file` resources
      t.scheme === Oe.file && // ...and we run in native environments
      (so || // ...or web worker extensions on desktop
      lo === `${Oe.vscodeFileResource}://${jt.FALLBACK_AUTHORITY}`) ? t.with({
...
(function(e) {
  ...
  function i(s) {
    let o;
    typeof s == "string" ? o = new URL(s).searchParams : s instanceof URL ? o = s.searchParams : Ce.isUri(s) && (o = new URL(s.toString(!0)).searchParams);
    const l = o?.get(n);
    if (l)
      return t.get(l);
  }
...
class Qo {
  ...
  sendMessage(t, n, i) {
    ...
    return new Promise((s, o) => {
      this._pendingReplies[r] = {
        resolve: s,
        reject: o
      }, this._send(new Go(this._workerId, r, t, n, i));
    });
  }
  listen(t, n, i) {
    let r = null;
    const s = new we({
      onWillAddFirstListener: () => {
        r = String(++this._lastSentReq), this._pendingEmitters.set(r, s), this._send(new Xo(this._workerId, r, t, n, i));
      },
      onDidRemoveLastListener: () => {
  ...
  createProxyToRemoteChannel(t, n) {
    const i = {
      get: (r, s) => (typeof s == "string" && !r[s] && (_a(s) ? r[s] = (o) => this.listen(t, s, o) : ba(s) ? r[s] = this.listen(t, s, void 0) : s.charCodeAt(0) === 36 && (r[s] = async (...o) => (await n?.(), this.sendMessage(t, s, o)))), r[s])
    };
  ...
  _handleRequestMessage(t) {
    ...
    this._handler.handleMessage(t.channel, t.method, t.args).then((r) => {
      this._send(new xi(this._workerId, n, r, void 0));
    }, (r) => {
      r.detail instanceof Error && (r.detail = pi(r.detail)), this._send(new xi(this._workerId, n, void 0, pi(r)));
    });
  }
  _handleSubscribeEventMessage(t) {
    const n = t.req, i = this._handler.handleEvent(t.channel, t.eventName, t.arg)((r) => {
      this._send(new Yo(this._workerId, n, r));
    });
...
function ba(e) {
  return e[0] === "o" && e[1] === "n" && ca(e.charCodeAt(2));
}
function _a(e) {
  return /^onDynamic/.test(e) && ca(e.charCodeAt(9));
}
class Zo {
  constructor(t, n) {
    this._localChannels = /* @__PURE__ */ new Map(), this._remoteChannels = /* @__PURE__ */ new Map(), this._requestHandlerFactory = n, this._requestHandler = null, this._protocol = new Qo({
      sendMessage: (i, r) => {
        t(i, r);
      },
  ...
  _handleMessage(t, n, i) {
    ...
    const r = t === gn ? this._requestHandler : this._localChannels.get(t);
    if (!r)
  ...
  async initialize(t, n, i) {
    ...
    return n && (typeof n.baseUrl < "u" && delete n.baseUrl, typeof n.paths < "u" && typeof n.paths.vs < "u" && delete n.paths.vs, typeof n.trustedTypesPolicy < "u" && delete n.trustedTypesPolicy, n.catchError = !0, globalThis.require.config(n)), import(`${ga.asBrowserUri(`${i}.js`).toString(!0)}`).then((s) => {
...
function el(e, t, n) {
  return new Be(new ki(e), new ki(t)).ComputeDiff(n).changes;
}
class Qe {
  static Assert(t, n) {
    if (!t)
...
class Be {
  ...
  constructor(t, n, i = null) {
    ...
    const [r, s, o] = Be._getElements(t), [l, a, u] = Be._getElements(n);
    this._hasStrings = o && u, this._originalStringElements = r, this._originalElementsOrHash = s, this._modifiedStringElements = l, this._modifiedElementsOrHash = a, this.m_forwardHistory = [], this.m_reverseHistory = [];
  }
  ...
  ComputeDiffRecursive(t, n, i, r, s) {
    ...
    const o = [0], l = [0], a = this.ComputeRecursionPoint(t, n, i, r, o, l, s), u = o[0], c = l[0];
    if (a !== null)
      return a;
    if (!s[0]) {
      ...
      let m = [];
      return s[0] ? m = [
        new Pe(u + 1, n - (u + 1) + 1, c + 1, r - (c + 1) + 1)
  ...
  WALKTRACE(t, n, i, r, s, o, l, a, u, c, d, m, f, _, g, k, y, v) {
    let L = null, M = null, D = new Ai(), N = n, b = i, p = f[0] - k[0] - r, x = -1073741824, H = this.m_forwardHistory.length - 1;
    do {
      const S = p + t;
    ...
    if (L = D.getReverseChanges(), v[0]) {
      ...
      M = [
        new Pe(S, m - S + 1, T, g - T + 1)
      ];
    } else {
      D = new Ai(), N = o, b = l, p = f[0] - k[0] - a, x = 1073741824, H = y ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
      do {
        const S = p + s;
        S === N || S < b && c[S - 1] >= c[S + 1] ? (d = c[S + 1] - 1, _ = d - p - a, d > x && D.MarkNextChange(), x = d + 1, D.AddOriginalElement(d + 1, _ + 1), p = S + 1 - s) : (d = c[S - 1], _ = d - p - a, d > x && D.MarkNextChange(), x = d, D.AddModifiedElement(d + 1, _ + 1), p = S - 1 - s), H >= 0 && (c = this.m_reverseHistory[H], s = c[0], N = 1, b = c.length - 1);
      } while (--H >= -1);
      M = D.getChanges();
    }
  ...
  ComputeRecursionPoint(t, n, i, r, s, o, l) {
    ...
    for (let p = 1; p <= _ / 2 + 1; p++) {
      ...
      for (let T = c; T <= d; T += 2) {
        T === c || T < d && k[T - 1] < k[T + 1] ? a = k[T + 1] : a = k[T - 1] + 1, u = a - (T - v) - M;
        const E = a;
        for (; a < n && u < r && this.ElementsAreEqual(a + 1, u + 1); )
          a++, u++;
        if (k[T] = a, a + u > x + H && (x = a, H = u), !b && Math.abs(T - L) <= p - 1 && a >= y[T])
          return s[0] = a, o[0] = u, E <= y[T] && p <= 1448 ? this.WALKTRACE(v, c, d, M, L, m, f, D, k, y, a, n, s, u, r, o, b, l) : null;
      }
      const S = (x - t + (H - i) - p) / 2;
      if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(x, S))
        return l[0] = !0, s[0] = x, o[0] = H, S > 0 && p <= 1448 ? this.WALKTRACE(v, c, d, M, L, m, f, D, k, y, a, n, s, u, r, o, b, l) : (t++, i++, [
          new Pe(t, n - t + 1, i, r - i + 1)
        ]);
      m = this.ClipDiagonalBound(L - p, p, L, g), f = this.ClipDiagonalBound(L + p, p, L, g);
      for (let T = m; T <= f; T += 2) {
        T === m || T < f && y[T - 1] >= y[T + 1] ? a = y[T + 1] - 1 : a = y[T - 1], u = a - (T - L) - D;
        const E = a;
        for (; a > t && u > i && this.ElementsAreEqual(a, u); )
          a--, u--;
        if (y[T] = a, b && Math.abs(T - v) <= p && a <= k[T])
          return s[0] = a, o[0] = u, E >= k[T] && p <= 1448 ? this.WALKTRACE(v, c, d, M, L, m, f, D, k, y, a, n, s, u, r, o, b, l) : null;
      }
      if (p <= 1447) {
    ...
    return this.WALKTRACE(v, c, d, M, L, m, f, D, k, y, a, n, s, u, r, o, b, l);
  }
  /**
  ...
  PrettifyChanges(t) {
    for (let n = 0; n < t.length; n++) {
      const i = t[n], r = n < t.length - 1 ? t[n + 1].originalStart : this._originalElementsOrHash.length, s = n < t.length - 1 ? t[n + 1].modifiedStart : this._modifiedElementsOrHash.length, o = i.originalLength > 0, l = i.modifiedLength > 0;
      for (; i.originalStart + i.originalLength < r && i.modifiedStart + i.modifiedLength < s && (!o || this.OriginalElementsAreEqual(i.originalStart, i.originalStart + i.originalLength)) && (!l || this.ModifiedElementsAreEqual(i.modifiedStart, i.modifiedStart + i.modifiedLength)); ) {
    ...
    for (let n = t.length - 1; n >= 0; n--) {
      ...
      const o = i.originalLength > 0, l = i.modifiedLength > 0;
      let a = 0, u = this._boundaryScore(i.originalStart, i.originalLength, i.modifiedStart, i.modifiedLength);
      for (let d = 1; ; d++) {
        const m = i.originalStart - d, f = i.modifiedStart - d;
        if (m < r || f < s || o && !this.OriginalElementsAreEqual(m, m + i.originalLength) || l && !this.ModifiedElementsAreEqual(f, f + i.modifiedLength))
          break;
    ...
    if (this._hasStrings)
      for (let n = 1, i = t.length; n < i; n++) {
        const r = t[n - 1], s = t[n], o = s.originalStart - r.originalStart - r.originalLength, l = r.originalStart, a = s.originalStart + s.originalLength, u = a - l, c = r.modifiedStart, d = s.modifiedStart + s.modifiedLength, m = d - c;
        if (o < 5 && u < 20 && m < 20) {
          const f = this._findBetterContiguousSequence(l, u, c, m, o);
          if (f) {
            const [_, g] = f;
            (_ !== r.originalStart + r.originalLength || g !== r.modifiedStart + r.modifiedLength) && (r.originalLength = _ - r.originalStart, r.modifiedLength = g - r.modifiedStart, s.originalStart = _ + o, s.modifiedStart = g + o, s.originalLength = a - s.originalStart, s.modifiedLength = d - s.modifiedStart);
          }
        }
      }
    return t;
  ...
  ChangesOverlap(t, n, i) {
    if (Qe.Assert(t.originalStart <= n.originalStart, "Left change is not less than or equal to right change"), Qe.Assert(t.modifiedStart <= n.modifiedStart, "Left change is not less than or equal to right change"), t.originalStart + t.originalLength >= n.originalStart || t.modifiedStart + t.modifiedLength >= n.modifiedStart) {
      ...
      return t.originalStart + t.originalLength >= n.originalStart && (s = n.originalStart + n.originalLength - t.originalStart), t.modifiedStart + t.modifiedLength >= n.modifiedStart && (l = n.modifiedStart + n.modifiedLength - t.modifiedStart), i[0] = new Pe(r, s, o, l), !0;
    } else
      return i[0] = null, !1;
  }
  /**
...
let ee = class Ge {
  ...
  static intersectRanges(t, n) {
    ...
    const l = n.startLineNumber, a = n.startColumn, u = n.endLineNumber, c = n.endColumn;
    return i < l ? (i = l, r = a) : i === l && (r = Math.max(r, a)), s > u ? (s = u, o = c) : s === u && (o = Math.min(o, c)), i > s || i === s && r > o ? null : new te(i, r, s, o);
  }
  /**
  ...
  static compareRangesUsingStarts(t, n) {
    if (t && n) {
      ...
      if (s === o) {
        const l = t.startColumn | 0, a = n.startColumn | 0;
        if (l === a) {
...
class $t {
  static _createLink(t, n, i, r, s) {
    ...
    if (r > 0) {
      const l = n.charCodeAt(r - 1), a = n.charCodeAt(o);
    ...
    for (let s = 1, o = t.getLineCount(); s <= o; s++) {
      ...
      for (; u < a; ) {
        ...
        if (m === 13) {
          ...
          L === 1 && (r.push($t._createLink(i, l, s, c, u)), y = !0);
        } else if (m === 12) {
          let L;
      ...
      m === 13 && r.push($t._createLink(i, l, s, c, a));
    }
    return r;
  }
}
function sl(e) {
  return !e || typeof e.getLineCount != "function" || typeof e.getLineContent != "function" ? [] : $t.computeLinks(e);
}
class hi {
  constructor() {
...
class Mt {
  ...
  get onCancellationRequested() {
    return this._isCancelled ? wa : (this._emitter || (this._emitter = new we()), this._emitter.event);
  }
  dispose() {
...
class al {
  ...
  cancel() {
    this._token ? this._token instanceof Mt && this._token.cancel() : this._token = Gt.Cancelled;
  }
  dispose(t = !1) {
    t && this.cancel(), this._parentListener?.dispose(), this._token ? this._token instanceof Mt && this._token.dispose() : this._token = Gt.None;
  }
}
class di {
  constructor() {
...
const Nt = new di(), En = new di(), Rn = new di(), ol = new Array(230), ll = /* @__PURE__ */ Object.create(null), ul = /* @__PURE__ */ Object.create(null);
(function() {
  const e = "", t = [
  ...
  for (const r of t) {
    ...
    if (i[o] || (i[o] = !0, ll[l] = o, ul[l.toLowerCase()] = o), !n[a]) {
      if (n[a] = !0, !u)
        throw new Error(`String representation missing for key code ${a} around scan code ${l}`);
      Nt.define(a, u), En.define(a, m || u), Rn.define(a, f || m || u);
    }
    c && (ol[c] = a);
  }
})();
...
(function(e) {
  ...
  function s(l) {
    return En.strToKeyCode(l) || Rn.strToKeyCode(l);
  }
...
(function(e) {
  ...
  function n(s) {
    let o = t.get(s);
    return o || (console.info("No codicon found for CompletionItemKind " + s), o = F.symbolProperty), o;
  }
  e.toIcon = n;
...
(function(e) {
  ...
  function n(i) {
    let r = t.get(i);
    return r || (console.info("No codicon found for SymbolKind " + i), r = F.symbolProperty), r;
  }
  e.toIcon = n;
})(zi || (zi = {}));
let Fc = class Fe {
  static {
    this.Comment = new Fe("comment");
  }
  static {
    this.Imports = new Fe("imports");
  }
  static {
    this.Region = new Fe("region");
  }
  /**
...
class Xt {
  ...
  static getChannel(t) {
    return t.getChannel(Xt.CHANNEL_NAME);
  }
  static setChannel(t, n) {
    t.setChannel(Xt.CHANNEL_NAME, n);
  }
}
var Er;
class _l {
  constructor() {
    this[Er] = "LinkedMap", this._map = /* @__PURE__ */ new Map(), this._head = void 0, this._tail = void 0, this._size = 0, this._state = 0;
  }
  clear() {
...
function Sl(e, t, n, i, r) {
  return kl(e, t, n, i, r) && Al(e, t, n, i, r);
}
class Ll {
  constructor(t, n) {
  ...
  next(t) {
    ...
    do {
      ...
      if (this._prevMatchStartIndex = r, this._prevMatchLength = s, !this._wordSeparators || Sl(this._wordSeparators, t, n, r, s))
        return i;
    } while (i);
    return null;
  }
}
function Cl(e, t = "Unreachable") {
  throw new Error(t);
}
function Yt(e) {
  if (!e()) {
    debugger;
    e(), pt(new be("Assertion Failed"));
  }
}
function ya(e, t) {
  let n = 0;
...
function mi(e, t, n, i, r) {
  if (t = Ta(t), r || (r = Wt.first(ka)), n.length > r.maxLen) {
    let u = e - r.maxLen / 2;
    return u < 0 ? u = 0 : i += u, n = n.substring(u, e + r.maxLen / 2), mi(e, t, n, i, r);
  }
...
class Nl {
  static computeUnicodeHighlights(t, n, i) {
    const r = i ? i.startLineNumber : 1, s = i ? i.endLineNumber : t.getLineCount(), o = new Ir(n), l = o.getCandidateCodePoints();
    let a;
    l === "allNonBasicAscii" ? a = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : a = new RegExp(`${Dl(Array.from(l))}`, "g");
    const u = new Ll(null, a), c = [];
    ...
    e: for (let k = r, y = s; k <= y; k++) {
      ...
      do
        if (m = u.next(v), m) {
          ...
          const p = o.shouldHighlightNonBasicASCII(N, b ? b.word : null);
          if (p !== 0) {
            if (p === 3 ? f++ : p === 2 ? _++ : p === 1 ? g++ : Cl(), c.length >= 1e3) {
              d = !0;
              break e;
            }
  ...
  static computeUnicodeHighlightReason(t, n) {
    ...
    switch (i.shouldHighlightNonBasicASCII(t, null)) {
      ...
      case 3: {
        const s = t.codePointAt(0), o = i.ambiguousCharacters.getPrimaryConfusable(s), l = qe.getLocales().filter((a) => !qe.getInstance(/* @__PURE__ */ new Set([...n.allowedLocales, a])).isAmbiguous(s));
...
class Ir {
  ...
  getCandidateCodePoints() {
    ...
    if (this.options.invisibleCharacters)
      for (const n of Ye.codePoints)
        zr(String.fromCodePoint(n)) || t.add(n);
  ...
  shouldHighlightNonBasicASCII(t, n) {
    ...
    if (n)
      for (const o of n) {
        const l = o.codePointAt(0), a = xo(o);
        r = r || a, !a && !this.ambiguousCharacters.isAmbiguous(l) && !Ye.isInvisibleCharacter(l) && (s = !0);
      }
    return (
      /* Don't allow mixing weird looking characters with ASCII */
      !r && /* Is there an obviously weird looking character? */
      s ? 0 : this.options.invisibleCharacters && !zr(t) && Ye.isInvisibleCharacter(i) ? 2 : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(i) ? 3 : 0
    );
  }
}
function zr(e) {
...
function zn(e, t, n = 0, i = e.length) {
  let r = n, s = i;
  for (; r < s; ) {
    const o = Math.floor((r + s) / 2);
    t(e[o]) ? s = o : r = o + 1;
...
class Ee {
  ...
  addRange(t) {
    if (t.length === 0)
      return;
    const n = zn(this._normalizedRanges, (r) => r.endLineNumberExclusive >= t.startLineNumber), i = vt(this._normalizedRanges, (r) => r.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === i)
  ...
  getUnion(t) {
    ...
    for (; i < this._normalizedRanges.length || r < t._normalizedRanges.length; ) {
      ...
      if (i < this._normalizedRanges.length && r < t._normalizedRanges.length) {
        const l = this._normalizedRanges[i], a = t._normalizedRanges[r];
        l.startLineNumber < a.startLineNumber ? (o = l, i++) : (o = a, r++);
      } else i < this._normalizedRanges.length ? (o = this._normalizedRanges[i], i++) : (o = t._normalizedRanges[r], r++);
      s === null ? s = o : s.endLineNumberExclusive >= o.startLineNumber ? s = new O(s.startLineNumber, Math.max(s.endLineNumberExclusive, o.endLineNumberExclusive)) : (n.push(s), s = o);
    }
   ...
   */
  subtractFrom(t) {
    const n = zn(this._normalizedRanges, (o) => o.endLineNumberExclusive >= t.startLineNumber), i = vt(this._normalizedRanges, (o) => o.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === i)
      return new Ee([t]);
    const r = [];
  ...
  getIntersection(t) {
    ...
    let i = 0, r = 0;
    for (; i < this._normalizedRanges.length && r < t._normalizedRanges.length; ) {
      const s = this._normalizedRanges[i], o = t._normalizedRanges[r], l = s.intersect(o);
      l && !l.isEmpty && n.push(l), s.endLineNumberExclusive < o.endLineNumberExclusive ? i++ : r++;
    }
    return new Ee(n);
  }
  getWithDelta(t) {
...
class ye {
  static inverse(t, n, i) {
    ...
    let s = 1, o = 1;
    for (const a of t) {
      const u = new ye(new O(s, a.original.startLineNumber), new O(o, a.modified.startLineNumber));
      u.modified.isEmpty || r.push(u), s = a.original.endLineNumberExclusive, o = a.modified.endLineNumberExclusive;
    }
    const l = new ye(new O(s, n + 1), new O(o, i + 1));
    return l.modified.isEmpty || r.push(l), r;
  }
  static clip(t, n, i) {
    const r = [];
    for (const s of t) {
      const o = s.original.intersect(n), l = s.modified.intersect(i);
      o && !o.isEmpty && l && !l.isEmpty && r.push(new ye(o, l));
    }
    return r;
  }
  constructor(t, n) {
  ...
  */
  toRangeMapping2(t, n) {
    if (Hr(this.original.endLineNumberExclusive, t) && Hr(this.modified.endLineNumberExclusive, n))
      return new Ae(new G(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new G(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
...
class Ae {
  ...
  */
  toTextEdit(t) {
    ...
    return new Hl(this.originalRange, n);
  }
}
const Ul = 3;
class Wl {
  computeDiff(t, n, i) {
    ...
    for (const a of s.changes) {
      let u;
      a.originalEndLineNumber === 0 ? u = new O(a.originalStartLineNumber + 1, a.originalStartLineNumber + 1) : u = new O(a.originalStartLineNumber, a.originalEndLineNumber + 1);
      let c;
      a.modifiedEndLineNumber === 0 ? c = new O(a.modifiedStartLineNumber + 1, a.modifiedStartLineNumber + 1) : c = new O(a.modifiedStartLineNumber, a.modifiedEndLineNumber + 1);
      let d = new Ie(u, c, a.charChanges?.map((m) => new Ae(new G(m.originalStartLineNumber, m.originalStartColumn, m.originalEndLineNumber, m.originalEndColumn), new G(m.modifiedStartLineNumber, m.modifiedStartColumn, m.modifiedEndLineNumber, m.modifiedEndColumn))));
      l && (l.modified.endLineNumberExclusive === d.modified.startLineNumber || l.original.endLineNumberExclusive === d.original.startLineNumber) && (d = new Ie(l.original.join(d.original), l.modified.join(d.modified), l.innerChanges && d.innerChanges ? l.innerChanges.concat(d.innerChanges) : void 0), o.pop()), o.push(d), l = d;
    }
    return Yt(() => ya(o, (a, u) => u.original.startLineNumber - a.original.endLineNumberExclusive === u.modified.startLineNumber - a.modified.endLineNumberExclusive && // There has to be an unchanged line in between (otherwise both diffs should have been joined)
    a.original.endLineNumberExclusive < u.original.startLineNumber && a.modified.endLineNumberExclusive < u.modified.startLineNumber)), new Dt(o, [], s.quitEarly);
  }
}
function Aa(e, t, n, i) {
...
let Ur = class {
  ...
  createCharSequence(t, n, i) {
    ...
    let l = 0;
    for (let a = n; a <= i; a++) {
      const u = this.lines[a], c = t ? this._startColumns[a] : 1, d = t ? this._endColumns[a] : u.length + 1;
      for (let m = c; m < d; m++)
        r[l] = u.charCodeAt(m - 1), s[l] = a + 1, o[l] = m, l++;
      !t && a < i && (r[l] = 10, s[l] = a + 1, o[l] = u.length + 1, l++);
    }
    return new Pl(r, s, o);
  }
};
...
class at {
  constructor(t, n, i, r, s, o, l, a) {
    this.originalStartLineNumber = t, this.originalStartColumn = n, this.originalEndLineNumber = i, this.originalEndColumn = r, this.modifiedStartLineNumber = s, this.modifiedStartColumn = o, this.modifiedEndLineNumber = l, this.modifiedEndColumn = a;
  }
...
function Fl(e) {
  ...
  for (let i = 1, r = e.length; i < r; i++) {
    const s = e[i], o = s.originalStart - (n.originalStart + n.originalLength), l = s.modifiedStart - (n.modifiedStart + n.modifiedLength);
    Math.min(o, l) < Ul ? (n.originalLength = s.originalStart + s.originalLength - n.originalStart, n.modifiedLength = s.modifiedStart + s.modifiedLength - n.modifiedStart) : (t.push(s), n = s);
  }
  return t;
}
class gt {
  ...
  static createFromDiffResult(t, n, i, r, s, o, l) {
    let a, u, c, d, m;
    if (n.originalLength === 0 ? (a = i.getStartLineNumber(n.originalStart) - 1, u = 0) : (a = i.getStartLineNumber(n.originalStart), u = i.getEndLineNumber(n.originalStart + n.originalLength - 1)), n.modifiedLength === 0 ? (c = r.getStartLineNumber(n.modifiedStart) - 1, d = 0) : (c = r.getStartLineNumber(n.modifiedStart), d = r.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), o && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && s()) {
...
class Bl {
  ...
  computeDiff() {
    ...
    const t = Aa(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), n = t.changes, i = t.quitEarly;
    if (this.shouldIgnoreTrimWhitespace) {
      const l = [];
      for (let a = 0, u = n.length; a < u; a++)
        l.push(gt.createFromDiffResult(this.shouldIgnoreTrimWhitespace, n[a], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
      return {
        quitEarly: i,
        changes: l
      };
    ...
    for (let l = -1, a = n.length; l < a; l++) {
      const u = l + 1 < a ? n[l + 1] : null, c = u ? u.originalStart : this.originalLines.length, d = u ? u.modifiedStart : this.modifiedLines.length;
      for (; s < c && o < d; ) {
        const m = this.originalLines[s], f = this.modifiedLines[o];
        if (m !== f) {
          {
            let _ = Hn(m, 1), g = Hn(f, 1);
            for (; _ > 1 && g > 1; ) {
            ...
            (_ > 1 || g > 1) && this._pushTrimWhitespaceCharChange(r, s + 1, 1, _, o + 1, 1, g);
          }
          {
            let _ = Un(m, 1), g = Un(f, 1);
            ...
            (_ < k || g < y) && this._pushTrimWhitespaceCharChange(r, s + 1, _, k, o + 1, g, y);
          }
        }
        s++, o++;
      }
      u && (r.push(gt.createFromDiffResult(this.shouldIgnoreTrimWhitespace, u, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), s += u.originalLength, o += u.modifiedLength);
    }
    return {
      quitEarly: i,
      changes: r
  ...
  _pushTrimWhitespaceCharChange(t, n, i, r, s, o, l) {
    if (this._mergeTrimWhitespaceCharChange(t, n, i, r, s, o, l))
      return;
    let a;
    this.shouldComputeCharChanges && (a = [new at(n, i, n, r, s, o, s, l)]), t.push(new gt(n, n, s, s, a));
  }
  _mergeTrimWhitespaceCharChange(t, n, i, r, s, o, l) {
    ...
    if (a === 0)
      return !1;
    const u = t[a - 1];
    return u.originalEndLineNumber === 0 || u.modifiedEndLineNumber === 0 ? !1 : u.originalEndLineNumber === n && u.modifiedEndLineNumber === s ? (this.shouldComputeCharChanges && u.charChanges && u.charChanges.push(new at(n, i, n, r, s, o, s, l)), !0) : u.originalEndLineNumber + 1 === n && u.modifiedEndLineNumber + 1 === s ? (u.originalEndLineNumber = n, u.modifiedEndLineNumber = s, this.shouldComputeCharChanges && u.charChanges && u.charChanges.push(new at(n, i, n, r, s, o, s, l)), !0) : !1;
  }
}
function Hn(e, t) {
  const n = go(e);
...
class Ht {
  ...
  findLastMaxBy(t) {
    let n, i = !0;
    return this.iterate((r) => ((i || Wn.isGreaterThan(t(r, n))) && (i = !1, n = r), !0)), n;
  }
}
class ze {
  static trivial(t, n) {
...
class Yl {
  compute(t, n, i = kt.instance, r) {
    ...
    const s = new _n(t.length, n.length), o = new _n(t.length, n.length), l = new _n(t.length, n.length);
    for (let _ = 0; _ < t.length; _++)
      for (let g = 0; g < n.length; g++) {
        ...
        let v;
        t.getElement(_) === n.getElement(g) ? (_ === 0 || g === 0 ? v = 0 : v = s.get(_ - 1, g - 1), _ > 0 && g > 0 && o.get(_ - 1, g - 1) === 3 && (v += l.get(_ - 1, g - 1)), v += r ? r(_, g) : 1) : v = -1;
        const L = Math.max(k, y, v);
        if (L === v) {
          const M = _ > 0 && g > 0 ? l.get(_ - 1, g - 1) : 0;
          l.set(_, g, M + 1), o.set(_, g, 3);
        } else L === k ? (l.set(_, g, 0), o.set(_, g, 1)) : L === y && (l.set(_, g, 0), o.set(_, g, 2));
        s.set(_, g, L);
      }
    const a = [];
    let u = t.length, c = n.length;
    function d(_, g) {
      (_ + 1 !== u || g + 1 !== c) && a.push(new Z(new j(_ + 1, u), new j(g + 1, c))), u = _, c = g;
    }
    let m = t.length - 1, f = n.length - 1;
    for (; m >= 0 && f >= 0; )
      o.get(m, f) === 3 ? (d(m, f), m--, f--) : o.get(m, f) === 1 ? m-- : f--;
    return d(-1, -1), a.reverse(), new ze(a, !1);
  }
}
class Sa {
  compute(t, n, i = kt.instance) {
    ...
    a.set(0, o(0, 0));
    const u = new Ql();
    u.set(0, a.get(0) === 0 ? null : new Pr(null, 0, 0, a.get(0)));
    let c = 0;
    e: for (; ; ) {
      if (l++, !i.isValid())
      ...
      for (c = g; c <= k; c += 2) {
        const y = c === k ? -1 : a.get(c + 1), v = c === g ? -1 : a.get(c - 1) + 1, L = Math.min(Math.max(y, v), r.length), M = L - c;
        if (L > r.length || M > s.length)
          continue;
        const D = o(L, M);
        a.set(c, D);
        const N = L === y ? u.get(c + 1) : u.get(c - 1);
        if (u.set(c, D !== L ? new Pr(N, L, M, D - L) : N), a.get(c) === r.length && a.get(c) - c === s.length)
          break e;
      }
    }
    let d = u.get(c);
...
class Jt {
  constructor(t, n, i) {
    ...
    for (let r = this.range.startLineNumber; r <= this.range.endLineNumber; r++) {
      ...
      const a = r === this.range.endLineNumber ? Math.min(this.range.endColumn - 1 - o - l, s.length) : s.length;
      for (let u = 0; u < a; u++)
  ...
  getBoundaryScore(t) {
    const n = Br(t > 0 ? this.elements[t - 1] : -1), i = Br(t < this.elements.length ? this.elements[t] : -1);
    if (n === 7 && i === 8)
      return 0;
    if (n === 8)
      return 150;
    let r = 0;
    return n !== i && (r += 10, n === 0 && i === 1 && (r += 1)), r += Fr(n), r += Fr(i), r;
  }
  ...
  extendToFullLines(t) {
    const n = lt(this.firstElementOffsetByLineIdx, (r) => r <= t.start) ?? 0, i = zl(this.firstElementOffsetByLineIdx, (r) => t.endExclusive <= r) ?? this.elements.length;
    return new j(n, i);
  }
}
function wn(e) {
...
function Br(e) {
  return e === 10 ? 8 : e === 13 ? 7 : Pn(e) ? 6 : e >= 97 && e <= 122 ? 0 : e >= 65 && e <= 90 ? 1 : e >= 48 && e <= 57 ? 2 : e === -1 ? 3 : e === 44 || e === 59 ? 5 : 4;
}
function Kl(e, t, n, i, r, s) {
  let { moves: o, excludedChanges: l } = tu(e, t, n, s);
  if (!s.isValid())
    return [];
  const a = e.filter((c) => !l.has(c)), u = nu(a, i, r, t, n, s);
  return $l(o, u), o = iu(o), o = o.filter((c) => {
    const d = c.original.toOffsetRange().slice(t).map((f) => f.trim());
    return d.join(`
`).length >= 15 && eu(d, (f) => f.length >= 2) >= 2;
  }), o = ru(e, o), o;
}
function eu(e, t) {
  let n = 0;
...
function tu(e, t, n, i) {
  const r = [], s = e.filter((a) => a.modified.isEmpty && a.original.length >= 3).map((a) => new yt(a.original, t, a)), o = new Set(e.filter((a) => a.original.isEmpty && a.modified.length >= 3).map((a) => new yt(a.modified, n, a))), l = /* @__PURE__ */ new Set();
  for (const a of s) {
    let u = -1, c;
    for (const d of o) {
    ...
    if (u > 0.9 && c && (o.delete(c), r.push(new ye(a.range, c.range)), l.add(a.source), l.add(c.source)), !i.isValid())
...
function nu(e, t, n, i, r, s) {
  ...
  a.sort(Gl(It((m) => m.modifiedLineRange.length, zt)));
  ...
  for (const m of a) {
    ...
    for (const y of k.ranges) {
      ...
      o.push(new ye(L, v)), u.addRange(v), c.addRange(L);
    }
  }
  o.sort(It((m) => m.original.startLineNumber, zt));
  const d = new cn(e);
  for (let m = 0; m < o.length; m++) {
    const f = o[m], _ = d.findLastMonotonous((N) => N.original.startLineNumber <= f.original.startLineNumber), g = lt(e, (N) => N.modified.startLineNumber <= f.modified.startLineNumber), k = Math.max(f.original.startLineNumber - _.original.startLineNumber, f.modified.startLineNumber - g.modified.startLineNumber), y = d.findLastMonotonous((N) => N.original.startLineNumber < f.original.endLineNumberExclusive), v = lt(e, (N) => N.modified.startLineNumber < f.modified.endLineNumberExclusive), L = Math.max(y.original.endLineNumberExclusive - f.original.endLineNumberExclusive, v.modified.endLineNumberExclusive - f.modified.endLineNumberExclusive);
    let M;
    for (M = 0; M < k; M++) {
      const N = f.original.startLineNumber - M - 1, b = f.modified.startLineNumber - M - 1;
      if (N > i.length || b > r.length || u.contains(b) || c.contains(N) || !qr(i[N - 1], r[b - 1], s))
        break;
    }
    ...
    D > 0 && (c.addRange(new O(f.original.endLineNumberExclusive, f.original.endLineNumberExclusive + D)), u.addRange(new O(f.modified.endLineNumberExclusive, f.modified.endLineNumberExclusive + D))), (M > 0 || D > 0) && (o[m] = new ye(new O(f.original.startLineNumber - M, f.original.endLineNumberExclusive + D), new O(f.modified.startLineNumber - M, f.modified.endLineNumberExclusive + D)));
  }
  return o;
}
function qr(e, t, n) {
  ...
  if (e.length > 300 && t.length > 300)
    return !1;
  const r = new Sa().compute(new Jt([e], new G(1, 1, 1, e.length), !1), new Jt([t], new G(1, 1, 1, t.length), !1), n);
  let s = 0;
...
function Or(e, t, n) {
  let i = n;
  return i = Vr(e, t, i), i = Vr(e, t, i), i = su(e, t, i), i;
}
function Vr(e, t, n) {
  if (n.length === 0)
    return n;
  ...
  for (let s = 1; s < n.length; s++) {
    ...
    if (l.seq1Range.isEmpty || l.seq2Range.isEmpty) {
      ...
      for (u = 1; u <= a && !(e.getElement(l.seq1Range.start - u) !== e.getElement(l.seq1Range.endExclusive - u) || t.getElement(l.seq2Range.start - u) !== t.getElement(l.seq2Range.endExclusive - u)); u++)
        ;
      if (u--, u === a) {
        i[i.length - 1] = new Z(new j(o.seq1Range.start, l.seq1Range.endExclusive - a), new j(o.seq2Range.start, l.seq2Range.endExclusive - a));
        continue;
      }
      l = l.delta(-u);
    }
  ...
  for (let s = 0; s < i.length - 1; s++) {
    ...
    if (l.seq1Range.isEmpty || l.seq2Range.isEmpty) {
      ...
      for (u = 0; u < a && !(!e.isStronglyEqual(l.seq1Range.start + u, l.seq1Range.endExclusive + u) || !t.isStronglyEqual(l.seq2Range.start + u, l.seq2Range.endExclusive + u)); u++)
        ;
      if (u === a) {
        i[s + 1] = new Z(new j(l.seq1Range.start + a, o.seq1Range.endExclusive), new j(l.seq2Range.start + a, o.seq2Range.endExclusive));
        continue;
      }
      u > 0 && (l = l.delta(u));
    }
...
function su(e, t, n) {
  ...
  for (let i = 0; i < n.length; i++) {
    const r = i > 0 ? n[i - 1] : void 0, s = n[i], o = i + 1 < n.length ? n[i + 1] : void 0, l = new j(r ? r.seq1Range.endExclusive + 1 : 0, o ? o.seq1Range.start - 1 : e.length), a = new j(r ? r.seq2Range.endExclusive + 1 : 0, o ? o.seq2Range.start - 1 : t.length);
    s.seq1Range.isEmpty ? n[i] = jr(s, e, t, l, a) : s.seq2Range.isEmpty && (n[i] = jr(s.swap(), t, e, a, l).swap());
  }
  return n;
}
...
function cu(e, t, n) {
  ...
  return jl(i, (a, u, c) => {
    ...
    const k = Z.fromOffsetPairs(a ? a.getEndExclusives() : Se.zero, c ? c.getStarts() : Se.max), y = d.intersect(k);
...
class $r {
  ...
  getBoundaryScore(t) {
    const n = t === 0 ? 0 : Gr(this.lines[t - 1]), i = t === this.lines.length ? 0 : Gr(this.lines[t]);
    return 1e3 - (n + i);
  }
  getText(t) {
...
class hu {
  constructor() {
    this.dynamicProgrammingDiffing = new Yl(), this.myersDiffingAlgorithm = new Sa();
  }
  computeDiff(t, n, i) {
    if (t.length <= 1 && ql(t, n, (D, N) => D === N))
      return new Dt([], [], !1);
    ...
    const r = i.maxComputationTimeMs === 0 ? kt.instance : new Xl(i.maxComputationTimeMs), s = !i.ignoreTrimWhitespace, o = /* @__PURE__ */ new Map();
    function l(D) {
      let N = o.get(D);
      return N === void 0 && (N = o.size, o.set(D, N)), N;
    }
    const a = t.map((D) => l(D.trim())), u = n.map((D) => l(D.trim())), c = new $r(a, t), d = new $r(u, n), m = c.length + d.length < 1700 ? this.dynamicProgrammingDiffing.compute(c, d, r, (D, N) => t[D] === n[N] ? n[N].length === 0 ? 0.1 : 1 + Math.log(1 + n[N].length) : 0.99) : this.myersDiffingAlgorithm.compute(c, d, r);
    let f = m.diffs, _ = m.hitTimeout;
    f = Or(c, d, f), f = uu(c, d, f);
    const g = [], k = (D) => {
      if (s)
        for (let N = 0; N < D; N++) {
          const b = y + N, p = v + N;
    ...
    let y = 0, v = 0;
    for (const D of f) {
      Yt(() => D.seq1Range.start - y === D.seq2Range.start - v);
    ...
    const L = Xr(g, t, n);
    let M = [];
    return i.computeMoves && (M = this.computeMoves(L, t, n, a, u, r, s)), Yt(() => {
      function D(b, p) {
  ...
  computeMoves(t, n, i, r, s, o, l) {
    return Kl(t, n, i, r, s, o).map((c) => {
      const d = this.refineDiff(n, i, new Z(c.original.toOffsetRange(), c.modified.toOffsetRange()), o, l), m = Xr(d.mappings, n, i, !0);
      return new Il(c, m);
    });
  }
  refineDiff(t, n, i, r, s) {
    const l = mu(i).toRangeMapping2(t, n), a = new Jt(t, l.originalRange, s), u = new Jt(n, l.modifiedRange, s), c = a.length + u.length < 500 ? this.dynamicProgrammingDiffing.compute(a, u, r) : this.myersDiffingAlgorithm.compute(a, u, r);
    let d = c.diffs;
    return d = Or(a, u, d), d = ou(a, u, d), d = au(a, u, d), d = cu(a, u, d), {
      mappings: d.map((f) => new Ae(a.translateRange(f.seq1Range), u.translateRange(f.seq2Range))),
      hitTimeout: c.hitTimeout
    };
  }
}
function Xr(e, t, n, i = !1) {
  const r = [];
  for (const s of Ol(e.map((o) => du(o, t, n)), (o, l) => o.original.overlapOrTouch(l.original) || o.modified.overlapOrTouch(l.modified))) {
    const o = s[0], l = s[s.length - 1];
    r.push(new Ie(o.original.join(l.original), o.modified.join(l.modified), s.map((a) => a.innerChanges[0])));
  }
  return Yt(() => !i && r.length > 0 && (r[0].modified.startLineNumber !== r[0].original.startLineNumber || n.length - r[r.length - 1].modified.endLineNumberExclusive !== t.length - r[r.length - 1].original.endLineNumberExclusive) ? !1 : ya(r, (s, o) => o.original.startLineNumber - s.original.endLineNumberExclusive === o.modified.startLineNumber - s.modified.endLineNumberExclusive && // There has to be an unchanged line in between (otherwise both diffs should have been joined)
  s.original.endLineNumberExclusive < o.original.startLineNumber && s.modified.endLineNumberExclusive < o.modified.startLineNumber)), r;
}
function du(e, t, n) {
  let i = 0, r = 0;
  ...
  const s = new O(e.originalRange.startLineNumber + i, e.originalRange.endLineNumber + 1 + r), o = new O(e.modifiedRange.startLineNumber + i, e.modifiedRange.endLineNumber + 1 + r);
  return new Ie(s, o, [e]);
}
function mu(e) {
...
class ve {
   ...
   */
  static fromRGBA(t) {
    const n = t.r / 255, i = t.g / 255, r = t.b / 255, s = t.a, o = Math.max(n, i, r), l = Math.min(n, i, r);
    let a = 0, u = 0;
    const c = (l + o) / 2, d = o - l;
    if (d > 0) {
      switch (u = Math.min(c <= 0.5 ? d / (2 * c) : d / (2 - 2 * c), 1), o) {
        case n:
          a = (i - r) / d + (i < r ? 6 : 0);
          break;
        case i:
  ...
  static toRGBA(t) {
    ...
    if (i === 0)
      ...
      o = ve._hue2rgb(c, u, n + 1 / 3), l = ve._hue2rgb(c, u, n), a = ve._hue2rgb(c, u, n - 1 / 3);
    }
    return new ie(Math.round(o * 255), Math.round(l * 255), Math.round(a * 255), s);
  }
}
class rt {
  constructor(t, n, i, r) {
  ...
  static fromRGBA(t) {
    const n = t.r / 255, i = t.g / 255, r = t.b / 255, s = Math.max(n, i, r), o = Math.min(n, i, r), l = s - o, a = s === 0 ? 0 : l / s;
    let u;
    return l === 0 ? u = 0 : s === n ? u = ((i - r) / l % 6 + 6) % 6 : s === i ? u = (r - n) / l + 2 : u = (n - i) / l + 4, new rt(Math.round(u * 60), a, s, t.a);
  }
  // from http://www.rapidtables.com/convert/color/hsv-to-rgb.htm
  static toRGBA(t) {
    const { h: n, s: i, v: r, a: s } = t, o = r * i, l = o * (1 - Math.abs(n / 60 % 2 - 1)), a = r - o;
    let [u, c, d] = [0, 0, 0];
    return n < 60 ? (u = o, c = l) : n < 120 ? (u = l, c = o) : n < 180 ? (c = o, d = l) : n < 240 ? (c = l, d = o) : n < 300 ? (u = l, d = o) : n <= 360 && (u = o, d = l), u = Math.round((u + a) * 255), c = Math.round((c + a) * 255), d = Math.round((d + a) * 255), new ie(u, c, d, s);
  }
}
let Qt = class ne {
  static fromHex(t) {
...
function fu(e, t) {
  if (!e)
    return;
  const n = Qt.Format.CSS.parseHex(t);
  if (n)
    return {
      range: e,
...
function Jr(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const r = t[0].values(), s = La(r);
  return {
    range: e,
    color: fi(s[0], s[1], s[2], n ? s[3] : 1)
  };
}
function Qr(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const r = t[0].values(), s = La(r), o = new Qt(new ve(s[0], s[1] / 100, s[2] / 100, n ? s[3] : 1));
  return {
    range: e,
    color: fi(o.rgba.r, o.rgba.g, o.rgba.b, o.rgba.a)
  };
}
function mt(e, t) {
...
function pu(e) {
  const t = [], i = mt(e, /\b(rgb|rgba|hsl|hsla)(\([0-9\s,.\%]*\))|(#)([A-Fa-f0-9]{3})\b|(#)([A-Fa-f0-9]{4})\b|(#)([A-Fa-f0-9]{6})\b|(#)([A-Fa-f0-9]{8})\b/gm);
  if (i.length > 0)
    for (const r of i) {
      const s = r.filter((u) => u !== void 0), o = s[1], l = s[2];
      if (!l)
        continue;
      let a;
      if (o === "rgb") {
...
function wu(e, t) {
  ...
  for (let r = 1; r <= i; r++) {
    ...
    if (o) {
      const l = { startLineNumber: r, startColumn: o[0].length + 1, endLineNumber: r, endColumn: s.length + 1 };
      if (l.endColumn > l.startColumn) {
        const a = {
          range: l,
          ...Ca(s.substring(o[0].length)),
...
function Ca(e) {
  ...
  return e = e.replace(bu, ""), { text: e, hasSeparatorLine: t };
}
var Kr;
(function(e) {
  async function t(i) {
    let r;
    const s = await Promise.all(i.map((o) => o.then((l) => l, (l) => {
      r || (r = l);
    })));
    if (typeof r < "u")
      throw r;
...
class Au {
  ...
  $acceptNewModel(t) {
    this._models[t.url] = new Su(Ce.parse(t.url), t.lines, t.EOL, t.versionId);
  }
...
class Su extends ku {
  ...
  findMatches(t) {
    ...
    for (let i = 0; i < this._lines.length; i++) {
      const r = this._lines[i], s = this.offsetAt(new ee(i + 1, 1)), o = r.matchAll(t);
      for (const l of o)
  ...
  getWordAtPosition(t, n) {
    const i = mi(t.column, Ta(n), this._lines[t.lineNumber - 1], 0);
...
class Lu {
  constructor() {
    this._workerTextModelSyncServer = new Au();
  }
  dispose() {
  }
  _getModel(t) {
  ...
  async $computeUnicodeHighlights(t, n, i) {
    ...
    return r ? Nl.computeUnicodeHighlights(r, n, i) : { ranges: [], hasMore: !1, ambiguousCharacterCount: 0, invisibleCharacterCount: 0, nonBasicAsciiCharacterCount: 0 };
  }
  ...
  async $computeDiff(t, n, i, r) {
    ...
    return !s || !o ? null : Ut.computeDiff(s, o, i, r);
  }
  static computeDiff(t, n, i, r) {
    const s = r === "advanced" ? Yr.getDefault() : Yr.getLegacy(), o = t.getLinesContent(), l = n.getLinesContent(), a = s.computeDiff(o, l, i), u = a.changes.length > 0 ? !1 : this._modelsAreIdentical(t, n);
    function c(d) {
  ...
  static _modelsAreIdentical(t, n) {
    ...
    if (i !== r)
      return !1;
    for (let s = 1; s <= i; s++) {
      const o = t.getLineContent(s), l = n.getLineContent(s);
      if (o !== l)
        return !1;
    }
    return !0;
  ...
  async $computeMoreMinimalEdits(t, n, i) {
    ...
    n = n.slice(0).sort((a, u) => {
      ...
      const c = a.range ? 0 : 1, d = u.range ? 0 : 1;
      return c - d;
    });
    let l = 0;
    ...
    for (let { range: a, text: u, eol: c } of n) {
      if (typeof c == "number" && (o = c), G.isEmpty(a) && !u)
        continue;
      const d = r.getValueInRange(a);
      if (u = u.replace(/\r\n|\n|\r/g, r.eol), d === u)
        continue;
      if (Math.max(u.length, d.length) > Ut._diffLimit) {
        s.push({ range: a, text: u });
        continue;
      }
      const m = el(d, u, i), f = r.offsetAt(G.lift(a).getStartPosition());
      for (const _ of m) {
  ...
  async $textualSuggest(t, n, i, r) {
    const s = new un(), o = new RegExp(i, r), l = /* @__PURE__ */ new Set();
    e: for (const a of t) {
  ...
  async $computeWordRanges(t, n, i, r) {
    ...
    const o = new RegExp(i, r), l = /* @__PURE__ */ Object.create(null);
  ...
  async $navigateValueSet(t, n, i, r, s) {
    ...
    return hi.INSTANCE.navigateValueSet(n, a, u, c, i);
  }
}
class Ut extends Lu {
  constructor(t, n) {
  ...
  $loadForeignModule(t, n, i) {
    const o = {
      host: Tl(i, (l, a) => this._host.$fhr(l, a)),
      getMirrorModels: () => this._getModels()
    };
    return this._foreignModuleFactory ? (this._foreignModule = this._foreignModuleFactory(o, n), Promise.resolve(Rr(this._foreignModule))) : new Promise((l, a) => {
      const u = (c) => {
        this._foreignModule = c.create(o, n), l(Rr(this._foreignModule));
      };
      import(`${ga.asBrowserUri(`${t}.js`).toString(!0)}`).then(u).catch(a);
    });
  }
...
var Cu = /{([^}]+)}/g;
function Eu(e, t) {
  return Object.keys(t).length === 0 ? e : e.replace(Cu, (n, i) => t[i] ?? n);
}
var es;
(function(e) {
  function t(n) {
...
(function(e) {
  function t(i, r, s, o) {
    if (C.uinteger(i) && C.uinteger(r) && C.uinteger(s) && C.uinteger(o))
...
(function(e) {
  ...
  function n(i) {
    const r = i;
    return C.objectLiteral(r) && $.is(r.range) && qn.is(r.color);
  }
  e.is = n;
})(is || (is = {}));
var rs;
...
(function(e) {
  function t(i, r, s, o, l, a) {
    ...
    return C.defined(s) && (u.startCharacter = s), C.defined(o) && (u.endCharacter = o), C.defined(l) && (u.kind = l), C.defined(a) && (u.collapsedText = a), u;
  }
  e.create = t;
  function n(i) {
    const r = i;
...
(function(e) {
  function t(i, r, s, o, l, a) {
    ...
    return C.defined(s) && (u.severity = s), C.defined(o) && (u.code = o), C.defined(l) && (u.source = l), C.defined(a) && (u.relatedInformation = a), u;
  }
  e.create = t;
  function n(i) {
    var r;
    let s = i;
    return C.defined(s) && $.is(s.range) && C.string(s.message) && (C.number(s.severity) || C.undefined(s.severity)) && (C.integer(s.code) || C.string(s.code) || C.undefined(s.code)) && (C.undefined(s.codeDescription) || C.string((r = s.codeDescription) === null || r === void 0 ? void 0 : r.href)) && (C.string(s.source) || C.undefined(s.source)) && (C.undefined(s.relatedInformation) || C.typedArray(s.relatedInformation, On.is));
  }
  e.is = n;
})(tn || (tn = {}));
var ut;
...
(function(e) {
  ...
  function r(s) {
    const o = s;
    return C.objectLiteral(o) && C.string(o.newText) && $.is(o.range);
  }
  e.is = r;
})(oe || (oe = {}));
var Vn;
...
(function(e) {
  ...
  function r(s) {
    const o = s;
    return oe.is(o) && (Vn.is(o.annotationId) || ct.is(o.annotationId));
  }
  e.is = r;
})(us || (us = {}));
var jn;
(function(e) {
  ...
  function n(i) {
    let r = i;
    return C.defined(r) && Jn.is(r.textDocument) && Array.isArray(r.edits);
  }
  e.is = n;
})(jn || (jn = {}));
var $n;
...
(function(e) {
  function t(n) {
    let i = n;
    return i && (i.changes !== void 0 || i.documentChanges !== void 0) && (i.documentChanges === void 0 || i.documentChanges.every((r) => C.string(r.kind) ? $n.is(r) || Gn.is(r) || Xn.is(r) : jn.is(r)));
  }
  e.is = t;
})(Yn || (Yn = {}));
var cs;
...
(function(e) {
  function t(n) {
    let i = n;
    return !!i && C.objectLiteral(i) && (xt.is(i.contents) || nn.is(i.contents) || C.typedArray(i.contents, nn.is)) && (n.range === void 0 || $.is(n.range));
  }
  e.is = t;
})(ws || (ws = {}));
var vs;
...
(function(e) {
  ...
  function n(i) {
    let r = i;
    return C.defined(r) && C.typedArray(r.diagnostics, tn.is) && (r.only === void 0 || C.typedArray(r.only, C.string)) && (r.triggerKind === void 0 || r.triggerKind === sn.Invoked || r.triggerKind === sn.Automatic);
  }
  e.is = n;
})(Ss || (Ss = {}));
var Ls;
(function(e) {
  function t(i, r, s) {
    let o = { title: i }, l = !0;
    return typeof r == "string" ? (l = !1, o.kind = r) : ut.is(r) ? o.command = r : o.edit = r, l && s !== void 0 && (o.kind = s), o;
  }
  e.create = t;
  function n(i) {
    let r = i;
    return r && C.string(r.title) && (r.diagnostics === void 0 || C.typedArray(r.diagnostics, tn.is)) && (r.kind === void 0 || C.string(r.kind)) && (r.edit !== void 0 || r.command !== void 0) && (r.command === void 0 || ut.is(r.command)) && (r.isPreferred === void 0 || C.boolean(r.isPreferred)) && (r.edit === void 0 || Yn.is(r.edit));
  }
  e.is = n;
})(Ls || (Ls = {}));
var Cs;
...
(function(e) {
  ...
  function n(i) {
    const r = i;
    return C.objectLiteral(r) && (r.tooltip === void 0 || C.string(r.tooltip) || xt.is(r.tooltip)) && (r.location === void 0 || Kt.is(r.location)) && (r.command === void 0 || ut.is(r.command));
  }
  e.is = n;
})(ti || (ti = {}));
var Ws;
(function(e) {
  ...
  function n(i) {
    const r = i;
    return C.objectLiteral(r) && re.is(r.position) && (C.string(r.label) || C.typedArray(r.label, ti.is)) && (r.kind === void 0 || ei.is(r.kind)) && r.textEdits === void 0 || C.typedArray(r.textEdits, oe.is) && (r.tooltip === void 0 || C.string(r.tooltip) || xt.is(r.tooltip)) && (r.paddingLeft === void 0 || C.boolean(r.paddingLeft)) && (r.paddingRight === void 0 || C.boolean(r.paddingRight));
  }
  e.is = n;
})(Ws || (Ws = {}));
var Ps;
...
(function(e) {
  function t(n) {
    const i = n;
    return C.objectLiteral(i) && Bn.is(i.uri) && C.string(i.name);
  }
  e.is = t;
})(js || (js = {}));
var $s;
(function(e) {
  function t(s, o, l, a) {
    return new Ru(s, o, l, a);
  }
  e.create = t;
  function n(s) {
    let o = s;
    return !!(C.defined(o) && C.string(o.uri) && (C.undefined(o.languageId) || C.string(o.languageId)) && C.uinteger(o.lineCount) && C.func(o.getText) && C.func(o.positionAt) && C.func(o.offsetAt));
  }
  e.is = n;
  function i(s, o) {
    let l = s.getText(), a = r(o, (c, d) => {
...
var Gs = class ni {
  ...
  update(t, n) {
    for (let i of t)
      if (ni.isIncremental(i)) {
        const r = Ra(i.range), s = this.offsetAt(r.start), o = this.offsetAt(r.end);
        this._content = this._content.substring(0, s) + i.text + this._content.substring(o, this._content.length);
        const l = Math.max(r.start.line, 0), a = Math.max(r.end.line, 0);
        let u = this._lineOffsets;
        const c = Xs(i.text, !1, s);
        if (a - l === c.length)
          for (let m = 0, f = c.length; m < f; m++)
            u[m + l + 1] = c[m];
        else
          c.length < 1e4 ? u.splice(l + 1, a - l, ...c) : this._lineOffsets = u = u.slice(0, l + 1).concat(c, u.slice(a + 1));
  ...
  getLineOffsets() {
    return this._lineOffsets === void 0 && (this._lineOffsets = Xs(this._content, !0)), this._lineOffsets;
  }
  positionAt(t) {
...
(function(e) {
  ...
  e.update = n;
  function i(r, s) {
    let o = r.getText(), l = ri(s.map(Mu), (c, d) => {
      let m = c.range.start.line - d.range.start.line;
      return m === 0 ? c.range.start.character - d.range.start.character : m;
    }), a = 0;
    const u = [];
    for (const c of l) {
      ...
      if (d < a)
        throw new Error("Overlapping edit");
      d > a && u.push(o.substring(a, d)), c.newText.length && u.push(c.newText), a = r.offsetAt(c.range.end);
    }
...
var Nu = class {
  ...
  skipWhitespace() {
    return this.advanceWhileChar((t) => t === Pu || t === Fu || t === Hu || t === Wu || t === Uu) > 0;
  }
  advanceWhileChar(e) {
...
}, Js = 33, tt = 45, Ct = 60, Le = 62, vn = 47, Du = 61, Iu = 34, zu = 39, Hu = 10, Uu = 13, Wu = 12, Pu = 32, Fu = 9, Bu = {
...
function ge(e, t = 0, n = B.WithinContent, i = !1) {
  const r = new Nu(e, t);
  let s = n, o = 0, l = z.Unknown, a, u, c, d, m;
  function f() {
  ...
  function y() {
    ...
    switch (s) {
      ...
      case B.WithinContent:
        if (r.advanceIfChar(Ct)) {
          if (!r.eos() && r.peekChar() === Js) {
            if (r.advanceIfChars([Js, tt, tt]))
          ...
          return r.advanceIfChar(vn) ? (s = B.AfterOpeningEndTag, g(v, z.EndTagOpen)) : (s = B.AfterOpeningStartTag, g(v, z.StartTagOpen));
        }
        return r.advanceUntilChar(Ct), g(v, z.Content);
      ...
      case B.WithinTag:
        return r.skipWhitespace() ? (u = !0, g(v, z.Whitespace)) : u && (d = _(), d.length > 0) ? (s = B.AfterAttributeName, u = !1, g(v, z.AttributeName)) : r.advanceIfChars([vn, Le]) ? (s = B.WithinContent, g(v, z.StartTagSelfClose)) : r.advanceIfChar(Le) ? (c === "script" ? m && Bu[m] ? s = B.WithinContent : s = B.WithinScriptContent : c === "style" ? s = B.WithinStyleContent : s = B.WithinContent, g(v, z.StartTagClose)) : i && r.peekChar() === Ct ? (s = B.WithinContent, g(v, z.StartTagClose, Te("Closing bracket missing."))) : (r.advance(1), g(v, z.Unknown, Te("Unexpected character in tag.")));
      case B.AfterAttributeName:
        return r.skipWhitespace() ? (u = !0, g(v, z.Whitespace)) : r.advanceIfChar(Du) ? (s = B.BeforeAttributeValue, g(v, z.DelimiterAssign)) : (s = B.WithinTag, y());
      case B.BeforeAttributeValue:
        if (r.skipWhitespace())
          return g(v, z.Whitespace);
        let D = r.advanceIfRegExp(/^[^\s"'`=<>]+/);
        if (D.length > 0 && (r.peekChar() === Le && r.peekChar(-1) === vn && (r.goBack(1), D = D.substring(0, D.length - 1)), d === "type" && (m = D), D.length > 0))
          return s = B.WithinTag, u = !1, g(v, z.AttributeValue);
        const N = r.peekChar();
        return N === zu || N === Iu ? (r.advance(1), r.advanceUntilChar(N) && r.advance(1), d === "type" && (m = r.getSource().substring(v + 1, r.pos() - 1)), s = B.WithinTag, u = !1, g(v, z.AttributeValue)) : (s = B.WithinTag, u = !1, y());
...
var Zs = class {
  ...
  findNodeBefore(e) {
    const t = Qs(this.children, (n) => e <= n.start) - 1;
    if (t >= 0) {
  ...
  parse(e, t) {
    const n = ge(e, void 0, void 0, !0), i = new Zs(0, e.length, [], void 0);
    let r = i, s = -1, o, l = null, a = n.scan();
    for (; a !== z.EOS; ) {
      switch (a) {
        case z.StartTagOpen:
          const u = new Zs(n.getTokenOffset(), e.length, [], r);
...
var ju = 97, $u = 122, Gu = 65, Xu = 90, Yu = 48, Ju = 57;
function ft(e, t) {
  const n = e.charCodeAt(t);
  return ju <= n && n <= $u || Gu <= n && n <= Xu || Yu <= n && n <= Ju;
}
function on(e) {
  return typeof e < "u";
}
...
var Ma = class {
  ...
  provideValues(e, t) {
    ...
    const i = (s) => {
      s.forEach((o) => {
        o.name.toLowerCase() === t && (o.values && o.values.forEach((l) => {
          n.push(l);
        }), o.valueSet && this._valueSetMap[o.valueSet] && this._valueSetMap[o.valueSet].forEach((l) => {
          n.push(l);
        }));
      });
...
var Zu = class {
  ...
  async computeCompletions(e, t) {
    ...
    for (const i of this.atributeCompletions) {
      const r = ec(e.getText(i.range));
      if (tc(r))
        if (r === "." || r === "..")
          n.isIncomplete = !0;
        else {
          const s = nc(i.value, r, i.range), o = await this.providePathSuggestions(i.value, s, e, t);
          for (const l of o)
            n.items.push(l);
        }
    }
  ...
  async providePathSuggestions(e, t, n, i) {
    ...
    if (s)
      try {
        const o = [], l = await this.readDirectory(s);
        for (const [a, u] of l)
          a.charCodeAt(0) !== Ku && o.push(ic(a, u === si.Directory, t));
        return o;
      } catch {
      }
    return [];
...
function nc(e, t, n) {
  ...
  if (r === -1)
    ...
    const s = t.slice(r + 1), o = _t(n.end, -1 - s.length), l = s.indexOf(" ");
    let a;
    l !== -1 ? a = _t(o, l) : a = _t(n.end, -1), i = $.create(o, a);
  }
  return i;
}
function ic(e, t, n) {
...
function rc(e, t, n) {
  const i = _t(e.start, t), r = _t(e.end, n);
  return $.create(i, r);
}
var sc = class {
  constructor(e, t) {
  ...
  async doComplete2(e, t, n, i, r) {
    ...
    const s = new Zu(this.dataManager, this.lsOptions.fileSystemProvider.readDirectory), o = this.completionParticipants;
  ...
  _doComplete(e, t, n, i) {
    const r = {
      isIncomplete: !1,
      items: []
    }, s = this.completionParticipants, o = this.dataManager.getDataProviders().filter((w) => w.isApplicable(e.languageId) && (!i || i[w.getId()] !== !1)), l = this.dataManager.getVoidElements(o), a = this.doesSupportMarkdown(), u = e.getText(), c = e.offsetAt(t), d = n.findNodeBefore(c);
    if (!d)
      return r;
      ...
      return o.forEach((I) => {
        I.provideTags().forEach((P) => {
          r.items.push({
            label: P.name,
            kind: he.Property,
            documentation: Xe(P, void 0, a),
            textEdit: oe.replace(R, P.name),
...
\r`.indexOf(R) >= 0)
    ...
    function v(w, A, R = c) {
      const I = g(w, R), P = ea(u, R, B.WithinEndTag, z.EndTagClose) ? "" : ">";
      let U = d;
      for (A && (U = U.parent); U; ) {
        const W = U.tag;
      ...
      return A || o.forEach((W) => {
        W.provideTags().forEach((q) => {
          r.items.push({
            label: "/" + q.name,
            kind: he.Property,
            documentation: Xe(q, void 0, a),
            filterText: "/" + q.name + P,
            textEdit: oe.replace(I, "/" + q.name + P),
            insertTextFormat: xe.PlainText
          });
        });
      }), r;
    ...
    function N(w, A = c) {
      ...
      for (; R < A && u[R] !== "<"; )
        R++;
      const I = u.substring(w, A), P = g(w, R);
      let U = "";
      if (!ea(u, A, B.AfterAttributeName, z.DelimiterAssign)) {
        const q = i?.attributeDefaultValue ?? "doublequotes";
        q === "empty" ? U = "=$1" : q === "singlequotes" ? U = "='$1'" : U = '="$1"';
      }
      const W = D();
      return W[I] = !1, o.forEach((q) => {
        q.provideAttributes(f).forEach((X) => {
          ...
          X.valueSet !== "v" && U.length && (se = se + U, (X.valueSet || X.name === "style") && (_e = {
            ...
            documentation: Xe(X, void 0, a),
            textEdit: oe.replace(P, se),
            insertTextFormat: xe.Snippet,
            command: _e
          });
        });
    ...
    function b(w, A) {
      ...
      n && n.roots.forEach((U) => P(U)), Object.keys(I).forEach((U) => r.items.push({
        label: U,
        kind: he.Value,
    ...
    function p(w, A = c) {
      ...
      if (c > w && c <= A && ac(u[w])) {
        ...
        let W = A;
        A > w && u[A - 1] === u[w] && W--;
        const q = oc(u, c, U), X = lc(u, c, W);
        R = g(q, X), P = c >= U && c <= W ? u.substring(U, c) : "", I = !1;
      } else
        R = g(w, A), P = u.substring(w, c), I = !0;
      if (s.length > 0) {
        const U = f.toLowerCase(), W = _.toLowerCase(), q = g(w, A);
        for (const X of s)
          X.onHtmlAttributeValue && X.onHtmlAttributeValue({ document: e, position: t, tag: U, attribute: W, value: P, range: q });
      }
      return o.forEach((U) => {
        ...
        for (const I in bt)
          if (Vu(I, ";")) {
            ...
            r.items.push({
              label: P,
              kind: he.Keyword,
              documentation: Te("Character entity representing '{0}'", bt[I]),
              textEdit: oe.replace(R, P),
              insertTextFormat: xe.PlainText
            });
          }
      }
  ...
  doQuoteComplete(e, t, n, i) {
    ...
    if (s === "empty" || e.getText().charAt(r - 1) !== "=")
      return null;
    const l = s === "doublequotes" ? '"$1"' : "'$1'", a = n.findNodeBefore(r);
    if (a && a.attributes && a.start < r && (!a.endTagStart || a.endTagStart > r)) {
      const u = ge(e.getText(), a.start);
      let c = u.scan();
  ...
  doesSupportMarkdown() {
    if (!on(this.supportsMarkdown)) {
      if (!on(this.lsOptions.clientCapabilities))
...
var uc = class {
  ...
  doHover(e, t, n, i) {
    const r = this.convertContents.bind(this), s = this.doesSupportMarkdown(), o = e.offsetAt(t), l = n.findNodeAt(o), a = e.getText();
    if (!l || !l.tag)
      return null;
    ...
    function f(N, b) {
      ...
      for (const x in bt) {
        ...
        const S = "&" + x;
        if (p === S) {
          let T = bt[x].charCodeAt(0).toString(16).toUpperCase(), E = "U+";
          if (T.length < 4) {
            const A = 4 - T.length;
            let R = 0;
            for (; R < A; )
          ...
          E += T;
          const w = Te("Character entity representing '{0}', unicode equivalent '{1}'", bt[x], E);
    ...
    function _(N, b) {
      ...
      let x = p.scan();
      for (; x !== z.EOS && (p.getTokenEnd() < o || p.getTokenEnd() === o && x !== N); )
        x = p.scan();
      return x === N && o <= p.getTokenEnd() ? { start: e.positionAt(p.getTokenOffset()), end: e.positionAt(p.getTokenEnd()) } : null;
    }
    function g() {
      let N = o - 1, b = t.character;
      for (; N >= 0 && ft(a, N); )
        N--, b--;
      let p = N + 1, x = b;
      for (; ft(a, p); )
      ...
      if (N >= 0 && a[N] === "&") {
        let H = null;
        return a[p] === ";" ? H = $.create(re.create(t.line, b), re.create(t.line, x + 1)) : H = $.create(re.create(t.line, b), re.create(t.line, x)), H;
      }
      return null;
    }
    function k(N) {
    ...
    if (D) {
      const N = l.tag, b = cc(e.getText(D)), p = M(l.start, e.offsetAt(D.start));
      if (p)
        return m(N, p, b, D);
    }
    return null;
    ...
    function(r) {
      ...
      s.prototype.clone_empty = function() {
        ...
        for (var u = this.__items.length - 1; u >= 0; u--)
          if (this.__items[u].match(a))
            return !0;
        return !1;
      }, s.prototype.set_indent = function(a, u) {
        this.is_empty() && (this.__indent_count = a || 0, this.__alignment_count = u || 0, this.__character_count = this.__parent.get_indent_size(this.__indent_count, this.__alignment_count));
        ...
        var u = a.lastIndexOf(`
`);
        u !== -1 ? this.__character_count = a.length - u : this.__character_count += a.length;
      ...
      function o(a, u) {
        this.__cache = [""], this.__indent_size = a.indent_size, this.__indent_string = a.indent_char, a.indent_with_tabs || (this.__indent_string = new Array(a.indent_size + 1).join(a.indent_char)), u = u || "", a.indent_level > 0 && (u = new Array(a.indent_level + 1).join(this.__indent_string)), this.__base_string = u, this.__base_string_length = u.length;
      }
      o.prototype.get_indent_size = function(a, u) {
        var c = this.__base_string_length;
        return u = u || 0, a < 0 && (c = 0), c += a * this.__indent_size, c += u, c;
      }, o.prototype.get_indent_string = function(a, u) {
        var c = this.__base_string;
        return u = u || 0, a < 0 && (a = 0, c = ""), u += a * this.__indent_size, this.__ensure_cache(u), c += this.__cache[u], c;
      }, o.prototype.__ensure_cache = function(a) {
        for (; a >= this.__cache.length; )
          this.__add_column();
      }, o.prototype.__add_column = function() {
        var a = this.__cache.length, u = 0, c = "";
        this.__indent_size && a >= this.__indent_size && (u = Math.floor(a / this.__indent_size), a -= u * this.__indent_size, c = new Array(u + 1).join(this.__indent_string)), a && (c += new Array(a + 1).join(" ")), this.__cache.push(c);
      };
      function l(a, u) {
        this.__indent_cache = new o(a, u), this.raw = !1, this._end_with_newline = a.end_with_newline, this.indent_size = a.indent_size, this.wrap_line_length = a.wrap_line_length, this.indent_empty_lines = a.indent_empty_lines, this.__lines = [], this.previous_line = null, this.current_line = null, this.next_line = new s(this), this.space_before_token = !1, this.non_breaking_space = !1, this.previous_token_wrapped = !1, this.__add_outputline();
      }
...
` && (c = c.replace(/[\n]/g, a)), c;
        ...
        return a = a || 0, u = u || 0, this.next_line.set_indent(a, u), this.__lines.length > 1 ? (this.current_line.set_indent(a, u), !0) : (this.current_line.set_indent(), !1);
        ...
        for (var c = this.__lines.length - 2; c >= 0; ) {
          ...
          if (d.is_empty())
            break;
          if (d.item(0).indexOf(a) !== 0 && d.item(-1) !== u) {
    ...
    function(r) {
      ...
      s.prototype._get_array = function(a, u) {
        ...
        var c = this.raw_options[a], d = c === void 0 ? !!u : !!c;
        return d;
...
You passed in: '` + this.raw_options[a] + "'"
        ...
        return a.length && u.length && !a.some(function(c) {
      ...
      r.exports.Options = s, r.exports.normalizeOpts = l, r.exports.mergeOpts = o;
    },
    ,
    /* 8 */
    /***/
    function(r) {
      ...
      o.prototype.restart = function() {
        ...
        var a = null;
        return l = l || 0, l += this.__position, l >= 0 && l < this.__input_length && (a = this.__input.charAt(l)), a;
      }, o.prototype.__match = function(l, a) {
        l.lastIndex = a;
        var u = l.exec(this.__input);
        return u && !(s && l.sticky) && u.index !== a && (u = null), u;
      }, o.prototype.test = function(l, a) {
        return a = a || 0, a += this.__position, a >= 0 && a < this.__input_length ? !!this.__match(l, a) : !1;
    ...
    function(r) {
      function s(o, l) {
        o = typeof o == "string" ? o : o.source, l = typeof l == "string" ? l : l.source, this.__directives_block_pattern = new RegExp(o + / beautify( \w+[:]\w+)+ /.source + l, "g"), this.__directive_pattern = / (\w+)[:](\w+)/g, this.__directives_end_ignore_pattern = new RegExp(o + /\sbeautify\signore:end\s/.source + l, "g");
      }
      s.prototype.get_directives = function(o) {
        ...
        for (var a = this.__directive_pattern.exec(o); a; )
          l[a[1]] = a[2], a = this.__directive_pattern.exec(o);
        return l;
    ...
    /***/
    function(r, s, o) {
      var l = o(16).Beautifier, a = o(17).Options;
      function u(c, d) {
        var m = new l(c, d);
        return m.beautify();
      }
    ...
    /***/
    function(r, s, o) {
      var l = o(17).Options, a = o(2).Output, u = o(8).InputScanner, c = o(13).Directives, d = new c(/\/\*/, /\*\//), m = /\r\n|[\r\n]/, f = /\r\n|[\r\n]/g, _ = /\s/, g = /(?:\s|\n)+/g, k = /\/\*(?:[\s\S]*?)((?:\*\/)|$)/g, y = /\/\/(?:[^\n\r\u2028\u2029]*)/g;
      function v(L, M) {
...
`);
        var D = L.match(/^[\t ]*/)[0];
        this._output = new a(this._options, D), this._input = new u(L), this._indentLevel = 0, this._nestedLevel = 0, this._ch = null;
        for (var N = 0, b = !1, p = !1, x = !1, H = !1, S = !1, T = this._ch, E = !1, w, A, R; w = this._input.read(g), A = w !== "", R = T, this._ch = this._input.next(), this._ch === "\\" && this._input.hasNext() && (this._ch += this._input.next()), T = this._ch, this._ch; )
          if (this._ch === "/" && this._input.peek() === "*") {
            ...
            var I = this._input.read(k), P = d.get_directives(I);
            P && P.ignore === "start" && (I += d.readIgnored(this._input)), this.print_string(I), this.eatWhitespace(!0), this._output.add_new_line();
...
` && E && this._output.add_new_line();
        ...
        var hn = this._output.get_code(M);
        return hn;
...
` && (c = c.replace(/[\n]/g, a)), c;
    ...
    function(r) {
      function s(o, l, a, u) {
        this.type = o, this.text = l, this.comments_before = null, this.newlines = a || 0, this.whitespace_before = u || "", this.parent = null, this.next = null, this.previous = null, this.opened = null, this.closed = null, this.directives = null;
      }
      r.exports.Token = s;
    },
    ,
...
You passed in: '` + this.raw_options[a] + "'"
    ...
    /***/
    function(r, s, o) {
      var l = o(8).InputScanner, a = o(3).Token, u = o(10).TokenStream, c = o(11).WhitespacePattern, d = {
        START: "TK_START",
        RAW: "TK_RAW",
        EOF: "TK_EOF"
      }, m = function(f, _) {
      ...
      m.prototype.tokenize = function() {
        ...
        for (var f, _ = new a(d.START, ""), g = null, k = [], y = new u(); _.type !== d.EOF; ) {
    ...
    function(r) {
      ...
      s.prototype.restart = function() {
        ...
        var l = null;
        return o = o || 0, o += this.__position, o >= 0 && o < this.__tokens_length && (l = this.__tokens[o]), l;
    ...
    function(r, s, o) {
      ...
      a.prototype = new l(), a.prototype.__set_whitespace_patterns = function(u, c) {
    ...
    function(r) {
      ...
      s.prototype.read = function() {
        ...
        var l = this._create();
        return l._until_after = !0, l._until_pattern = this._input.get_regexp(o), l._update(), l;
      }, s.prototype.until = function(o) {
        var l = this._create();
        return l._until_after = !1, l._until_pattern = this._input.get_regexp(o), l._update(), l;
      }, s.prototype.starting_with = function(o) {
        var l = this._create();
        return l._starting_pattern = this._input.get_regexp(o, !0), l._update(), l;
      }, s.prototype.matching = function(o) {
        var l = this._create();
        return l._match_pattern = this._input.get_regexp(o, !0), l._update(), l;
    ...
    function(r, s, o) {
      ...
      function u(c, d) {
        l.call(this, c, d), this.__template_pattern = null, this._disabled = Object.assign({}, a), this._excluded = Object.assign({}, a), d && (this.__template_pattern = this._input.get_regexp(d.__template_pattern), this._excluded = Object.assign(this._excluded, d._excluded), this._disabled = Object.assign(this._disabled, d._disabled));
        var m = new l(c);
        this.__patterns = {
    ...
    /***/
    function(r, s, o) {
      var l = o(19).Beautifier, a = o(20).Options;
      function u(c, d, m, f) {
        var _ = new l(c, d, m, f);
        return _.beautify();
      }
    ...
    /***/
    function(r, s, o) {
      var l = o(20).Options, a = o(2).Output, u = o(21).Tokenizer, c = o(21).TOKEN, d = /\r\n|[\r\n]/, m = /\r\n|[\r\n]/g, f = function(b, p) {
        this.indent_level = 0, this.alignment_size = 0, this.max_preserve_newlines = b.max_preserve_newlines, this.preserve_newlines = b.preserve_newlines, this._output = new a(b, p);
      };
...
`) === -1 || (x.is_inline_element || x.is_unformatted || b.print_newline(!1), this._calcluate_parent_multiline(b, x));
    ...
    /***/
    function(r, s, o) {
      var l = o(9).Tokenizer, a = o(9).TOKEN, u = o(13).Directives, c = o(14).TemplatablePattern, d = o(12).Pattern, m = {
...
function fc(e, t, n) {
  ...
  if (t) {
    ...
    for (; m < i.length && na(i, m); )
      m++;
    (m === i.length || ta(i, m)) && (d = m), t = $.create(e.positionAt(u), e.positionAt(d));
...
`,
  ...
  let a = mc(pc(i), l);
  if (s > 0) {
    const u = n.insertSpaces ? Ks(" ", o * s) : Ks("	", s);
    a = a.split(`
`).join(`
` + u), t.start.character === 0 && (a = u + a);
  }
  return [{
    range: t,
    newText: a
...
(() => {
  var e = { 470: (r) => {
    ...
    function o(a, u) {
      for (var c, d = "", m = 0, f = -1, _ = 0, g = 0; g <= a.length; ++g) {
        if (g < a.length)
          c = a.charCodeAt(g);
        else {
          if (c === 47)
    ...
    var l = { resolve: function() {
      for (var a, u = "", c = !1, d = arguments.length - 1; d >= -1 && !c; d--) {
        var m;
        d >= 0 ? m = arguments[d] : (a === void 0 && (a = process.cwd()), m = a), s(m), m.length !== 0 && (u = m + "/" + u, c = m.charCodeAt(0) === 47);
      }
      return u = o(u, !c), c ? u.length > 0 ? "/" + u : "/" : u.length > 0 ? u : ".";
    }, normalize: function(a) {
      if (s(a), a.length === 0)
        return ".";
      var u = a.charCodeAt(0) === 47, c = a.charCodeAt(a.length - 1) === 47;
      return (a = o(a, !u)).length !== 0 || u || (a = "."), a.length > 0 && c && (a += "/"), u ? "/" + a : a;
      ...
      for (var c = 1; c < a.length && a.charCodeAt(c) === 47; ++c)
        ;
      for (var d = a.length, m = d - c, f = 1; f < u.length && u.charCodeAt(f) === 47; ++f)
        ;
      ...
      var L = "";
      for (y = c + k + 1; y <= d; ++y)
        y !== d && a.charCodeAt(y) !== 47 || (L.length === 0 ? L += ".." : L += "/..");
      ...
      if (s(a), a.length === 0)
        return ".";
      for (var u = a.charCodeAt(0), c = u === 47, d = -1, m = !0, f = a.length - 1; f >= 1; --f)
      ...
      s(a);
      for (var u = -1, c = 0, d = -1, m = !0, f = 0, _ = a.length - 1; _ >= 0; --_) {
      ...
      return u === -1 || d === -1 || f === 0 || f === 1 && u === d - 1 && u === c + 1 ? "" : a.slice(u, d);
    }, format: function(a) {
      ...
      m ? (u.root = "/", c = 1) : c = 0;
      for (var f = -1, _ = 0, g = -1, k = !0, y = a.length - 1, v = 0; y >= c; --y)
      ...
      return f === -1 || g === -1 || v === 0 || v === 1 && f === g - 1 && f === _ + 1 ? g !== -1 && (u.base = u.name = _ === 0 && m ? a.slice(1, g) : a.slice(_, g)) : (_ === 0 && m ? (u.name = a.slice(1, f), u.base = a.slice(1, g)) : (u.name = a.slice(_, f), u.base = a.slice(_, g)), u.ext = a.slice(f, g)), _ > 0 ? u.dir = a.slice(0, _ - 1) : m && (u.dir = "/"), u;
  ...
  (() => {
    ...
    class m {
      ...
      constructor(T, E, w, A, R, I = !1) {
        typeof T == "object" ? (this.scheme = T.scheme || u, this.authority = T.authority || u, this.path = T.path || u, this.query = T.query || u, this.fragment = T.fragment || u) : (this.scheme = /* @__PURE__ */ function(P, U) {
          return P || U ? P : "file";
        }(T, I), this.authority = E || u, this.path = function(P, U) {
          switch (P) {
            case "https":
            case "http":
            case "file":
          ...
          return U;
        }(this.scheme, w || u), this.query = A || u, this.fragment = R || u, a(this, I));
      }
      get fsPath() {
        return v(this);
      }
    ...
    function k(S, T, E) {
      ...
      for (let R = 0; R < S.length; R++) {
        ...
        if (I >= 97 && I <= 122 || I >= 65 && I <= 90 || I >= 48 && I <= 57 || I === 45 || I === 46 || I === 95 || I === 126 || T && I === 47 || E && I === 91 || E && I === 93 || E && I === 58)
          ...
          const P = g[I];
          P !== void 0 ? (A !== -1 && (w += encodeURIComponent(S.substring(A, R)), A = -1), w += P) : A === -1 && (A = R);
        }
      }
    ...
    function L(S, T) {
      const E = T ? y : k;
      let w = "", { scheme: A, authority: R, path: I, query: P, fragment: U } = S;
      ...
      return P && (w += "?", w += E(P, !1, !1)), U && (w += "#", w += T ? U : k(U, !1, !1)), w;
    }
    function M(S) {
      try {
...
function yc(e, t, n, i, r, s) {
  const o = ai(n);
  if (!wc(o, e.languageId))
    return;
  o.length < n.length && (i++, r--);
  const l = vc(e.uri, o, t, s);
  if (!l)
    return;
  const a = Tc(l, e);
  return {
...
function Tc(e, t) {
  try {
    ...
    return n.scheme === "file" && n.query && (n = n.with({ query: null }), e = n.toString(
      /* skipEncodig*/
      !0
    )), n.scheme === "file" && n.fragment && !(e.startsWith(t.uri) && e.charCodeAt(t.uri.length) === xc) ? n.with({ fragment: null }).toString(
      /* skipEncodig*/
      !0
    ) : e;
  } catch {
...
var kc = class {
  ...
  findDocumentLinks(e, t) {
    ...
    let r = i.scan(), s, o, l = !1, a;
    const u = {};
    for (; r !== z.EOS; ) {
      switch (r) {
        case z.StartTag:
          o = i.getTokenText().toLowerCase(), a || (l = o === "base");
          break;
        case z.AttributeName:
        ...
        case z.AttributeValue:
          if (o && s && this.dataManager.isPathAttribute(o, s)) {
            ...
            if (!l) {
              const d = yc(e, t, c, i.getTokenOffset(), i.getTokenEnd(), a);
              d && n.push(d);
            }
            l && typeof a > "u" && (a = ai(c), a && t && (a = t.resolveReference(a, e.uri))), l = !1, s = void 0;
          } else if (s === "id") {
...
function Ac(e, t, n) {
  ...
  if (!r.tag)
    return [];
  const s = [], o = sa(z.StartTag, e, r.start), l = typeof r.endTagStart == "number" && sa(z.EndTag, e, r.endTagStart);
  return (o && ra(o, t) || l && ra(l, t)) && (o && s.push({ kind: rn.Read, range: o }), l && s.push({ kind: rn.Read, range: l })), s;
}
function ia(e, t) {
...
function Sc(e, t) {
  ...
  return n;
  function r(s, o) {
    const l = Zn.create(s.name, s.kind, s.range, e.uri, o?.name);
...
function Ha(e, t, n) {
  const i = Lc(t), r = $.create(e.positionAt(t.start), e.positionAt(t.end)), s = Kn.create(i, void 0, Qn.Field, r, r);
  n.push(s), t.children.forEach((o) => {
    s.children ?? (s.children = []), Ha(e, o, s.children);
  });
}
function Lc(e) {
  let t = e.tag;
...
var Mc = class {
  ...
  limitRanges(e, t) {
    ...
    for (let c = 0; c < e.length; c++) {
      const d = r[c];
      typeof d == "number" && (d < a || d === a && l++ < t) && u.push(e[c]);
    }
    return u;
  }
        ...
        case z.Comment: {
          ...
          if (f)
            if (f[1])
              ...
              let _ = o.length - 1;
              for (; _ >= 0 && o[_].tagName.length; )
                _--;
              if (_ >= 0) {
                const g = o[_];
                o.length = _;
                const k = d;
                d = g.startLine, k > d && a !== d && u({ startLine: d, endLine: k, kind: en.Region });
              }
            }
          else {
            const _ = e.positionAt(i.getTokenOffset() + i.getTokenLength()).line;
            d < _ && u({ startLine: d, endLine: _, kind: en.Comment });
          }
          break;
        }
      }
  ...
  getSelectionRange(e, t, n) {
    ...
    for (let o = i.length - 1; o >= 0; o--) {
      const l = i[o];
      (!r || l[0] !== r[0] || l[1] !== r[1]) && (s = an.create($.create(t.positionAt(i[o][0]), t.positionAt(i[o][1])), s)), r = l;
    }
    return s || (s = an.create($.create(e, e))), s;
  }
  getApplicableRanges(e, t, n) {
    ...
    if (r.startTagEnd && !r.endTagStart) {
      ...
      const o = $.create(e.positionAt(r.startTagEnd - 2), e.positionAt(r.startTagEnd));
  ...
  getAttributeLevelRanges(e, t, n) {
    const i = $.create(e.positionAt(t.start), e.positionAt(t.end)), r = e.getText(i), s = n - t.start, o = ge(r);
    let l = o.scan();
    const a = t.start, u = [];
    let c = !1, d = -1;
    for (; l !== z.EOS; ) {
      switch (l) {
        case z.AttributeName: {
          ...
          s <= o.getTokenEnd() && u.unshift([o.getTokenOffset(), o.getTokenEnd()]), c = !0, d = o.getTokenOffset();
          break;
        }
        case z.AttributeValue: {
          if (!c)
          ...
          s >= o.getTokenOffset() && s <= o.getTokenEnd() && (u.unshift([o.getTokenOffset(), o.getTokenEnd()]), (m[0] === '"' && m[m.length - 1] === '"' || m[0] === "'" && m[m.length - 1] === "'") && s >= o.getTokenOffset() + 1 && s <= o.getTokenEnd() - 1 && u.unshift([o.getTokenOffset() + 1, o.getTokenEnd() - 1]), u.push([d, o.getTokenEnd()]));
          break;
        }
      }
      l = o.scan();
...
*   a _positive value_ means that the element should be focusable and reachable via sequential keyboard navigation; the order in which the elements are focused is the increasing value of the [**tabindex**](#attr-tabindex). If several elements share the same tabindex, their relative order follows their relative positions in the document.`
  ...
  setDataProviders(e, t) {
    this.dataProviders = [], e && this.dataProviders.push(new Ma("html5", Dc)), this.dataProviders.push(...t);
  }
  getDataProviders() {
    return this.dataProviders;
  }
  isVoidElement(e, t) {
    return !!e && qu(t, e.toLowerCase(), (n, i) => n.localeCompare(i)) >= 0;
  }
  getVoidElements(e) {
...
function Uc(e = Hc) {
  const t = new Ic(e), n = new uc(e, t), i = new sc(e, t), r = new Ou(t), s = new Nc(r), o = new Mc(t), l = new kc(t);
  return {
    ...
    format: fc,
    findDocumentHighlights: Ac,
    findDocumentLinks: l.findDocumentLinks.bind(l),
    findDocumentSymbols: Sc,
    findDocumentSymbols2: za,
  ...
  constructor(e, t) {
    ...
    if (n?.dataProviders)
      for (const s in n.dataProviders)
        r.push(Wc(s, n.dataProviders[s]));
    this._languageService = Uc({
