...
import { setFocusOnElement as u, focusElement as f } from "@arcgis/toolkit/dom";
...
class I extends p {
  constructor() {
    ...
    }, this._colorizeStyle = "", this._filterValue = "", this.languageId = "arcade", this.hideDocumentationActions = !1, this.loading = !1, this.closed = !1, this.arcgisClose = c({ bubbles: !1 }), this.arcgisItemSelected = c({ bubbles: !1 });
  }
  static {
