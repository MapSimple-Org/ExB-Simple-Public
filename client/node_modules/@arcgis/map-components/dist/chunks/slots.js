import { html as n, css as l } from "lit";
import { safeClassMap as i } from "@arcgis/lumina";
/*! All material copyright Esri, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.34/esri/copyright.txt for details.
v4.34.3 */
const a = "arcgis-map", e = {
  base: a,
  containerUI: `${a}-container-ui`,
  containerElement: `${a}-container-ui__element`,
  containerElementDefaultSlot: `${a}-container-ui__element-default`,
  containerElementPopupSlot: `${a}-container-ui__element-popup`,
  containerTopLeftColumn: `${a}-container-ui__top-left-column`,
  containerTopRightColumn: `${a}-container-ui__top-right-column`,
  containerBottomLeftRow: `${a}-container-ui__bottom-left-row`,
  containerBottomRightRow: `${a}-container-ui__bottom-right-row`,
  containerElementTopLeft: `${a}-container-ui__element-top-left`,
  containerElementTopRight: `${a}-container-ui__element-top-right`,
  containerElementBottomLeft: `${a}-container-ui__element-bottom-left`,
  containerElementBottomRight: `${a}-container-ui__element-bottom-right`,
  containerElementTopStart: `${a}-container-ui__element-top-start`,
  containerElementTopEnd: `${a}-container-ui__element-top-end`,
  containerElementBottomStart: `${a}-container-ui__element-bottom-start`,
  containerElementBottomEnd: `${a}-container-ui__element-bottom-end`
}, t = {
  topLeft: "top-left",
  topRight: "top-right",
