    ...
    this.manager.onLifecycle(() => [
      ...
      d(() => [
        ...
        if (this._hasMetadata = !!i, !this._hasMetadata)
          return;
        const { missionInfo: e, platformInfo: c, frameInfo: l } = i;
        this._missionInfo = e, this._platformInfo = c, this._frameInfo = l;
      }, { initial: !0 })
    ]);
  }
  render() {
...
r("arcgis-video-player-metadata", h);
export {
