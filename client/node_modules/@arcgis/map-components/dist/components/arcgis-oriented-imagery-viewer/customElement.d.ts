...
declare const useOrientedImageryViewerWidget: (component: LitElement & Pick<OrientedImageryViewer, "icon" | "label" | "layer" | "disabled" | "viewModel" | "currentCoverageVisible" | "dataCaptureEnabled" | "galleryOpened" | "imageEnhancementToolActive" | "isAdditionalCoverageVisible" | "isAdditionalPointSourcesVisible" | "mapImageConversionToolState" | "navigationToolActive"> & {
    state?: unknown;
