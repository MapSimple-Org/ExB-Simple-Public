...
declare const useValuePickerWidget: (component: LitElement & Pick<ValuePicker, "icon" | "label" | "values" | "component" | "layout" | "caption" | "canPlay" | "canNext" | "canPrevious" | "loop" | "playRate"> & {
    state?: unknown;
    viewModel?: unknown;
    closed?: boolean;
...
export declare class ArcgisValuePicker extends LitElement {
     ...
     * @default null
     */
    values: any[] | string[] | nullish | number[];
