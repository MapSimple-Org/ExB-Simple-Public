...
class d extends o {
  ...
  static {
    this.properties = { autoDestroyDisabled: 5, feature: 0, formTemplate: 0, editType: 1, groupDisplay: 1, headingLevel: 9, icon: 1, label: 1, layer: 0, position: 1, referenceElement: 1, state: 3, timeZone: 1 };
  }
  static {
    this.styles = l;
  }
