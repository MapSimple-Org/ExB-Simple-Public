...
declare const useFeatureFormWidget: (component: LitElement & Pick<FeatureForm, "icon" | "label" | "timeZone" | "layer" | "feature" | "viewModel" | "headingLevel" | "formTemplate" | "groupDisplay"> & {
    state?: unknown;
...
export declare class ArcgisFeatureForm extends LitElement {
     ...
     *
     * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureForm-FeatureFormViewModel.html#editType)
     *
     * @default "NA"
     */
     ...
     */
    layer: nullish | __esri.FeatureLayer | __esri.SceneLayer | __esri.GeoJSONLayer | __esri.OrientedImageryLayer | __esri.KnowledgeGraphSublayer | __esri.SubtypeSublayer;
