...
declare const useDistanceMeasurement2dWidget: (component: LitElement & Pick<DistanceMeasurement2D, "icon" | "label" | "viewModel" | "snappingOptions" | "unit" | "unitOptions"> & {
    state?: unknown;
...
/**
 * The Distance Measurement 2D component calculates and displays the distance between two or more points in a [MapView](https://developers.arcgis.com/javascript/latest/api-reference/esri-views-MapView.html).
 *
 * [Read more...](https://developers.arcgis.com/javascript/latest/references/map-components/arcgis-distance-measurement-2d/)
 *
 * @since 4.28
 */
export declare class ArcgisDistanceMeasurement2d extends LitElement {
     ...
     * @default "disabled"
     */
    readonly state: "ready" | "disabled" | "measured" | "measuring";
    /**
