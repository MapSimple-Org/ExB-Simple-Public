...
declare const useFeatureTableWidget: (component: LitElement & Pick<FeatureTable, "description" | "icon" | "label" | "timeExtent" | "timeZone" | "layer" | "layers" | "viewModel" | "definitionExpression" | "outFields" | "editingEnabled" | "attributeTableTemplate" | "pageSize" | "actionColumnConfig" | "attachmentsEnabled" | "filterBySelectionEnabled" | "filterGeometry" | "hiddenFields" | "highlightIds" | "initialSize" | "maxSize" | "menuConfig" | "multipleSortPriority" | "navigationScale" | "noDataMessage" | "objectIds" | "pageIndex" | "paginationEnabled" | "relatedRecordsEnabled" | "relatedTable" | "relatedTables" | "returnGeometryEnabled" | "returnMEnabled" | "returnZEnabled" | "rowHighlightIds" | "tableController" | "tableParent" | "tableTemplate"> & {
    state?: "loaded" | "ready" | "loading" | "disabled" | "error" | undefined;
    viewModel?: __esri.FeatureTableViewModel | undefined;
    closed?: boolean;
    icon: import('@arcgis/toolkit/type').nil | string;
    label: import('@arcgis/toolkit/type').nil | string;
 ...
 *
 * [Read more...](https://developers.arcgis.com/javascript/latest/references/map-components/arcgis-feature-table/)
 *
 * @since 4.31
 */
export declare class ArcgisFeatureTable extends LitElement {
    ...
    view?: __esri.LinkChartView | __esri.MapView | __esri.SceneView | nullish;
    /**
     * A flattened array of all [attachment columns](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureTable-AttachmentsColumn.html) within the table, including nested columns.
     *
    ...
    /**
     * Reference to the current [action column](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureTable-ActionColumn.html).
     *
     * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureTable.html#actionColumn)
     */
    readonly actionColumn: nullish | __esri.ActionColumn;
    /**
     * Configuration for the [ActionColumn](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureTable-ActionColumn.html).
     *
    ...
    /**
     * A flattened array of all [columns](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureTable-Grid-Column.html) within the table, including nested columns.
     *
     * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureTable.html#allColumns)
     */
    readonly allColumns: __esri.Column[];
    /**
    ...
    /**
     * A flattened array of all visible [columns](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureTable-Grid-Column.html) within the table, including nested columns.
     *
     * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureTable.html#allVisibleColumns)
     */
    readonly allVisibleColumns: __esri.Column[];
    /**
     ...
     */
    readonly attachmentsViewOptions: __esri.AttachmentsViewOptions;
    /**
     ...
     */
    readonly columns: __esri.Collection<__esri.AttachmentsColumn | __esri.ActionColumn | __esri.Column | __esri.FieldColumn | __esri.GroupColumn | __esri.RelationshipColumn>;
    /**
    ...
    /**
     * A flattened array of all [field columns](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureTable-FieldColumn.html) within the table, including nested columns.
     *
     * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureTable.html#fieldColumns)
     */
    readonly fieldColumns: __esri.FieldColumn[];
    /**
    ...
    /**
     * A flattened array of all [group columns](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureTable-Grid-GroupColumn.html) within the table.
     *
     * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureTable.html#groupColumns)
     */
    readonly groupColumns: __esri.GroupColumn[];
    /**
     ...
     * @default false
     */
    hideLayerDropdownIcons: boolean | undefined;
    /**
     ...
     * [KnowledgeGraphSublayer](https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-knowledgeGraph-KnowledgeGraphSublayer.html), [ParquetLayer](https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-ParquetLayer.html) [SceneLayer](https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-SceneLayer.html), [WFSLayer](https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-WFSLayer.html), [OrientedImageryLayer](https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-OrientedImageryLayer.html)
     * or [Sublayer](https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-support-Sublayer.html) containing the fields and attributes to display within the widget.
     *
     * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureTable.html#layer)
     */
    layer: nullish | __esri.FeatureLayer | __esri.SceneLayer | __esri.GeoJSONLayer | __esri.OrientedImageryLayer | __esri.KnowledgeGraphSublayer | __esri.WFSLayer | __esri.CSVLayer | __esri.ImageryLayer | __esri.Sublayer | __esri.ParquetLayer | __esri.CatalogFootprintLayer;
    /**
     ...
     */
    layers: nullish | (__esri.FeatureLayer | __esri.SceneLayer | __esri.GeoJSONLayer | __esri.KnowledgeGraphSublayer | __esri.WFSLayer | __esri.CSVLayer | __esri.ImageryLayer | __esri.CatalogFootprintLayer)[];
    /**
    ...
    /**
     * A flattened array of all [relationship columns](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureTable-RelationshipColumn.html) within the table, including nested columns.
     *
     * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-FeatureTable.html#relationshipColumns)
     */
    readonly relationshipColumns: __esri.RelationshipColumn[];
    /**
    ...
    /**
     * Indicates whether the table should synchronize the current attributeTableTemplate
    ...
    /**
     * The [TimeExtent](https://developers.arcgis.com/javascript/latest/api-reference/esri-time-TimeExtent.html) in which to filter and display data within the FeatureTable widget.
     *
     ...
     */
    readonly visibleColumns: __esri.Column[];
    ...
    readonly arcgisPropertyChange: TargetedEvent<this, {
        name: "state" | "size" | "layerView" | "effectiveSize" | "isQueryingOrSyncing";
    }>;
