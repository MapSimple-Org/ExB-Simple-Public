...
import n from "@arcgis/core/widgets/FeatureTable.js";
...
class b extends s {
  ...
  willUpdate(e) {
    if (e.has("layerItemId") && (g(this.layerItemId) ? this.layer = null : this.layerItemId && r.fromPortalItem({
      portalItem: {
        id: this.layerItemId
      }
    }).then((i) => {
      ...
      const i = this.layerUrl;
      i ? r.fromArcGISServerUrl({
        url: i
      }).then((o) => {
        this.layer = o;
  ...
  loaded() {
    m(this)?.classList.add("arcgis-feature-table");
    const e = d(this.el);
    this.setAttribute("calcite-mode", e);
  }
}
l("arcgis-feature-table", b);
export {
