...
class _ extends l {
  ...
  static {
    this.properties = { view: 0, apiKey: 1, autoDestroyDisabled: 5, goToOverride: 0, headingLevel: 9, hideLayerDetails: 5, hideSaveAsButton: 5, hideSaveButton: 5, icon: 1, label: 1, lastRoute: 0, layer: 0, maxStops: 9, position: 1, referenceElement: 1, routeLayerItemId: 1, searchProperties: 0, state: 3, unit: 1, useDefaultRouteLayer: 5 };
  }
  static {
    this.styles = m;
  }
...
a("arcgis-directions", _);
export {
  _ as ArcgisDirections
};
