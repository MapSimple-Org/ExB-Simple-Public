...
import v from "@arcgis/core/WebLinkChart.js";
import { LitElement as m, createEvent as r, safeClassMap as h } from "@arcgis/lumina";
import { makeAccessorController as c, reEmitEvent as e, reCreateAccessor as g } from "@arcgis/lumina/controllers/accessor";
import { createRef as n, ref as o } from "lit/directives/ref.js";
import { s as d } from "../../chunks/esri-main.js";
import { s as y, C as w } from "../../chunks/slots.js";
import { c as u, i as V } from "../../chunks/component-utils.js";
import { U as f, u as b, a as C } from "../../chunks/useArcgisViewReadyError.js";
...
class L extends m {
  ...
  set itemId(i) {
    g(this._map, this), this._map.portalItem = { id: i }, this.view.map = this._map;
  }
  get navigating() {
  ...
  set viewpoint(i) {
    V(this.viewpoint, i) && (this.view.viewpoint = i);
  }
  get zoom() {
  ...
  render() {
    return a`<section class=${h(w.containerUI)} ${o(this._containerRef)}>${this._uiController.render()}</section>${this.renderMain()}`;
  }
}
l("arcgis-link-chart", L);
export {
  L as ArcgisLinkChart
};
