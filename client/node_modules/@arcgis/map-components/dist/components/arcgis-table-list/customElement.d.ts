...
declare const useTableListWidget: (component: LitElement & Pick<TableList, "icon" | "label" | "viewModel" | "collapsed" | "dragEnabled" | "filterPlaceholder" | "filterPredicate" | "filterText" | "selectionMode" | "listItemCreatedFunction" | "minDragEnabledItems" | "minFilterItems" | "selectedItems"> & {
    state?: unknown;
