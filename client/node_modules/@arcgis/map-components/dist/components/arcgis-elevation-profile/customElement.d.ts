...
declare const useElevationProfileWidget: (component: LitElement & Pick<ElevationProfile, "icon" | "label" | "input" | "viewModel" | "unit" | "profiles" | "unitOptions"> & {
    state?: unknown;
...
export declare class ArcgisElevationProfile extends LitElement {
     ...
     */
    profiles: __esri.Collection<__esri.ElevationProfileElevationProfileLineGround | __esri.ElevationProfileElevationProfileLineInput | __esri.ElevationProfileElevationProfileLineQuery | __esri.ElevationProfileLineView>;
    /**
     ...
     * @default "disabled"
     */
    readonly state: "ready" | "selected" | "disabled" | "created" | "creating" | "selecting";
    /**
