...
import l from "@arcgis/core/views/MapView.js";
import v from "@arcgis/core/WebMap.js";
import { LitElement as m, createEvent as r, safeClassMap as h } from "@arcgis/lumina";
import { makeAccessorController as c, reEmitEvent as e, reCreateAccessor as d } from "@arcgis/lumina/controllers/accessor";
import { createRef as n, ref as o } from "lit/directives/ref.js";
import { s as g } from "../../chunks/esri-main.js";
import { s as y, C as w } from "../../chunks/slots.js";
import { c as u, i as f } from "../../chunks/component-utils.js";
import { U as V, u as b, a as C } from "../../chunks/useArcgisViewReadyError.js";
...
class _ extends m {
  ...
  set itemId(i) {
    d(this._map, this), this._map.portalItem = { id: i }, this.view.map = this._map;
  }
  get navigating() {
  ...
  async openPopup(i) {
    this._uiController.openPopup(i);
  }
  ...
  loaded() {
    const i = this;
    i.el.childElem = this._mapRef.value, this.view.container ??= i.el.childElem, this.map ||= this._map, this.manager.onLifecycle(() => [
      s(() => this.map, (t) => {
        t && (this._map = t);
      }, { initial: !0, sync: !0 }),
  ...
  renderMain() {
    return a`<div class=${h(w.base)} ${o(this._mapRef)}></div>`;
  }
  render() {
    return a`<section class=${h(w.containerUI)} ${o(this._containerRef)}>${this._uiController.render()}${this.extraContent}</section>${this.renderMain()}`;
  }
}
p("arcgis-map", _);
export {
