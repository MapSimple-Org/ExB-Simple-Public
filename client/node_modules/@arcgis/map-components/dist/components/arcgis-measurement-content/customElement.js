...
class d extends l {
  constructor() {
    super(...arguments), this._formatter = new c(), this.items = [], this.state = "disabled", this.unsupportedLabel = "";
  }
  static {
...
function f(t) {
  const a = t.measurement.state === "available" ? m(t.formatter, t.measurement.value) : null, n = t.measurement.state === "unavailable";
  return i`<div class=${s({
    [e.item]: !0,
    [e.itemDisabled]: n
  })}><span class=${s(e.itemTitle)}>${t.title}</span><span aria-live=polite class=${s(e.itemValue)}>${a ?? "-"}</span></div>`;
}
r("arcgis-measurement-content", d);
export {
