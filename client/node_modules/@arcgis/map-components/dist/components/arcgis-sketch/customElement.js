...
class b extends n {
  ...
  async triggerUpdate(i, e) {
    this.widget?.update(i, e);
  }
  async undo() {
    this.widget?.undo();
  }
  _arcgisReadyHandler() {
    this.defaultGraphicsLayerDisabled || (this._defaultGraphicsLayer = new a({ title: "Sketch Layer" }), this.widget.availableCreateTools = [
      ...
      "rectangle",
      "circle"
    ], this.widget.layer = this._defaultGraphicsLayer, this.el.view?.map?.add(this.widget.layer), this.manager.onLifecycle(() => g(() => this.el.view?.map, (i, e) => {
      const t = this._defaultGraphicsLayer;
      !t || this.widget.layer !== t || (e?.allLayers.includes(t) && e.remove(t), i?.add(t));
