...
export declare class ArcgisSearch extends LitElement {
    ...
    disabled: boolean;
    /**
     * When `true`, will not include [defaultSources](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-Search-SearchViewModel.html#defaultSources) in the Search UI.
     *
     * @default false
     */
    ...
    /**
     * By default, the graphic can be clicked to display a [Popup](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-Popup.html).
     * When `true`, disables displaying the [Popup](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-Popup.html) on feature click.
     *
     * @default false
     */
    ...
    /**
     * If `true`, the [resultGraphic](#resultGraphic) will not display at the
