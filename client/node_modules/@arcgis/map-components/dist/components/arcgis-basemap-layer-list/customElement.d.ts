...
declare const useBasemapLayerListWidget: (component: LitElement & Pick<BasemapLayerList, "icon" | "label" | "viewModel" | "headingLevel" | "collapsed" | "dragEnabled" | "filterPlaceholder" | "selectionMode" | "minFilterItems" | "selectedItems" | "catalogOptions" | "visibilityAppearance" | "baseFilterPredicate" | "baseFilterText" | "baseListItemCreatedFunction" | "basemapTitle" | "editingTitle" | "referenceFilterPredicate" | "referenceFilterText" | "referenceListItemCreatedFunction"> & {
    state?: unknown;
