...
class m extends l {
  ...
  _handleVisibilityChange(t, r) {
    const e = `show${r}`, o = `hide${r}`, s = `visibleElements${r}`, i = this;
    t.has(e) ? i[s] = !!i[e] : t.has(o) ? i[s] = !i[o] : t.has(s) && (console.warn(`${this.el.tagName.toLowerCase()}: The property ${s} is deprecated. Use ${e in i ? e : o} instead..`), e in i ? i[e] = !!i[s] : o in i && (i[o] = !i[s]));
  }
}
a("arcgis-utility-network-associations", m);
export {
  m as ArcgisUtilityNetworkAssociations
};
