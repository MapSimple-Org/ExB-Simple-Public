...
import { css as _, html as w } from "lit";
...
let r = class extends L {
  ...
  get measurement() {
    ...
    const i = e?.directDistance, o = i != null && M(i);
    return {
      mode: t ?? "euclidean",
      directDistance: c(o ? void 0 : i),
...
r = s([
  U("components.direct-line-measurement-3d.DirectLineMeasurement3dViewModel")
], r);
const P = "arcgis-direct-line-measurement-3d", j = { base: P }, S = z(r);
class m extends f {
  constructor() {
    super(...arguments), this.viewModel = S(this), this.messages = D({ name: "directline-measurement-3d", blocking: !0 }), this.view = this.viewModel.view, this.analysis = this.viewModel.analysis, this.autoDestroyDisabled = !1, this.icon = "measure-line", this.state = this.viewModel.state, this.unit = this.viewModel.unit, this.unitOptions = this.viewModel.unitOptions, this.arcgisPropertyChange = y()("analysis", "state"), this.arcgisReady = v();
  }
  static {
  ...
  render() {
    const { messages: t, unit: i, unitOptions: o, viewModel: n } = this, { measurement: l, state: d } = n;
    return w`<div aria-label=${t.componentLabel ?? b} class=${x({
      [j.base]: !0,
      [g.widget]: !0,
      [g.panel]: !0
    ...
    ]}><arcgis-unit-select slot=settings .options=${o} .selectLabel=${t.unit} .value=${i} @arcgisUnitSelectChange=${(h) => {
      this.unit = h.detail;
...
p("arcgis-direct-line-measurement-3d", m);
p("arcgis-directline-measurement-3d", T);
export {
  m as ArcgisDirectLineMeasurement3d,
  T as DeprecatedArcgisDirectLineMeasurement3d
};
