...
declare const useLayerListWidget: (component: LitElement & Pick<LayerList, "icon" | "label" | "viewModel" | "headingLevel" | "collapsed" | "dragEnabled" | "filterPlaceholder" | "filterPredicate" | "filterText" | "selectionMode" | "listItemCreatedFunction" | "minDragEnabledItems" | "minFilterItems" | "selectedItems" | "catalogOptions" | "knowledgeGraphOptions" | "visibilityAppearance"> & {
    state?: unknown;
