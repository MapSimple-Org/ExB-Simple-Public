...
declare const useUtilityNetworkTraceWidget: (component: LitElement & Pick<UtilityNetworkTrace, "icon" | "label" | "disabled" | "viewModel" | "defaultGraphicColor" | "enableResultArea" | "flags" | "inputSettings" | "resultAreaProperties" | "selectedTraces"> & {
    state?: unknown;
...
export declare class ArcgisUtilityNetworkTrace extends LitElement {
     ...
     *
     * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-UtilityNetworkTrace.html#traceResults)
     *
     * @since 4.34
     */
    readonly traceResults: __esri.TraceResultExtend[];
