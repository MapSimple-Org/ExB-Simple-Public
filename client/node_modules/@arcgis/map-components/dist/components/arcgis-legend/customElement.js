...
class b extends g {
  ...
  get respectLayerVisibilityDisabled() {
    return !this.viewModel.respectLayerVisibility;
  }
  set respectLayerVisibilityDisabled(e) {
    this.viewModel.respectLayerVisibility = !e;
  }
  async destroy() {
