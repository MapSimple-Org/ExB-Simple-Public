...
class d extends r {
  ...
  static {
    this.properties = { view: 0, activeTool: 1, activeWidget: 0, areaUnit: 1, autoDestroyDisabled: 5, icon: 1, label: 1, linearUnit: 1, position: 1, referenceElement: 1, state: 3 };
  }
  static {
    this.styles = s;
  }
...
e("arcgis-measurement", d);
export {
  d as ArcgisMeasurement
};
