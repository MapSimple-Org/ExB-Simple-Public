...
import { css as h, html as _ } from "lit";
import { LitElement as w, createEvent as f, nothing as v, safeClassMap as b } from "@arcgis/lumina";
...
import z from "@arcgis/core/analysis/AreaMeasurementAnalysis.js";
import { hasValidAreaResult as M } from "@arcgis/core/applications/Components/analysisUtils.js";
import { getDefaultUnitForView as O } from "@arcgis/core/applications/Components/getDefaultUnits.js";
import { property as n, subclass as A } from "@arcgis/core/core/accessorSupport/decorators.js";
import { watch as $ } from "@arcgis/core/core/reactiveUtils.js";
import { A as U } from "../../chunks/AnalysisViewModel.js";
import { g, a as u } from "../../chunks/measurementUtils.js";
...
var D = Object.defineProperty, E = Object.getOwnPropertyDescriptor, a = (e, t, i, s) => {
  for (var o = s > 1 ? void 0 : s ? E(t, i) : t, l = e.length - 1, d; l >= 0; l--)
    (d = e[l]) && (o = (s ? d(t, i, o) : d(o)) || o);
...
let r = class extends U {
  ...
  get measurement() {
    const { analysisView: e } = this, t = e?.result, i = t?.mode ?? "euclidean", s = e != null && M(e);
    return {
      mode: i,
      area: g(t?.area, s),
      perimeter: g(t?.perimeter, s)
    };
  }
  get unitOptions() {
    const e = this._userUnitOptions?.filter((t) => u.includes(t));
    return e && e.length > 0 ? e : u.slice();
  }
  set unitOptions(e) {
    this._userUnitOptions = e;
  }
  get unit() {
    const e = this._userUnit ?? this.analysis.unit, t = this.unitOptions;
    if (e && t.includes(e))
      return e;
    const i = this._defaultUnit;
  ...
  get _defaultUnit() {
    return this.view ? O(this.view) : void 0;
  }
  async place(e) {
...
a([
  n()
], r.prototype, "_defaultUnit", 1);
r = a([
  A("components.area-measurement-3d.AreaMeasurement3dViewModel")
], r);
const j = "arcgis-area-measurement-3d", L = { base: j }, P = k(r);
class S extends w {
  constructor() {
    super(...arguments), this.viewModel = P(this), this.messages = y({ blocking: !0 }), this.view = this.viewModel.view, this.analysis = this.viewModel.analysis, this.autoDestroyDisabled = !1, this.icon = "measure-area", this.state = this.viewModel.state, this.unit = this.viewModel.unit, this.unitOptions = this.viewModel.unitOptions, this.arcgisPropertyChange = x()("analysis", "state"), this.arcgisReady = f();
  }
  static {
    this.properties = { view: 0, analysis: 0, autoDestroyDisabled: 5, icon: 3, label: 1, position: 1, referenceElement: 1, state: 35, unit: 1, unitOptions: 0 };
  }
  static {
    this.styles = C;
  }
  ...
  render() {
    const { messages: t, unit: i, unitOptions: s, viewModel: o } = this, { measurement: l, state: d } = o;
    return _`<div aria-label=${t.componentLabel ?? v} class=${b({
      [L.base]: !0,
      [c.widget]: !0,
      [c.panel]: !0
    })} role=presentation><arcgis-measurement-content .state=${o.displayState} .hintLabel=${t.hint} .unsupportedLabel=${t.unsupported} .items=${[
      {
        title: t.area,
        measurement: l.area
      },
    ...
    ]}><arcgis-unit-select slot=settings .options=${s} .selectLabel=${t.unit} .value=${i} @arcgisUnitSelectChange=${(p) => {
      this.unit = p.detail;
    }}></arcgis-unit-select><calcite-button slot=actions .disabled=${d === "disabled"} @click=${this.start}>${t.newMeasurement}</calcite-button></arcgis-measurement-content></div>`;
  }
}
m("arcgis-area-measurement-3d", S);
export {
  S as ArcgisAreaMeasurement3d
};
