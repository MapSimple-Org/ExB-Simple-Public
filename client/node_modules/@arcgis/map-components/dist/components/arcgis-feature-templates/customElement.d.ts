...
declare const useFeatureTemplatesWidget: (component: LitElement & Pick<FeatureTemplates, "icon" | "label" | "layers" | "viewModel" | "headingLevel" | "filterText" | "selectionMode" | "enableListScroll" | "filterFunction" | "groupBy"> & {
    state?: unknown;
...
export declare class ArcgisFeatureTemplates extends LitElement {
     ...
     */
    layers: (__esri.FeatureLayer | __esri.SceneLayer | __esri.SubtypeGroupLayer | __esri.GeoJSONLayer | __esri.OrientedImageryLayer | __esri.KnowledgeGraphSublayer | __esri.SubtypeSublayer)[];
