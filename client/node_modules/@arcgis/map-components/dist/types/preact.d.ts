...
import type { ArcgisElevationProfileNext } from "../components/arcgis-elevation-profile-next";
...
import type { ArcgisPopup } from "../components/arcgis-popup";
...
import type { ArcgisUtilityNetworkTraceAnalysis } from "../components/arcgis-utility-network-trace-analysis";
import type { ArcgisUtilityNetworkResultFeatureList } from "../components/arcgis-utility-network-result-feature-list";
import type { ArcgisUtilityNetworkTraceInputs } from "../components/arcgis-utility-network-trace-inputs";
import type { ArcgisUtilityNetworkTraceResults } from "../components/arcgis-utility-network-trace-results";
...
interface PreactArcgisAreaMeasurement2d extends Partial<Pick<ArcgisAreaMeasurement2d, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'snappingOptions' | 'unit' | 'unitOptions' | 'view'>>, HTMLAttributes<HTMLArcgisAreaMeasurement2dElement> {
...
interface PreactArcgisAreaMeasurement3d extends Partial<Pick<ArcgisAreaMeasurement3d, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions' | 'view'>>, HTMLAttributes<HTMLArcgisAreaMeasurement3dElement> {
...
interface PreactArcgisBasemapGallery extends Partial<Pick<ArcgisBasemapGallery, 'activeBasemap' | 'autoDestroyDisabled' | 'disabled' | 'headingLevel' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'source' | 'view'>>, HTMLAttributes<HTMLArcgisBasemapGalleryElement> {
...
interface PreactArcgisBasemapToggle extends Partial<Pick<ArcgisBasemapToggle, 'autoDestroyDisabled' | 'icon' | 'label' | 'messageOverrides' | 'nextBasemap' | 'position' | 'referenceElement' | 'showTitle' | 'view'>>, HTMLAttributes<HTMLArcgisBasemapToggleElement> {
...
interface PreactArcgisBookmarks extends Partial<Pick<ArcgisBookmarks, 'autoDestroyDisabled' | 'bookmarks' | 'closed' | 'defaultCreateOptions' | 'defaultEditOptions' | 'disabled' | 'dragEnabled' | 'filterPlaceholder' | 'filterText' | 'goToOverride' | 'headingLevel' | 'hideFlow' | 'hideThumbnail' | 'hideTime' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'showAddBookmarkButton' | 'showCloseButton' | 'showCollapseButton' | 'showEditBookmarkButton' | 'showFilter' | 'showHeading' | 'timeDisabled' | 'view'>>, HTMLAttributes<HTMLArcgisBookmarksElement> {
  onarcgisBookmarkEdit?: EventHandler<HTMLArcgisBookmarksElement["arcgisBookmarkEdit"]>;
  onarcgisBookmarkSelect?: EventHandler<HTMLArcgisBookmarksElement["arcgisBookmarkSelect"]>;
...
interface PreactArcgisBuildingExplorer extends Partial<Pick<ArcgisBuildingExplorer, 'autoDestroyDisabled' | 'headingLevel' | 'hideDisciplines' | 'hideLevels' | 'hidePhases' | 'icon' | 'label' | 'layers' | 'position' | 'referenceElement' | 'view'>>, HTMLAttributes<HTMLArcgisBuildingExplorerElement> {
...
interface PreactArcgisCompass extends Partial<Pick<ArcgisCompass, 'autoDestroyDisabled' | 'goToOverride' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'view'>>, HTMLAttributes<HTMLArcgisCompassElement> {
...
interface PreactArcgisCoordinateConversion extends Partial<Pick<ArcgisCoordinateConversion, 'autoDestroyDisabled' | 'conversions' | 'currentLocation' | 'expanded' | 'formats' | 'goToOverride' | 'headingLevel' | 'hideCaptureButton' | 'hideExpandButton' | 'hideInputButton' | 'hideSettingsButton' | 'icon' | 'label' | 'locationSymbol' | 'mode' | 'multipleConversionsDisabled' | 'orientation' | 'position' | 'referenceElement' | 'storageDisabled' | 'storageType' | 'view'>>, HTMLAttributes<HTMLArcgisCoordinateConversionElement> {
  onarcgisConversionChange?: EventHandler<HTMLArcgisCoordinateConversionElement["arcgisConversionChange"]>;
...
type ArcgisDaylightSetterTypes = ArcgisDaylight["_setterTypes"]

interface PreactArcgisDirectionalPad extends Partial<Pick<ArcgisDirectionalPad, 'autoDestroyDisabled' | 'disabled' | 'hideDirectionalButtons' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'showRotationResetButton' | 'showRotationSlider' | 'view' | 'visualScale'>>, HTMLAttributes<HTMLArcgisDirectionalPadElement> {
...
interface PreactArcgisDirections extends Partial<Pick<ArcgisDirections, 'apiKey' | 'autoDestroyDisabled' | 'goToOverride' | 'headingLevel' | 'hideLayerDetails' | 'hideSaveAsButton' | 'hideSaveButton' | 'icon' | 'label' | 'layer' | 'maxStops' | 'position' | 'referenceElement' | 'routeLayerItemId' | 'searchProperties' | 'unit' | 'useDefaultRouteLayer' | 'view'>>, HTMLAttributes<HTMLArcgisDirectionsElement> {
...
interface PreactArcgisDirectLineMeasurement3d extends Partial<Pick<ArcgisDirectLineMeasurement3d, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions' | 'view'>>, HTMLAttributes<HTMLArcgisDirectLineMeasurement3dElement> {
...
interface PreactArcgisDirectlineMeasurement3d extends Partial<Pick<DeprecatedArcgisDirectLineMeasurement3d, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions' | 'view'>>, HTMLAttributes<HTMLArcgisDirectlineMeasurement3dElement> {
  onarcgisPropertyChange?: EventHandler<HTMLArcgisDirectlineMeasurement3dElement["arcgisPropertyChange"]>;
  onarcgisReady?: EventHandler<HTMLArcgisDirectlineMeasurement3dElement["arcgisReady"]>;
}

interface PreactArcgisDistanceMeasurement2d extends Partial<Pick<ArcgisDistanceMeasurement2d, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'snappingOptions' | 'unit' | 'unitOptions' | 'view'>>, HTMLAttributes<HTMLArcgisDistanceMeasurement2dElement> {
...
interface PreactArcgisEditor extends Partial<Pick<ArcgisEditor, 'autoDestroyDisabled' | 'headingLevel' | 'hideCreateFeaturesSection' | 'hideEditFeaturesSection' | 'hideFlow' | 'hideLabelsToggle' | 'hideMergeButton' | 'hideSettingsMenu' | 'hideSketch' | 'hideSnappingControlsElementsEnabledToggle' | 'hideSnappingControlsElementsFeatureEnabledToggle' | 'hideSnappingControlsElementsLayerList' | 'hideSnappingControlsElementsSelfEnabledToggle' | 'hideSplitButton' | 'hideTooltipsToggle' | 'hideUndoRedoButtons' | 'hideZoomToButton' | 'icon' | 'label' | 'labelOptions' | 'layerInfos' | 'position' | 'referenceElement' | 'showSnappingControlsElementsHeader' | 'snappingOptions' | 'supportingWidgetDefaults' | 'tooltipOptions' | 'view'>>, HTMLAttributes<HTMLArcgisEditorElement> {
  ...
  onarcgisSketchCreate?: EventHandler<HTMLArcgisEditorElement["arcgisSketchCreate"]>;
  onarcgisSketchUpdate?: EventHandler<HTMLArcgisEditorElement["arcgisSketchUpdate"]>;
}

interface PreactArcgisElevationProfile extends Partial<Pick<ArcgisElevationProfile, 'autoDestroyDisabled' | 'hideChart' | 'hideClearButton' | 'hideLegend' | 'hideSelectButton' | 'hideSettingsButton' | 'hideSketchButton' | 'hideUniformChartScalingToggle' | 'hideUnitSelector' | 'highlightEnabled' | 'hoveredChartPosition' | 'icon' | 'input' | 'label' | 'position' | 'profiles' | 'referenceElement' | 'uniformChartScaling' | 'unit' | 'unitOptions' | 'view'>>, HTMLAttributes<HTMLArcgisElevationProfileElement> {
...
interface PreactArcgisElevationProfileNext extends Partial<Pick<ArcgisElevationProfileNext, 'analysis' | 'autoDestroyDisabled' | 'elevationInfo' | 'geometry' | 'hideChart' | 'hideClearButton' | 'hideLegend' | 'hideSelectButton' | 'hideSettingsButton' | 'hideSketchButton' | 'hideUniformChartScalingToggle' | 'hideUnitSelector' | 'highlightEnabled' | 'hoveredPosition' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'profiles' | 'referenceElement' | 'state' | 'uniformChartScaling' | 'unitDistance' | 'unitElevation' | 'unitOptionsDistance' | 'unitOptionsElevation' | 'view'>>, HTMLAttributes<HTMLArcgisElevationProfileNextElement> {
  onarcgisPropertyChange?: EventHandler<HTMLArcgisElevationProfileNextElement["arcgisPropertyChange"]>;
  onarcgisReady?: EventHandler<HTMLArcgisElevationProfileNextElement["arcgisReady"]>;
}

interface PreactArcgisExpand extends Partial<Pick<ArcgisExpand, 'autoCollapse' | 'autoDestroyDisabled' | 'closeOnEscDisabled' | 'collapseTooltip' | 'expanded' | 'expandIcon' | 'expandTooltip' | 'focusTrapDisabled' | 'focusTrapEnabled' | 'group' | 'iconNumber' | 'label' | 'messageOverrides' | 'mode' | 'placement' | 'position' | 'referenceElement' | 'view'>>, ArcgisExpandSetterTypes, HTMLAttributes<HTMLArcgisExpandElement> {
  onarcgisPropertyChange?: EventHandler<HTMLArcgisExpandElement["arcgisPropertyChange"]>;
  onarcgisReady?: EventHandler<HTMLArcgisExpandElement["arcgisReady"]>;
}
type ArcgisExpandSetterTypes = ArcgisExpand["_setterTypes"]

interface PreactArcgisFeature extends Partial<Pick<ArcgisFeature, 'autoDestroyDisabled' | 'chartAnimationDisabled' | 'defaultPopupTemplateEnabled' | 'graphic' | 'headingLevel' | 'hideAttachmentsContent' | 'hideContent' | 'hideContentAttachments' | 'hideContentExpression' | 'hideContentFields' | 'hideContentMedia' | 'hideContentText' | 'hideCustomContent' | 'hideExpressionContent' | 'hideFieldsContent' | 'hideHeading' | 'hideLastEditedInfo' | 'hideLastEditInfo' | 'hideMediaContent' | 'hideTextContent' | 'hideTitle' | 'icon' | 'label' | 'location' | 'map' | 'messageOverrides' | 'position' | 'referenceElement' | 'showRelationshipContent' | 'showUtilityNetworkContent' | 'spatialReference' | 'timeZone' | 'view' | 'viewModel'>>, HTMLAttributes<HTMLArcgisFeatureElement> {
...
interface PreactArcgisFeatureForm extends Partial<Pick<ArcgisFeatureForm, 'autoDestroyDisabled' | 'editType' | 'feature' | 'formTemplate' | 'groupDisplay' | 'headingLevel' | 'icon' | 'label' | 'layer' | 'position' | 'referenceElement' | 'timeZone'>>, HTMLAttributes<HTMLArcgisFeatureFormElement> {
...
interface PreactArcgisFeatureTemplates extends Partial<Pick<ArcgisFeatureTemplates, 'autoDestroyDisabled' | 'enableListScroll' | 'filterFunction' | 'filterText' | 'groupBy' | 'headingLevel' | 'hideFilter' | 'icon' | 'label' | 'layers' | 'position' | 'referenceElement' | 'selectionMode'>>, HTMLAttributes<HTMLArcgisFeatureTemplatesElement> {
...
interface PreactArcgisFeatures extends Partial<Pick<ArcgisFeatures, 'actions' | 'autoDestroyDisabled' | 'closed' | 'collapsed' | 'content' | 'defaultPopupTemplateEnabled' | 'featureMenuOpen' | 'featureMenuTitle' | 'featureNavigationTop' | 'features' | 'featuresPerPage' | 'featuresTitle' | 'featureViewModelAbilities' | 'goToOverride' | 'headerActions' | 'heading' | 'headingLevel' | 'hideActionBar' | 'hideCloseButton' | 'hideFeatureListLayerTitle' | 'hideFeatureMenuHeading' | 'hideFeatureNavigation' | 'hideFlow' | 'hideHeading' | 'hideSpinner' | 'highlightDisabled' | 'icon' | 'includeDefaultActionsDisabled' | 'initialDisplayMode' | 'label' | 'map' | 'messageOverrides' | 'position' | 'promises' | 'referenceElement' | 'selectedFeatureIndex' | 'showCollapseButton' | 'spatialReference' | 'timeZone' | 'view' | 'viewModel' | 'visible'>>, HTMLAttributes<HTMLArcgisFeaturesElement> {
...
interface PreactArcgisFloorFilter extends Partial<Pick<ArcgisFloorFilter, 'autoDestroyDisabled' | 'facility' | 'headingLevel' | 'icon' | 'label' | 'level' | 'longNames' | 'position' | 'referenceElement' | 'site' | 'view'>>, HTMLAttributes<HTMLArcgisFloorFilterElement> {
  onarcgisReady?: EventHandler<HTMLArcgisFloorFilterElement["arcgisReady"]>;
}

interface PreactArcgisFullscreen extends Partial<Pick<ArcgisFullscreen, 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'view'>>, ArcgisFullscreenSetterTypes, HTMLAttributes<HTMLArcgisFullscreenElement> {
...
interface PreactArcgisHistogramRangeSlider extends Partial<Pick<ArcgisHistogramRangeSlider, 'autoDestroyDisabled' | 'average' | 'barCreatedFunction' | 'bins' | 'dataLineCreatedFunction' | 'dataLines' | 'icon' | 'label' | 'labelFormatFunction' | 'max' | 'min' | 'position' | 'precision' | 'rangeType' | 'referenceElement' | 'standardDeviation' | 'standardDeviationCount' | 'values'>>, ArcgisHistogramRangeSliderSetterTypes, HTMLAttributes<HTMLArcgisHistogramRangeSliderElement> {
...
interface PreactArcgisHome extends Partial<Pick<ArcgisHome, 'autoDestroyDisabled' | 'goToOverride' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'view' | 'viewpoint'>>, HTMLAttributes<HTMLArcgisHomeElement> {
...
interface PreactArcgisLegend extends Partial<Pick<ArcgisLegend, 'activeLayerInfos' | 'autoDestroyDisabled' | 'basemapLegendVisible' | 'cardStyleLayout' | 'headingLevel' | 'hideLayersNotInCurrentView' | 'icon' | 'ignoreLayerVisibility' | 'label' | 'layerInfos' | 'legendStyle' | 'messageOverrides' | 'position' | 'referenceElement' | 'respectLayerDefinitionExpression' | 'respectLayerVisibilityDisabled' | 'view'>>, HTMLAttributes<HTMLArcgisLegendElement> {
...
interface PreactArcgisLineOfSight extends Partial<Pick<ArcgisLineOfSight, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'view'>>, HTMLAttributes<HTMLArcgisLineOfSightElement> {
...
interface PreactArcgisLinkChart extends Partial<Pick<ArcgisLinkChart, 'analyses' | 'animationsDisabled' | 'aria' | 'autoDestroyDisabled' | 'background' | 'basemap' | 'basemapView' | 'constraints' | 'displayFilterDisabled' | 'extent' | 'fatalError' | 'graphics' | 'highlightOptions' | 'highlights' | 'itemId' | 'loadErrorSources' | 'map' | 'navigation' | 'padding' | 'popup' | 'popupDisabled' | 'resizeAlign' | 'rotation' | 'scale' | 'spatialReference' | 'theme' | 'timeExtent' | 'timeZone' | 'viewpoint' | 'zoom'>>, ArcgisLinkChartSetterTypes, HTMLAttributes<HTMLArcgisLinkChartElement> {
  onarcgisLoadError?: EventHandler<HTMLArcgisLinkChartElement["arcgisLoadError"]>;
  onarcgisViewAnalysisViewCreate?: EventHandler<HTMLArcgisLinkChartElement["arcgisViewAnalysisViewCreate"]>;
  onarcgisViewAnalysisViewCreateError?: EventHandler<HTMLArcgisLinkChartElement["arcgisViewAnalysisViewCreateError"]>;
  onarcgisViewAnalysisViewDestroy?: EventHandler<HTMLArcgisLinkChartElement["arcgisViewAnalysisViewDestroy"]>;
  ...
  onarcgisViewReadyError?: EventHandler<HTMLArcgisLinkChartElement["arcgisViewReadyError"]>;
}
type ArcgisLinkChartSetterTypes = ArcgisLinkChart["_setterTypes"]

interface PreactArcgisLinkChartLayoutSwitcher extends Partial<Pick<ArcgisLinkChartLayoutSwitcher, 'appearance' | 'autoDestroyDisabled' | 'closeOnSelectDisabled' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'preventExtentUpdate' | 'referenceElement' | 'view'>>, HTMLAttributes<HTMLArcgisLinkChartLayoutSwitcherElement> {
...
interface PreactArcgisLocate extends Partial<Pick<ArcgisLocate, 'autoDestroyDisabled' | 'geolocationOptions' | 'goToLocationDisabled' | 'goToOverride' | 'graphic' | 'icon' | 'label' | 'messageOverrides' | 'popupDisabled' | 'position' | 'referenceElement' | 'scale' | 'state' | 'view'>>, HTMLAttributes<HTMLArcgisLocateElement> {
...
interface PreactArcgisMap extends Partial<Pick<ArcgisMap, 'analyses' | 'animationsDisabled' | 'aria' | 'autoDestroyDisabled' | 'background' | 'basemap' | 'basemapView' | 'constraints' | 'displayFilterDisabled' | 'extent' | 'fatalError' | 'floors' | 'graphics' | 'highlightOptions' | 'highlights' | 'ipsInfo' | 'itemId' | 'loadErrorSources' | 'map' | 'navigation' | 'padding' | 'popup' | 'popupDisabled' | 'resizeAlign' | 'rotation' | 'scale' | 'spatialReference' | 'spatialReferenceLocked' | 'theme' | 'timeExtent' | 'timeZone' | 'viewpoint' | 'zoom'>>, ArcgisMapSetterTypes, HTMLAttributes<HTMLArcgisMapElement> {
  onarcgisLoadError?: EventHandler<HTMLArcgisMapElement["arcgisLoadError"]>;
  onarcgisViewAnalysisViewCreate?: EventHandler<HTMLArcgisMapElement["arcgisViewAnalysisViewCreate"]>;
  onarcgisViewAnalysisViewCreateError?: EventHandler<HTMLArcgisMapElement["arcgisViewAnalysisViewCreateError"]>;
  onarcgisViewAnalysisViewDestroy?: EventHandler<HTMLArcgisMapElement["arcgisViewAnalysisViewDestroy"]>;
  ...
  onarcgisViewReadyError?: EventHandler<HTMLArcgisMapElement["arcgisViewReadyError"]>;
}
type ArcgisMapSetterTypes = ArcgisMap["_setterTypes"]

interface PreactArcgisMeasurement extends Partial<Pick<ArcgisMeasurement, 'activeTool' | 'areaUnit' | 'autoDestroyDisabled' | 'icon' | 'label' | 'linearUnit' | 'position' | 'referenceElement' | 'view'>>, HTMLAttributes<HTMLArcgisMeasurementElement> {
...
interface PreactArcgisNavigationToggle extends Partial<Pick<ArcgisNavigationToggle, 'icon' | 'label' | 'layout' | 'messageOverrides' | 'navigationMode' | 'position' | 'referenceElement' | 'view'>>, HTMLAttributes<HTMLArcgisNavigationToggleElement> {
...
interface PreactArcgisPlacement extends Partial<Pick<ArcgisPlacement, 'position' | 'referenceElement' | 'view'>>, HTMLAttributes<HTMLArcgisPlacementElement> {
  onarcgisReady?: EventHandler<HTMLArcgisPlacementElement["arcgisReady"]>;
}

interface PreactArcgisPopup extends Partial<Pick<ArcgisPopup, 'actions' | 'alignment' | 'autoCloseEnabled' | 'autoDestroyDisabled' | 'content' | 'defaultPopupTemplateEnabled' | 'dockEnabled' | 'dockOptions' | 'featureMenuOpen' | 'features' | 'goToOverride' | 'heading' | 'headingLevel' | 'hideActionBar' | 'hideCloseButton' | 'hideCollapseButton' | 'hideFeatureListLayerTitle' | 'hideFeatureMenuHeading' | 'hideFeatureNavigation' | 'hideHeading' | 'hideSpinner' | 'highlightDisabled' | 'includeDefaultActionsDisabled' | 'initialDisplayMode' | 'label' | 'location' | 'messageOverrides' | 'promises' | 'referenceElement' | 'selectedFeatureIndex' | 'view' | 'visible'>>, HTMLAttributes<HTMLArcgisPopupElement> {
  onarcgisClose?: EventHandler<HTMLArcgisPopupElement["arcgisClose"]>;
  onarcgisPropertyChange?: EventHandler<HTMLArcgisPopupElement["arcgisPropertyChange"]>;
  onarcgisReady?: EventHandler<HTMLArcgisPopupElement["arcgisReady"]>;
  onarcgisTriggerAction?: EventHandler<HTMLArcgisPopupElement["arcgisTriggerAction"]>;
}

interface PreactArcgisPrint extends Partial<Pick<ArcgisPrint, 'allowedFormats' | 'allowedFormatsForSaving' | 'allowedLayouts' | 'autoDestroyDisabled' | 'browseTemplateButtonOnClick' | 'excludeDefaultTemplates' | 'excludeOrganizationTemplates' | 'exportedLinks' | 'extraParameters' | 'headingLevel' | 'hideHeader' | 'icon' | 'label' | 'messageOverrides' | 'outSpatialReference' | 'portal' | 'position' | 'printServiceUrl' | 'referenceElement' | 'saveAsButtonCallback' | 'showPrintAreaEnabled' | 'templateCustomTextElements' | 'templateOptions' | 'view'>>, HTMLAttributes<HTMLArcgisPrintElement> {
...
interface PreactArcgisScene extends Partial<Pick<ArcgisScene, 'alphaCompositingEnabled' | 'analyses' | 'aria' | 'autoDestroyDisabled' | 'basemap' | 'basemapView' | 'camera' | 'cameraFov' | 'cameraHeading' | 'cameraPosition' | 'cameraTilt' | 'clippingArea' | 'constraints' | 'displayFilterDisabled' | 'environment' | 'extent' | 'fatalError' | 'floors' | 'focusAreas' | 'graphics' | 'highlightOptions' | 'highlights' | 'itemId' | 'loadErrorSources' | 'map' | 'navigation' | 'padding' | 'popup' | 'popupDisabled' | 'qualityProfile' | 'scale' | 'spatialReference' | 'theme' | 'timeExtent' | 'viewingMode' | 'viewpoint' | 'zoom'>>, ArcgisSceneSetterTypes, HTMLAttributes<HTMLArcgisSceneElement> {
  onarcgisLoadError?: EventHandler<HTMLArcgisSceneElement["arcgisLoadError"]>;
...
interface PreactArcgisSearchResultRenderer extends Partial<Pick<ArcgisSearchResultRenderer, 'autoDestroyDisabled' | 'messages' | 'viewModel'>>, HTMLAttributes<HTMLArcgisSearchResultRendererElement> {
  onarcgisReady?: EventHandler<HTMLArcgisSearchResultRendererElement["arcgisReady"]>;
}

interface PreactArcgisShadowCast extends Partial<Pick<ArcgisShadowCast, 'autoDestroyDisabled' | 'discreteOptions' | 'durationOptions' | 'endTimeOfDay' | 'headingLevel' | 'hideColorPicker' | 'hideDatePicker' | 'hideThresholdContext' | 'hideThresholdContextColor' | 'hideThresholdContextTimeInterval' | 'hideThresholdContextToggle' | 'hideTimeRangeSlider' | 'hideTimezone' | 'hideTooltip' | 'hideVisualizationOptions' | 'icon' | 'label' | 'position' | 'referenceElement' | 'startTimeOfDay' | 'thresholdOptions' | 'utcOffset' | 'view' | 'visualizationType'>>, ArcgisShadowCastSetterTypes, HTMLAttributes<HTMLArcgisShadowCastElement> {
...
interface PreactArcgisSlice extends Partial<Pick<ArcgisSlice, 'analysis' | 'autoDestroyDisabled' | 'excludedLayers' | 'excludeGroundSurface' | 'headingLevel' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'shape' | 'tiltEnabled' | 'view'>>, HTMLAttributes<HTMLArcgisSliceElement> {
...
interface PreactArcgisSwipe extends Partial<Pick<ArcgisSwipe, 'autoDestroyDisabled' | 'direction' | 'disabled' | 'hideDivider' | 'hideHandle' | 'icon' | 'label' | 'leadingLayers' | 'messageOverrides' | 'position' | 'referenceElement' | 'swipePosition' | 'trailingLayers' | 'view'>>, HTMLAttributes<HTMLArcgisSwipeElement> {
  ...
  onarcgisSwipeChange?: EventHandler<HTMLArcgisSwipeElement["arcgisSwipeChange"]>;
  onarcgisSwipeInput?: EventHandler<HTMLArcgisSwipeElement["arcgisSwipeInput"]>;
}

interface PreactArcgisTableList extends Partial<Pick<ArcgisTableList, 'autoDestroyDisabled' | 'closed' | 'collapsed' | 'dragEnabled' | 'filterPlaceholder' | 'filterPredicate' | 'filterText' | 'hideFlow' | 'hideStatusIndicators' | 'icon' | 'label' | 'listItemCreatedFunction' | 'map' | 'minDragEnabledItems' | 'minFilterItems' | 'position' | 'referenceElement' | 'selectedItems' | 'selectionMode' | 'showCloseButton' | 'showCollapseButton' | 'showErrors' | 'showFilter' | 'showHeading' | 'showTemporaryTableIndicators' | 'view'>>, HTMLAttributes<HTMLArcgisTableListElement> {
...
interface PreactArcgisTimeSlider extends Partial<Pick<ArcgisTimeSlider, 'actions' | 'autoDestroyDisabled' | 'disabled' | 'fullTimeExtent' | 'icon' | 'label' | 'layout' | 'loop' | 'mode' | 'playRate' | 'position' | 'referenceElement' | 'stops' | 'tickConfigs' | 'timeExtent' | 'timeVisible' | 'timeZone' | 'view'>>, HTMLAttributes<HTMLArcgisTimeSliderElement> {
...
interface PreactArcgisTimeZoneLabel extends Partial<Pick<ArcgisTimeZoneLabel, 'disabled' | 'expanded' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'view'>>, ArcgisTimeZoneLabelSetterTypes, HTMLAttributes<HTMLArcgisTimeZoneLabelElement> {
...
interface PreactArcgisTrack extends Partial<Pick<ArcgisTrack, 'autoDestroyDisabled' | 'error' | 'geolocationOptions' | 'goToLocationDisabled' | 'goToOverride' | 'graphic' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'positionFilterFunction' | 'referenceElement' | 'rotationDisabled' | 'scale' | 'view'>>, HTMLAttributes<HTMLArcgisTrackElement> {
...
interface PreactArcgisUtilityNetworkTraceAnalysis extends Partial<Pick<ArcgisUtilityNetworkTraceAnalysis, 'allowEditingDisabled' | 'autoDestroyDisabled' | 'closable' | 'icon' | 'label' | 'messageOverrides' | 'mode' | 'referenceElement' | 'view'>>, HTMLAttributes<HTMLArcgisUtilityNetworkTraceAnalysisElement> {
  onarcgisPropertyChange?: EventHandler<HTMLArcgisUtilityNetworkTraceAnalysisElement["arcgisPropertyChange"]>;
  onarcgisReady?: EventHandler<HTMLArcgisUtilityNetworkTraceAnalysisElement["arcgisReady"]>;
}

interface PreactArcgisUtilityNetworkResultFeatureList extends Required<Pick<ArcgisUtilityNetworkResultFeatureList, 'elements' | 'layers' | 'utilityNetwork'>>, Partial<Pick<ArcgisUtilityNetworkResultFeatureList, 'messageOverrides'>>, HTMLAttributes<HTMLArcgisUtilityNetworkResultFeatureListElement> {
  onarcgisSelectedLayerChange?: EventHandler<HTMLArcgisUtilityNetworkResultFeatureListElement["arcgisSelectedLayerChange"]>;
}

interface PreactArcgisUtilityNetworkTraceInputs extends Required<Pick<ArcgisUtilityNetworkTraceInputs, 'view'>>, Partial<Pick<ArcgisUtilityNetworkTraceInputs, 'referenceElement' | 'selectedTraceConfiguration' | 'selectedUtilityNetwork'>>, HTMLAttributes<HTMLArcgisUtilityNetworkTraceInputsElement> {
  onarcgisTraceInputsChange?: EventHandler<HTMLArcgisUtilityNetworkTraceInputsElement["arcgisTraceInputsChange"]>;
  onarcgisUtilityNetworkChange?: EventHandler<HTMLArcgisUtilityNetworkTraceInputsElement["arcgisUtilityNetworkChange"]>;
}

interface PreactArcgisUtilityNetworkTraceResults extends Partial<Pick<ArcgisUtilityNetworkTraceResults, 'layers' | 'messageOverrides' | 'traceConfigTitle' | 'traceResult' | 'utilityNetwork'>>, HTMLAttributes<HTMLArcgisUtilityNetworkTraceResultsElement> {
  onarcgisSelectedResultTypeChange?: EventHandler<HTMLArcgisUtilityNetworkTraceResultsElement["arcgisSelectedResultTypeChange"]>;
}

interface PreactArcgisUtilityNetworkValidateTopology extends Partial<Pick<ArcgisUtilityNetworkValidateTopology, 'autoDestroyDisabled' | 'extentToValidate' | 'icon' | 'label' | 'position' | 'referenceElement' | 'utilityNetwork' | 'view'>>, HTMLAttributes<HTMLArcgisUtilityNetworkValidateTopologyElement> {
...
interface PreactArcgisValuePicker extends Partial<Pick<ArcgisValuePicker, 'autoDestroyDisabled' | 'canNext' | 'canPlay' | 'canPrevious' | 'caption' | 'component' | 'hideNextButton' | 'hidePlayButton' | 'hidePreviousButton' | 'icon' | 'label' | 'layout' | 'loop' | 'playRate' | 'position' | 'referenceElement' | 'values'>>, HTMLAttributes<HTMLArcgisValuePickerElement> {
...
interface PreactArcgisVersionManagement extends Partial<Pick<ArcgisVersionManagement, 'allowEditingDisabled' | 'autoDestroyDisabled' | 'closable' | 'icon' | 'initialVersionInfos' | 'label' | 'messageOverrides' | 'mode' | 'pageSize' | 'position' | 'referenceElement' | 'versioningStates' | 'view'>>, HTMLAttributes<HTMLArcgisVersionManagementElement> {
...
interface PreactArcgisVideo extends Partial<Pick<ArcgisVideo, 'aria' | 'autoDestroyDisabled' | 'layer' | 'map'>>, HTMLAttributes<HTMLArcgisVideoElement> {
  onarcgisViewReadyChange?: EventHandler<HTMLArcgisVideoElement["arcgisViewReadyChange"]>;
}

interface PreactArcgisVideoPlayer extends Partial<Pick<ArcgisVideoPlayer, 'autoDestroyDisabled' | 'followingMode' | 'hideHeader' | 'icon' | 'label' | 'layer' | 'messageOverrides' | 'position' | 'referenceElement' | 'view'>>, HTMLAttributes<HTMLArcgisVideoPlayerElement> {
...
interface PreactArcgisWeather extends Partial<Pick<ArcgisWeather, 'autoDestroyDisabled' | 'headingLevel' | 'hideHeader' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'view'>>, HTMLAttributes<HTMLArcgisWeatherElement> {
...
interface PreactArcgisZoom extends Partial<Pick<ArcgisZoom, 'autoDestroyDisabled' | 'icon' | 'label' | 'layout' | 'messageOverrides' | 'position' | 'referenceElement' | 'state' | 'view'>>, HTMLAttributes<HTMLArcgisZoomElement> {
...
declare module 'preact' {
  namespace createElement.JSX {
    interface IntrinsicElements {
      ...
      "arcgis-elevation-profile-next": PreactArcgisElevationProfileNext;
      ...
      "arcgis-popup": PreactArcgisPopup;
      ...
      "arcgis-utility-network-trace-analysis": PreactArcgisUtilityNetworkTraceAnalysis;
      "arcgis-utility-network-result-feature-list": PreactArcgisUtilityNetworkResultFeatureList;
      "arcgis-utility-network-trace-inputs": PreactArcgisUtilityNetworkTraceInputs;
      "arcgis-utility-network-trace-results": PreactArcgisUtilityNetworkTraceResults;
