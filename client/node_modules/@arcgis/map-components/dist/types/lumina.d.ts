...
interface LuminaArcgisAreaMeasurement2d extends Partial<Pick<ArcgisAreaMeasurement2d, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'snappingOptions' | 'unit' | 'unitOptions' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisAreaMeasurement2dElement> {
...
interface LuminaArcgisAreaMeasurement3d extends Partial<Pick<ArcgisAreaMeasurement3d, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisAreaMeasurement3dElement> {
...
interface LuminaArcgisBasemapGallery extends Partial<Pick<ArcgisBasemapGallery, 'activeBasemap' | 'autoDestroyDisabled' | 'disabled' | 'headingLevel' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'source' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisBasemapGalleryElement> {
...
interface LuminaArcgisBasemapToggle extends Partial<Pick<ArcgisBasemapToggle, 'autoDestroyDisabled' | 'icon' | 'label' | 'messageOverrides' | 'nextBasemap' | 'position' | 'referenceElement' | 'showTitle' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisBasemapToggleElement> {
...
interface LuminaArcgisBuildingExplorer extends Partial<Pick<ArcgisBuildingExplorer, 'autoDestroyDisabled' | 'headingLevel' | 'hideDisciplines' | 'hideLevels' | 'hidePhases' | 'icon' | 'label' | 'layers' | 'position' | 'referenceElement' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisBuildingExplorerElement> {
...
interface LuminaArcgisCompass extends Partial<Pick<ArcgisCompass, 'autoDestroyDisabled' | 'goToOverride' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisCompassElement> {
...
interface LuminaArcgisCoordinateConversion extends Partial<Pick<ArcgisCoordinateConversion, 'autoDestroyDisabled' | 'conversions' | 'currentLocation' | 'expanded' | 'formats' | 'goToOverride' | 'headingLevel' | 'hideCaptureButton' | 'hideExpandButton' | 'hideInputButton' | 'hideSettingsButton' | 'icon' | 'label' | 'locationSymbol' | 'mode' | 'multipleConversionsDisabled' | 'orientation' | 'position' | 'referenceElement' | 'storageDisabled' | 'storageType' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisCoordinateConversionElement> {
...
interface LuminaArcgisDirectionalPad extends Partial<Pick<ArcgisDirectionalPad, 'autoDestroyDisabled' | 'disabled' | 'hideDirectionalButtons' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'showRotationResetButton' | 'showRotationSlider' | 'view' | 'visualScale'>>, h.JSX.HTMLAttributes<HTMLArcgisDirectionalPadElement> {
...
interface LuminaArcgisDirections extends Partial<Pick<ArcgisDirections, 'apiKey' | 'autoDestroyDisabled' | 'goToOverride' | 'headingLevel' | 'hideLayerDetails' | 'hideSaveAsButton' | 'hideSaveButton' | 'icon' | 'label' | 'layer' | 'maxStops' | 'position' | 'referenceElement' | 'routeLayerItemId' | 'searchProperties' | 'unit' | 'useDefaultRouteLayer' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisDirectionsElement> {
...
interface LuminaArcgisDirectLineMeasurement3d extends Partial<Pick<ArcgisDirectLineMeasurement3d, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisDirectLineMeasurement3dElement> {
...
interface LuminaArcgisDirectlineMeasurement3d extends Partial<Pick<DeprecatedArcgisDirectLineMeasurement3d, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisDirectlineMeasurement3dElement> {
  onarcgisPropertyChange?: EventHandler<HTMLArcgisDirectlineMeasurement3dElement["arcgisPropertyChange"]>;
  onarcgisReady?: EventHandler<HTMLArcgisDirectlineMeasurement3dElement["arcgisReady"]>;
}

interface LuminaArcgisDistanceMeasurement2d extends Partial<Pick<ArcgisDistanceMeasurement2d, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'snappingOptions' | 'unit' | 'unitOptions' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisDistanceMeasurement2dElement> {
...
interface LuminaArcgisElevationProfileNext extends Partial<Pick<ArcgisElevationProfileNext, 'analysis' | 'autoDestroyDisabled' | 'elevationInfo' | 'geometry' | 'hideChart' | 'hideClearButton' | 'hideLegend' | 'hideSelectButton' | 'hideSettingsButton' | 'hideSketchButton' | 'hideUniformChartScalingToggle' | 'hideUnitSelector' | 'highlightEnabled' | 'hoveredPosition' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'profiles' | 'referenceElement' | 'state' | 'uniformChartScaling' | 'unitDistance' | 'unitElevation' | 'unitOptionsDistance' | 'unitOptionsElevation' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisElevationProfileNextElement> {
...
interface LuminaArcgisExpand extends Partial<Pick<ArcgisExpand, 'autoCollapse' | 'autoDestroyDisabled' | 'closeOnEscDisabled' | 'collapseTooltip' | 'expanded' | 'expandIcon' | 'expandTooltip' | 'focusTrapDisabled' | 'focusTrapEnabled' | 'group' | 'iconNumber' | 'label' | 'messageOverrides' | 'mode' | 'placement' | 'position' | 'referenceElement' | 'view'>>, ArcgisExpandSetterTypes, h.JSX.HTMLAttributes<HTMLArcgisExpandElement> {
...
interface LuminaArcgisFeatureForm extends Partial<Pick<ArcgisFeatureForm, 'autoDestroyDisabled' | 'editType' | 'feature' | 'formTemplate' | 'groupDisplay' | 'headingLevel' | 'icon' | 'label' | 'layer' | 'position' | 'referenceElement' | 'timeZone'>>, h.JSX.HTMLAttributes<HTMLArcgisFeatureFormElement> {
...
interface LuminaArcgisFeatures extends Partial<Pick<ArcgisFeatures, 'actions' | 'autoDestroyDisabled' | 'closed' | 'collapsed' | 'content' | 'defaultPopupTemplateEnabled' | 'featureMenuOpen' | 'featureMenuTitle' | 'featureNavigationTop' | 'features' | 'featuresPerPage' | 'featuresTitle' | 'featureViewModelAbilities' | 'goToOverride' | 'headerActions' | 'heading' | 'headingLevel' | 'hideActionBar' | 'hideCloseButton' | 'hideFeatureListLayerTitle' | 'hideFeatureMenuHeading' | 'hideFeatureNavigation' | 'hideFlow' | 'hideHeading' | 'hideSpinner' | 'highlightDisabled' | 'icon' | 'includeDefaultActionsDisabled' | 'initialDisplayMode' | 'label' | 'map' | 'messageOverrides' | 'position' | 'promises' | 'referenceElement' | 'selectedFeatureIndex' | 'showCollapseButton' | 'spatialReference' | 'timeZone' | 'view' | 'viewModel' | 'visible'>>, h.JSX.HTMLAttributes<HTMLArcgisFeaturesElement> {
...
interface LuminaArcgisFloorFilter extends Partial<Pick<ArcgisFloorFilter, 'autoDestroyDisabled' | 'facility' | 'headingLevel' | 'icon' | 'label' | 'level' | 'longNames' | 'position' | 'referenceElement' | 'site' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisFloorFilterElement> {
  onarcgisReady?: EventHandler<HTMLArcgisFloorFilterElement["arcgisReady"]>;
}

interface LuminaArcgisFullscreen extends Partial<Pick<ArcgisFullscreen, 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'view'>>, ArcgisFullscreenSetterTypes, h.JSX.HTMLAttributes<HTMLArcgisFullscreenElement> {
...
interface LuminaArcgisHome extends Partial<Pick<ArcgisHome, 'autoDestroyDisabled' | 'goToOverride' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'view' | 'viewpoint'>>, h.JSX.HTMLAttributes<HTMLArcgisHomeElement> {
...
interface LuminaArcgisLegend extends Partial<Pick<ArcgisLegend, 'activeLayerInfos' | 'autoDestroyDisabled' | 'basemapLegendVisible' | 'cardStyleLayout' | 'headingLevel' | 'hideLayersNotInCurrentView' | 'icon' | 'ignoreLayerVisibility' | 'label' | 'layerInfos' | 'legendStyle' | 'messageOverrides' | 'position' | 'referenceElement' | 'respectLayerDefinitionExpression' | 'respectLayerVisibilityDisabled' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisLegendElement> {
...
interface LuminaArcgisLineOfSight extends Partial<Pick<ArcgisLineOfSight, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisLineOfSightElement> {
...
interface LuminaArcgisLinkChartLayoutSwitcher extends Partial<Pick<ArcgisLinkChartLayoutSwitcher, 'appearance' | 'autoDestroyDisabled' | 'closeOnSelectDisabled' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'preventExtentUpdate' | 'referenceElement' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisLinkChartLayoutSwitcherElement> {
...
interface LuminaArcgisLocate extends Partial<Pick<ArcgisLocate, 'autoDestroyDisabled' | 'geolocationOptions' | 'goToLocationDisabled' | 'goToOverride' | 'graphic' | 'icon' | 'label' | 'messageOverrides' | 'popupDisabled' | 'position' | 'referenceElement' | 'scale' | 'state' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisLocateElement> {
...
interface LuminaArcgisMeasurement extends Partial<Pick<ArcgisMeasurement, 'activeTool' | 'areaUnit' | 'autoDestroyDisabled' | 'icon' | 'label' | 'linearUnit' | 'position' | 'referenceElement' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisMeasurementElement> {
...
interface LuminaArcgisNavigationToggle extends Partial<Pick<ArcgisNavigationToggle, 'icon' | 'label' | 'layout' | 'messageOverrides' | 'navigationMode' | 'position' | 'referenceElement' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisNavigationToggleElement> {
...
interface LuminaArcgisPlacement extends Partial<Pick<ArcgisPlacement, 'position' | 'referenceElement' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisPlacementElement> {
  onarcgisReady?: EventHandler<HTMLArcgisPlacementElement["arcgisReady"]>;
}

interface LuminaArcgisPopup extends Partial<Pick<ArcgisPopup, 'actions' | 'alignment' | 'autoCloseEnabled' | 'autoDestroyDisabled' | 'content' | 'defaultPopupTemplateEnabled' | 'dockEnabled' | 'dockOptions' | 'featureMenuOpen' | 'features' | 'goToOverride' | 'heading' | 'headingLevel' | 'hideActionBar' | 'hideCloseButton' | 'hideCollapseButton' | 'hideFeatureListLayerTitle' | 'hideFeatureMenuHeading' | 'hideFeatureNavigation' | 'hideHeading' | 'hideSpinner' | 'highlightDisabled' | 'includeDefaultActionsDisabled' | 'initialDisplayMode' | 'label' | 'location' | 'messageOverrides' | 'promises' | 'referenceElement' | 'selectedFeatureIndex' | 'view' | 'visible'>>, h.JSX.HTMLAttributes<HTMLArcgisPopupElement> {
...
interface LuminaArcgisScaleBar extends Partial<Pick<ArcgisScaleBar, 'autoDestroyDisabled' | 'barStyle' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'unit' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisScaleBarElement> {
  onarcgisReady?: EventHandler<HTMLArcgisScaleBarElement["arcgisReady"]>;
}

interface LuminaArcgisScaleRangeSlider extends Partial<Pick<ArcgisScaleRangeSlider, 'autoDestroyDisabled' | 'disabled' | 'hidePreview' | 'hideScaleMenusMaxScaleMenu' | 'hideScaleMenusMinScaleMenu' | 'icon' | 'label' | 'layer' | 'maxScale' | 'maxScaleLimit' | 'minScale' | 'minScaleLimit' | 'mode' | 'position' | 'referenceElement' | 'region' | 'showWorldValue' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisScaleRangeSliderElement> {
...
interface LuminaArcgisSlice extends Partial<Pick<ArcgisSlice, 'analysis' | 'autoDestroyDisabled' | 'excludedLayers' | 'excludeGroundSurface' | 'headingLevel' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'shape' | 'tiltEnabled' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisSliceElement> {
...
interface LuminaArcgisSwipe extends Partial<Pick<ArcgisSwipe, 'autoDestroyDisabled' | 'direction' | 'disabled' | 'hideDivider' | 'hideHandle' | 'icon' | 'label' | 'leadingLayers' | 'messageOverrides' | 'position' | 'referenceElement' | 'swipePosition' | 'trailingLayers' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisSwipeElement> {
...
interface LuminaArcgisTimeSlider extends Partial<Pick<ArcgisTimeSlider, 'actions' | 'autoDestroyDisabled' | 'disabled' | 'fullTimeExtent' | 'icon' | 'label' | 'layout' | 'loop' | 'mode' | 'playRate' | 'position' | 'referenceElement' | 'stops' | 'tickConfigs' | 'timeExtent' | 'timeVisible' | 'timeZone' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisTimeSliderElement> {
...
interface LuminaArcgisTimeZoneLabel extends Partial<Pick<ArcgisTimeZoneLabel, 'disabled' | 'expanded' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'view'>>, ArcgisTimeZoneLabelSetterTypes, h.JSX.HTMLAttributes<HTMLArcgisTimeZoneLabelElement> {
...
interface LuminaArcgisTrack extends Partial<Pick<ArcgisTrack, 'autoDestroyDisabled' | 'error' | 'geolocationOptions' | 'goToLocationDisabled' | 'goToOverride' | 'graphic' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'positionFilterFunction' | 'referenceElement' | 'rotationDisabled' | 'scale' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisTrackElement> {
...
interface LuminaArcgisUtilityNetworkTraceAnalysis extends Partial<Pick<ArcgisUtilityNetworkTraceAnalysis, 'allowEditingDisabled' | 'autoDestroyDisabled' | 'closable' | 'icon' | 'label' | 'messageOverrides' | 'mode' | 'referenceElement' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisUtilityNetworkTraceAnalysisElement> {
...
interface LuminaArcgisUtilityNetworkResultFeatureList extends Required<Pick<ArcgisUtilityNetworkResultFeatureList, 'elements' | 'layers' | 'utilityNetwork'>>, Partial<Pick<ArcgisUtilityNetworkResultFeatureList, 'messageOverrides'>>, h.JSX.HTMLAttributes<HTMLArcgisUtilityNetworkResultFeatureListElement> {
  onarcgisSelectedLayerChange?: EventHandler<HTMLArcgisUtilityNetworkResultFeatureListElement["arcgisSelectedLayerChange"]>;
}

interface LuminaArcgisUtilityNetworkTraceInputs extends Required<Pick<ArcgisUtilityNetworkTraceInputs, 'view'>>, Partial<Pick<ArcgisUtilityNetworkTraceInputs, 'referenceElement' | 'selectedTraceConfiguration' | 'selectedUtilityNetwork'>>, h.JSX.HTMLAttributes<HTMLArcgisUtilityNetworkTraceInputsElement> {
...
interface LuminaArcgisUtilityNetworkTraceResults extends Partial<Pick<ArcgisUtilityNetworkTraceResults, 'layers' | 'messageOverrides' | 'traceConfigTitle' | 'traceResult' | 'utilityNetwork'>>, h.JSX.HTMLAttributes<HTMLArcgisUtilityNetworkTraceResultsElement> {
  onarcgisSelectedResultTypeChange?: EventHandler<HTMLArcgisUtilityNetworkTraceResultsElement["arcgisSelectedResultTypeChange"]>;
}

interface LuminaArcgisUtilityNetworkValidateTopology extends Partial<Pick<ArcgisUtilityNetworkValidateTopology, 'autoDestroyDisabled' | 'extentToValidate' | 'icon' | 'label' | 'position' | 'referenceElement' | 'utilityNetwork' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisUtilityNetworkValidateTopologyElement> {
...
interface LuminaArcgisVideo extends Partial<Pick<ArcgisVideo, 'aria' | 'autoDestroyDisabled' | 'layer' | 'map'>>, h.JSX.HTMLAttributes<HTMLArcgisVideoElement> {
  onarcgisViewReadyChange?: EventHandler<HTMLArcgisVideoElement["arcgisViewReadyChange"]>;
}

interface LuminaArcgisVideoPlayer extends Partial<Pick<ArcgisVideoPlayer, 'autoDestroyDisabled' | 'followingMode' | 'hideHeader' | 'icon' | 'label' | 'layer' | 'messageOverrides' | 'position' | 'referenceElement' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisVideoPlayerElement> {
...
interface LuminaArcgisWeather extends Partial<Pick<ArcgisWeather, 'autoDestroyDisabled' | 'headingLevel' | 'hideHeader' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisWeatherElement> {
...
interface LuminaArcgisZoom extends Partial<Pick<ArcgisZoom, 'autoDestroyDisabled' | 'icon' | 'label' | 'layout' | 'messageOverrides' | 'position' | 'referenceElement' | 'state' | 'view'>>, h.JSX.HTMLAttributes<HTMLArcgisZoomElement> {
...
declare module "@arcgis/lumina" {
  export namespace h.JSX {
    interface IntrinsicElements {
      ...
      "arcgis-elevation-profile-next": LuminaArcgisElevationProfileNext;
      ...
      "arcgis-popup": LuminaArcgisPopup;
      ...
      "arcgis-utility-network-trace-analysis": LuminaArcgisUtilityNetworkTraceAnalysis;
      "arcgis-utility-network-result-feature-list": LuminaArcgisUtilityNetworkResultFeatureList;
      "arcgis-utility-network-trace-inputs": LuminaArcgisUtilityNetworkTraceInputs;
      "arcgis-utility-network-trace-results": LuminaArcgisUtilityNetworkTraceResults;
