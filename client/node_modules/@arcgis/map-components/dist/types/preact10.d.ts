...
interface PreactArcgisAreaMeasurement2d extends Partial<Pick<ArcgisAreaMeasurement2d, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'snappingOptions' | 'unit' | 'unitOptions' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisAreaMeasurement2dElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisAreaMeasurement3d extends Partial<Pick<ArcgisAreaMeasurement3d, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisAreaMeasurement3dElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisBasemapGallery extends Partial<Pick<ArcgisBasemapGallery, 'activeBasemap' | 'autoDestroyDisabled' | 'disabled' | 'headingLevel' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'source' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisBasemapGalleryElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisBasemapToggle extends Partial<Pick<ArcgisBasemapToggle, 'autoDestroyDisabled' | 'icon' | 'label' | 'messageOverrides' | 'nextBasemap' | 'position' | 'referenceElement' | 'showTitle' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisBasemapToggleElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisBuildingExplorer extends Partial<Pick<ArcgisBuildingExplorer, 'autoDestroyDisabled' | 'headingLevel' | 'hideDisciplines' | 'hideLevels' | 'hidePhases' | 'icon' | 'label' | 'layers' | 'position' | 'referenceElement' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisBuildingExplorerElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisCompass extends Partial<Pick<ArcgisCompass, 'autoDestroyDisabled' | 'goToOverride' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisCompassElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisDirectionalPad extends Partial<Pick<ArcgisDirectionalPad, 'autoDestroyDisabled' | 'disabled' | 'hideDirectionalButtons' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'showRotationResetButton' | 'showRotationSlider' | 'view' | 'visualScale'>>, PreactJsx.HTMLAttributes<HTMLArcgisDirectionalPadElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisDirections extends Partial<Pick<ArcgisDirections, 'apiKey' | 'autoDestroyDisabled' | 'goToOverride' | 'headingLevel' | 'hideLayerDetails' | 'hideSaveAsButton' | 'hideSaveButton' | 'icon' | 'label' | 'layer' | 'maxStops' | 'position' | 'referenceElement' | 'routeLayerItemId' | 'searchProperties' | 'unit' | 'useDefaultRouteLayer' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisDirectionsElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisDirectLineMeasurement3d extends Partial<Pick<ArcgisDirectLineMeasurement3d, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisDirectLineMeasurement3dElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisDirectlineMeasurement3d extends Partial<Pick<DeprecatedArcgisDirectLineMeasurement3d, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisDirectlineMeasurement3dElement> {
  onarcgisPropertyChange?: EventHandler<HTMLArcgisDirectlineMeasurement3dElement["arcgisPropertyChange"]>;
  onarcgisReady?: EventHandler<HTMLArcgisDirectlineMeasurement3dElement["arcgisReady"]>;
}

/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisDistanceMeasurement2d extends Partial<Pick<ArcgisDistanceMeasurement2d, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'snappingOptions' | 'unit' | 'unitOptions' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisDistanceMeasurement2dElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisFeatureForm extends Partial<Pick<ArcgisFeatureForm, 'autoDestroyDisabled' | 'editType' | 'feature' | 'formTemplate' | 'groupDisplay' | 'headingLevel' | 'icon' | 'label' | 'layer' | 'position' | 'referenceElement' | 'timeZone'>>, PreactJsx.HTMLAttributes<HTMLArcgisFeatureFormElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisFloorFilter extends Partial<Pick<ArcgisFloorFilter, 'autoDestroyDisabled' | 'facility' | 'headingLevel' | 'icon' | 'label' | 'level' | 'longNames' | 'position' | 'referenceElement' | 'site' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisFloorFilterElement> {
  onarcgisReady?: EventHandler<HTMLArcgisFloorFilterElement["arcgisReady"]>;
}

/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisFullscreen extends Partial<Pick<ArcgisFullscreen, 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'view'>>, ArcgisFullscreenSetterTypes, PreactJsx.HTMLAttributes<HTMLArcgisFullscreenElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisHome extends Partial<Pick<ArcgisHome, 'autoDestroyDisabled' | 'goToOverride' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'view' | 'viewpoint'>>, PreactJsx.HTMLAttributes<HTMLArcgisHomeElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisLineOfSight extends Partial<Pick<ArcgisLineOfSight, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisLineOfSightElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisLinkChartLayoutSwitcher extends Partial<Pick<ArcgisLinkChartLayoutSwitcher, 'appearance' | 'autoDestroyDisabled' | 'closeOnSelectDisabled' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'preventExtentUpdate' | 'referenceElement' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisLinkChartLayoutSwitcherElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisLocate extends Partial<Pick<ArcgisLocate, 'autoDestroyDisabled' | 'geolocationOptions' | 'goToLocationDisabled' | 'goToOverride' | 'graphic' | 'icon' | 'label' | 'messageOverrides' | 'popupDisabled' | 'position' | 'referenceElement' | 'scale' | 'state' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisLocateElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisMeasurement extends Partial<Pick<ArcgisMeasurement, 'activeTool' | 'areaUnit' | 'autoDestroyDisabled' | 'icon' | 'label' | 'linearUnit' | 'position' | 'referenceElement' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisMeasurementElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisNavigationToggle extends Partial<Pick<ArcgisNavigationToggle, 'icon' | 'label' | 'layout' | 'messageOverrides' | 'navigationMode' | 'position' | 'referenceElement' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisNavigationToggleElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisPlacement extends Partial<Pick<ArcgisPlacement, 'position' | 'referenceElement' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisPlacementElement> {
  onarcgisReady?: EventHandler<HTMLArcgisPlacementElement["arcgisReady"]>;
}

/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisPopup extends Partial<Pick<ArcgisPopup, 'actions' | 'alignment' | 'autoCloseEnabled' | 'autoDestroyDisabled' | 'content' | 'defaultPopupTemplateEnabled' | 'dockEnabled' | 'dockOptions' | 'featureMenuOpen' | 'features' | 'goToOverride' | 'heading' | 'headingLevel' | 'hideActionBar' | 'hideCloseButton' | 'hideCollapseButton' | 'hideFeatureListLayerTitle' | 'hideFeatureMenuHeading' | 'hideFeatureNavigation' | 'hideHeading' | 'hideSpinner' | 'highlightDisabled' | 'includeDefaultActionsDisabled' | 'initialDisplayMode' | 'label' | 'location' | 'messageOverrides' | 'promises' | 'referenceElement' | 'selectedFeatureIndex' | 'view' | 'visible'>>, PreactJsx.HTMLAttributes<HTMLArcgisPopupElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisScaleBar extends Partial<Pick<ArcgisScaleBar, 'autoDestroyDisabled' | 'barStyle' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'unit' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisScaleBarElement> {
  onarcgisReady?: EventHandler<HTMLArcgisScaleBarElement["arcgisReady"]>;
}

/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisScaleRangeSlider extends Partial<Pick<ArcgisScaleRangeSlider, 'autoDestroyDisabled' | 'disabled' | 'hidePreview' | 'hideScaleMenusMaxScaleMenu' | 'hideScaleMenusMinScaleMenu' | 'icon' | 'label' | 'layer' | 'maxScale' | 'maxScaleLimit' | 'minScale' | 'minScaleLimit' | 'mode' | 'position' | 'referenceElement' | 'region' | 'showWorldValue' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisScaleRangeSliderElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisSlice extends Partial<Pick<ArcgisSlice, 'analysis' | 'autoDestroyDisabled' | 'excludedLayers' | 'excludeGroundSurface' | 'headingLevel' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'shape' | 'tiltEnabled' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisSliceElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisSwipe extends Partial<Pick<ArcgisSwipe, 'autoDestroyDisabled' | 'direction' | 'disabled' | 'hideDivider' | 'hideHandle' | 'icon' | 'label' | 'leadingLayers' | 'messageOverrides' | 'position' | 'referenceElement' | 'swipePosition' | 'trailingLayers' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisSwipeElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisTimeSlider extends Partial<Pick<ArcgisTimeSlider, 'actions' | 'autoDestroyDisabled' | 'disabled' | 'fullTimeExtent' | 'icon' | 'label' | 'layout' | 'loop' | 'mode' | 'playRate' | 'position' | 'referenceElement' | 'stops' | 'tickConfigs' | 'timeExtent' | 'timeVisible' | 'timeZone' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisTimeSliderElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisTimeZoneLabel extends Partial<Pick<ArcgisTimeZoneLabel, 'disabled' | 'expanded' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'view'>>, ArcgisTimeZoneLabelSetterTypes, PreactJsx.HTMLAttributes<HTMLArcgisTimeZoneLabelElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisTrack extends Partial<Pick<ArcgisTrack, 'autoDestroyDisabled' | 'error' | 'geolocationOptions' | 'goToLocationDisabled' | 'goToOverride' | 'graphic' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'positionFilterFunction' | 'referenceElement' | 'rotationDisabled' | 'scale' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisTrackElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisUtilityNetworkTraceAnalysis extends Partial<Pick<ArcgisUtilityNetworkTraceAnalysis, 'allowEditingDisabled' | 'autoDestroyDisabled' | 'closable' | 'icon' | 'label' | 'messageOverrides' | 'mode' | 'referenceElement' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisUtilityNetworkTraceAnalysisElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisUtilityNetworkResultFeatureList extends Required<Pick<ArcgisUtilityNetworkResultFeatureList, 'elements' | 'layers' | 'utilityNetwork'>>, Partial<Pick<ArcgisUtilityNetworkResultFeatureList, 'messageOverrides'>>, PreactJsx.HTMLAttributes<HTMLArcgisUtilityNetworkResultFeatureListElement> {
  onarcgisSelectedLayerChange?: EventHandler<HTMLArcgisUtilityNetworkResultFeatureListElement["arcgisSelectedLayerChange"]>;
}

/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisUtilityNetworkTraceInputs extends Required<Pick<ArcgisUtilityNetworkTraceInputs, 'view'>>, Partial<Pick<ArcgisUtilityNetworkTraceInputs, 'referenceElement' | 'selectedTraceConfiguration' | 'selectedUtilityNetwork'>>, PreactJsx.HTMLAttributes<HTMLArcgisUtilityNetworkTraceInputsElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisUtilityNetworkTraceResults extends Partial<Pick<ArcgisUtilityNetworkTraceResults, 'layers' | 'messageOverrides' | 'traceConfigTitle' | 'traceResult' | 'utilityNetwork'>>, PreactJsx.HTMLAttributes<HTMLArcgisUtilityNetworkTraceResultsElement> {
  onarcgisSelectedResultTypeChange?: EventHandler<HTMLArcgisUtilityNetworkTraceResultsElement["arcgisSelectedResultTypeChange"]>;
}

/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisUtilityNetworkValidateTopology extends Partial<Pick<ArcgisUtilityNetworkValidateTopology, 'autoDestroyDisabled' | 'extentToValidate' | 'icon' | 'label' | 'position' | 'referenceElement' | 'utilityNetwork' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisUtilityNetworkValidateTopologyElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisVideo extends Partial<Pick<ArcgisVideo, 'aria' | 'autoDestroyDisabled' | 'layer' | 'map'>>, PreactJsx.HTMLAttributes<HTMLArcgisVideoElement> {
  onarcgisViewReadyChange?: EventHandler<HTMLArcgisVideoElement["arcgisViewReadyChange"]>;
}

/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisVideoPlayer extends Partial<Pick<ArcgisVideoPlayer, 'autoDestroyDisabled' | 'followingMode' | 'hideHeader' | 'icon' | 'label' | 'layer' | 'messageOverrides' | 'position' | 'referenceElement' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisVideoPlayerElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisWeather extends Partial<Pick<ArcgisWeather, 'autoDestroyDisabled' | 'headingLevel' | 'hideHeader' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisWeatherElement> {
...
/** @deprecated Update to Preact 10.27.2+ or 11+ and consume types/preact file over types/preact10 */
interface PreactArcgisZoom extends Partial<Pick<ArcgisZoom, 'autoDestroyDisabled' | 'icon' | 'label' | 'layout' | 'messageOverrides' | 'position' | 'referenceElement' | 'state' | 'view'>>, PreactJsx.HTMLAttributes<HTMLArcgisZoomElement> {
