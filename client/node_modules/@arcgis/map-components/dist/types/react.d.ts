...
interface ReactArcgisAreaMeasurement2d extends Partial<Pick<ArcgisAreaMeasurement2d, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'snappingOptions' | 'unit' | 'unitOptions' | 'view'>>, HTMLProps<HTMLArcgisAreaMeasurement2dElement> {
...
interface ReactArcgisAreaMeasurement3d extends Partial<Pick<ArcgisAreaMeasurement3d, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions' | 'view'>>, HTMLProps<HTMLArcgisAreaMeasurement3dElement> {
...
interface ReactArcgisBasemapGallery extends Partial<Pick<ArcgisBasemapGallery, 'activeBasemap' | 'autoDestroyDisabled' | 'disabled' | 'headingLevel' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'source' | 'view'>>, HTMLProps<HTMLArcgisBasemapGalleryElement> {
...
interface ReactArcgisBasemapToggle extends Partial<Pick<ArcgisBasemapToggle, 'autoDestroyDisabled' | 'icon' | 'label' | 'messageOverrides' | 'nextBasemap' | 'position' | 'referenceElement' | 'showTitle' | 'view'>>, HTMLProps<HTMLArcgisBasemapToggleElement> {
...
interface ReactArcgisBuildingExplorer extends Partial<Pick<ArcgisBuildingExplorer, 'autoDestroyDisabled' | 'headingLevel' | 'hideDisciplines' | 'hideLevels' | 'hidePhases' | 'icon' | 'label' | 'layers' | 'position' | 'referenceElement' | 'view'>>, HTMLProps<HTMLArcgisBuildingExplorerElement> {
...
interface ReactArcgisCompass extends Partial<Pick<ArcgisCompass, 'autoDestroyDisabled' | 'goToOverride' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'view'>>, HTMLProps<HTMLArcgisCompassElement> {
...
interface ReactArcgisCoordinateConversion extends Partial<Pick<ArcgisCoordinateConversion, 'autoDestroyDisabled' | 'conversions' | 'currentLocation' | 'expanded' | 'formats' | 'goToOverride' | 'headingLevel' | 'hideCaptureButton' | 'hideExpandButton' | 'hideInputButton' | 'hideSettingsButton' | 'icon' | 'label' | 'locationSymbol' | 'mode' | 'multipleConversionsDisabled' | 'orientation' | 'position' | 'referenceElement' | 'storageDisabled' | 'storageType' | 'view'>>, HTMLProps<HTMLArcgisCoordinateConversionElement> {
...
interface ReactArcgisDirectionalPad extends Partial<Pick<ArcgisDirectionalPad, 'autoDestroyDisabled' | 'disabled' | 'hideDirectionalButtons' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'showRotationResetButton' | 'showRotationSlider' | 'view' | 'visualScale'>>, HTMLProps<HTMLArcgisDirectionalPadElement> {
...
interface ReactArcgisDirections extends Partial<Pick<ArcgisDirections, 'apiKey' | 'autoDestroyDisabled' | 'goToOverride' | 'headingLevel' | 'hideLayerDetails' | 'hideSaveAsButton' | 'hideSaveButton' | 'icon' | 'label' | 'layer' | 'maxStops' | 'position' | 'referenceElement' | 'routeLayerItemId' | 'searchProperties' | 'unit' | 'useDefaultRouteLayer' | 'view'>>, HTMLProps<HTMLArcgisDirectionsElement> {
...
interface ReactArcgisDirectLineMeasurement3d extends Partial<Pick<ArcgisDirectLineMeasurement3d, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions' | 'view'>>, HTMLProps<HTMLArcgisDirectLineMeasurement3dElement> {
...
interface ReactArcgisDirectlineMeasurement3d extends Partial<Pick<DeprecatedArcgisDirectLineMeasurement3d, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'unit' | 'unitOptions' | 'view'>>, HTMLProps<HTMLArcgisDirectlineMeasurement3dElement> {
  onarcgisPropertyChange?: EventHandler<HTMLArcgisDirectlineMeasurement3dElement["arcgisPropertyChange"]>;
  onarcgisReady?: EventHandler<HTMLArcgisDirectlineMeasurement3dElement["arcgisReady"]>;
}

interface ReactArcgisDistanceMeasurement2d extends Partial<Pick<ArcgisDistanceMeasurement2d, 'autoDestroyDisabled' | 'icon' | 'label' | 'position' | 'referenceElement' | 'snappingOptions' | 'unit' | 'unitOptions' | 'view'>>, HTMLProps<HTMLArcgisDistanceMeasurement2dElement> {
...
interface ReactArcgisElevationProfileNext extends Partial<Pick<ArcgisElevationProfileNext, 'analysis' | 'autoDestroyDisabled' | 'elevationInfo' | 'geometry' | 'hideChart' | 'hideClearButton' | 'hideLegend' | 'hideSelectButton' | 'hideSettingsButton' | 'hideSketchButton' | 'hideUniformChartScalingToggle' | 'hideUnitSelector' | 'highlightEnabled' | 'hoveredPosition' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'profiles' | 'referenceElement' | 'state' | 'uniformChartScaling' | 'unitDistance' | 'unitElevation' | 'unitOptionsDistance' | 'unitOptionsElevation' | 'view'>>, HTMLProps<HTMLArcgisElevationProfileNextElement> {
...
interface ReactArcgisExpand extends Partial<Pick<ArcgisExpand, 'autoCollapse' | 'autoDestroyDisabled' | 'closeOnEscDisabled' | 'collapseTooltip' | 'expanded' | 'expandIcon' | 'expandTooltip' | 'focusTrapDisabled' | 'focusTrapEnabled' | 'group' | 'iconNumber' | 'label' | 'messageOverrides' | 'mode' | 'placement' | 'position' | 'referenceElement' | 'view'>>, ArcgisExpandSetterTypes, HTMLProps<HTMLArcgisExpandElement> {
...
interface ReactArcgisFeatureForm extends Partial<Pick<ArcgisFeatureForm, 'autoDestroyDisabled' | 'editType' | 'feature' | 'formTemplate' | 'groupDisplay' | 'headingLevel' | 'icon' | 'label' | 'layer' | 'position' | 'referenceElement' | 'timeZone'>>, HTMLProps<HTMLArcgisFeatureFormElement> {
...
interface ReactArcgisFeatures extends Partial<Pick<ArcgisFeatures, 'actions' | 'autoDestroyDisabled' | 'closed' | 'collapsed' | 'content' | 'defaultPopupTemplateEnabled' | 'featureMenuOpen' | 'featureMenuTitle' | 'featureNavigationTop' | 'features' | 'featuresPerPage' | 'featuresTitle' | 'featureViewModelAbilities' | 'goToOverride' | 'headerActions' | 'heading' | 'headingLevel' | 'hideActionBar' | 'hideCloseButton' | 'hideFeatureListLayerTitle' | 'hideFeatureMenuHeading' | 'hideFeatureNavigation' | 'hideFlow' | 'hideHeading' | 'hideSpinner' | 'highlightDisabled' | 'icon' | 'includeDefaultActionsDisabled' | 'initialDisplayMode' | 'label' | 'map' | 'messageOverrides' | 'position' | 'promises' | 'referenceElement' | 'selectedFeatureIndex' | 'showCollapseButton' | 'spatialReference' | 'timeZone' | 'view' | 'viewModel' | 'visible'>>, HTMLProps<HTMLArcgisFeaturesElement> {
...
interface ReactArcgisFloorFilter extends Partial<Pick<ArcgisFloorFilter, 'autoDestroyDisabled' | 'facility' | 'headingLevel' | 'icon' | 'label' | 'level' | 'longNames' | 'position' | 'referenceElement' | 'site' | 'view'>>, HTMLProps<HTMLArcgisFloorFilterElement> {
  onarcgisReady?: EventHandler<HTMLArcgisFloorFilterElement["arcgisReady"]>;
}

interface ReactArcgisFullscreen extends Partial<Pick<ArcgisFullscreen, 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'view'>>, ArcgisFullscreenSetterTypes, HTMLProps<HTMLArcgisFullscreenElement> {
...
interface ReactArcgisHome extends Partial<Pick<ArcgisHome, 'autoDestroyDisabled' | 'goToOverride' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'view' | 'viewpoint'>>, HTMLProps<HTMLArcgisHomeElement> {
...
interface ReactArcgisLegend extends Partial<Pick<ArcgisLegend, 'activeLayerInfos' | 'autoDestroyDisabled' | 'basemapLegendVisible' | 'cardStyleLayout' | 'headingLevel' | 'hideLayersNotInCurrentView' | 'icon' | 'ignoreLayerVisibility' | 'label' | 'layerInfos' | 'legendStyle' | 'messageOverrides' | 'position' | 'referenceElement' | 'respectLayerDefinitionExpression' | 'respectLayerVisibilityDisabled' | 'view'>>, HTMLProps<HTMLArcgisLegendElement> {
...
interface ReactArcgisLineOfSight extends Partial<Pick<ArcgisLineOfSight, 'analysis' | 'autoDestroyDisabled' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'view'>>, HTMLProps<HTMLArcgisLineOfSightElement> {
...
interface ReactArcgisLinkChartLayoutSwitcher extends Partial<Pick<ArcgisLinkChartLayoutSwitcher, 'appearance' | 'autoDestroyDisabled' | 'closeOnSelectDisabled' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'preventExtentUpdate' | 'referenceElement' | 'view'>>, HTMLProps<HTMLArcgisLinkChartLayoutSwitcherElement> {
...
interface ReactArcgisLocate extends Partial<Pick<ArcgisLocate, 'autoDestroyDisabled' | 'geolocationOptions' | 'goToLocationDisabled' | 'goToOverride' | 'graphic' | 'icon' | 'label' | 'messageOverrides' | 'popupDisabled' | 'position' | 'referenceElement' | 'scale' | 'state' | 'view'>>, HTMLProps<HTMLArcgisLocateElement> {
...
interface ReactArcgisMeasurement extends Partial<Pick<ArcgisMeasurement, 'activeTool' | 'areaUnit' | 'autoDestroyDisabled' | 'icon' | 'label' | 'linearUnit' | 'position' | 'referenceElement' | 'view'>>, HTMLProps<HTMLArcgisMeasurementElement> {
...
interface ReactArcgisNavigationToggle extends Partial<Pick<ArcgisNavigationToggle, 'icon' | 'label' | 'layout' | 'messageOverrides' | 'navigationMode' | 'position' | 'referenceElement' | 'view'>>, HTMLProps<HTMLArcgisNavigationToggleElement> {
...
interface ReactArcgisPlacement extends Partial<Pick<ArcgisPlacement, 'position' | 'referenceElement' | 'view'>>, HTMLProps<HTMLArcgisPlacementElement> {
  onarcgisReady?: EventHandler<HTMLArcgisPlacementElement["arcgisReady"]>;
}

interface ReactArcgisPopup extends Partial<Pick<ArcgisPopup, 'actions' | 'alignment' | 'autoCloseEnabled' | 'autoDestroyDisabled' | 'content' | 'defaultPopupTemplateEnabled' | 'dockEnabled' | 'dockOptions' | 'featureMenuOpen' | 'features' | 'goToOverride' | 'heading' | 'headingLevel' | 'hideActionBar' | 'hideCloseButton' | 'hideCollapseButton' | 'hideFeatureListLayerTitle' | 'hideFeatureMenuHeading' | 'hideFeatureNavigation' | 'hideHeading' | 'hideSpinner' | 'highlightDisabled' | 'includeDefaultActionsDisabled' | 'initialDisplayMode' | 'label' | 'location' | 'messageOverrides' | 'promises' | 'referenceElement' | 'selectedFeatureIndex' | 'view' | 'visible'>>, HTMLProps<HTMLArcgisPopupElement> {
...
interface ReactArcgisScaleBar extends Partial<Pick<ArcgisScaleBar, 'autoDestroyDisabled' | 'barStyle' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'unit' | 'view'>>, HTMLProps<HTMLArcgisScaleBarElement> {
  onarcgisReady?: EventHandler<HTMLArcgisScaleBarElement["arcgisReady"]>;
}

interface ReactArcgisScaleRangeSlider extends Partial<Pick<ArcgisScaleRangeSlider, 'autoDestroyDisabled' | 'disabled' | 'hidePreview' | 'hideScaleMenusMaxScaleMenu' | 'hideScaleMenusMinScaleMenu' | 'icon' | 'label' | 'layer' | 'maxScale' | 'maxScaleLimit' | 'minScale' | 'minScaleLimit' | 'mode' | 'position' | 'referenceElement' | 'region' | 'showWorldValue' | 'view'>>, HTMLProps<HTMLArcgisScaleRangeSliderElement> {
...
interface ReactArcgisSlice extends Partial<Pick<ArcgisSlice, 'analysis' | 'autoDestroyDisabled' | 'excludedLayers' | 'excludeGroundSurface' | 'headingLevel' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'shape' | 'tiltEnabled' | 'view'>>, HTMLProps<HTMLArcgisSliceElement> {
...
interface ReactArcgisSwipe extends Partial<Pick<ArcgisSwipe, 'autoDestroyDisabled' | 'direction' | 'disabled' | 'hideDivider' | 'hideHandle' | 'icon' | 'label' | 'leadingLayers' | 'messageOverrides' | 'position' | 'referenceElement' | 'swipePosition' | 'trailingLayers' | 'view'>>, HTMLProps<HTMLArcgisSwipeElement> {
...
interface ReactArcgisTimeSlider extends Partial<Pick<ArcgisTimeSlider, 'actions' | 'autoDestroyDisabled' | 'disabled' | 'fullTimeExtent' | 'icon' | 'label' | 'layout' | 'loop' | 'mode' | 'playRate' | 'position' | 'referenceElement' | 'stops' | 'tickConfigs' | 'timeExtent' | 'timeVisible' | 'timeZone' | 'view'>>, HTMLProps<HTMLArcgisTimeSliderElement> {
...
interface ReactArcgisTimeZoneLabel extends Partial<Pick<ArcgisTimeZoneLabel, 'disabled' | 'expanded' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'view'>>, ArcgisTimeZoneLabelSetterTypes, HTMLProps<HTMLArcgisTimeZoneLabelElement> {
...
interface ReactArcgisTrack extends Partial<Pick<ArcgisTrack, 'autoDestroyDisabled' | 'error' | 'geolocationOptions' | 'goToLocationDisabled' | 'goToOverride' | 'graphic' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'positionFilterFunction' | 'referenceElement' | 'rotationDisabled' | 'scale' | 'view'>>, HTMLProps<HTMLArcgisTrackElement> {
...
interface ReactArcgisUtilityNetworkTraceAnalysis extends Partial<Pick<ArcgisUtilityNetworkTraceAnalysis, 'allowEditingDisabled' | 'autoDestroyDisabled' | 'closable' | 'icon' | 'label' | 'messageOverrides' | 'mode' | 'referenceElement' | 'view'>>, HTMLProps<HTMLArcgisUtilityNetworkTraceAnalysisElement> {
...
interface ReactArcgisUtilityNetworkResultFeatureList extends Required<Pick<ArcgisUtilityNetworkResultFeatureList, 'elements' | 'layers' | 'utilityNetwork'>>, Partial<Pick<ArcgisUtilityNetworkResultFeatureList, 'messageOverrides'>>, HTMLProps<HTMLArcgisUtilityNetworkResultFeatureListElement> {
  onarcgisSelectedLayerChange?: EventHandler<HTMLArcgisUtilityNetworkResultFeatureListElement["arcgisSelectedLayerChange"]>;
}

interface ReactArcgisUtilityNetworkTraceInputs extends Required<Pick<ArcgisUtilityNetworkTraceInputs, 'view'>>, Partial<Pick<ArcgisUtilityNetworkTraceInputs, 'referenceElement' | 'selectedTraceConfiguration' | 'selectedUtilityNetwork'>>, HTMLProps<HTMLArcgisUtilityNetworkTraceInputsElement> {
...
interface ReactArcgisUtilityNetworkTraceResults extends Partial<Pick<ArcgisUtilityNetworkTraceResults, 'layers' | 'messageOverrides' | 'traceConfigTitle' | 'traceResult' | 'utilityNetwork'>>, HTMLProps<HTMLArcgisUtilityNetworkTraceResultsElement> {
  onarcgisSelectedResultTypeChange?: EventHandler<HTMLArcgisUtilityNetworkTraceResultsElement["arcgisSelectedResultTypeChange"]>;
}

interface ReactArcgisUtilityNetworkValidateTopology extends Partial<Pick<ArcgisUtilityNetworkValidateTopology, 'autoDestroyDisabled' | 'extentToValidate' | 'icon' | 'label' | 'position' | 'referenceElement' | 'utilityNetwork' | 'view'>>, HTMLProps<HTMLArcgisUtilityNetworkValidateTopologyElement> {
...
interface ReactArcgisVideo extends Partial<Pick<ArcgisVideo, 'aria' | 'autoDestroyDisabled' | 'layer' | 'map'>>, HTMLProps<HTMLArcgisVideoElement> {
  onarcgisViewReadyChange?: EventHandler<HTMLArcgisVideoElement["arcgisViewReadyChange"]>;
}

interface ReactArcgisVideoPlayer extends Partial<Pick<ArcgisVideoPlayer, 'autoDestroyDisabled' | 'followingMode' | 'hideHeader' | 'icon' | 'label' | 'layer' | 'messageOverrides' | 'position' | 'referenceElement' | 'view'>>, HTMLProps<HTMLArcgisVideoPlayerElement> {
...
interface ReactArcgisWeather extends Partial<Pick<ArcgisWeather, 'autoDestroyDisabled' | 'headingLevel' | 'hideHeader' | 'icon' | 'label' | 'messageOverrides' | 'position' | 'referenceElement' | 'view'>>, HTMLProps<HTMLArcgisWeatherElement> {
...
interface ReactArcgisZoom extends Partial<Pick<ArcgisZoom, 'autoDestroyDisabled' | 'icon' | 'label' | 'layout' | 'messageOverrides' | 'position' | 'referenceElement' | 'state' | 'view'>>, HTMLProps<HTMLArcgisZoomElement> {
...
declare module "react" {
  namespace JSX {
    interface IntrinsicElements {
      ...
      "arcgis-elevation-profile-next": ReactArcgisElevationProfileNext;
      ...
      "arcgis-utility-network-trace-analysis": ReactArcgisUtilityNetworkTraceAnalysis;
      "arcgis-utility-network-result-feature-list": ReactArcgisUtilityNetworkResultFeatureList;
      "arcgis-utility-network-trace-inputs": ReactArcgisUtilityNetworkTraceInputs;
      "arcgis-utility-network-trace-results": ReactArcgisUtilityNetworkTraceResults;
