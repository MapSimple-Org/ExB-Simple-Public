import { WebBoxPlot, WebChart, WebChartBarChartSeries, WebChartBoxPlotSeries, WebChartGaugeSeries, WebChartHistogramSeries, WebChartLegend, WebChartLineChartSeries, WebChartPieChartLegend, WebChartPieChartSeries, WebChartRadarChartSeries, WebChartScatterplotSeries, WebGaugeChart, WebHeatChart } from '../../spec';
...
/**
 * Type alias for a Scatterplot config.
 */
 ...
 */
export type ChartConfig<T extends ModelTypes = ModelTypes, V extends WebChart = T extends typeof ModelTypes.BoxPlot ? WebBoxPlot : T extends typeof ModelTypes.Gauge ? WebGaugeChart : T extends typeof ModelTypes.HeatChart ? WebHeatChart : WebChart> = Omit<V, "legend" | "series"> & {
