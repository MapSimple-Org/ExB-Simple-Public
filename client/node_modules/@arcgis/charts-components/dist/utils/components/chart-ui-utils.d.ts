import { RESTSimpleLineSymbolStyle } from '../../spec';
...
/**
 * Downloads an object as a file using a data URL.
 *
 * @param {string} objectURL - The data URL of the object to download.
 * @param {string} downloadString - The name of the file to download.
 * @category Public
 */
export declare function downloadFile(objectURL: string, downloadString: string): void;
/**
 ...
 */
export declare function destroyTooltip(tooltip: HTMLCalciteTooltipElement | null | undefined): null;
