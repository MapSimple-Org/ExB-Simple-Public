...
import { DefaultChartActions, PieSlicesSymbols, SelectionData, SeriesSymbolsMap } from '../../utils';
import { CalculatedMinMaxBoundsPayload, LegendItemVisibility, WebChartDataTypes, WebChartLegendPositions } from '../../spec';
...
export type PopoverChangePayload = {
    open: boolean | undefined;
    element: JsxNode;
};
...
export type NoRenderPropChangePayload = {
    propName: string;
    value: MapView | SceneView | WebChartLegendPositions | boolean | number | undefined;
    model: ChartModel | undefined;
};
