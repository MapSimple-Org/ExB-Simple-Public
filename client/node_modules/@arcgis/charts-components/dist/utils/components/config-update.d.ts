...
import { SupportedLayer, WebChart, WebChartLegendPositions } from '../../spec';
/**
 ...
 * @param config
 */
export declare function resetAxesBounds(config?: WebChart): WebChart | undefined;
/**
 ...
 */
export declare function isValidDataSource(config?: WebChart, layer?: FeatureLayerView | SupportedLayer): boolean;
/**
 ...
 */
export declare function addMissingSplitBySeries(component: ArcgisChart, config: WebChart | undefined, options: ChartOptions): Promise<void>;
