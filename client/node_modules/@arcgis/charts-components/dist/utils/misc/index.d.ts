import { IField, LegendItemVisibility, WebBoxPlot, WebChart, WebChartDataItem, WebChartDataItemValue, WebChartSeries, WebChartStackedKinds, OverlayTerms, WebChartSortOrderKinds, WebChartTemporalBinningUnits, WebChartTypes } from '../../spec';
import { ChartElementLimit } from '../defaults/interfaces';
import { SelectionData, ChartSubType } from './interfaces';
type WebChartType = typeof WebChartTypes.BarSeries | typeof WebChartTypes.BoxPlotSeries | typeof WebChartTypes.ComboLineAndBarSeries | typeof WebChartTypes.GaugeSeries | typeof WebChartTypes.HeatSeries | typeof WebChartTypes.HistogramSeries | typeof WebChartTypes.LineSeries | typeof WebChartTypes.PieSeries | typeof WebChartTypes.RadarSeries | typeof WebChartTypes.ScatterSeries;
type XYChartType = typeof WebChartTypes.BarSeries | typeof WebChartTypes.BoxPlotSeries | typeof WebChartTypes.ComboLineAndBarSeries | typeof WebChartTypes.HeatSeries | typeof WebChartTypes.HistogramSeries | typeof WebChartTypes.LineSeries | typeof WebChartTypes.RadarSeries | typeof WebChartTypes.ScatterSeries;
type SerialChartType = typeof WebChartTypes.BarSeries | typeof WebChartTypes.ComboLineAndBarSeries | typeof WebChartTypes.HeatSeries | typeof WebChartTypes.LineSeries | typeof WebChartTypes.RadarSeries;
type SupportedChartType = typeof WebChartTypes.BarSeries | typeof WebChartTypes.BoxPlotSeries | typeof WebChartTypes.HeatSeries | typeof WebChartTypes.HistogramSeries | typeof WebChartTypes.LineSeries | typeof WebChartTypes.PieSeries | typeof WebChartTypes.RadarSeries | typeof WebChartTypes.ScatterSeries;
...
/**
 * Indicates whether a chart respects the number limit of elements (bars, markers, cells or slices).
 ...
 * For heat chart, a limit on the number of cells is set.
...
/**
 * Returns whether a scatterplot is currently supported
 * @param config The chart's config
 */
declare function isSupportedScatterplot(config: WebChart): boolean;
/**
 * Returns whether a histogram is currently supported
 * @param config The chart's config
 */
declare function isSupportedHistogram(config: WebChart): boolean;
/**
 * Returns whether a pie chart is currently supported
 * @param config The chart's config
 */
declare function isSupportedPieChart(config: WebChart): boolean;
/**
 * Based on a provided list of supported chart types, this function returns a boolean indicating if the config
 * contains supported series. An extra test is done for the scatterplot, pie, and histogram series.
...
export declare const miscPrivateFunctions: {
    isSupportedHistogram: typeof isSupportedHistogram;
    isSupportedPieChart: typeof isSupportedPieChart;
    isSupportedScatterplot: typeof isSupportedScatterplot;
};
export {};
