import { WebChart, WebChartSeriesType, RESTSymbolType, WebChartTypes, WebChartVersionStatus } from '../../../spec';
...
/**
 * Gets the query type for the pie.
 * @param series the pie series
 */
declare function getPieChartChartSubType(series: WebChartSeriesType[]): ChartSubType;
/**
 * Gets the query type for bar/line chart.
 * @param series the bar/line series
 */
declare function getBarLineChartSubType(series: WebChartSeriesType[]): ChartSubType;
/**
 ...
 * @param newConfig
 */
export declare function hasConfigFilterChanged(oldConfig: WebChart, newConfig: WebChart): boolean;
export declare const chartConfigUtilsPrivateFunctions: {
    getPieChartChartSubType: typeof getPieChartChartSubType;
    getBarLineChartSubType: typeof getBarLineChartSubType;
};
export {};
