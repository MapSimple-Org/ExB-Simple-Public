import { TimeIntervalInfo, WebChartDataItem, WebChartTemporalBinningUnits } from '../../../spec';
export interface DateRange {
    dateMinTimestamp: number | null | undefined;
    dateMaxTimestamp: number | null | undefined;
}
