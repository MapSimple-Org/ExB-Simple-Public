...
import { WebBoxPlot, WebChart, WebChartDataItem, WebChartQuery, WebChartTemporalBinning, WebHeatChart } from '../../../spec';
import { ErrorStrings } from '../../localization/interfaces';
...
/**
 * Fetches and returns the heat chart data using query(Attribute)Bins
 ...
 */
export declare function queryAttributeBinsForHeatChart(props: {
    chartConfig: WebBoxPlot | WebChart | WebHeatChart;
    queryObject: QueryObject;
    queryConfig: WebChartQuery;
    errorStrings: ErrorStrings;
}): Promise<AttributeBinsFeatureSet | undefined>;
/**
 * Query the features for the matrix heat chart.
 * @param props.chartConfig The chart configuration
 * @param props.queryObject The object used to query (FL or FLV)
 * @param props.queryConfig The query configuration
 * @param props.returnFeaturesExtent Whether to add an out statistic to fetch the features extent
 * @param props.errorStrings The t9n error strings
 * @param props.abortKey The key to abort the query
 */
export declare function queryFeaturesForMatrixHeatChart(props: {
    chartConfig: WebBoxPlot | WebChart | WebHeatChart;
    queryObject: QueryObject;
    queryConfig: WebChartQuery;
