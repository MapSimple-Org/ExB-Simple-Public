...
import { SupportedLayer, WebChart } from '../../../spec';
 ...
 * @param queryObject
 */
export declare function isFeatureLayerView(queryObject: QueryObject | SubtypeGroupLayer): queryObject is FeatureLayerView;
/**
...
/**
 * Indicates whether a layer supports the queryBins operation for the heat chart use case.
 * @param layer The layer to test
 * @returns A boolean indicating whether the operation is supported
 */
export declare function doesLayerSupportsQueryBinsForHeatChart(layer: SupportedLayer, queryObject: QueryObject): boolean;
/**
 ...
 * @returns A boolean indicating whether the operation is supported
 */
export declare function doesLayerSupportsQueryBinsForTemporalData(layer?: FeatureLayerView | SubtypeGroupLayer | SupportedLayer, splitByField?: string): boolean;
/**
