 ...
 */
export declare const WebChartCurrentVersion = "24.4.0";
/**
...
export interface WebChartNullCategory {
    /**
     * Specifies the text to use for the null category.
     * If none is provided, the default `null` text will be used.
     *
     */
    text?: string;
    /**
     ...
     *
     * @default [150, 150, 150, 255] - symbol.color
     * @default [150, 150, 150, 255] - symbol.outline.color
     * @default 1 - symbol.outline.width
     */
...
export interface DateTimeFormatOptions {
    ...
    /**
     * Represent the JS native [Intl.DateTimeFormatOptions](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/DateTimeFormat/DateTimeFormat), which is based on [CLDR](http://cldr.unicode.org/translation/date-time-1/date-time-patterns) specifications.
     */
...
export interface WebChartAxis {
     ...
     * @remarks This property only applies for axes of an XYChart, not Gauge.
     * @minimum 1
     */
    tickSpacing?: number;
    /**
 ...
 */
interface WebChartTemporalBinningBase {
    /**
 ...
 */
interface WebChartTemporalBinningExtras {
    /**
    ...
    outTimeZone?: string;
    /**
     * The first day of the week. This property is used to determine the start of the week for date-based bins. The default value depends on the user locale (e.g. 7 as Sunday for a USA user, 1 as Monday for a French one).
     * Current limitation: this is applied only when the provided layer supports the `queryBins` operation.
     * @minimum 1
     * @maximum 7
     * @multipleOf 1
...
export interface WebChartCalendarDatePartsBinning extends WebChartTemporalBinningBase {
    /**
 ...
 */
export interface WebChartTemporalBinning extends WebChartTemporalBinningBase, WebChartTemporalBinningExtras {
    /**
...
export interface WebChartBarChartSeries extends WebChartSeries, WebChartTemporalSeries {
     ...
     */
    nullCategory?: WebChartNullCategory;
}
/**
 ...
 */
export interface WebChartHeatChartGradient {
    /**
    ...
    maxValue?: number;
    /**
     * Specifies the color to use for the items outside the lower range specified by minValue. If none is provided,
     * the default color will be used.
     *
     * @default [250, 250, 250, 255] - white
     */
    outsideRangeLowerColor?: Color;
    /**
     * Specifies the color to use for the items outside the upper range specified by maxValue. If none is provided,
     * the default color will be used.
     *
     * @default [0, 0, 255, 255] - blue
     */
    outsideRangeUpperColor?: Color;
}
/**
 * JSON representation of the Heat chart series
 */
export interface WebChartHeatChartSeries extends WebChartSeries {
    type: typeof WebChartTypes.HeatSeries;
    /**
     * Specifies which field represents the y-coordinates of this series. Empty string or one with just white spaces is not allowed. At least 1 or more word characters (a-z, A-Z, _) are needed.
     * @minLength 1
     */
     ...
     */
    xTemporalBinning?: WebChartCalendarDatePartsBinning;
    /**
     * Describes how to bin the temporal data when the y-axis field is a date.
     */
    yTemporalBinning?: WebChartCalendarDatePartsBinning;
    /**
     * Defines how the cells outline should render.
     */
    gridLine?: ISimpleLineSymbol;
    /**
     * Defines the type of rule to apply for the heat chart.
     *
     * @default WebChartHeatChartHeatRulesTypes.Gradient
     */
    ...
    emptyCells?: {
        /**
         * Specifies the text to use by the empty cells.
         * If none is provided, the default `null` text will be used.
         *
         * @default `null`
         */
        text?: string;
        /**
         * Specifies the symbol to use by the empty cells.
         * If none is provided, the default symbol will be used.
         */
        symbol?: ISimpleFillSymbol;
    };
}
 ...
 */
export type WebChartSeriesType = WebChartBarChartSeries | WebChartBoxPlotSeries | WebChartGaugeSeries | WebChartHeatChartSeries | WebChartHistogramSeries | WebChartLineChartSeries | WebChartPieChartSeries | WebChartRadarChartSeries | WebChartScatterplotSeries;
/**
 ...
 */
export interface WebHeatChart extends WebChart, WebChartTemporalBinningExtras {
    /**
