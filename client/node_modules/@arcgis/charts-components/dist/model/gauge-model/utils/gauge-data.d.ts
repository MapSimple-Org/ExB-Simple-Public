 ...
 * @param props.aggregationType
 * @param props.config
 * @param props.layerInfo
 * @param props.commonStrings
 */
 ...
 * @param props.field The field to set
 * @param props.config The guage chart config
 * @param props.layerInfo The layer info
 * @param props.commonStrings The common strings
 */
export declare const setField: (props: {
    field: string;
    config: ChartConfig<typeof ModelTypes.Gauge>;
    layerInfo: LayerInfo;
    commonStrings: CommonStrings;
 ...
 * @returns {string}
 */
export declare function getChartTitle(commonStrings: CommonStrings): string;
