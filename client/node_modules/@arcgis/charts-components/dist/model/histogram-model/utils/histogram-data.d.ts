import { HistogramOverlays, ISimpleFillSymbol, ISimpleLineSymbol, WebChartDataTransformations } from '../../../spec';
import { CommonStrings, HistogramConfig } from '../../../utils';
import { LayerInfo } from '../../interfaces/common';
/**
 * Generate the proper chart title given the current config.
 */
export declare function getChartTitle(config: HistogramConfig, layerInfo: LayerInfo, commonStrings: CommonStrings): string;
/**
 ...
 * @param commonStrings The common strings
 */
export declare const setNumericField: (props: {
    numericField: string;
 ...
 * @param show Whether to show the normal distribution overlay
 * @param config The histogram config
 */
 ...
 * @param config The histogram config
 */
export declare const setSeriesOverlays: (overlays: HistogramOverlays | undefined, config: HistogramConfig) => void;
