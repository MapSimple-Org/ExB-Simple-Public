import { WebChartNullPolicyTypes, WebChartTemporalBinningUnits, WebChartTimeAggregationTypes } from '../../../spec';
 ...
 * @param config The chart configuration.
 */
export declare const getTemporalBinningUnit: (config: ChartConfig) => WebChartTemporalBinningUnits | undefined;
/**
 ...
 * @param config The chart configuration.
 */
export declare const setTemporalBinningUnit: (newUnit: WebChartTemporalBinningUnits | undefined, config: ChartConfig) => void;
/**
