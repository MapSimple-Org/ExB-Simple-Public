import { Color, RESTSimpleLineSymbolStyle, RESTSimpleMarkerSymbolStyle, WebChart, WebChartLineChartSeries, WebChartTypes } from '../../spec';
...
export declare class ComboBarLineChartModel extends SerialChartModel {
     ...
     */
    setSeriesType(seriesIndex: number, seriesType: WebChartTypes): void;
    /**
