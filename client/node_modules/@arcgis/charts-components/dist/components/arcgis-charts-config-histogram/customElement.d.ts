...
import { CalculatedMinMaxBoundsPayload, SupportedLayer, WebChartHistogramDataItem } from '../../spec';
import { JsxNode, PublicLitElement as LitElement, TargetedEvent } from '@arcgis/lumina';
import { PropertyValues } from 'lit';
import { ChartAuthoringPages } from '../../interfaces';

/** @private */
export declare class ArcgisChartsConfigHistogram extends LitElement {
    /**
     * Histogram Model.
     *
     * @category Public
