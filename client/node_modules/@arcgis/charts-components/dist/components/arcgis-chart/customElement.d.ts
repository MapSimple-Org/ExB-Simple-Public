...
import { SupportedLayer, WebChart, WebChartDataFilters, WebChartDataTypes, WebChartLegendPositions } from '../../spec';
import { AxisLabelFormatCallback, ChartOptions, GaugeInnerLabelFormatCallback, GuideTooltipFormatCallback, NotifyOptions, PieChartLegendValueLabelFormatCallback, PreRenderCallback } from '../../chart-rendering/common/interfaces';
...
import { MissingSplitBySeriesProps, DownloadableChartImagesTypes } from '../../utils/components/interfaces';

/**
 * The ArcGIS Chart component renders a chart based on the provided model. Get started by reading the [Introduction to charts](https://developers.arcgis.com/javascript/latest/charts-components-intro/) page.
 *
 ...
 * - [Tutorial: Display a chart](https://developers.arcgis.com/javascript/latest/tutorials/display-and-create-charts-components/)
 * - [Tutorial: Create a heat chart](https://developers.arcgis.com/javascript/latest/tutorials/create-a-heat-chart/)
 * - [Tutorial: Modify a chart](https://developers.arcgis.com/javascript/latest/tutorials/modify-a-chart/)
 *
...
export declare class ArcgisChart extends LitElement {
    ...
    nullAsValid: boolean;
    /**
     * Whether to display or hide all UI messages (e.g. no data warnings, or when the logarithmic scale can't be applied to an
    ...
    /**
     * When `true`, the data label text color is automatically inverted based on the data label background color.
     ...
     *
     * @remarks This feature is currently only available for bar chart.
     * @type {boolean | undefined}
     * @category Public
     * @default undefined
     */
     ...
     *
     * @example <arcgis-chart layer-item-id="05e015c5f0314db9a487a9b46cb37eca" chart-index="2"></arcgis-chart>
     ...
     *
     * NOTE: This method won't work for scatterplot series. The support charts for this method are:
     * - Bar chart
     * - Line chart
     ...
     * @event
     */
    readonly arcgisChartNotFoundWarning: TargetedEvent<this, string>;
    /**
