...
import { CalculatedMinMaxBoundsPayload, SupportedLayer } from '../../spec';
import { JsxNode, PublicLitElement as LitElement, TargetedEvent } from '@arcgis/lumina';
import { PropertyValues } from 'lit';
import { ChartAuthoringPages } from '../../interfaces';

/** @private */
export declare class ArcgisChartsConfigScatterplot extends LitElement {
    /**
     * Scatterplot Model.
     *
     * @category Public
    ...
    /**
     * r2 value for the scatterplot chart.
     *
     * @category Public
     */
    r2?: number;
