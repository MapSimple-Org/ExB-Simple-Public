...
import { k as g } from "../../chunks/chart-ui-utils2.js";
import { u as h } from "../../chunks/useT9n.js";
import { LitElement as m, createEvent as n } from "@arcgis/lumina";
/*! All material copyright Esri, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.34/esri/copyright.txt for details.
v4.34.3 */
const u = "arcgis-charts-config-storage-colors", v = l`:host{--calcite-color-border-1: transparent}.color-header{margin-bottom:.5rem}`;
class b extends m {
  constructor() {
    super(...arguments), this._messages = h(), this.colorSelect = n();
  }
  static {
  ...
  render() {
    ...
    return c`<calcite-label>${this.heading ?? this._messages.color}</calcite-label><calcite-color-picker .value=${g(s)} @calciteColorPickerInput=${this.onColorSelect} .messageOverrides=${{
      g: this._messages.g,
