...
import { PieSlicesSymbols } from '../../utils';
import { CalculatedMinMaxBoundsPayload, SupportedLayer, WebChartGenericDataItem } from '../../spec';
...
/** @private */
export declare class ArcgisChartsConfigPieChart extends LitElement {
    /**
     * Pie Chart Model.
     *
     * @category Public
     ...
     * @event
     */
    readonly arcgisChartsConfigWebChartChange: TargetedEvent<this, void>;
}
