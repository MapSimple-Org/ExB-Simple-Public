...
/**
 * Sets the position attribute of the element containing the AmCharts SVG element
 *
 * @param chart
 * @param position
 */
declare function setSvgContainerPosition(chart: Chart, position?: string): void;
/**
...
/**
 * Setting a message for the chart to raise and display, if prefer, when it fails to create the chart due to bad data.
 *
 * @param chart The chart
...
export declare const utilsErrorModalPrivateFunctions: {
    setSvgContainerPosition: typeof setSvgContainerPosition;
};
export {};
