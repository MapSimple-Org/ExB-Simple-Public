...
import { NumberFormatOptions, WebChart, WebChartAxis, WebChartBarChartSeries, WebChartDataItem, WebChartLineChartSeries, WebChartSeries, WebChartSeriesType, WebChartStackedKinds } from '../../../../../spec';
...
/**
 * Indicates whether a data item contains statistics that will lead to render a box-plot candle.
 *
 * @param props.dataItem The data item containing the statistics
 * @param props.y The y field
 * @param props.splitBy The split-by field
 * @param props.showOutliers Whether the outliers are shown
 */
declare function isValidBoxPlotCandle(props: {
...
export declare const seriesUtilsPrivateFunctions: {
    isValidBoxPlotCandle: typeof isValidBoxPlotCandle;
};
export {};
