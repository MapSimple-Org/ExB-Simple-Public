import { Axis, PieChart, CategoryAxis, DateAxis, ValueAxis, XYChart } from '@amcharts/amcharts4/charts.js';
import { DataItem } from '@amcharts/amcharts4/core.js';
import { ErrorStrings } from '../../../../../../utils';
import { DateTimeFormatOptions, WebChartAxis, WebChartTextSymbol, WebChartTypes } from '../../../../../../spec';
...
/**
 * Updates an adapter on a date axis labels that formats them according to either the config
 * or a custom formatter passed when the chart is created or updated.
 *
 * @param props.axis is an instance of DateAxis
 * @param props.formatOptions contains INTL.DateTimeFormat options info for formatting date-time
 * @param props.axisValueFormatter custom label formatter
 */
declare function updateDateAxisFormatter(props: {
    axis: DateAxis;
    formatOptions: DateTimeFormatOptions;
    dateAxisFormatter?: AxisLabelFormatCallback;
}): void;
/**
...
export declare const utilsAxisformatPrivateFunctions: {
    updateDateAxisFormatter: typeof updateDateAxisFormatter;
};
export {};
