import { ISimpleMarkerSymbol, ISimpleFillSymbol, ISimpleLineSymbol, WebChartBarChartSeries, WebChartScatterplotSeries, WebChartHistogramSeries, WebChartLineChartSeries, WebChartPieChartSeries, WebChartBoxPlotSeries, IRendererSymbol } from '../../../../spec';
...
export interface UpdateSymbolProps<T extends ISimpleFillSymbol | ISimpleLineSymbol | ISimpleMarkerSymbol> {
    element: Sprite;
    seriesConfig: WebChartBarChartSeries | WebChartBoxPlotSeries | WebChartHistogramSeries | WebChartLineChartSeries | WebChartPieChartSeries | WebChartScatterplotSeries;
    seriesSymbol: T;
    seriesIndex?: number;
    colorMatch?: boolean;
