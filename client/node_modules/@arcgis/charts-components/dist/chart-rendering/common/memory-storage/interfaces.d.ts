import { ActionModes, BinnedServerData, QueryObject, SelectionIndexes } from '../../../utils';
import { IField, OverlayTerms, ScatterplotTrendLineData, TimeIntervalInfo, WebChart, WebChartDataItem, WebChartLabelBehavior, WebChartQuery, WebChartStackedKinds, WebChartTypes } from '../../../spec';
import { AxisLabelFormatCallback, BarAndLineDataLabelFormatCallback, BarAndLineTooltipFormatCallback, BoxPlotTooltipFormatCallback, ChartOptions, GuideTooltipFormatCallback, HeatChartDataLabelFormatCallback, HeatChartLabelFormatCallback, HistogramLabelFormatCallback, PieChartLabelFormatCallback, PieChartLegendValueLabelFormatCallback, ScatterplotLabelFormatCallback } from '../interfaces';
export interface CommonStorageType {
    ...
    chart: {
        ...
        trendLineData?: ScatterplotTrendLineData;
    ...
    series: {
        ...
        heatChartDataLabelFormatter?: HeatChartDataLabelFormatCallback;
        ...
        heatChartTooltipFormatter?: HeatChartLabelFormatCallback;
