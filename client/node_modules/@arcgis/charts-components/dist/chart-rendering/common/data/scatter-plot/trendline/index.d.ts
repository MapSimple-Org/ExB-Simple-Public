import { WebChartDataItem } from '../../../../../spec';
 ...
 * @param props
 */
declare function isServerCalculationPossible(props: TrendlineDataProps): Promise<boolean>;
/**
...
export declare const commonScatterplotTrendlinePrivateFunctions: {
    isServerCalculationPossible: typeof isServerCalculationPossible;
};
export {};
