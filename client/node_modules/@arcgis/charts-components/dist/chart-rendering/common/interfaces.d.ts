...
import { IField, SupportedLayer, WebBoxPlot, WebChart, WebChartDataFilters, WebChartDataItem, WebChartDataItemValue, WebChartDataTypes, WebChartPieChartSlice, WebChartQuery, WebGaugeChart } from '../../spec';
import { AbortControllerKeyType, ActionModes, BinnedServerData, ChartElementLimit, CursorRange, ErrorStrings, LoaderColors, QueryObject, SelectionData, SelectionTheme, UtilsStrings } from '../../utils';
...
export interface FetchDataProps {
    ...
    completeHeatChartDataset?: boolean;
    fieldList?: IField[];
}
...
export type HeatChartLabelFormatCallback = (statValue: number, x?: number | string, y?: number | string) => string;
...
export type ScatterplotLabelFormatCallback = (x: number, y: number, sizePolicyValue?: number, dataContext?: WebChartDataItem) => string;
...
/** Describes the signature of the callback function used to customize the heat chart data labels */
export type HeatChartDataLabelFormatCallback = (statValue: number, x?: string, y?: string) => string;
...
export interface ChartOptions {
     ...
     *
     * @remark Currently this feature is only available for stacked bar series and pie charts with `dataLabelsInside` set to true.
     */
     ...
     * or update of the chart, or render the elements up to the given limits. Available on all charts but scatterplot and histogram.
     */
