import { Color, ISimpleFillSymbol, WebChartCursorCrosshair, WebChartDataItem, WebChartNullCategory, WebChartPieChartGroupSlice, RESTHorizontalAlignment, RESTSimpleMarkerSymbolStyle, RESTVerticalAlignment, WebChartLegendPositions, WebChartLineSmoothedKinds, WebChartSortOrderKinds, WebChartStackedKinds } from '../../../spec';
...
export interface CommonChartDefaults {
    ...
    technicalFieldSplitByField: string;
    ...
    lightTextColor: Readonly<EsriColor>;
    darkTextColor: Readonly<EsriColor>;
    ...
    /** gray color used for various purposes */
    grayColor: EsriColor;
}
/**
