...
import { WebChart, WebChartBoxPlotDataItem, WebChartDataItem } from '../../../../spec';
/**
...
/**
 * Compares two configs and indicates whether the style of series has changed
 *
 * @param oldConfig The previous config
 * @param newConfig The updated config
 * @returns A boolean indicating whether the series style has changed
 * @remarks This function is currently not yet applied to box-plots
 */
export declare function hasSeriesStyleChanged(oldConfig: WebChart, newConfig: WebChart): boolean;
