...
import { IField, WebChart, WebChartBarChartSeries, WebChartDataTypes, WebChartLineChartSeries, WebChartRadarChartSeries, WebChartSeriesType, WebChartTypes } from '../../../../../spec';
 ...
 * @param props.groupOfSlicesUpdateNeeded Whether the group slices updated needed
 ...
 */
export declare function setAccessibilityFeatures(series: Series, chartConfig: WebChart): void;
/**
 * Indicates whether the scatterplot series need to be reinitialized.
 * It returns true when the field name changed. The other properties (policy type and min/max values) don't require a reinit.
 *
 * @param chart The chart
 * @param chartConfig The chart's config
 */
declare function isInitializingScatterplotSeriesNeeded(chart: XYChart, chartConfig: WebChart): boolean;
/**
...
export declare const nextSeriesUtilsPrivateFunctions: {
    isInitializingScatterplotSeriesNeeded: typeof isInitializingScatterplotSeriesNeeded;
};
export {};
