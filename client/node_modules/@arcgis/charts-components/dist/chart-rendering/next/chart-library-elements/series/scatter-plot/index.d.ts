import { SerialChart, Series } from '@amcharts/amcharts5';
import { LineSeries } from '@amcharts/amcharts5/xy.js';
import { InitializeScatterplotSeriesProps, UpdateScatterplotSeriesProps } from './interfaces';
/**
 * Indicates whether the provided series instance is a scatterplot overlay series (trendline).
 *
 * @param series The series instance
 */
export declare function isScatterplotOverlaySeries(series: Series): boolean;
/**
 * Finds a scatterplot series amongst the chart's series. For now we handle only one marker series
 * per scatterplot so it will return the first it finds.
 *
 * @param chart The chart
 */
export declare function getScatterplotMarkerSeries(chart: SerialChart): Series | undefined;
/**
 * Finds a scatterplot trend line series amongst the chart's series. For now we handle only one trend line series
 * per scatterplot so it will return the first it finds.
 *
 * @param chart The chart
 */
 ...
 * @param props
 */
export declare function initializeScatterplotSeries(props: InitializeScatterplotSeriesProps): LineSeries[];
/**
 * Update the scatterplot series
 *
 ...
 * @param props.utilsStrings The utils strings
 */
