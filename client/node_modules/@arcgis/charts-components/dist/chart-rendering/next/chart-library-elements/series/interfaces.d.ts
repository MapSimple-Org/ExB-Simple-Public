import { Root, SerialChart } from '@amcharts/amcharts5';
...
import { IField, RESTRendererType, WebBoxPlot, WebChart, WebChartBarChartSeries, WebChartBoxPlotSeries, WebChartDataTypes, WebChartHeatChartSeries, WebChartHistogramSeries, WebChartLineChartSeries, WebChartPieChartSeries, WebChartRadarChartSeries, WebChartScatterplotSeries, WebRadarChart } from '../../../../spec';
import { ChartSubType, QueryObject, SeriesSymbolsMap, SubtypeInfo, UtilsStrings } from '../../../../utils';
...
export interface InitializeSeriesProps<SeriesType extends WebChartBarChartSeries | WebChartBoxPlotSeries | WebChartHeatChartSeries | WebChartHistogramSeries | WebChartLineChartSeries | WebChartPieChartSeries | WebChartRadarChartSeries | WebChartScatterplotSeries> {
...
export interface InitializeXYSeriesProps<SeriesType extends WebChartBarChartSeries | WebChartBoxPlotSeries | WebChartHeatChartSeries | WebChartHistogramSeries | WebChartLineChartSeries | WebChartRadarChartSeries | WebChartScatterplotSeries> extends InitializeSeriesProps<SeriesType> {
...
export interface UpdateSeriesProps<DataTypes extends WebChartDataTypes, ConfigType extends WebBoxPlot | WebChart | WebRadarChart> {
    ...
    utilsStrings: UtilsStrings;
    groupOfSlicesUpdateNeeded?: boolean;
}
export interface UpdateXYSeriesProps<DataTypes extends WebChartDataTypes, SeriesConfig extends WebChartBarChartSeries | WebChartBoxPlotSeries | WebChartHeatChartSeries | WebChartHistogramSeries | WebChartLineChartSeries | WebChartRadarChartSeries | WebChartScatterplotSeries, SeriesType extends ColumnSeries | LineSeries | RadarLineSeries, ConfigType extends WebBoxPlot | WebChart | WebRadarChart> extends UpdateSeriesProps<DataTypes, ConfigType> {
