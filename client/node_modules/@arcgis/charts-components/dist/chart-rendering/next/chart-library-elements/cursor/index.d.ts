...
import { RadarCursor } from '@amcharts/amcharts5/radar.js';
import { XYCursor } from '@amcharts/amcharts5/xy.js';
import { WebChart, WebChartCursorCrosshair } from '../../../../spec';
 ...
 */
export declare function initializeChartCursor(props: {
    root: Root;
    chart: Chart;
    config: WebChart;
}): RadarCursor | XYCursor | undefined;
/**
 * Updates the style and visibility of the cursor's crosshair.
 *
 * @param props.root The root element
 * @param props.chart The chart
 * @param props.cursorCrosshair The cursor crosshair style
 * @param props.config The chart configuration
 */
export declare function updateChartCursor(props: {
    root: Root;
    chart: Chart;
