...
import { TimeIntervalInfo, WebChart, WebChartAxis, WebChartDataTypes } from '../../../../../../spec';
/**
...
/**
 * Determines whether the chart with stacked series contains negative values.
 *
 * @param chart The chart
 * @returns boolean indicating if the chart data has negative values; true if it does, false otherwise
 */
declare function isStackedSeriesWithNegativeValues(chart: XYChart): boolean;
/**
...
export declare const nextUtilsAxisRendererPrivateFunctions: {
    isStackedSeriesWithNegativeValues: typeof isStackedSeriesWithNegativeValues;
};
export {};
