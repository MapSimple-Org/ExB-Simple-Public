import { Graphics, Root, Sprite, Template } from '@amcharts/amcharts5';
import { IRendererSymbol, ISimpleFillSymbol, ISimpleLineSymbol, ISimpleMarkerSymbol, WebChartSeriesType } from '../../../../spec';
interface ElementsProps {
    element?: Graphics | Sprite | Template<Graphics>;
    visible?: boolean;
