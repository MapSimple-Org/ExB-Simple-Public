...
import { ISimpleMarkerSymbol, SimpleFillSymbolStyle, WebChartTextSymbol, RESTHorizontalAlignment, RESTSimpleLineSymbolStyle } from '../../../../../../spec';
 ...
 * @param isTopOrBottom if it should be top or bottom
 */
export declare function mapHAlignmentToAlign(alignment: WebChartTextSymbol["horizontalAlignment"], defaults?: RESTHorizontalAlignment): Percent | undefined;
type HCenterAlignment = "center" | "left" | "right" | undefined;
/**
 * Horizontal alignment for center
 *
 * @param alignment horizontal alignment
 * @param defaults the defaults
 */
export declare function mapHAlignmentToHCenter(alignment: WebChartTextSymbol["horizontalAlignment"], defaults?: RESTHorizontalAlignment): HCenterAlignment;
export {};
