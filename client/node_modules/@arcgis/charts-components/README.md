# ArcGIS Maps SDK for JavaScript - Charts Components

The ArcGIS Maps SDK for JavaScript provides a suite of ready-to-use UI components that simplify the process of creating GIS web applications. This package contains the [Chart component](https://developers.arcgis.com/javascript/latest/references/charts-components/arcgis-chart/) and the [Charts action bar component](https://developers.arcgis.com/javascript/latest/references/charts-components/arcgis-charts-action-bar/) which can be used to build charts and interact with them in your applications.
